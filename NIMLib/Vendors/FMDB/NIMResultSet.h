...
@interface NIMResultSet : NSObject {
    NIMDatabase          *_parentDB;
    NIMStatement         *_statement;
...
/** `NIMStatement` used by result set. */

@property (atomic, retain) NIMStatement *statement;

///------------------------------------
/// @name Creating and closing database
///------------------------------------

/** Create result set from `<NIMStatement>`
 
 @param statement A `<NIMStatement>` to be performed
