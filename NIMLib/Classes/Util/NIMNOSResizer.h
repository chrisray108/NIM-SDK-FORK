...
#define NIMNOSX(w,h) [[NIMNOSResizer sharedResizer] resize:@"x" width:(w) height:(h)]
#define NIMNOSY(w,h) [[NIMNOSResizer sharedResizer] resize:@"y" width:(w) height:(h)]
#define NIMNOSZ(w,h) [[NIMNOSResizer sharedResizer] resize:@"z" width:(w) height:(h)]

@interface NIMNOSResizer : NSObject
