...
class basic_string_base
{
 ...
 public:
   ...
   typedef ::nimboost::intrusive::pointer_traits<pointer> pointer_traits;
   ...
   basic_string_base(BOOST_RV_REF(basic_string_base) b)
      :  members_(nimboost::move(b.alloc()))
   { 
      this->init();
      this->swap_data(b);
   }
   ...
   typedef typename nimboost::aligned_storage< sizeof(long_t),
      ...
      :  public Allocator
   {
      ...
      explicit members_holder(BOOST_FWD_REF(AllocatorConvertible) a)
         :  Allocator(nimboost::forward<AllocatorConvertible>(a))
      {}
   ...
   typedef container_detail::integral_constant<unsigned,
      nimboost::container::container_detail::version<Allocator>::value> alloc_version;
   ...
   void swap_data(basic_string_base& other)
   {
      if(this->is_short()){
         ...
         if(other.is_short()){
            ...
            nimboost::container::swap_dispatch(this->members_.m_repr.long_repr(), other.members_.m_repr.long_repr());
         }
      }
   }
};
...
struct has_trivial_destructor_after_move<nimboost::container::basic_string<C, T, Allocator> >
