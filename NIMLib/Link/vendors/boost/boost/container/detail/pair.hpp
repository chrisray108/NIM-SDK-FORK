...
struct pair
{
   ...
   pair(BOOST_RV_REF(pair) p)
      : first(::nimboost::move(p.first)), second(::nimboost::move(p.second))
   {}
   ...
   pair(BOOST_FWD_REF(U) u, BOOST_FWD_REF(V) v)
      : first(::nimboost::forward<U>(u))
      , second(::nimboost::forward<V>(v))
   {}
...
/*
   ...
   pair(U &&u, V &&v)
      : first(::nimboost::forward<U>(u))
      , second(::nimboost::forward<V>(v), ::nimboost::forward<Args>(args)...)
   {}
...
*/
   ...
   {
      first  = ::nimboost::move(p.first);
      second = ::nimboost::move(p.second);
      return *this;
   }

   template <class D, class S>
   typename ::nimboost::container::container_detail::enable_if_c
      < !(::nimboost::container::container_detail::is_same<T1, D>::value &&
          ::nimboost::container::container_detail::is_same<T2, S>::value)
      , pair &>::type
...
struct is_enum< ::nimboost::container::container_detail::pair<T, U> >
{
   static const bool value = false;
};
...
template <class T1, class T2>
struct is_class< ::nimboost::container::container_detail::pair<T1, T2> >
...
template<class T1, class T2>
struct has_move_emulation_enabled< ::nimboost::container::container_detail::pair<T1, T2> >
   : ::nimboost::true_type
{};
