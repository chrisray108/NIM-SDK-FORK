...
class flat_tree
{
   typedef nimboost::container::vector<Value, A>  vector_t;
 ...
 private:
      ...
      : public value_compare
   {
      ...
      Data(BOOST_RV_REF(Data) d)
         : value_compare(nimboost::move(static_cast<value_compare&>(d))), m_vect(nimboost::move(d.m_vect))
      {}
      ...
      Data(BOOST_RV_REF(Data) d, const A &a)
         : value_compare(nimboost::move(static_cast<value_compare&>(d))), m_vect(nimboost::move(d.m_vect), a)
      {}
      ...
      {
         this->value_compare::operator=(nimboost::move(static_cast<value_compare &>(d)));
         m_vect = nimboost::move(d.m_vect);
         return *this;
      }
      ...
      void swap(Data &d)
      {
         ...
         nimboost::container::swap_dispatch(mycomp, othercomp);
   ...
   flat_tree(BOOST_RV_REF(flat_tree) x, const allocator_type &a)
      :  m_data(nimboost::move(x.m_data), a)
   { }
   ...
   {  m_data = nimboost::move(mx.m_data); return *this;  }
   ...
   std::pair<iterator,bool> insert_unique(BOOST_RV_REF(value_type) val)
   {
      ...
      insert_commit_data data;
      ret.second = this->priv_insert_unique_prepare(val, data);
      ret.first = ret.second ? this->priv_insert_commit(data, nimboost::move(val))
                             : iterator(vector_iterator_get_ptr(data.position));
      return ret;
   }
   ...
   iterator insert_equal(BOOST_RV_REF(value_type) mval)
   {
      ...
      i = this->m_data.m_vect.insert(i, nimboost::move(mval));
      return i;
   }
   ...
   iterator insert_unique(const_iterator pos, BOOST_RV_REF(value_type) val)
   {
      ...
      insert_commit_data data;
      return this->priv_insert_unique_prepare(pos, val, data)
         ? this->priv_insert_commit(data, nimboost::move(val))
         : iterator(vector_iterator_get_ptr(data.position));
   }
   ...
   iterator insert_equal(const_iterator pos, BOOST_RV_REF(value_type) mval)
   {
      ...
      return this->priv_insert_commit(data, nimboost::move(mval));
   }
   ...
   std::pair<iterator, bool> emplace_unique(Args&&... args)
   {
      ...
      stored_allocator_traits::construct(a, &val, ::nimboost::forward<Args>(args)... );
      value_destructor<stored_allocator_type> d(a, val);
      return this->insert_unique(::nimboost::move(val));
   }
   ...
   iterator emplace_hint_unique(const_iterator hint, Args&&... args)
   {
      ...
      stored_allocator_traits::construct(a, &val, ::nimboost::forward<Args>(args)... );
      value_destructor<stored_allocator_type> d(a, val);
      return this->insert_unique(hint, ::nimboost::move(val));
   }
   ...
   iterator emplace_equal(Args&&... args)
   {
      ...
      stored_allocator_traits::construct(a, &val, ::nimboost::forward<Args>(args)... );
      value_destructor<stored_allocator_type> d(a, val);
      return this->insert_equal(::nimboost::move(val));
   }
   ...
   iterator emplace_hint_equal(const_iterator hint, Args&&... args)
   {
      ...
      stored_allocator_traits::construct(a, &val, ::nimboost::forward<Args>(args)... );
      value_destructor<stored_allocator_type> d(a, val);
      return this->insert_equal(hint, ::nimboost::move(val));
   }
      ...
      (insert_commit_data &commit_data, BOOST_FWD_REF(Convertible) convertible)
   {
      return this->m_data.m_vect.insert
         ...
         , nimboost::forward<Convertible>(convertible));
   }
...
class C, class A>
struct has_trivial_destructor_after_move<nimboost::container::container_detail::flat_tree<K, V, KOV, C, A> >
{
