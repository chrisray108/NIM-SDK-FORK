...
class static_storage_allocator
{
   ...
   typedef nimboost::container::container_detail::version_type<static_storage_allocator, 0>   version;
   ...
   typename nimboost::aligned_storage
      <sizeof(T)*N, nimboost::alignment_of<T>::value>::type storage;
};
 ...
 *
 * static_vector is a sequence container like nimboost::container::vector with contiguous storage that can
...
// TEMPORARY WORKAROUND
    ...
    static_vector & operator=(::nimboost::rv< static_vector<value_type, C> > const& other)
#else
    ...
    static_vector(BOOST_RV_REF(static_vector) other)
        : base_t(nimboost::move(static_cast<base_t&>(other)))
    {}
    ...
    static_vector(BOOST_RV_REF_BEG static_vector<value_type, C> BOOST_RV_REF_END other)
        : base_t(nimboost::move(static_cast<typename static_vector<value_type, C>::base_t&>(other)))
    {}
    ...
    {
        base_t::operator=(nimboost::move(static_cast<base_t&>(other)));
        return *this;
    }
    ...
    {
        base_t::operator=(nimboost::move(static_cast<typename static_vector<value_type, C>::base_t&>(other)));
        return *this;
    }
