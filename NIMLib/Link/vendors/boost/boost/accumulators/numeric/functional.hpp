...
#define BOOST_NUMERIC_FUNCTIONAL_DEFINE_UNARY_OP(Name, Op)                                      \
    ...
    {                                                                                           \
        ...
        {                                                                                       \
            BOOST_TYPEOF_NESTED_TYPEDEF_TPL(                                                    \
                nested                                                                          \
              , Op nimboost::numeric::functional::detail::lvalue_of<Arg>()                         \
            )                                                                                   \
    ...
    {                                                                                           \
        struct Name                                                                             \
          : nimboost::detail::function1<functional::Name<_, functional::tag<_> > >                 \
        {};                                                                                     \
    }                                                                                           \
    namespace                                                                                   \
    {                                                                                           \
        op::Name const &Name = nimboost::detail::pod_singleton<op::Name>::instance;                \
    }                                                                                           \
    /**/
...
#define BOOST_NUMERIC_FUNCTIONAL_DEDUCED(Left, Op, Right)                                       \
    BOOST_TYPEOF_NESTED_TYPEDEF_TPL(                                                            \
        nested                                                                                  \
      , nimboost::numeric::functional::detail::lvalue_of<Left>() Op                                \
        nimboost::numeric::functional::detail::lvalue_of<Right>()                                  \
    )                                                                                           \
    typedef typename nested::type type;                                                         \
    /**/
...
#undef BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP
    ...
    namespace op
    {
        ...
        struct promote
          : nimboost::detail::function1<functional::promote<To, _, typename functional::tag<To>::type, functional::tag<_> > >
        {};

        struct min_assign
          : nimboost::detail::function2<functional::min_assign<_1, _2, functional::tag<_1>, functional::tag<_2> > >
        {};

        struct max_assign
          : nimboost::detail::function2<functional::max_assign<_1, _2, functional::tag<_1>, functional::tag<_2> > >
        {};

        struct fdiv
          : nimboost::detail::function2<functional::fdiv<_1, _2, functional::tag<_1>, functional::tag<_2> > >
        {};
        ...
        struct as_min
          : nimboost::detail::function1<functional::as_min<_, functional::tag<_> > >
        {};

        struct as_max
          : nimboost::detail::function1<functional::as_max<_, functional::tag<_> > >
        {};

        struct as_zero
          : nimboost::detail::function1<functional::as_zero<_, functional::tag<_> > >
        {};

        struct as_one
          : nimboost::detail::function1<functional::as_one<_, functional::tag<_> > >
        {};
    }

    namespace
    {
        op::min_assign const &min_assign = nimboost::detail::pod_singleton<op::min_assign>::instance;
        op::max_assign const &max_assign = nimboost::detail::pod_singleton<op::max_assign>::instance;
        op::fdiv const &fdiv = nimboost::detail::pod_singleton<op::fdiv>::instance;
        op::fdiv const &average = nimboost::detail::pod_singleton<op::fdiv>::instance; ///< INTERNAL ONLY
        op::as_min const &as_min = nimboost::detail::pod_singleton<op::as_min>::instance;
        op::as_max const &as_max = nimboost::detail::pod_singleton<op::as_max>::instance;
        op::as_zero const &as_zero = nimboost::detail::pod_singleton<op::as_zero>::instance;
        op::as_one const &as_one = nimboost::detail::pod_singleton<op::as_one>::instance;
