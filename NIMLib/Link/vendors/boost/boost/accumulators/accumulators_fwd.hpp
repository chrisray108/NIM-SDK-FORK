...
#define BOOST_ACCUMULATORS_IGNORE_GLOBAL(X)                             \
    ...
    {                                                                   \
        ...
        {                                                               \
            void ignore()                                               \
            {                                                           \
                nimboost::accumulators::detail::ignore_variable(&X);       \
            }                                                           \
        };                                                              \
    }                                                                   \
    /**/
...
// For defining nimboost::parameter keywords that can be inherited from to
...
#define BOOST_PARAMETER_NESTED_KEYWORD(tag_namespace, name, alias)                                  \
    ...
    {                                                                                               \
        ...
        {                                                                                           \
            ...
            static ::nimboost::parameter::keyword<name ## _<Dummy> > &alias;                           \
        };                                                                                          \
        template<int Dummy>                                                                         \
        ::nimboost::parameter::keyword<name ## _<Dummy> > &name ## _<Dummy>::alias =                   \
        ::nimboost::parameter::keyword<name ## _<Dummy> >::get();                                      \
        typedef name ## _ <> name;                                                                  \
    }                                                                                               \
    namespace                                                                                       \
    {                                                                                               \
        ::nimboost::parameter::keyword<tag_namespace::name> &name =                                    \
        ::nimboost::parameter::keyword<tag_namespace::name>::get();                                    \
    }
