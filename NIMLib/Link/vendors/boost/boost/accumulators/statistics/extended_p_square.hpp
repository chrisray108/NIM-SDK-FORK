    ...
    */
      ...
      : accumulator_base
    {
        ...
        extended_p_square_impl(Args const &args)
          : probabilities(
                nimboost::begin(args[extended_p_square_probabilities])
              , nimboost::end(args[extended_p_square_probabilities])
            )
...
namespace tag
{
      ...
      , extended_p_square_probabilities
    {
        ...
        static nimboost::parameter::keyword<tag::probabilities> const probabilities;
        #endif
    };
}
