...
namespace nimboost { namespace accumulators
{
...
namespace impl
{
    ...
    */
      ...
      : accumulator_base
    {
        ...
        // for nimboost::result_of
        typedef nimboost::tuple<float_type, float_type, float_type> result_type;
        ...
        weighted_peaks_over_threshold_impl(Args const &args)
          ...
          , fit_parameters_(nimboost::make_tuple(0., 0., 0.))
          , is_dirty_(true)
        {
        }
        ...
        result_type result(Args const &args) const
        {
            if (this->is_dirty_)
            {
                ...
                this->fit_parameters_ = nimboost::make_tuple(u_bar, beta_bar, xi_hat);
            }
    ...
    private:
        ...
        mutable result_type fit_parameters_; // nimboost::tuple that stores fit parameters
                ...
                while (sum < threshold)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            nimboost::throw_exception(std::runtime_error(msg.str()));
                            return nimboost::make_tuple(Sample(0), Sample(0), Sample(0));
                        }
                    }
                }
...
}} // namespace nimboost::accumulators
