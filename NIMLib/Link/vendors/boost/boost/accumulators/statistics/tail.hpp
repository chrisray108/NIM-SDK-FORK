...
namespace detail
{
    ...
    struct tail_range
    {
        typedef nimboost::iterator_range<
            nimboost::reverse_iterator<nimboost::permutation_iterator<ElementIterator, IndexIterator> >
        > type;
    };
    ...
    {
        return nimboost::make_iterator_range(
            nimboost::make_reverse_iterator(
                nimboost::make_permutation_iterator(elem_begin, index_end)
            )
          , nimboost::make_reverse_iterator(
                nimboost::make_permutation_iterator(elem_begin, index_begin)
            )
        );
    }
...
namespace tag
{
      ...
      , tail_cache_size_named_arg<LeftRight>
    {
        ...
        static nimboost::parameter::keyword<tail_cache_size_named_arg<LeftRight> > const cache_size;
        #endif
    };
