...
//!\file
//!Describes index adaptor of nimboost::intrusive::unordered_set container, to use it
   ...
   struct equal_function
   {
      ...
      : std::unary_function<value_type, std::size_t>
    {
        std::size_t operator()(const value_type &val) const
        {
            ...
            return nimboost::hash_range(beg, end);
        }
...
//!Index type based in nimboost::intrusive::set.
//!Just derives from nimboost::intrusive::set
   ...
   ,  public iunordered_set_index_aux<MapConfig>::index_t
{
      ...
      , allocator_type &alloc, size_type new_size)
   {
      ...
      if(!alloc.allocation_command
         (nimboost::interprocess::try_shrink_in_place | nimboost::interprocess::nothrow_allocation, old_size, new_size, received_size, buckets).first){
         return old_size;
      }
      ...
      bucket_ptr shunk_p = alloc.allocation_command
         (nimboost::interprocess::shrink_in_place | nimboost::interprocess::nothrow_allocation, received_size, received_size, received_size, buckets).first;
      ...
      , allocator_type &alloc,  const size_type new_num)
   {
      ...
      std::pair<bucket_ptr, bool> ret =
         alloc.allocation_command
            (nimboost::interprocess::expand_fwd | nimboost::interprocess::allocate_new, new_num, new_num, received_size, old_buckets);
...
struct is_intrusive_index
   <nimboost::interprocess::iunordered_set_index<MapConfig> >
{
