...
//!\file
//!Describes index adaptor of nimboost::map container, to use it
...
struct map_index_aux
{
   ...
   typedef nimboost::interprocess::map
...
//!Index type based in nimboost::interprocess::map. Just derives from nimboost::interprocess::map
...
struct is_node_index
   <nimboost::interprocess::map_index<MapConfig> >
{
