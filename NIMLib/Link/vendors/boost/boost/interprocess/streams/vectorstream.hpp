...
//!std::vector, nimboost::interprocess::vector or nimboost::interprocess::basic_string
...
//!contiguous storage, like std::vector, nimboost::interprocess::vector or
//!nimboost::interprocess::basic_string
template <class CharVector, class CharTraits>
