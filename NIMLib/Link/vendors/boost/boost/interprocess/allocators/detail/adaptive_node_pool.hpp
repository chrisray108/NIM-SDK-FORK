...
class private_adaptive_node_pool
   :  public nimboost::container::container_detail::private_adaptive_node_pool_impl
         < typename SegmentManager::segment_manager_base_type
         , ::nimboost::container::adaptive_pool_flag::size_ordered |
           ::nimboost::container::adaptive_pool_flag::address_ordered
         >
{
   typedef nimboost::container::container_detail::private_adaptive_node_pool_impl
      < typename SegmentManager::segment_manager_base_type
      , ::nimboost::container::adaptive_pool_flag::size_ordered |
        ::nimboost::container::adaptive_pool_flag::address_ordered
      > base_t;
