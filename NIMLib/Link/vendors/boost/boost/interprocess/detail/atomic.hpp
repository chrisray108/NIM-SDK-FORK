...
//! Atomically increment an nimboost::uint32_t by 1
//! "mem": pointer to the object
//! Returns the old value pointed to by mem
inline nimboost::uint32_t atomic_inc32(volatile nimboost::uint32_t *mem);

//! Atomically read an nimboost::uint32_t from memory
inline nimboost::uint32_t atomic_read32(volatile nimboost::uint32_t *mem);

//! Atomically set an nimboost::uint32_t in memory
//! "mem": pointer to the object
//! "param": val value that the object will assume
inline void atomic_write32(volatile nimboost::uint32_t *mem, nimboost::uint32_t val);

//! Compare an nimboost::uint32_t's value with "cmp".
//! If they are the same swap the value with "with"
//! "mem": pointer to the value
//! "with": what to swap it with
//! "cmp": the value to compare it to
//! Returns the old value of *mem
inline nimboost::uint32_t atomic_cas32
   (volatile nimboost::uint32_t *mem, nimboost::uint32_t with, nimboost::uint32_t cmp);
...
//! Atomically decrement an nimboost::uint32_t by 1
//! "mem": pointer to the atomic value
//! Returns the old value pointed to by mem
inline nimboost::uint32_t atomic_dec32(volatile nimboost::uint32_t *mem)
...
//! Atomically add 'val' to an nimboost::uint32_t
//! "mem": pointer to the object
//! "val": amount to add
//! Returns the old value pointed to by mem
inline nimboost::uint32_t atomic_add32
   (volatile nimboost::uint32_t *mem, nimboost::uint32_t val)
{
   // int r = *pw;
   // *mem += val;
   // return r;
...
//! Returns the old value pointed to by mem
inline nimboost::uint32_t atomic_dec32(volatile nimboost::uint32_t *mem)
{  return atomic_add32(mem, (nimboost::uint32_t)-1);  }
...
//! "val": amount to add
//! Returns the old value pointed to by mem
inline nimboost::uint32_t atomic_add32(volatile nimboost::uint32_t *mem, nimboost::uint32_t val)
{
   nimboost::uint32_t prev, temp;
...
//! Returns the old value pointed to by mem
inline nimboost::uint32_t atomic_dec32(volatile nimboost::uint32_t *mem)
{  return atomic_add32(mem, nimboost::uint32_t(-1u));  }
...
//! Returns the old value pointed to by mem
inline nimboost::uint32_t atomic_dec32(volatile nimboost::uint32_t *mem)
{  return atomic_add_32_nv(reinterpret_cast<volatile ::uint32_t*>(mem), (nimboost::uint32_t)-1) + 1; }
...
inline nimboost::uint32_t atomic_dec32(volatile nimboost::uint32_t *mem)
{  nimboost::uint32_t old_val = __ATOMIC_DECREMENT_LONG(mem); __MB(); return old_val; }
...
inline nimboost::uint32_t atomic_read32(volatile nimboost::uint32_t *mem)
{  nimboost::uint32_t old_val = *mem; __MB(); return old_val;  }
...
//first define nimboost::uint32_t versions of __lwarx and __stwcx to avoid poluting
...
inline nimboost::uint32_t lwarxu(volatile nimboost::uint32_t *mem)
{
   return static_cast<nimboost::uint32_t>(__lwarx(reinterpret_cast<volatile int*>(mem)));
}
...
//!unsuccessful
inline bool stwcxu(volatile nimboost::uint32_t* mem, nimboost::uint32_t val)
{
...
{
   nimboost::uint32_t oldValue;
   nimboost::uint32_t valueToStore;
   do
   {
      oldValue = lwarxu(mem);
...
inline nimboost::uint32_t atomic_add32
   (volatile nimboost::uint32_t *mem, nimboost::uint32_t val)
{  return __sync_fetch_and_add(const_cast<nimboost::uint32_t *>(mem), val);   }
...
inline nimboost::uint32_t atomic_cas32
   (volatile nimboost::uint32_t *mem, nimboost::uint32_t with, nimboost::uint32_t cmp)
{  return __sync_val_compare_and_swap(const_cast<nimboost::uint32_t *>(mem), cmp, with);   }
...
inline bool atomic_add_unless32
   (volatile nimboost::uint32_t *mem, nimboost::uint32_t value, nimboost::uint32_t unless_this)
{
   nimboost::uint32_t old, c(atomic_read32(mem));
