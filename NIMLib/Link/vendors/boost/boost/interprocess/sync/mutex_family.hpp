...
//!based on nimboost::interprocess synchronization objects.
struct mutex_family
{
   typedef nimboost::interprocess::interprocess_mutex                 mutex_type;
   typedef nimboost::interprocess::interprocess_recursive_mutex       recursive_mutex_type;
};
...
{
   typedef nimboost::interprocess::null_mutex                   mutex_type;
   typedef nimboost::interprocess::null_mutex                   recursive_mutex_type;
};
