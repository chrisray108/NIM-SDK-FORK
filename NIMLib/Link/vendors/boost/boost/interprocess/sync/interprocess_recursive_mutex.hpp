...
inline void interprocess_recursive_mutex::lock()
{
      ...
      nimboost::posix_time::ptime wait_time
         = nimboost::posix_time::microsec_clock::universal_time()
         + nimboost::posix_time::milliseconds(BOOST_INTERPROCESS_TIMEOUT_WHEN_LOCKING_DURATION_MS);
...
inline bool interprocess_recursive_mutex::timed_lock(const nimboost::posix_time::ptime &abs_time)
