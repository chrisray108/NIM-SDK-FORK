...
class upgradable_lock
{
   ...
   upgradable_lock(mutex_type& m, const nimboost::posix_time::ptime& abs_time)
      : mp_mutex(&m), m_locked(false)
   ...
   //!   expression: "nimboost::move(lock);". This constructor does not alter the
