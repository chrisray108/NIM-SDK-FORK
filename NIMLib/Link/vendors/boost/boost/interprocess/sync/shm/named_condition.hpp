...
class shm_named_condition
{
   ...
   friend class nimboost::interprocess::ipcdetail::interprocess_tester;
   void dont_close_on_destruction();

   typedef ipcdetail::managed_open_or_create_impl<shared_memory_object, 0, true, false> open_create_impl_t;
   open_create_impl_t m_shmem;

   template <class T, class Arg> friend class nimboost::interprocess::ipcdetail::named_creation_functor;
   typedef nimboost::interprocess::ipcdetail::named_creation_functor<internal_condition> construct_func_t;
   /// @endcond
};
...
inline bool shm_named_condition::timed_wait
   (L& lock, const nimboost::posix_time::ptime &abs_time)
{  return this->internal_cond().timed_wait(lock, abs_time); }

template <typename L, typename Pr>
inline bool shm_named_condition::timed_wait
   (L& lock, const nimboost::posix_time::ptime &abs_time, Pr pred)
