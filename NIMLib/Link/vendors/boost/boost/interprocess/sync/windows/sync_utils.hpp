...
class sync_id
{
   ...
   {  return nimboost::hash_value(m.rand_);  }
...
class sync_handles
{
   ...
   typedef nimboost::unordered_map<sync_id, void*> umap_type;
   typedef nimboost::container::map<const sync_id*, umap_type::iterator, address_less> map_type;
