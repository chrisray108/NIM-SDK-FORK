...
struct scoped_ptr_dealloc_functor
{
   ...
   typedef ipcdetail::integral_constant<unsigned,
      nimboost::interprocess::version<Allocator>::value>                   alloc_version;
...
class sp_counted_impl_pd
   ...
   ,  nimboost::container::allocator_traits<A>::template
   ...
   ,  D  // copy constructor must not throw
{
   ...
   void destroy() // nothrow
   {
      ...
      this_allocator a_copy(::nimboost::move(static_cast<this_allocator&>(*this)));
