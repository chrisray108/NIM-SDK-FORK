...
// to_raw_pointer() enables nimboost::mem_fn to recognize shared_ptr
template<class T, class VoidAllocator, class Deleter> inline
...
//!of type T with the allocator nimboost::interprocess::allocator allocator
//!and nimboost::interprocess::deleter deleter
...
// to_raw_pointer() enables nimboost::mem_fn to recognize shared_ptr
template<class T, class VoidAllocator, class Deleter> inline
T * to_raw_pointer(nimboost::interprocess::shared_ptr<T, VoidAllocator, Deleter> const & p)
{  return p.get();   }
#endif
