...
protected:
    ...
    void load(nimboost::serialization::item_version_type & t){
        unsigned int v;
        load(v);
        t = nimboost::serialization::item_version_type(v);
    }
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(nimboost::archive::text_wiarchive)
