...
class naked_binary_iarchive : 
    public binary_iarchive_impl<
        nimboost::archive::naked_binary_iarchive, 
...
class binary_iarchive : 
    public binary_iarchive_impl<
        nimboost::archive::binary_iarchive, 
        std::istream::char_type, 
        std::istream::traits_type
    >,
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(nimboost::archive::binary_iarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(nimboost::archive::binary_iarchive)
