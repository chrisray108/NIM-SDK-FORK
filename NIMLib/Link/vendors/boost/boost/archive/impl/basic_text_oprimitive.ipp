...
basic_text_oprimitive<OStream>::save_binary(
    ...
    typedef 
        nimboost::archive::iterators::insert_linebreaks<
            nimboost::archive::iterators::base64_from_binary<
                nimboost::archive::iterators::transform_width<
                    const char *,
                    6,
                    8
                >
    ...
    nimboost::archive::iterators::ostream_iterator<CharType> oi(os);
    std::copy(
