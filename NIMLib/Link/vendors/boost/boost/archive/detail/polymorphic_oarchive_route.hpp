...
private:
    ...
    virtual void save(const nimboost::long_long_type t){
        ArchiveImplementation::save(t);
    }
    virtual void save(const nimboost::ulong_long_type t){
        ArchiveImplementation::save(t);
    }
    #elif defined(BOOST_HAS_MS_INT64)
    virtual void save(const nimboost::int64_t t){
        ArchiveImplementation::save(t);
    }
    virtual void save(const nimboost::uint64_t t){
        ArchiveImplementation::save(t);
    }
    #endif
