...
private:
    virtual void destroy(/*const*/ void *address) const {
        nimboost::serialization::access::destroy(static_cast<T *>(address));
    }
protected:
    // protected constructor since it's always created by singleton
    explicit iserializer() :
        basic_iserializer(
            nimboost::serialization::singleton<
                BOOST_DEDUCED_TYPENAME 
                nimboost::serialization::type_info_implementation< T >::type
            >::get_const_instance()
        )
    {}
public:
    ...
    virtual bool class_info() const {
        return nimboost::serialization::implementation_level< T >::value 
            >= nimboost::serialization::object_class_info;
    }
    virtual bool tracking(const unsigned int /* flags */) const {
        return nimboost::serialization::tracking_level< T >::value 
                == nimboost::serialization::track_always
            || ( nimboost::serialization::tracking_level< T >::value 
                == nimboost::serialization::track_selectively
                && serialized_as_pointer());
    }
    virtual version_type version() const {
        return version_type(::nimboost::serialization::version< T >::value);
    }
    virtual bool is_polymorphic() const {
        return nimboost::is_polymorphic< T >::value;
    }
    virtual ~iserializer(){};
};
...
BOOST_DLLEXPORT void iserializer<Archive, T>::load_object_data(
    ...
    if(file_version > static_cast<const unsigned int>(version()))
        nimboost::serialization::throw_exception(
            archive::archive_exception(
                nimboost::archive::archive_exception::unsupported_class_version,
                get_debug_info()
            )
        );
    #endif
    ...
    nimboost::serialization::serialize_adl(
        nimboost::serialization::smart_cast_reference<Archive &>(ar),
        * static_cast<T *>(x), 
        file_version
    );
}
...
private:
    virtual const basic_iserializer & get_basic_serializer() const {
        return nimboost::serialization::singleton<
...
{
    // nimboost::has_new_operator< T > doesn't work on these compilers
    #if DONT_USE_HAS_NEW_OPERATOR
...
public:
    ...
    ~auto_ptr_with_deleter(){
        if (m_p)
            nimboost::serialization::access::destroy(m_p);
    }
    T* get() const {
        return m_p;
    }
...
) const
{
    ...
    if(NULL == ap.get())
        nimboost::serialization::throw_exception(std::bad_alloc()) ;
    ...
    BOOST_TRY {
        ...
        nimboost::serialization::load_construct_data_adl<Archive, T>(
            ar_impl,
            t, 
            file_version
        );
    ...
    ar_impl >> nimboost::serialization::make_nvp(NULL, * t);
    ap.release();
}
...
struct load_non_pointer_type {
    ...
    struct load_only {
        ...
        static void invoke(Archive & ar, const T & t){
            ...
            nimboost::serialization::serialize_adl(
                ar, 
                const_cast<T &>(t), 
                nimboost::serialization::version< T >::value
            );
        }
    };
    ...
    static void invoke(Archive & ar, T &t){
        typedef BOOST_DEDUCED_TYPENAME mpl::eval_if<
                // if its primitive
                mpl::equal_to<
                    nimboost::serialization::implementation_level< T >,
                    mpl::int_<nimboost::serialization::primitive_type>
                >,
            ...
            mpl::greater_equal<
                        nimboost::serialization::implementation_level< T >,
                        mpl::int_<nimboost::serialization::object_class_info>
                    >,
            // do standard load
        ...
        BOOST_DEDUCED_TYPENAME mpl::eval_if<
            // no tracking
                    mpl::equal_to<
                        nimboost::serialization::tracking_level< T >,
                        mpl::int_<nimboost::serialization::track_never>
                >,
                // do a fast load
...
struct load_pointer_type {
    struct abstract
    {
        ...
        static const basic_pointer_iserializer * register_type(Archive & /* ar */){
            ...
            BOOST_STATIC_ASSERT(nimboost::is_polymorphic< T >::value);
    ...
    static const basic_pointer_iserializer * register_type(Archive &ar, const T & /*t*/){
        ...
        typedef BOOST_DEDUCED_TYPENAME
            mpl::eval_if<
                nimboost::serialization::is_abstract<const T>,
                nimboost::mpl::identity<abstract>,
                nimboost::mpl::identity<non_abstract>  
            >::type typex;
    ...
    static T * pointer_tweak(
        const nimboost::serialization::extended_type_info & eti,
        void const * const t,
        const T &
    ) {
        ...
        return static_cast<T *>(
            const_cast<void *>(
                nimboost::serialization::void_upcast(
                    eti,
                    nimboost::serialization::singleton<
                        BOOST_DEDUCED_TYPENAME 
                        nimboost::serialization::type_info_implementation< T >::type
    ...
    find(const nimboost::serialization::extended_type_info & type){
...
struct load_enum_type {
    ...
    static void invoke(Archive &ar, T &t){
        ...
        int i;
        ar >> nimboost::serialization::make_nvp(NULL, i);
        t = static_cast< T >(i);
    }
};
...
struct load_array_type {
    ...
    static void invoke(Archive &ar, T &t){
        ...
        nimboost::serialization::collection_size_type count;
        ar >> BOOST_SERIALIZATION_NVP(count);
        if(static_cast<std::size_t>(count) > current_count)
            nimboost::serialization::throw_exception(
                archive::archive_exception(
                    nimboost::archive::archive_exception::array_size_too_short
                )
            );
...
inline void load_wrapper(Archive &ar, const T&t, mpl::true_){
    nimboost::archive::load(ar, const_cast<T&>(t));
}
