...
public:
    ...
    virtual void save(const nimboost::long_long_type t) = 0;
    virtual void save(const nimboost::ulong_long_type t) = 0;
    ...
    void save_override(
                ...
                const
                #endif
                ::nimboost::serialization::nvp< T > & t, int
        ){
        save_start(t.name());
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(nimboost::archive::polymorphic_oarchive)
