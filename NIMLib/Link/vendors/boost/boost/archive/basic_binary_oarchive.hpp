...
public:
    ...
    #if 0
    void save_override(const nimboost::archive::version_type & t, int version){
        ...
        if(nimboost::archive::library_version_type(6) < lvt){
            const nimboost::uint_least16_t x = t;
            * this->This() << x;
        }
        else{
    ...
    void save_override(const nimboost::serialization::item_version_type & t, int version){
        library_version_type lvt = this->get_library_version();
        if(nimboost::archive::library_version_type(7) < lvt){
            this->detail_common_oarchive::save_override(t, version);
        }
    ...
    void save_override(const serialization::collection_size_type & t, int){
        if (get_library_version() < nimboost::archive::library_version_type(6)){
            unsigned int x=0;
            * this->This() >> x;
