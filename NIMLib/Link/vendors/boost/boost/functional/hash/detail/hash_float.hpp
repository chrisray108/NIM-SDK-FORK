...
namespace nimboost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_impl(Float v,
            BOOST_DEDUCED_TYPENAME nimboost::enable_if_c<
        ...
        {
            nimboost::hash_detail::call_frexp<T> frexp;
            nimboost::hash_detail::call_ldexp<T> ldexp;
            ...
            std::size_t const length
                = (limits<T>::digits *
                        nimboost::static_log2<limits<T>::radix>::value
...
namespace nimboost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_value(T v)
        {
            return nimboost::hash_detail::is_zero(v) ? 0 : float_hash_impl(v, 0);
        }
    }
}
