...
namespace nimboost 
{
    ...
    namespace detail
    {
        ...
        struct lightweight_forward_adapter_result
        {
            ...
            template< typename T > struct x< nimboost::reference_wrapper<T> >
            { typedef T& t; };
...
#   define BOOST_TMP_MACRO(f,fn,fc) \
        nimboost::detail::lightweight_forward_adapter_impl< \
...
#       include BOOST_PP_ITERATE()
    ...
    struct result_of<nimboost::lightweight_forward_adapter<F,A0,A1> const ()>
        : nimboost::detail::lightweight_forward_adapter_result::template apply<
            nimboost::lightweight_forward_adapter<F,A0,A1> const () >
    { };
    template<class F, int A0, int A1>
    struct result_of<nimboost::lightweight_forward_adapter<F,A0,A1>()>
        : nimboost::detail::lightweight_forward_adapter_result::template apply<
            nimboost::lightweight_forward_adapter<F,A0,A1>() >
    { };
    template<class F, int A0, int A1>
    struct result_of<nimboost::lightweight_forward_adapter<F,A0,A1> const& ()>
        : nimboost::detail::lightweight_forward_adapter_result::template apply<
...
#     define N BOOST_PP_ITERATION() 
            ...
            : lightweight_forward_adapter_result
        {
            ...
            inline typename nimboost::result_of< F(BOOST_PP_ENUM_BINARY_PARAMS(N,
