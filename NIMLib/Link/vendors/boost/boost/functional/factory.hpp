...
namespace nimboost
{
    ...
    template< typename Pointer, class Allocator = nimboost::none_t,
    ...
    class factory<Pointer, nimboost::none_t, AP> 
    {
      public:
        typedef typename nimboost::remove_cv<Pointer>::type result_type;
        typedef typename nimboost::pointee<result_type>::type value_type;
...
#     include BOOST_PP_ITERATE()
    ...
    class factory
        : private Allocator::template rebind< typename nimboost::pointee<
            typename nimboost::remove_cv<Pointer>::type >::type >::other
    {
      public:
        typedef typename nimboost::remove_cv<Pointer>::type result_type;
        typedef typename nimboost::pointee<result_type>::type value_type;
      ...
      private:
        ...
        inline result_type make_pointer(value_type* ptr, nimboost::non_type<
    ...
    inline result_type operator()(BOOST_PP_ENUM_BINARY_PARAMS(N,T,& a)) const
    {
        ...
        { 
            return make_pointer(
                ...
                nimboost::non_type<factory_alloc_propagation,AP>() );
        }
