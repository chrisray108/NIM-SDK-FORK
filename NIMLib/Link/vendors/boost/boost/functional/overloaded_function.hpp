...
#define BOOST_FUNCTIONAL_base(z, n, unused) \
    ::nimboost::overloaded_function_detail::base< \
...
#define BOOST_FUNCTIONAL_function_type(z, n, unused) \
    typename ::nimboost::overloaded_function_detail::function_type< \
        BOOST_FUNCTIONAL_f_type(z, n, ~) \
    >::type
...
BOOST_TYPEOF_REGISTER_TEMPLATE(nimboost::overloaded_function,
...
public:
    ...
    that can be converted to a <c>nimboost::function</c> function object can be
    ...
    */
    overloaded_function(const nimboost::function<F1>&,
            const nimboost::function<F2>&, ...);
    ...
    the constructor.
    */
    typename nimboost::function_traits<F1>::result_type operator()(
            typename nimboost::function_traits<F1>::arg1_type,
            typename nimboost::function_traits<F1>::arg2_type,
            ...) const;
    ...
    documentation).
    */
    typename nimboost::function_traits<F2>::result_type operator()(
            typename nimboost::function_traits<F2>::arg1_type,
            typename nimboost::function_traits<F2>::arg2_type,
            ...) const;
};
