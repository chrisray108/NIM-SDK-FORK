...
struct fixed_sized:
    nimboost::parameter::template_keyword<tag::fixed_sized, nimboost::mpl::bool_<IsFixedSized> >
{};
...
struct capacity:
    nimboost::parameter::template_keyword<tag::capacity, nimboost::mpl::size_t<Size> >
{};
...
struct allocator:
    nimboost::parameter::template_keyword<tag::allocator, Alloc>
{};
