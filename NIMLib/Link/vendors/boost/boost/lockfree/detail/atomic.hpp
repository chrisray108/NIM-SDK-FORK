...
#if defined(BOOST_LOCKFREE_NO_HDR_ATOMIC)
using nimboost::atomic;
using nimboost::memory_order_acquire;
using nimboost::memory_order_consume;
using nimboost::memory_order_relaxed;
using nimboost::memory_order_release;
#else
using std::atomic;
