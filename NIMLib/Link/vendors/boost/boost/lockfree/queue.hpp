 ...
 *
 *  \b Policies:
 *  - \ref nimboost::lockfree::fixed_sized, defaults to \c nimboost::lockfree::fixed_sized<false> \n
 ...
 *
 *  - \ref nimboost::lockfree::capacity, optional \n
 ...
 *
 *  - \ref nimboost::lockfree::allocator, defaults to \c nimboost::lockfree::allocator<std::allocator<void>> \n
...
public:
    ...
    /** \copydoc nimboost::lockfree::stack::reserve
     * */
    ...
    /** \copydoc nimboost::lockfree::stack::reserve_unsafe
     * */
...
public:
    ...
    /// \copydoc nimboost::lockfree::queue::consume_one(Functor & rhs)
    template <typename Functor>
    ...
    /// \copydoc nimboost::lockfree::queue::consume_all(Functor & rhs)
    template <typename Functor>
