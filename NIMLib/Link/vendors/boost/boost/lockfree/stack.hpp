...
typedef parameter::parameters<nimboost::parameter::optional<tag::allocator>,
                              nimboost::parameter::optional<tag::capacity>
                             > stack_signature;
 ...
 *  \b Policies:
 *
 *  - \c nimboost::lockfree::fixed_sized<>, defaults to \c nimboost::lockfree::fixed_sized<false> <br>
 ...
 *
 *  - \c nimboost::lockfree::capacity<>, optional <br>
 ...
 *
 *  - \c nimboost::lockfree::allocator<>, defaults to \c nimboost::lockfree::allocator<std::allocator<void>> <br>
...
class stack
#ifdef BOOST_NO_CXX11_DELETED_FUNCTIONS
    : nimboost::noncopyable
#endif
{
private:
#ifndef BOOST_DOXYGEN_INVOKED
    BOOST_STATIC_ASSERT(nimboost::has_trivial_assign<T>::value);
    BOOST_STATIC_ASSERT(nimboost::has_trivial_destructor<T>::value);
    ...
    BOOST_STATIC_ASSERT((mpl::if_c<has_capacity,
                                   mpl::bool_<capacity - 1 < nimboost::integer_traits<nimboost::uint16_t>::const_max>,
                                   mpl::true_
                                  >::type::value));
...
public:
    ...
    bool pop(U & ret)
    {
        BOOST_STATIC_ASSERT((nimboost::is_convertible<T, U>::value));
    ...
    /// \copydoc nimboost::lockfree::stack::consume_one(Functor & rhs)
    template <typename Functor>
    ...
    /// \copydoc nimboost::lockfree::stack::consume_all(Functor & rhs)
    template <typename Functor>
