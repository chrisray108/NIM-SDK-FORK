...
#define BOOST_EXPLICIT_OPERATOR_BOOL()\
    BOOST_FORCEINLINE operator nimboost::detail::unspecified_bool_type () const\
    {\
        return (!this->operator! () ? &nimboost::detail::unspecified_bool::true_value : (nimboost::detail::unspecified_bool_type)0);\
    }

#define BOOST_CONSTEXPR_EXPLICIT_OPERATOR_BOOL()\
    BOOST_FORCEINLINE BOOST_CONSTEXPR operator nimboost::detail::unspecified_bool_type () const\
    {\
        return (!this->operator! () ? &nimboost::detail::unspecified_bool::true_value : (nimboost::detail::unspecified_bool_type)0);\
    }
