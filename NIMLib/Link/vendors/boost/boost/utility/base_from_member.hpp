...
{
    typedef typename ::nimboost::remove_cv<typename
     ::nimboost::remove_reference<T>::type>::type  type;

};  // nimboost::detail::remove_cv_ref
...
struct is_related
    : public ::nimboost::is_same<
     typename ::nimboost::detail::remove_cv_ref<T>::type,
     typename ::nimboost::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::nimboost::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::nimboost::disable_if< ::nimboost::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::nimboost::detail::enable_if_unrelated<base_from_member, T...>::type>
