...
#define BOOST_TYPEOF_REGISTER_TEMPLATE_IMPL(Name, Params, Size, ID)\
    ...
    {\
        typedef typename nimboost::type_of::push_back<V, nimboost::mpl::size_t<ID> >::type V0;\
    ...
    {\
        typedef decode_type_impl<nimboost::mpl::size_t<ID>, Iter> self_t;\
        typedef nimboost::mpl::size_t<ID> self_id;\
        typedef Iter iter0;\
