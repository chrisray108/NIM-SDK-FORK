...
#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace nimboost_typeof {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER nimboost_typeof

#else

#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace nimboost { namespace type_of {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER nimboost::type_of
