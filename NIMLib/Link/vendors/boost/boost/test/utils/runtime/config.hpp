...
#include <boost/test/utils/basic_cstring/io.hpp> // operator<<(nimboost::runtime::cstring)
...
#define BOOST_RT_PARAM_PUTENV ::nimboost::BOOST_RT_PARAM_NAMESPACE::putenv_impl
