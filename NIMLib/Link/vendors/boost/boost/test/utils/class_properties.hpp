...
public:
    ...
    // access methods
    arrow_res_t     operator->() const      { return nimboost::addressof( base_prop::value ); }
};
...
#define BOOST_READONLY_PROPERTY( property_type, friends ) nimboost::unit_test::readwrite_property<property_type >
...
: public nimboost::unit_test::readonly_property<property_type > {                      \
    typedef nimboost::unit_test::readonly_property<property_type > base_prop;          \
...
public:
    ...
    arrow_res_t     operator->()            { return nimboost::addressof( base_prop::value ); }
    const_arrow_res_t operator->() const    { return nimboost::addressof( base_prop::value ); }
