...
#  define BOOST_LIB_NAME nimboost_unit_test_framework
...
namespace nimboost { namespace unit_test {
...
{
    return ::nimboost::unit_test::unit_test_main( &init_unit_test, argc, argv );
}
