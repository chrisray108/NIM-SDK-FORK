...
process_user_cpu_clock::time_point process_user_cpu_clock::now() BOOST_NOEXCEPT
{
    ...
    if ( nimboost::detail::winapi::GetProcessTimes(
            nimboost::detail::winapi::GetCurrentProcess(), &creation, &exit,
        ...
        system::error_code & ec)
{
    ...
    {
        nimboost::detail::winapi::DWORD_ cause = nimboost::detail::winapi::GetLastError();
        if (BOOST_CHRONO_IS_THROWS(ec))
        {
            nimboost::throw_exception(
                    system::system_error(
