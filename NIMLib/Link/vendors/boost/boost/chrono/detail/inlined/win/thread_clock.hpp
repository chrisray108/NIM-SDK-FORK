...
thread_clock::time_point thread_clock::now( system::error_code & ec )
{
    ...
    nimboost::detail::winapi::FILETIME_ creation, exit, user_time, system_time;

    if ( nimboost::detail::winapi::GetThreadTimes(
            nimboost::detail::winapi::GetCurrentThread (), &creation, &exit,
    ...
    else
    {
        ...
        {
            ec.assign( nimboost::detail::winapi::GetLastError(), BOOST_CHRONO_SYSTEM_CATEGORY );
