...
namespace chrono_detail
{
  ...
  {
      nimboost::detail::winapi::LARGE_INTEGER_ freq;
      if ( !nimboost::detail::winapi::QueryPerformanceFrequency( &freq ) )
          return 0.0L;
  ...
  steady_clock::time_point steady_clock::now() BOOST_NOEXCEPT
  {
    ...
    nimboost::detail::winapi::LARGE_INTEGER_ pcount;
    if ( (nanosecs_per_tic <= 0.0L) ||
            (!nimboost::detail::winapi::QueryPerformanceCounter( &pcount )) )
    {
  ...
  steady_clock::time_point steady_clock::now( system::error_code & ec )
  {
    ...
    if ( (nanosecs_per_tic <= 0.0L)
            || (!nimboost::detail::winapi::QueryPerformanceCounter( &pcount )) )
    {
        nimboost::detail::winapi::DWORD_ cause =
            ((nanosecs_per_tic <= 0.0L)
                    ? ERROR_NOT_SUPPORTED
                    : nimboost::detail::winapi::GetLastError());
  ...
  {
    nimboost::detail::winapi::FILETIME_ ft;
    nimboost::detail::winapi::GetSystemTimeAsFileTime( &ft );  // never fails
