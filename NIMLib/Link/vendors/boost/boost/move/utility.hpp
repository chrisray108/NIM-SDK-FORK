...
#include <boost/move/detail/meta_utils.hpp>
   ...
   template <class T>
   inline typename ::nimboost::move_detail::enable_if_c
   ...
   inline typename ::nimboost::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && has_move_emulation_enabled<T>::value, rv<T>&>::type
         move(T& x) BOOST_NOEXCEPT
   {
      return *static_cast<rv<T>* >(::nimboost::move_detail::addressof(x));
   }
   ...
   template <class T>
   inline typename ::nimboost::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && ::nimboost::move_detail::is_rv<T>::value, T &>::type
         forward(const typename ::nimboost::move_detail::identity<T>::type &x) BOOST_NOEXCEPT
   {
   ...
   template <class T>
   inline typename ::nimboost::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && !::nimboost::move_detail::is_rv<T>::value, const T &>::type
      forward(const typename ::nimboost::move_detail::identity<T>::type &x) BOOST_NOEXCEPT
   {
      return x;
   }
      ...
      //! so that the user can define a different move emulation for that type in namespace nimboost
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         //! <i>::nimboost::rv<T> &</i> so that move emulation is activated.
         template <class T>
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         //!
         //! Otherwise:
         //! * If input_reference binds to const ::nimboost::rv<T> & then it output_reference is
         //!   ::nimboost::rv<T> &
         //!
         ...
         template <class T>
         inline T&& forward(typename ::nimboost::move_detail::identity<T>::type&& t) BOOST_NOEXCEPT
         {  return t;   }
         ...
         inline T&& forward(U&& t
             , typename ::nimboost::move_detail::enable_if_c<
