...
//used to detect noncopyable types for other Boost libraries.
   ...
   template <class T>
   class rv
      : public ::nimboost::move_detail::if_c
         < ::nimboost::move_detail::is_class_or_union<T>::value
         , T
         , ::nimboost::move_detail::empty
         >::type
   {
      rv();
      ~rv();
   ...
   template <class T>
   struct is_rv
      : ::nimboost::move_detail::integral_constant<bool, false>
   {};
   ...
   struct has_move_emulation_enabled
      : ::nimboost::move_detail::is_convertible< T, ::nimboost::rv<T>& >
   {};
   ...
   template<class T>
   struct has_move_emulation_enabled< ::nimboost::rv<T> >
      : ::nimboost::move_detail::integral_constant<bool, false>
   {};
   ...
   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::nimboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::nimboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::nimboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::nimboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPYABLE_AND_MOVABLE(TYPE)\
      ...
      {  this->operator=(static_cast<const ::nimboost::rv<TYPE> &>(const_cast<const TYPE &>(t))); return *this;}\
      public:\
      operator ::nimboost::rv<TYPE>&() \
      {  return *static_cast< ::nimboost::rv<TYPE>* >(this);  }\
      operator const ::nimboost::rv<TYPE>&() const \
