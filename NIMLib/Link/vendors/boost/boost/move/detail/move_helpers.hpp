...
#define BOOST_MOVE_CATCH_CONST(U)  \
   typename ::nimboost::mpl::if_< ::nimboost::is_class<U>, BOOST_CATCH_CONST_RLVALUE(U), const U &>::type
#define BOOST_MOVE_CATCH_RVALUE(U)\
   typename ::nimboost::mpl::if_< ::nimboost::is_class<U>, BOOST_RV_REF(U), not_a_type>::type
...
\
   ...
   {  return FWD_FUNCTION(::nimboost::move(x));  }\
\
...
\
   ...
   typename ::nimboost::enable_if_c\
                     <  ::nimboost::is_class<TYPE>::value &&\
                        ::nimboost::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value &&\
                       !::nimboost::has_move_emulation_enabled<BOOST_MOVE_TEMPL_PARAM>::value\
                     , RETURN_VALUE >::type\
...
\
   template<class BOOST_MOVE_TEMPL_PARAM>\
   typename ::nimboost::enable_if_c\
                     < (!::nimboost::is_class<BOOST_MOVE_TEMPL_PARAM>::value || \
                        !::nimboost::move_detail::is_rv<BOOST_MOVE_TEMPL_PARAM>::value) && \
                       !::nimboost::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value \
                     , RETURN_VALUE >::type\
   PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u)\
   {\
      TYPE t(u);\
      return FWD_FUNCTION(::nimboost::move(t));\
   }\
//
//                         ::nimboost::is_convertible<BOOST_MOVE_TEMPL_PARAM, TYPE>::value &&
...
\
   ...
   {  return FWD_FUNCTION(arg1, ::nimboost::move(x));  }\
\
...
\
   ...
   typename ::nimboost::enable_if_c<\
                       !::nimboost::move_detail::is_rv<BOOST_MOVE_TEMPL_PARAM>::value && \
                       !::nimboost::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value && \
                       !::nimboost::is_convertible<BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO>::value \
                     , RETURN_VALUE >::type\
   PUB_FUNCTION(ARG1 arg1, const BOOST_MOVE_TEMPL_PARAM &u)\
   {\
      TYPE t(u);\
      return FWD_FUNCTION(arg1, ::nimboost::move(t));\
   }\
//
