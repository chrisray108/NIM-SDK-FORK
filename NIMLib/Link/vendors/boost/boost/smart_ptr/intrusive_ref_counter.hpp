...
{
    typedef nimboost::detail::atomic_count type;

    static unsigned int load(nimboost::detail::atomic_count const& counter) BOOST_NOEXCEPT
    {
        return static_cast< unsigned int >(static_cast< long >(counter));
    }

    static void increment(nimboost::detail::atomic_count& counter) BOOST_NOEXCEPT
    {
        ++counter;
    }

    static unsigned int decrement(nimboost::detail::atomic_count& counter) BOOST_NOEXCEPT
    {
        return --counter;
    }
};
