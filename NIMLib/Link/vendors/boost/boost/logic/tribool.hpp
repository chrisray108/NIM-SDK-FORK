...
namespace nimboost { namespace logic {
...
inline bool                                                             \
Name(nimboost::logic::tribool x,                                           \
     nimboost::logic::detail::indeterminate_t =                            \
       nimboost::logic::detail::indeterminate_t())                         \
{ return x.value == nimboost::logic::tribool::indeterminate_value; }
