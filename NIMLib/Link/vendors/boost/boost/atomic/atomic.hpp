...
class atomic :
    public atomics::detail::base_atomic<
        ...
        mpl::and_< nimboost::is_integral<T>, nimboost::is_signed<T> >::value
#endif
    >
{
private:
...
typedef atomic<nimboost::ulong_long_type> atomic_ullong;
typedef atomic<nimboost::long_long_type> atomic_llong;
#endif
