...
class const_multi_array_view :
    public nimboost::detail::multi_array::multi_array_impl_base<T,NumDims>
{
  typedef nimboost::detail::multi_array::multi_array_impl_base<T,NumDims> super_type;
public: 
...
#else
  typename
  disable_if<typename nimboost::is_integral<BaseList>::type,void >::type
#endif
  reindex(const BaseList& values) {
    nimboost::function_requires<
      CollectionConcept<BaseList> >();
    nimboost::detail::multi_array::
  ...
  const element& operator()(IndexList indices) const {
    ...
    return super_type::access_element(nimboost::type<const element&>(),
                                      indices,origin(),
  ...
  const_reference operator[](index idx) const {
    return super_type::access(nimboost::type<const_reference>(),
                              idx,origin(),
                              shape(),strides(),
                              index_bases());
  }
  ...
  operator[](const nimboost::detail::multi_array::
             index_gen<NumDims,NDims>& indices)
    const {
    typedef typename const_array_view<NDims>::type return_type;
    return
      super_type::generate_array_view(nimboost::type<return_type>(),
                                      indices,
                                      shape(),
                                      strides(),
                                      index_bases(),
...
public: // should be protected
  ...
  explicit const_multi_array_view(TPtr base,
                           ...
                           const nimboost::array<Index,NumDims>& strides): 
  ...
  typedef nimboost::array<size_type,NumDims> size_list;
  typedef nimboost::array<index,NumDims> index_list;
...
public: 
  ...
  element& operator()(const IndexList& indices) {
    nimboost::function_requires<
      CollectionConcept<IndexList> >();
    return super_type::access_element(nimboost::type<element&>(),
                                      indices,origin(),
  ...
  reference operator[](index idx) {
    return super_type::access(nimboost::type<reference>(),
                              idx,origin(),
                              this->shape(),this->strides(),
                              this->index_bases());
  }
...
public:
  typedef nimboost::detail::multi_array::multi_array_view<element,N> type;
};
...
class const_array_view_gen {
  typedef typename Array::element element;
public:
  typedef nimboost::detail::multi_array::const_multi_array_view<element,N> type;  
};
