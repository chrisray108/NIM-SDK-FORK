...
namespace nimboost {
  ...
  public:
    ...
    general_storage_order(OrderingIter ordering,
      ...
      nimboost::detail::multi_array::copy_n(ordering,NumDims,ordering_.begin());
      nimboost::detail::multi_array::copy_n(ascending,NumDims,ascending_.begin());
    }
  ...
  protected:
    nimboost::array<size_type,NumDims> ordering_;
    nimboost::array<bool,NumDims> ascending_;
  };
  ...
  public:
    ...
    operator general_storage_order<NumDims>() const {
      nimboost::array<size_type,NumDims> ordering;
      nimboost::array<bool,NumDims> ascending;
