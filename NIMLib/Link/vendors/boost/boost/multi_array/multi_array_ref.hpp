...
public: 
  ...
  void assign(InputIterator begin, InputIterator end) {
    nimboost::function_requires<InputIteratorConcept<InputIterator> >();
...
public:
    ...
    base_(base), storage_(so), origin_offset_(0), directional_offset_(0)
 {
   ...
   if(extents) {
     ...
     nimboost::array<index,NumDims> extent_list;
...
private:
  ...
  void init_from_extent_gen(const
    ...
    typedef nimboost::array<index,NumDims> extent_list;

    // get the index_base values
    std::transform(ranges.ranges_.begin(),ranges.ranges_.end(),
              index_base_list_.begin(),
              nimboost::mem_fun_ref(&extent_range::start));

    // calculate the extents
    extent_list extents;
    std::transform(ranges.ranges_.begin(),ranges.ranges_.end(),
              extents.begin(),
              nimboost::mem_fun_ref(&extent_range::size));
