...
namespace detail {
  ...
  struct ConstMultiArrayConcept
  {
    ...
    function_requires< nimboost_concepts::ForwardTraversalConcept<iterator> >();
    function_requires< nimboost_concepts::ReadableIteratorConcept<iterator> >();
    function_requires< nimboost_concepts::ForwardTraversalConcept<const_iterator> >();
    function_requires< nimboost_concepts::ReadableIteratorConcept<const_iterator> >();
  ...
  struct MutableMultiArrayConcept
  {
    void constraints() {
      ...
      function_requires< nimboost_concepts::ForwardTraversalConcept<iterator> >();
      function_requires< nimboost_concepts::ReadableIteratorConcept<iterator> >();
      function_requires< nimboost_concepts::WritableIteratorConcept<iterator> >();
      function_requires< nimboost_concepts::ForwardTraversalConcept<const_iterator> >();
      function_requires< nimboost_concepts::ReadableIteratorConcept<const_iterator> >();
      function_requires< nimboost::OutputIterator<iterator,value_type> >();
...
namespace detail {
  namespace multi_array { // Old locations for these
    using nimboost::multi_array_concepts::ConstMultiArrayConcept;
    using nimboost::multi_array_concepts::MutableMultiArrayConcept;
  }
}
