...
namespace multi_array_types {
  typedef nimboost::detail::multi_array::size_type size_type;
  typedef std::ptrdiff_t difference_type;
  typedef nimboost::detail::multi_array::index index;
...
// nimboost::extents and nimboost::indices are now a part of the public
...
public:
  ...
  //
  typedef T element;
  typedef nimboost::multi_array<T,NumDims-1> value_type;
...
protected:
  ...
  Reference access(nimboost::type<Reference>,index idx,TPtr base,
...
struct mutable_iterator_tag
 : nimboost::random_access_traversal_tag, std::input_iterator_tag
{
...
public:
  ...
  struct subarray {
    typedef nimboost::detail::multi_array::sub_array<T,NDims> type;
  };

  template <std::size_t NDims>
  struct const_subarray {
    typedef nimboost::detail::multi_array::const_sub_array<T,NDims> type;
  };

  template <std::size_t NDims>
  struct array_view {
    typedef nimboost::detail::multi_array::multi_array_view<T,NDims> type;
  };

  template <std::size_t NDims>
  struct const_array_view {
  public:
    typedef nimboost::detail::multi_array::const_multi_array_view<T,NDims> type;
  };
...
#else
  typedef array_iterator<T,T*,mpl::size_t<NumDims>,reference,
                         nimboost::random_access_traversal_tag> iterator;
#endif
  typedef array_iterator<T,T const*,mpl::size_t<NumDims>,const_reference,
                         nimboost::random_access_traversal_tag> const_iterator;
...
protected:
  ...
  Reference access_element(nimboost::type<Reference>,
                           const IndexList& indices,
                           TPtr base,
                           const size_type* extents,
                           const index* strides,
                           const index* index_bases) const {
    nimboost::function_requires<
  ...
  ArrayRef
  generate_array_view(nimboost::type<ArrayRef>,
                      const nimboost::detail::multi_array::
    ...
    nimboost::array<index,NDims> new_strides;
    nimboost::array<index,NDims> new_extents;
