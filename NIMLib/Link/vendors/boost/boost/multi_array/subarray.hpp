...
public: 
  ...
  sub_array& operator=(const ConstMultiArray& other) {
    function_requires< nimboost::multi_array_concepts::ConstMultiArrayConcept< 
...
public:
  typedef nimboost::detail::multi_array::sub_array<element,N> type;
};
...
class const_subarray_gen {
  typedef typename Array::element element;
public:
  typedef nimboost::detail::multi_array::const_sub_array<element,N> type;  
};
} // namespace nimboost
