...
namespace nimboost { namespace msm { namespace front {namespace detail
{
template <class Attributes= ::nimboost::fusion::map<> >
struct inherit_attributes
{
    ...
    typename ::nimboost::fusion::result_of::at_key<attributes_type, 
                                                Index>::type
    get_attribute(Index const&) 
    {
        return ::nimboost::fusion::at_key<Index>(m_attributes);
    }
    ...
    get_attribute(Index const&)const 
    {
        return const_cast< 
            typename ::nimboost::add_const< 
                typename ::nimboost::fusion::result_of::at_key< attributes_type,
                                                             Index >::type>::type>
                                (::nimboost::fusion::at_key<Index>(m_attributes));
    }
...
template<class USERBASE,class Attributes= ::nimboost::fusion::map<> >
struct state_base : public inherit_attributes<Attributes>, USERBASE
{
    ...
    typedef ::nimboost::mpl::vector0<>  internal_transition_table;
    typedef ::nimboost::mpl::vector0<>  transition_table;
};
