...
namespace nimboost { namespace msm { namespace front
{
    ...
    struct a_row2
    {
        ...
        static ::nimboost::msm::back::HandledEnum action_call(FSM& fsm,Event const& evt,SourceState& src,TargetState& tgt, 
                                AllStates& all_states)
        {
            // in this front-end, we don't need to know source and target states
            ::nimboost::msm::front::detail::row2_action_helper<CalledForAction,Event,action>::template call_helper
                (fsm,evt,src,tgt,all_states,
                ::nimboost::mpl::bool_< ::nimboost::is_base_of<CalledForAction,FSM>::type::value>());
            return ::nimboost::msm::back::HANDLED_TRUE;
        }
    };
    ...
    struct row2
    {
        ...
        {
            // in this front-end, we don't need to know source and target states
            ::nimboost::msm::front::detail::row2_action_helper<CalledForAction,Event,action>::call_helper
                (fsm,evt,src,tgt,all_states,
                ::nimboost::mpl::bool_< ::nimboost::is_base_of<CalledForAction,FSM>::type::value>());
            return ::nimboost::msm::back::HANDLED_TRUE;
        }
        ...
        {
            // in this front-end, we don't need to know source and target states
            return ::nimboost::msm::front::detail::row2_guard_helper<CalledForGuard,Event,guard>::call_helper
                (fsm,evt,src,tgt,all_states,
                ::nimboost::mpl::bool_< ::nimboost::is_base_of<CalledForGuard,FSM>::type::value>());
        }
    };
    template<
        typename T1
