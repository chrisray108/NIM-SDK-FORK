...
namespace nimboost { namespace msm { namespace front
{
    ...
    {
        static const ::nimboost::msm::back::HandledEnum value = ::nimboost::msm::back::HANDLED_TRUE;
    };
    template <class Func>
    ...
    > 
    {
        static const ::nimboost::msm::back::HandledEnum value = ::nimboost::msm::back::HANDLED_DEFERRED;
    };
    // for sequences
    template <class Func>
    struct get_functor_return_value<Func, 
    ...
    > 
    {
        static const ::nimboost::msm::back::HandledEnum value = 
            (Func::some_deferring_actions::value ? ::nimboost::msm::back::HANDLED_DEFERRED : ::nimboost::msm::back::HANDLED_TRUE );
    };
    ...
    struct Row
    {
        ...
        static ::nimboost::msm::back::HandledEnum action_call(FSM& fsm,EVT const& evt,SourceState& src,TargetState& tgt, AllStates&)
        {
    ...
    struct ActionSequence_
    {
        ...
        typedef ::nimboost::mpl::bool_< 
            ::nimboost::mpl::count_if<sequence, 
                                   has_deferring_action< ::nimboost::mpl::placeholders::_1 > 
        ...
        template <class FCT>
        void operator()(::nimboost::msm::wrap<FCT> const& )
        {
        ...
        {
            mpl::for_each<Sequence,nimboost::msm::wrap< ::nimboost::mpl::placeholders::_1> >
