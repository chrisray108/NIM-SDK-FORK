...
struct state_machine_def :  public nimboost::msm::front::detail::state_base<BaseState>
{
    // tags
    // default: no flag
    ...
    typedef ::nimboost::mpl::vector0<>               configuration;
    ...
    struct a_row
    {
        ...
        static ::nimboost::msm::back::HandledEnum action_call(FSM& fsm,Event const& evt,SourceState&,TargetState&, AllStates&)
        {
