...
template<class StateNameTag,
         ...
         class Attributes= ::nimboost::fusion::vector<>,
         class Flags = ::nimboost::mpl::vector0<>,
         class Defer = ::nimboost::mpl::vector0<>,
         class BASE = ::nimboost::msm::front::default_base_state>
struct func_state :  public ::nimboost::msm::front::detail::state_base<BASE,Attributes>, 
                     euml_state_intern<func_state<StateNameTag,EntryFunctor,ExitFunctor,Attributes,Flags,Defer,BASE> >
{
    func_state(){}
    // grammar testing
    BOOST_MPL_ASSERT_NOT(( nimboost::is_same<EntryFunctor,invalid_type> ));
    BOOST_MPL_ASSERT_NOT(( nimboost::is_same<ExitFunctor,invalid_type> ));

    typedef StateNameTag state_name_tag;
    // flags
    typedef Flags       flag_list;
    typedef ::nimboost::mpl::vector0<> internal_flag_list;
    // deferred events
...
struct entry_func_state :  public ::nimboost::msm::front::detail::state_base<BASE,Attributes>, 
...
template<class StateNameTag,
         ...
         class Defer = ::nimboost::mpl::vector0<>,
         class BASE = default_base_state>
struct explicit_entry_func_state :  public ::nimboost::msm::front::detail::state_base<BASE,Attributes>, 
                                    public ::nimboost::msm::front::explicit_entry<ZoneIndex>,
...
template<class StateNameTag,
         ...
         class Defer = ::nimboost::mpl::vector0<>,
         class BASE = default_base_state>
struct exit_func_state :   public ::nimboost::msm::front::detail::state_base<BASE,Attributes>, 
...
struct BuildActionSequence
   : proto::or_<
        ...
        proto::when <
                    ...
                    ActionSequence_<nimboost::mpl::push_back<
    ...
    : proto::switch_<CustomPhoenixGrammar>
{
    ...
    struct case_ 
        : proto::and_<
            ...
            nimboost::nimboostphoenix::meta_grammar::case_<Tag>
        >
    {};
};
#endif
...
struct attr_name ## _                                                                                                   \
    : proto::extends< proto::terminal< ::nimboost::msm::front::action_tag>::type, attr_name ## _, nimboost::msm::sm_domain>   \
    {typedef  attr_name ## _ action_name;                                                                               \
        typedef ::nimboost::fusion::pair<attr_name ## _,attr_type> attribute_type;                                         \
        attr_name ## _ (){}                                                                                             \
    };                                                                                                                  \
...
struct transform_to_fusion_pair 
{
    typedef typename ::nimboost::mpl::fold<
        Seq,::nimboost::mpl::vector<>,
        ::nimboost::mpl::push_back< ::nimboost::mpl::placeholders::_1, 
                                 get_attribute_type< ::nimboost::mpl::placeholders::_2> >
        >::type type;
};
...
struct attribute
{
   BOOST_PROTO_BASIC_EXTENDS(
     ...
     , attribute
     , nimboost::msm::sm_domain
   )
   typedef ::nimboost::fusion::pair<int,int> attribute_type;
};
...
attribute<> const attributes_ = {{{}}};
 ...
 struct BuildAttributesHelper
   : proto::make<
       ::nimboost::mpl::pop_front<
          proto::fold_tree<
              proto::_
            , ::nimboost::fusion::vector<>()
            , ::nimboost::mpl::push_back<proto::_state, 
                                      ::nimboost::mpl::if_< has_attribute_tag< proto::_value>,
                                                         proto::_value,
...
struct BuildAttributes 
 : proto::make<
      ::nimboost::mpl::if_<
          has_attribute_tag< ::nimboost::mpl::deref< ::nimboost::mpl::prior< ::nimboost::mpl::end< BuildAttributesHelper > > > >,
          ::nimboost::fusion::result_of::as_map< ::nimboost::mpl::pop_back< BuildAttributesHelper > >,
          ::nimboost::fusion::result_of::as_map< BuildAttributesHelper > > 
   > 
{};
   ...
   : proto::make<
       ::nimboost::mpl::pop_front<
          proto::fold_tree<
            ...
            , ::nimboost::mpl::push_back<proto::_state, proto::_>()
           >
       >
    >
 {};
...
struct BuildFlags 
 : proto::make<
    ::nimboost::mpl::remove_if<
        BuildMplVectorHelper,
        ::nimboost::mpl::not_< ::nimboost::is_same<get_euml_tag_type< ::nimboost::mpl::placeholders::_ >, flag_tag > > 
    >
 >
{};
...
struct BuildConfigure 
 : proto::make<
    ::nimboost::mpl::remove_if<
        BuildMplVectorHelper,
        ::nimboost::mpl::not_< ::nimboost::is_same<get_euml_tag_type< ::nimboost::mpl::placeholders::_ >, config_tag > > 
    >
 >
{};
...
struct BuildDeferred 
 : proto::make<
    ::nimboost::mpl::remove_if<
        BuildMplVectorHelper,
        ::nimboost::mpl::not_< ::nimboost::is_same<get_euml_tag_type< ::nimboost::mpl::placeholders::_ >, event_tag > > 
    >
 >
{};
...
typename ::nimboost::mpl::eval_if<
    ...
    nimboost::result_of<ActionGrammar(Expr1)>,
    make_invalid_type>::type,
typename ::nimboost::mpl::eval_if<
    typename proto::matches<Expr2,ActionGrammar>::type,
    nimboost::result_of<ActionGrammar(Expr2)>,
    make_invalid_type>::type,
typename nimboost::result_of<BuildAttributes(Attr)>::type,
typename nimboost::result_of<BuildFlags(Configure)>::type,
typename nimboost::result_of<BuildDeferred(Configure)>::type,
BASE
>
build_state(Expr1 const& ,Expr2 const& , Attr const&, Configure const&, BASE )
{
    typedef typename nimboost::result_of<ActionGrammar(Expr1)>::type entry_action;
    typedef typename nimboost::result_of<ActionGrammar(Expr2)>::type exit_action;
    typedef typename nimboost::result_of<BuildAttributes(Attr)>::type attributes_type;
    typedef typename nimboost::result_of<BuildFlags(Configure)>::type flags_type;
    typedef typename nimboost::result_of<BuildDeferred(Configure)>::type deferred_type;
...
template<class StateNameTag,
         ...
         class Flags = ::nimboost::mpl::vector0<>,
         class Defer = ::nimboost::mpl::vector0<>,
         class Configuration = ::nimboost::mpl::vector0<>,
         class NoTransitionFunctor = NoAction,
         class OnExceptionFunctor = NoAction,
         class BASE = ::nimboost::msm::front::default_base_state>
struct func_state_machine :  public ::nimboost::msm::front::detail::state_base<BASE,Attributes>, 
                                                        ...
                                                        Defer,NoTransitionFunctor,OnExceptionFunctor,BASE> >
{
    ...
    BOOST_MPL_ASSERT_NOT(( nimboost::is_same<EntryFunctor,invalid_type> ));
    BOOST_MPL_ASSERT_NOT(( nimboost::is_same<ExitFunctor,invalid_type> ));
    BOOST_MPL_ASSERT_NOT(( nimboost::is_same<NoTransitionFunctor,invalid_type> ));
    BOOST_MPL_ASSERT_NOT(( nimboost::is_same<OnExceptionFunctor,invalid_type> ));
    BOOST_MPL_ASSERT_NOT(( nimboost::is_same<STT,invalid_type> ));
...
StateNameTag,
STT,
typename nimboost::result_of<BuildInit(Init)>::type
>
build_sm(STT ,Init)
{
    typedef typename nimboost::result_of<BuildInit(Init)>::type init_type;
...
typename nimboost::result_of<BuildFlags(Configure)>::type,
typename nimboost::result_of<BuildDeferred(Configure)>::type,
typename nimboost::result_of<BuildConfigure(Configure)>::type
>
build_sm(STT ,Init , Expr1 const& ,Expr2 const& , Attr const&, Configure const& )
{
    ...
    typedef typename nimboost::result_of<BuildFlags(Configure)>::type flags_type;
    typedef typename nimboost::result_of<BuildDeferred(Configure)>::type deferred_type;
    typedef typename nimboost::result_of<BuildConfigure(Configure)>::type config_type;
...
typename ::nimboost::mpl::eval_if<
    ...
    nimboost::result_of<ActionGrammar(Expr3)>,
    make_invalid_type>::type
>
build_sm(STT ,Init , Expr1 const& ,Expr2 const& ,Attr const&, Configure const&, Expr3 const& )
{
    ...
    typedef typename nimboost::result_of<ActionGrammar(Expr1)>::type entry_action;
    typedef typename nimboost::result_of<ActionGrammar(Expr2)>::type exit_action;
    typedef typename nimboost::result_of<ActionGrammar(Expr3)>::type no_transition_action;
    typedef typename nimboost::result_of<BuildAttributes(Attr)>::type attributes_type;
    typedef typename nimboost::result_of<BuildFlags(Configure)>::type flags_type;
    typedef typename nimboost::result_of<BuildDeferred(Configure)>::type deferred_type;
    typedef typename nimboost::result_of<BuildConfigure(Configure)>::type config_type;
...
typename ::nimboost::mpl::eval_if<
    ...
    nimboost::result_of<ActionGrammar(Expr4)>,
    make_invalid_type>::type
>
build_sm(STT ,Init , Expr1 const& ,Expr2 const& , Attr const&, Configure const&, Expr3 const&, Expr4 const& )
{
    ...
    typedef typename nimboost::result_of<BuildConfigure(Configure)>::type config_type;
    typedef typename nimboost::result_of<ActionGrammar(Expr3)>::type no_transition_action;
    typedef typename nimboost::result_of<ActionGrammar(Expr4)>::type on_exception_action;
    typedef typename nimboost::result_of<BuildAttributes(Attr)>::type attributes_type;
    return func_state_machine<StateNameTag,STT,init_type,entry_action,exit_action,attributes_type,flags_type,deferred_type,
...
template <class Expr>
inline
::nimboost::msm::front::detail::inherit_attributes<typename nimboost::result_of<BuildAttributes(Expr)>::type>
build_attributes (Expr const&)
{
    return ::nimboost::msm::front::detail::inherit_attributes<typename nimboost::result_of<BuildAttributes(Expr)>::type> ();
}
...
typename ::nimboost::mpl::eval_if<
    ...
    make_invalid_type>::type,
typename nimboost::result_of<BuildAttributes(Attr)>::type,
typename ::nimboost::mpl::push_back< typename nimboost::result_of<BuildFlags(Configure)>::type,
                                  ::nimboost::msm::TerminateFlag>::type,
typename nimboost::result_of<BuildDeferred(Configure)>::type,
BASE
>
build_terminate_state(Expr1 const& ,Expr2 const& , Attr const&, Configure const&, BASE )
{
    typedef typename nimboost::result_of<ActionGrammar(Expr1)>::type entry_action;
    typedef typename nimboost::result_of<ActionGrammar(Expr2)>::type exit_action;
    typedef typename ::nimboost::mpl::push_back<
        typename nimboost::result_of<BuildFlags(Configure)>::type,
        ::nimboost::msm::TerminateFlag >::type flags_type;
    typedef typename nimboost::result_of<BuildDeferred(Configure)>::type deferred_type;
    typedef typename nimboost::result_of<BuildAttributes(Attr)>::type attributes_type;
    return func_state<StateNameTag,entry_action,exit_action,attributes_type,flags_type,deferred_type,BASE>();
}
...
typename ::nimboost::mpl::eval_if<
    ...
    make_invalid_type>::type,
typename nimboost::result_of<BuildAttributes(Attr)>::type,
::nimboost::mpl::vector<nimboost::msm::TerminateFlag> 
>
build_terminate_state(Expr1 const& ,Expr2 const& ,Attr const&)
{
    ...
    typedef typename nimboost::result_of<ActionGrammar(Expr2)>::type exit_action;
    typedef typename nimboost::result_of<BuildAttributes(Attr)>::type attributes_type;
    return func_state<StateNameTag,entry_action,exit_action,attributes_type, ::nimboost::mpl::vector< ::nimboost::msm::TerminateFlag> >();
}
...
build_terminate_state(Expr1 const& ,Expr2 const& )
{
    ...
    typedef typename nimboost::result_of<ActionGrammar(Expr2)>::type exit_action;
    return func_state<StateNameTag,entry_action,exit_action,
                      ::nimboost::fusion::vector<>, ::nimboost::mpl::vector< ::nimboost::msm::TerminateFlag> >();
}
...
{
    typedef typename nimboost::result_of<ActionGrammar(Expr1)>::type entry_action;
    return func_state<StateNameTag,entry_action,NoAction,::nimboost::fusion::vector<>,::nimboost::mpl::vector<nimboost::msm::TerminateFlag> >();
}
template<class StateNameTag>
inline
func_state<
...
{
    return func_state<StateNameTag,NoAction,NoAction,::nimboost::fusion::vector<>,::nimboost::mpl::vector<nimboost::msm::TerminateFlag> >();
}
...
typename ::nimboost::mpl::eval_if<
    ...
    make_invalid_type>::type,
typename nimboost::result_of<BuildAttributes(Attr)>::type,
typename ::nimboost::mpl::push_back<
    typename ::nimboost::mpl::push_back< typename nimboost::result_of<BuildFlags(Configure)>::type,
                                      ::nimboost::msm::InterruptedFlag>::type,
    nimboost::msm::EndInterruptFlag<EndInterruptEvent>
    >::type,
typename nimboost::result_of<BuildDeferred(Configure)>::type,
BASE
>
...
typename ::nimboost::mpl::eval_if<
    ...
    make_invalid_type>::type,
typename nimboost::result_of<BuildAttributes(Attr)>::type,
::nimboost::mpl::vector<nimboost::msm::InterruptedFlag, nimboost::msm::EndInterruptFlag<EndInterruptEvent> > 
>
...
{
    typedef typename nimboost::result_of<ActionGrammar(Expr1)>::type entry_action;
    return func_state<StateNameTag,entry_action,NoAction, ::nimboost::fusion::vector<>,
                     ::nimboost::mpl::vector<nimboost::msm::InterruptedFlag, nimboost::msm::EndInterruptFlag<EndInterruptEvent> > >();
}
...
{
    return func_state<StateNameTag,NoAction,NoAction, ::nimboost::fusion::vector<>,
                      ::nimboost::mpl::vector<nimboost::msm::InterruptedFlag, nimboost::msm::EndInterruptFlag<EndInterruptEvent> > >();
}
