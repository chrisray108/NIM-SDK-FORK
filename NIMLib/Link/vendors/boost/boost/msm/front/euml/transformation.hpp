...
struct BackInserter_Helper: proto::extends< proto::terminal<back_inserter_tag>::type, BackInserter_Helper, nimboost::msm::sm_domain>
{
    BackInserter_Helper(){}
...
struct FrontInserter_Helper: proto::extends< proto::terminal<front_inserter_tag>::type, FrontInserter_Helper, nimboost::msm::sm_domain>
{
...
struct inserter_tag {};
struct Inserter_Helper: proto::extends< proto::terminal<inserter_tag>::type, Inserter_Helper, nimboost::msm::sm_domain>
{
    Inserter_Helper(){}
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
...
struct Transform_<Param1,Param2,Param3,Param4,Param5,
                  typename ::nimboost::enable_if<typename ::nimboost::is_same<Param5,void>::type >::type> 
...
struct Transform_Helper: proto::extends< proto::terminal<transform_tag>::type, Transform_Helper, nimboost::msm::sm_domain>
{
    Transform_Helper(){}
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
