...
struct BuildStt
   : proto::or_<
        proto::when<
                    ...
                    nimboost::mpl::push_back<BuildStt(proto::_left),BuildRow(proto::_right)>()
                >,
        proto::when <
                    BuildRow,
...
typename ::nimboost::mpl::eval_if<
    ...
    nimboost::result_of<BuildStt(Expr)>,
    make_invalid_type>::type
build_stt(Expr const& expr)
{
    return typename nimboost::result_of<BuildStt(Expr)>::type();
}
...
struct BuildInternalStt
   : proto::or_<
        proto::when<
                    ...
                    nimboost::mpl::push_back<BuildInternalStt(proto::_left),BuildInternalRow(proto::_right)>()
                >,
        proto::when <
                    BuildInternalRow,
...
typename ::nimboost::mpl::eval_if<
    ...
    nimboost::result_of<BuildInternalStt(Expr)>,
    make_invalid_type>::type
build_internal_stt(Expr const& expr)
{
    return typename nimboost::result_of<BuildInternalStt(Expr)>::type();
}
