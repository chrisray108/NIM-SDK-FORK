...
namespace proto = nimboost::proto;
...
namespace nimboost { namespace msm { namespace front { namespace euml
{
template <class T>
struct get_iterator 
{
...
{
    typedef typename ::nimboost::mpl::has_key<
...
template <class T>
struct get_state_name<T,typename ::nimboost::enable_if<has_not_intern_euml_state<T> >::type>
{
...
template <class EVT>
struct euml_event: proto::extends<typename proto::terminal<event_tag>::type, EVT, nimboost::msm::sm_domain>
{
    typedef event_tag euml_tag_type;
    typedef EVT event_name;
    using proto::extends<typename proto::terminal<event_tag>::type, EVT, nimboost::msm::sm_domain>::operator=;
...
struct euml_state_intern: proto::extends<typename proto::terminal< nimboost::msm::state_tag>::type, STATE, nimboost::msm::state_domain>
{
    typedef state_tag euml_tag_type;
    using proto::extends<typename proto::terminal<state_tag>::type, STATE, nimboost::msm::state_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
        ,class Arg6 
#endif
...
template <class STATE>
struct euml_state: proto::extends<typename proto::terminal< nimboost::msm::state_tag>::type, STATE, nimboost::msm::state_domain>
{
    typedef state_tag euml_tag_type;
...
struct euml_action: proto::extends<typename proto::terminal<action_tag>::type, ACTION, nimboost::msm::sm_domain>
{
    typedef action_tag euml_tag_type;
    typedef ACTION action_name;
    using proto::extends<typename proto::terminal<action_tag>::type, ACTION, nimboost::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
template <class FLAG>
struct euml_flag: proto::extends<typename proto::terminal<flag_tag>::type, FLAG, nimboost::msm::sm_domain>
{
    typedef flag_tag euml_tag_type;
    using proto::extends<typename proto::terminal<flag_tag>::type, FLAG, nimboost::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
struct euml_config: proto::extends<typename proto::terminal<config_tag>::type, CONFIG, nimboost::msm::sm_domain>
{
    typedef config_tag euml_tag_type;
    using proto::extends<typename proto::terminal<config_tag>::type, CONFIG, nimboost::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
{
    typedef nimboost::msm::active_state_switch_before_transition active_state_switch_policy;
...
{
    typedef nimboost::msm::active_state_switch_after_exit active_state_switch_policy;
...
{
    typedef nimboost::msm::active_state_switch_after_transition_action active_state_switch_policy;
...
{
    typedef nimboost::mpl::vector<ROW> type;
};
template <class T>
...
{
    typedef nimboost::mpl::vector0<> type;
};
...
struct NoAction : euml_action<NoAction>
{
    ...
    typedef ::nimboost::mpl::set<state_action_tag,action_tag> tag_type;
...
struct GetSource_ : euml_action<GetSource_<Index> >
{
    ...
    struct transition_action_result 
    {
        typedef typename ::nimboost::fusion::result_of::at_key<typename SourceState::attributes_type,
                                                        Index >::type type;
    };
    typedef ::nimboost::mpl::set<action_tag> tag_type;
...
struct GetSource_Helper: proto::extends< proto::terminal<fsm_artefact_tag>::type, GetSource_Helper, nimboost::msm::sm_domain>
{
    GetSource_Helper(){}
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
...
struct GetTarget_ : euml_action<GetTarget_<Index> >
{
    ...
    struct transition_action_result 
    {
        typedef typename ::nimboost::fusion::result_of::at_key<typename TargetState::attributes_type,
                                                        Index >::type type;
    };
    typedef ::nimboost::mpl::set<action_tag> tag_type;
...
struct GetTarget_Helper: proto::extends< proto::terminal<fsm_artefact_tag>::type, GetTarget_Helper, nimboost::msm::sm_domain>
{
    GetTarget_Helper(){}
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
...
struct GetState_ : euml_action<GetState_<Index> >
{
    ...
    struct state_action_result 
    {
        typedef typename ::nimboost::fusion::result_of::at_key<typename STATE::attributes_type,
                                                        Index >::type type;
    };
    typedef ::nimboost::mpl::set<state_action_tag> tag_type;
...
struct GetState_Helper: proto::extends< proto::terminal<fsm_artefact_tag>::type, GetState_Helper, nimboost::msm::sm_domain>
{
    GetState_Helper(){}
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
...
struct GetEvent_ : euml_action<GetEvent_<Index> >
{
    ...
    struct state_action_result 
    {
        typedef typename ::nimboost::add_const<
            typename ::nimboost::fusion::result_of::at_key<typename Event::attributes_type,
    ...
    {
        typedef typename ::nimboost::add_const<
            typename ::nimboost::fusion::result_of::at_key<typename EVT::attributes_type,
                                                        Index >::type>::type type;
    };
    typedef ::nimboost::mpl::set<state_action_tag,action_tag> tag_type;
...
struct GetEvent_Helper: proto::extends< proto::terminal<fsm_artefact_tag>::type, GetEvent_Helper, nimboost::msm::sm_domain>
{
    GetEvent_Helper(){}
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
...
struct GetFsm_ : euml_action<GetFsm_<Index> >
{
    ...
    struct state_action_result 
    {
        typedef typename ::nimboost::fusion::result_of::at_key<typename FSM::attributes_type,
                                                        Index >::type type;
    };
    template <class EVT,class FSM,class SourceState,class TargetState>
    struct transition_action_result 
...
struct GetFsm_Helper: proto::extends< proto::terminal<fsm_artefact_tag>::type, GetFsm_Helper, nimboost::msm::sm_domain>
{
    GetFsm_Helper(){}
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
...
struct SubState_Helper: proto::extends< proto::terminal<fsm_artefact_tag>::type, SubState_Helper, nimboost::msm::sm_domain>
{
    SubState_Helper(){}
    using proto::extends< proto::terminal<fsm_artefact_tag>::type, SubState_Helper, nimboost::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
struct GetAttribute_  : euml_action<GetAttribute_<Target, Index> >
{
    ...
    {
        typedef typename 
            ::nimboost::fusion::result_of::at_key<
...
struct GetAttribute_Helper: proto::extends< proto::terminal<fsm_artefact_tag>::type, GetAttribute_Helper, nimboost::msm::sm_domain>
{
    GetAttribute_Helper(){}
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
...
struct Source_ : euml_action<Source_<Index> >
{
    ...
    {
        typedef typename 
            ::nimboost::fusion::result_of::at_key<typename SourceState::attributes_type,
                                               Index >::type type;
    };
    typedef ::nimboost::mpl::set<action_tag> tag_type;
...
struct Target_ : euml_action<Target_<Index> >
{
    ...
    {
        typedef typename 
            ::nimboost::fusion::result_of::at_key<typename TargetState::attributes_type,
                                               Index >::type type;
    };
    typedef ::nimboost::mpl::set<action_tag> tag_type;
...
struct State_ : euml_action<State_<Index> >
{
    ...
    {
        typedef typename 
            ::nimboost::fusion::result_of::at_key<typename STATE::attributes_type,
                                               Index >::type type;
    };
    typedef ::nimboost::mpl::set<state_action_tag> tag_type;
...
struct State_Attribute_ : euml_action<State_Attribute_<StateType,Index> >
{
    ...
    {
        typedef typename 
            ::nimboost::fusion::result_of::at_key<typename StateType::attributes_type,
                                               Index >::type type;
    };
    typedef ::nimboost::mpl::set<state_action_tag> tag_type;
...
struct Fsm_ : euml_action<Fsm_<Index> >
{
    ...
    {
        typedef typename 
            ::nimboost::fusion::result_of::at_key<typename FSM::attributes_type,
                                               Index >::type type;
    };
    template <class EVT,class FSM,class SourceState,class TargetState>
    struct transition_action_result 
...
struct Int_ : euml_action<Int_<Val> >
{
    ...
    typedef ::nimboost::mpl::int_<Val> value_type;
    enum {value = Val};
...
struct String_ : euml_action<String_<T> >
{
    ...
    {
        return ::nimboost::mpl::c_str<T>::value;
    }
    template <class Event,class FSM,class STATE>
...
struct process_tag {};
struct Process_Helper: proto::extends< proto::terminal<process_tag>::type, Process_Helper, nimboost::msm::sm_domain>
{
    Process_Helper(){}
    using proto::extends< proto::terminal<process_tag>::type, Process_Helper, nimboost::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
struct Reprocess_Helper: proto::extends< proto::terminal<reprocess_tag>::type, Reprocess_Helper, nimboost::msm::sm_domain>
{
    Reprocess_Helper(){}
    using proto::extends< proto::terminal<reprocess_tag>::type, Reprocess_Helper, nimboost::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
struct process2_tag {};
struct Process2_Helper : proto::extends< proto::terminal<process2_tag>::type, Process2_Helper, nimboost::msm::sm_domain>
{
    Process2_Helper(){}
    using proto::extends< proto::terminal<process2_tag>::type, Process2_Helper, nimboost::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
struct Get_Flag_ <Flag,Param1
    , typename ::nimboost::enable_if<typename ::nimboost::is_same<Param1,void>::type >::type>
...
struct Get_Flag_ <Flag,Param1
    , typename ::nimboost::disable_if<
            typename ::nimboost::is_same<Param1,void>::type
            >::type>
    : euml_action<Get_Flag_<Flag, Param1> >
{
    template <class Event,class FSM,class STATE >
...
struct Get_Flag_Helper: proto::extends< proto::terminal<fsm_artefact_tag>::type, Get_Flag_Helper, nimboost::msm::sm_domain>
{
    Get_Flag_Helper(){}
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
...
struct Defer_Helper : proto::extends< proto::terminal<fsm_artefact_tag>::type, Defer_Helper, nimboost::msm::sm_domain>
{
    Defer_Helper(){}
    using proto::extends< proto::terminal<fsm_artefact_tag>::type, Defer_Helper, nimboost::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
struct explicit_tag {};
struct Explicit_Helper : proto::extends< proto::terminal<explicit_tag>::type, Explicit_Helper, nimboost::msm::sm_domain>
{
    Explicit_Helper(){}
    using proto::extends< proto::terminal<explicit_tag>::type, Explicit_Helper, nimboost::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
struct entry_pt_tag {};
struct Entry_Pt_Helper : proto::extends< proto::terminal<entry_pt_tag>::type, Entry_Pt_Helper, nimboost::msm::sm_domain>
{
    Entry_Pt_Helper(){}
    using proto::extends< proto::terminal<entry_pt_tag>::type, Entry_Pt_Helper, nimboost::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
struct exit_pt_tag {};
struct Exit_Pt_Helper : proto::extends< proto::terminal<exit_pt_tag>::type, Exit_Pt_Helper, nimboost::msm::sm_domain>
{
    Exit_Pt_Helper(){}
    using proto::extends< proto::terminal<exit_pt_tag>::type, Exit_Pt_Helper, nimboost::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
#define BOOST_MSM_EUML_FUNCTION(functor,function,function_name,result_trans,result_state)               \
    ...
    struct functor<Param1,Param2,Param3,Param4,Param5,Param6,                                           \
        ...
        typedef ::nimboost::mpl::set<nimboost::msm::front::state_action_tag,nimboost::msm::front::action_tag> tag_type; \
        template <class EVT,class FSM,class SourceState,class TargetState>                              \
        typename transition_action_result<EVT,FSM,SourceState,TargetState>::type                        \
    ...
    template <class Param1, class Param2, class Param3, class Param4, class Param5,class Param6>        \
    struct functor<Param1,Param2,Param3,Param4,Param5,Param6,                                           \
        typename ::nimboost::disable_if<typename ::nimboost::mpl::or_<                                        \
        typename ::nimboost::is_same<Param1,void>::type,typename ::nimboost::mpl::not_<                       \
        typename ::nimboost::is_same<Param2,void>::type>::type>::type >::type>                             \
        : euml_action<functor<Param1,Param2,Param3,Param4,Param5,Param6> > {                            \
        template <class Event,class FSM,class STATE > struct state_action_result {                      \
        typedef result_state type;} ;                                                                   \
        template <class EVT,class FSM,class SourceState,class TargetState>                              \
        ...
        typedef ::nimboost::mpl::set<nimboost::msm::front::state_action_tag,nimboost::msm::front::action_tag> tag_type; \
        template <class EVT,class FSM,class SourceState,class TargetState>                              \
        typename ::nimboost::enable_if<typename ::nimboost::mpl::has_key<                                     \
        typename Param1::tag_type,nimboost::msm::front::action_tag>::type,                                 \
        typename transition_action_result<EVT,FSM,SourceState,TargetState>::type >::type                \
        operator()(EVT const& evt, FSM& fsm,SourceState& src,TargetState& tgt)const {                   \
        return function (Param1()(evt,fsm,src,tgt));}                                                   \
        template <class Event,class FSM,class STATE>                                                    \
        typename ::nimboost::enable_if<typename ::nimboost::mpl::has_key<                                     \
        typename Param1::tag_type,nimboost::msm::front::state_action_tag>::type,                           \
        typename state_action_result<Event,FSM,STATE>::type >::type                                     \
        operator()(Event const& evt,FSM& fsm,STATE& state )const {                                      \
    ...
    struct functor<Param1,Param2,Param3,Param4,Param5,Param6,                                           \
        typename ::nimboost::disable_if<typename ::nimboost::mpl::or_<                                        \
        typename ::nimboost::is_same<Param2,void>::type,typename ::nimboost::mpl::not_<                       \
        typename ::nimboost::is_same<Param3,void>::type>::type>::type >::type>                             \
        : euml_action<functor<Param1,Param2,Param3,Param4,Param5,Param6> > {                            \
        template <class Event,class FSM,class STATE > struct state_action_result {                      \
        typedef result_state type;} ;                                                                   \
        template <class EVT,class FSM,class SourceState,class TargetState>                              \
    ...
    struct functor<Param1,Param2,Param3,Param4,Param5,Param6,                                           \
        typename ::nimboost::disable_if<typename ::nimboost::mpl::or_<                                        \
        typename ::nimboost::is_same<Param3,void>::type,typename ::nimboost::mpl::not_<                       \
        typename ::nimboost::is_same<Param4,void>::type>::type>::type >::type>                             \
        : euml_action<functor<Param1,Param2,Param3,Param4,Param5,Param6> > {                            \
        template <class Event,class FSM,class STATE > struct state_action_result {                      \
        typedef result_state type;} ;                                                                   \
        template <class EVT,class FSM,class SourceState,class TargetState>                              \
    ...
    struct functor<Param1,Param2,Param3,Param4,Param5,Param6,                                           \
        typename ::nimboost::disable_if<typename ::nimboost::mpl::or_<                                        \
        typename ::nimboost::is_same<Param4,void>::type,typename ::nimboost::mpl::not_<                       \
        typename ::nimboost::is_same<Param5,void>::type>::type>::type >::type>                             \
        : euml_action<functor<Param1,Param2,Param3,Param4,Param5,Param6> > {                            \
        template <class Event,class FSM,class STATE > struct state_action_result {                      \
        typedef result_state type;} ;                                                                   \
        template <class EVT,class FSM,class SourceState,class TargetState>                              \
    ...
    struct functor<Param1,Param2,Param3,Param4,Param5,Param6,                                           \
        typename ::nimboost::disable_if<typename ::nimboost::mpl::or_<                                        \
        typename ::nimboost::is_same<Param5,void>::type,typename ::nimboost::mpl::not_<                       \
        typename ::nimboost::is_same<Param6,void>::type>::type>::type >::type>                             \
        : euml_action<functor<Param1,Param2,Param3,Param4,Param5,Param6> > {                            \
        template <class Event,class FSM,class STATE > struct state_action_result {                      \
        typedef result_state type;} ;                                                                   \
        template <class EVT,class FSM,class SourceState,class TargetState>                              \
    ...
    template <class Param1, class Param2, class Param3, class Param4, class Param5,class Param6>        \
    struct functor<Param1,Param2,Param3,Param4,Param5,Param6,                                           \
        typename ::nimboost::disable_if<typename ::nimboost::is_same<Param6,void>::type>::type>               \
        : euml_action<functor<Param1,Param2,Param3,Param4,Param5,Param6> > {                            \
        template <class Event,class FSM,class STATE > struct state_action_result {                      \
        typedef result_state type;} ;                                                                   \
        template <class EVT,class FSM,class SourceState,class TargetState>                              \
        ...
        functor ## Helper , nimboost::msm::sm_domain> { functor ## Helper(){}                              \
...
#define BOOST_MSM_EUML_METHOD(functor,function,function_name,result_trans,result_state)                 \
    ...
    template <class Param1, class Param2, class Param3, class Param4, class Param5, class Param6>       \
    struct functor<Param1,Param2,Param3,Param4,Param5,Param6,                                           \
        typename ::nimboost::enable_if<typename ::nimboost::is_same<Param2,void>::type>::type>                \
        : euml_action<functor<Param1,Param2,Param3,Param4,Param5,Param6> > {                            \
        template <class Event,class FSM,class STATE > struct state_action_result {                      \
        typedef result_state type;} ;                                                                   \
        template <class EVT,class FSM,class SourceState,class TargetState>                              \
...
#define BOOST_MSM_EUML_FUNCTION(functor,function,function_name,result_trans,result_state)               \
    ...
    template <class Param1, class Param2, class Param3, class Param4, class Param5>                     \
    struct functor<Param1,Param2,Param3,Param4,Param5,                                                  \
        typename ::nimboost::disable_if<typename ::nimboost::is_same<Param5,void>::type>::type>               \
        : euml_action<functor<Param1,Param2,Param3,Param4,Param5> > {                                   \
        template <class Event,class FSM,class STATE > struct state_action_result {                      \
        typedef result_state type;} ;                                                                   \
        template <class EVT,class FSM,class SourceState,class TargetState>                              \
...
#define RESULT_TYPE2_REMOVE_REF_PARAM1 typename ::nimboost::remove_reference<typename get_result_type2<Param1,Event,FSM,STATE>::type>::type
#define RESULT_TYPE_REMOVE_REF_PARAM1 typename ::nimboost::remove_reference<typename get_result_type<Param1,EVT,FSM,SourceState,TargetState>::type>::type 
...
#define RESULT_TYPE2_GET_REF_REMOVE_REF_PARAM1 typename get_reference<typename ::nimboost::remove_reference<typename get_result_type2<Param1,Event,FSM,STATE>::type>::type>::type
#define RESULT_TYPE_GET_REF_REMOVE_REF_PARAM1 typename get_reference<typename ::nimboost::remove_reference<typename get_result_type<Param1,EVT,FSM,SourceState,TargetState>::type>::type>::type 

#define RESULT_TYPE2_GET_ITERATOR_REMOVE_REF_PARAM1 typename get_iterator<typename ::nimboost::remove_reference<typename get_result_type2<Param1,Event,FSM,STATE>::type>::type>::type
#define RESULT_TYPE_GET_ITERATOR_REMOVE_REF_PARAM1 typename get_iterator<typename ::nimboost::remove_reference<typename get_result_type<Param1,EVT,FSM,SourceState,TargetState>::type>::type>::type 

#define RESULT_TYPE2_GET_REV_ITERATOR_REMOVE_REF_PARAM1 typename get_reverse_iterator<typename ::nimboost::remove_reference<typename get_result_type2<Param1,Event,FSM,STATE>::type>::type>::type
#define RESULT_TYPE_GET_REV_ITERATOR_REMOVE_REF_PARAM1 typename get_reverse_iterator<typename ::nimboost::remove_reference<typename get_result_type<Param1,EVT,FSM,SourceState,TargetState>::type>::type>::type 

#define RESULT_TYPE2_GET_SIZE_TYPE_REMOVE_REF_PARAM1 typename get_size_type<typename ::nimboost::remove_reference<typename get_result_type2<Param1,Event,FSM,STATE>::type>::type>::type
#define RESULT_TYPE_GET_SIZE_TYPE_REMOVE_REF_PARAM1 typename get_size_type<typename ::nimboost::remove_reference<typename get_result_type<Param1,EVT,FSM,SourceState,TargetState>::type>::type>::type 
...
struct kleene_ : msm::front::euml::euml_event<kleene_>, public nimboost::any
{
    kleene_() : nimboost::any(){}
    template<typename ValueType>
    kleene_(const ValueType & v) : nimboost::any(v){}
};
...
#define MSM_EUML_EVENT_INSTANCE_HELPER_ATTRIBUTE_MAP_ENTRY(z, n, unused)                        \
    typename nimboost::fusion::result_of::first<                                                   \
            typename ::nimboost::remove_reference<                                                 \
            typename nimboost::fusion::result_of::at_c<T, BOOST_PP_CAT( , n)>::type>::type>::type  \

#define MSM_EUML_EVENT_HELPER_GET_ATTRIBUTE(z, n, unused)                                       \
    get_attribute(                                                                              \
        typename nimboost::fusion::result_of::first<                                               \
        typename ::nimboost::remove_reference<                                                     \
        typename nimboost::fusion::result_of::at_c<T, n>::type>::type>::type())=arg ## n;
...
#define MSM_EUML_EVENT_INSTANCE_HELPER_ATTRIBUTE_MAP(z, n, unused)                              \
    ...
    T,typename ::nimboost::enable_if< typename nimboost::mpl::eval_if< typename ::nimboost::fusion::traits::is_sequence<T>::type,size_helper<T,n>,::nimboost::mpl::false_>::type,void >::type* =0)      \
    {                                                                                           \
...
#define BOOST_MSM_EUML_EVENT_WITH_ATTRIBUTES(instance_name, attributes_name)                          \
    ...
    {                                                                                           \
        ...
        {                                                                                       \
            typedef typename ::nimboost::mpl::less_equal<                                          \
                typename ::nimboost::fusion::result_of::size<T>::type,                             \
                ::nimboost::mpl::int_<checked_size> >::type type;                                  \
        };                                                                                      \
        BOOST_PP_CAT(instance_name,_helper()) : attributes_name(){}                             \
        typedef attributes_name::attributes_type attribute_map;                                 \
        typedef ::nimboost::fusion::result_of::as_vector<attribute_map>::type attribute_vec;       \
...
}}}} // nimboost::msm::front::euml

namespace nimboost { namespace msm{
    template<> 
    struct is_kleene_event< nimboost::msm::front::euml::kleene_ >
    { 
      typedef ::nimboost::mpl::true_ type;
    };
}}
