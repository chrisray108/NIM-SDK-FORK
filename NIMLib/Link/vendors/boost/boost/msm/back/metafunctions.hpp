...
struct set_insert_range
{
    typedef typename ::nimboost::mpl::fold<
        Range,Sequence, 
        ::nimboost::mpl::insert< ::nimboost::mpl::placeholders::_1, ::nimboost::mpl::placeholders::_2 >
    >::type type;
};
...
{
    typedef typename ::nimboost::mpl::pair<typename Transition::current_state_type,Id> type;
};
template <class Id,class Transition>
struct make_pair_target_state_id
{
    typedef typename ::nimboost::mpl::pair<typename Transition::next_state_type,Id> type;
};
...
struct generate_state_ids
{
    typedef typename 
        ::nimboost::mpl::fold<
        stt,::nimboost::mpl::pair< ::nimboost::mpl::map< >, ::nimboost::mpl::int_<0> >,
        ::nimboost::mpl::pair<
            ::nimboost::mpl::if_<
                     ::nimboost::mpl::has_key< ::nimboost::mpl::first< ::nimboost::mpl::placeholders::_1>,
                                            transition_source_type< ::nimboost::mpl::placeholders::_2> >,
                     ::nimboost::mpl::first< ::nimboost::mpl::placeholders::_1>,
                     ::nimboost::mpl::insert< ::nimboost::mpl::first<mpl::placeholders::_1>,
                                make_pair_source_state_id< ::nimboost::mpl::second< ::nimboost::mpl::placeholders::_1 >,
                                                           ::nimboost::mpl::placeholders::_2> >
                      >,
            ::nimboost::mpl::if_<
                    ::nimboost::mpl::has_key< ::nimboost::mpl::first< ::nimboost::mpl::placeholders::_1>,
                                           transition_source_type< ::nimboost::mpl::placeholders::_2> >,
                    ::nimboost::mpl::second< ::nimboost::mpl::placeholders::_1 >,
                    ::nimboost::mpl::next< ::nimboost::mpl::second<mpl::placeholders::_1 > >
                    >
        > //pair
        >::type source_state_ids;
    typedef typename ::nimboost::mpl::first<source_state_ids>::type source_state_map;
    typedef typename ::nimboost::mpl::second<source_state_ids>::type highest_state_id;


    typedef typename 
        ::nimboost::mpl::fold<
        stt,::nimboost::mpl::pair<source_state_map,highest_state_id >,
        ::nimboost::mpl::pair<
            ::nimboost::mpl::if_<
                     ::nimboost::mpl::has_key< ::nimboost::mpl::first< ::nimboost::mpl::placeholders::_1>,
                                            transition_target_type< ::nimboost::mpl::placeholders::_2> >,
                     ::nimboost::mpl::first< ::nimboost::mpl::placeholders::_1>,
                     ::nimboost::mpl::insert< ::nimboost::mpl::first< ::nimboost::mpl::placeholders::_1>,
                                make_pair_target_state_id< ::nimboost::mpl::second< ::nimboost::mpl::placeholders::_1 >,
                                ::nimboost::mpl::placeholders::_2> >
                     >,
            ::nimboost::mpl::if_<
                    ::nimboost::mpl::has_key< ::nimboost::mpl::first< ::nimboost::mpl::placeholders::_1>,
                                           transition_target_type< ::nimboost::mpl::placeholders::_2> >,
                    ::nimboost::mpl::second< ::nimboost::mpl::placeholders::_1 >,
                    ::nimboost::mpl::next< ::nimboost::mpl::second< ::nimboost::mpl::placeholders::_1 > >
                    >
        > //pair
        >::type all_state_ids;
    typedef typename ::nimboost::mpl::first<all_state_ids>::type type;
};
...
{
    typedef typename nimboost::mpl::deref<Iter>::type Fsm;
    typedef typename Fsm::active_state_switch_policy type;
};
...
{
    typedef typename ::nimboost::mpl::find_if<
        typename Fsm::configuration,
        has_active_state_switch_policy< ::nimboost::mpl::placeholders::_1 > >::type iter;

    typedef typename ::nimboost::mpl::eval_if<
        typename ::nimboost::is_same<
            iter, 
            typename ::nimboost::mpl::end<typename Fsm::configuration>::type
        >::type,
...
struct get_state_id
{
    typedef typename ::nimboost::mpl::at<typename generate_state_ids<stt>::type,State>::type type;
...
struct get_initial_states 
{
    typedef typename ::nimboost::mpl::if_<
        ::nimboost::mpl::is_sequence<States>,
        States,
        typename ::nimboost::mpl::push_back< ::nimboost::mpl::vector0<>,States>::type >::type type;
};
...
struct get_number_of_regions 
{
    typedef typename mpl::if_<
        ::nimboost::mpl::is_sequence<region>,
        ::nimboost::mpl::size<region>,
        ::nimboost::mpl::int_<1> >::type type;
};
...
struct get_regions_as_sequence 
{
    typedef typename ::nimboost::mpl::if_<
        ::nimboost::mpl::is_sequence<region>,
        region,
        typename ::nimboost::mpl::push_back< ::nimboost::mpl::vector0<>,region>::type >::type type;
};
...
{
    typedef typename ::nimboost::mpl::if_<
        ::nimboost::mpl::is_sequence<ToCreateSeq>,
        ToCreateSeq,
        typename ::nimboost::mpl::push_back< ::nimboost::mpl::vector0<>,ToCreateSeq>::type >::type type;
};
...
struct keep_source_names
{
    ...
    typedef typename 
        ::nimboost::mpl::transform<
        stt,transition_source_type< ::nimboost::mpl::placeholders::_1> >::type type;
};
...
struct keep_target_names
{
    ...
    typedef typename 
        ::nimboost::mpl::transform<
        stt,transition_target_type< ::nimboost::mpl::placeholders::_1> >::type type;
};
...
struct generate_event_set
{
    typedef typename 
        ::nimboost::mpl::fold<
            stt, ::nimboost::mpl::set<>,
            ::nimboost::mpl::if_<
                ::nimboost::mpl::has_key< ::nimboost::mpl::placeholders::_1, 
                                       transition_event< ::nimboost::mpl::placeholders::_2> >,
                ::nimboost::mpl::placeholders::_1,
                ::nimboost::mpl::insert< ::nimboost::mpl::placeholders::_1,
                                      transition_event< ::nimboost::mpl::placeholders::_2> > >
        >::type type;
};
...
{
    typedef typename ::nimboost::mpl::find<typename State::deferred_events,Event>::type found;
    typedef typename ::nimboost::mpl::if_<
        ::nimboost::is_same<found,typename ::nimboost::mpl::end<typename State::deferred_events>::type >,
        ::nimboost::mpl::bool_<false>,
        ::nimboost::mpl::bool_<true> >::type type;
};
...
{
    typedef typename ::nimboost::mpl::if_<
        ::nimboost::mpl::empty<typename State::deferred_events>,
        ::nimboost::mpl::bool_<false>,
        ::nimboost::mpl::bool_<true> >::type type;
};
...
{
    typedef typename ::nimboost::mpl::if_< typename has_pseudo_entry<State>::type,
        ::nimboost::mpl::bool_<true>,::nimboost::mpl::bool_<false> 
    >::type type;
};
...
{
    typedef typename ::nimboost::mpl::if_< typename has_pseudo_exit<State>::type,
        ::nimboost::mpl::bool_<true>, ::nimboost::mpl::bool_<false> 
    >::type type;
};
...
{
    typedef typename ::nimboost::mpl::if_< typename has_explicit_entry_state<State>::type,
        ::nimboost::mpl::bool_<true>, ::nimboost::mpl::bool_<false> 
    >::type type;
};
...
struct convert_fake_state
{
    ...
    typedef typename ::nimboost::mpl::if_<
        ...
        typename ::nimboost::mpl::identity<StateType>::type
    >::type type;
};
...
struct get_wrapped_state 
{
    typedef typename ::nimboost::mpl::eval_if<
                ...
                ::nimboost::mpl::identity<StateType> >::type type;
};
...
struct create_stt 
{
    ...
    typedef typename 
        ...
        init_states,Stt,
        ::nimboost::mpl::if_<
                 ::nimboost::mpl::has_key<states, ::nimboost::mpl::placeholders::_2>,
                 ::nimboost::mpl::placeholders::_1,
                 ::nimboost::mpl::insert< ::nimboost::mpl::placeholders::_1, ::nimboost::mpl::end< ::nimboost::mpl::placeholders::_1>,
                             not_a_row< get_wrapped_state< ::nimboost::mpl::placeholders::_2> > > 
                  >
        >::type with_init;
    // do the same for states marked as explicitly created
    typedef typename get_explicit_creation_as_sequence<
       typename ::nimboost::mpl::eval_if<
            typename has_explicit_creation<Derived>::type,
            get_explicit_creation<Derived>,
            ::nimboost::mpl::vector0<> >::type
        >::type fake_explicit_created;

    typedef typename 
        ::nimboost::mpl::transform<
        fake_explicit_created,convert_fake_state< ::nimboost::mpl::placeholders::_1,Derived> >::type explicit_created;
    ...
    typedef typename 
        ...
        ::nimboost::mpl::if_<
                 ::nimboost::mpl::has_key<states, ::nimboost::mpl::placeholders::_2>,
                 ::nimboost::mpl::placeholders::_1,
                 ::nimboost::mpl::insert< ::nimboost::mpl::placeholders::_1, ::nimboost::mpl::end<mpl::placeholders::_1>,
                             not_a_row< get_wrapped_state< ::nimboost::mpl::placeholders::_2> > > 
                  >
        >::type type;
};
...
struct recursive_get_internal_transition_table
{
    ...
    typedef typename ::nimboost::mpl::fold<
            ...
            ::nimboost::mpl::insert_range< ::nimboost::mpl::placeholders::_1, ::nimboost::mpl::end< ::nimboost::mpl::placeholders::_1>,
             recursive_get_internal_transition_table< ::nimboost::mpl::placeholders::_2, is_composite_state< ::nimboost::mpl::placeholders::_2> >
             >
    >::type type;
};
// stop iterating on leafs (simple states)
template <class StateType>
struct recursive_get_internal_transition_table<StateType, ::nimboost::mpl::false_ >
{
...
struct recursive_get_transition_table
{
    ...
    typedef typename ::nimboost::mpl::eval_if<typename is_composite_state<Composite>::type,
        get_transition_table<Composite>,
        ::nimboost::mpl::vector0<>
    >::type org_table;
    ...
    typedef typename ::nimboost::mpl::fold<
        states,org_table,
        ::nimboost::mpl::insert_range< ::nimboost::mpl::placeholders::_1, ::nimboost::mpl::end<mpl::placeholders::_1>,
        recursive_get_transition_table< ::nimboost::mpl::placeholders::_2 > >
    >::type type;
...
struct has_fsm_deferred_events 
{
    ...
    typedef typename ::nimboost::mpl::or_<
        typename has_activate_deferred_events<Derived>::type,
        ::nimboost::mpl::bool_< ::nimboost::mpl::count_if<
                typename Derived::configuration,
                has_activate_deferred_events< ::nimboost::mpl::placeholders::_1 > >::value != 0> 
    >::type found_in_fsm;
    ...
    typedef typename ::nimboost::mpl::or_<
            ...
            ::nimboost::mpl::bool_< ::nimboost::mpl::count_if<
                state_list,has_state_delayed_events<
                    ::nimboost::mpl::placeholders::_1 > >::value != 0>
            >::type type;
};
...
struct is_completion_event  
{
    typedef typename ::nimboost::mpl::if_<
        ...
        ::nimboost::mpl::bool_<true>,
        ::nimboost::mpl::bool_<false> >::type type;
};
...
struct has_fsm_eventless_transition 
{
    ...
    typedef ::nimboost::mpl::bool_< ::nimboost::mpl::count_if<
        event_list,is_completion_event< ::nimboost::mpl::placeholders::_1 > >::value != 0> type;
};
template <class Derived>
struct find_completion_events 
{
    ...
    typedef typename ::nimboost::mpl::fold<
        event_list, ::nimboost::mpl::set<>,
        ::nimboost::mpl::if_<
                 is_completion_event< ::nimboost::mpl::placeholders::_2>,
                 ::nimboost::mpl::insert< ::nimboost::mpl::placeholders::_1, ::nimboost::mpl::placeholders::_2 >, 
                 ::nimboost::mpl::placeholders::_1 >
    >::type type;
};
...
struct make_vector 
{
    typedef ::nimboost::mpl::vector<Transition> type;
};
template< typename Entry > 
struct get_first_element_pair_second
{ 
    typedef typename ::nimboost::mpl::front<typename Entry::second>::type type;
}; 
...
{
    typedef typename ::nimboost::mpl::if_<
        typename ::nimboost::mpl::not_<typename ::nimboost::is_same<typename State::owner,
...
{
    typedef typename ::nimboost::mpl::front<Sequence>::type seq_front;
    typedef typename ::nimboost::mpl::if_<
                    typename ::nimboost::mpl::not_<
                        typename ::nimboost::is_same<typename seq_front::owner,ContainingSM>::type>::type,
...
struct has_exit_pseudo_states_helper 
{
    ...
    typedef ::nimboost::mpl::bool_< ::nimboost::mpl::count_if<
                state_list,is_pseudo_exit< ::nimboost::mpl::placeholders::_1> >::value != 0> type;
};
template <class StateType>
struct has_exit_pseudo_states 
{
    typedef typename ::nimboost::mpl::eval_if<typename is_composite_state<StateType>::type,
...
struct get_flag_list 
{
    typedef typename ::nimboost::mpl::insert_range< 
        ...
        typename ::nimboost::mpl::end< typename StateType::flag_list >::type,
...
{
    typedef typename ::nimboost::mpl::fold<
        typename get_flag_list<StateType>::type, ::nimboost::mpl::set<>,
        ::nimboost::mpl::if_<
                 has_event_blocking_flag< ::nimboost::mpl::placeholders::_2>,
                 ::nimboost::mpl::insert< ::nimboost::mpl::placeholders::_1, ::nimboost::mpl::placeholders::_2 >, 
                 ::nimboost::mpl::placeholders::_1 >
    >::type blocking_flags;

    typedef typename ::nimboost::mpl::if_<
        ::nimboost::mpl::empty<blocking_flags>,
        ::nimboost::mpl::bool_<false>,
        ::nimboost::mpl::bool_<true> >::type type;
};
...
struct has_fsm_blocking_states  
{
    ...
    typedef typename ::nimboost::mpl::fold<
        state_list, ::nimboost::mpl::set<>,
        ::nimboost::mpl::if_<
                 is_state_blocking< ::nimboost::mpl::placeholders::_2>,
                 ::nimboost::mpl::insert< ::nimboost::mpl::placeholders::_1, ::nimboost::mpl::placeholders::_2 >, 
                 ::nimboost::mpl::placeholders::_1 >
    >::type blocking_states;

    typedef typename ::nimboost::mpl::if_<
        ::nimboost::mpl::empty<blocking_states>,
        ::nimboost::mpl::bool_<false>,
        ::nimboost::mpl::bool_<true> >::type type;
};
...
struct is_no_exception_thrown
{
    typedef ::nimboost::mpl::bool_< ::nimboost::mpl::count_if<
        ...
        has_no_exception_thrown< ::nimboost::mpl::placeholders::_1 > >::value != 0> found;
...
struct is_no_message_queue
{
    typedef ::nimboost::mpl::bool_< ::nimboost::mpl::count_if<
        typename StateType::configuration,
        has_no_message_queue< ::nimboost::mpl::placeholders::_1 > >::value != 0> found;
...
struct is_active_state_switch_policy 
{
    typedef ::nimboost::mpl::bool_< ::nimboost::mpl::count_if<
        typename StateType::configuration,
        has_active_state_switch_policy< ::nimboost::mpl::placeholders::_1 > >::value != 0> found;
...
struct build_one_orthogonal_region 
{
     ...
     {
         typedef typename ::nimboost::mpl::push_back< Seq, row_to_incidence< Elt > >::type type;
     };

     typedef typename ::nimboost::mpl::fold<
         TransitionTable,
         ::nimboost::mpl::vector<>,
         transition_incidence_list_helper< ::nimboost::mpl::placeholders::_1, ::nimboost::mpl::placeholders::_2>
     >::type transition_incidence_list;

     typedef ::nimboost::msm::mpl_graph::incidence_list_graph<transition_incidence_list>
         transition_graph;

     struct preordering_dfs_visitor : 
         ::nimboost::msm::mpl_graph::dfs_default_visitor_operations 
     {    
         template<typename Node, typename Graph, typename State>
         struct discover_vertex :
             ::nimboost::mpl::insert<State, Node>
         {};
     };

     typedef typename mpl::first< 
         typename ::nimboost::msm::mpl_graph::depth_first_search<
            transition_graph, 
...
{
    typedef typename ::nimboost::mpl::copy<
        typename Fsm::substate_list,
        ::nimboost::mpl::inserter< 
            ::nimboost::mpl::set0<>,
            ::nimboost::mpl::if_<
                has_explicit_entry_state< ::nimboost::mpl::placeholders::_2 >,
                ::nimboost::mpl::insert< ::nimboost::mpl::placeholders::_1, ::nimboost::mpl::placeholders::_2>,
                ::nimboost::mpl::placeholders::_1
            >
        >
...
{
    typedef typename ::nimboost::mpl::fold<
        Set1, ::nimboost::mpl::false_,
        ::nimboost::mpl::if_<
            ::nimboost::mpl::has_key<
                Set2,
                ::nimboost::mpl::placeholders::_2
            >,
            ::nimboost::mpl::true_,
...
{
    typedef typename ::nimboost::mpl::transform<
        AllRegions, 
        ::nimboost::mpl::if_<
            is_common_element<EntryRegion, ::nimboost::mpl::placeholders::_1>,
            set_insert_range< ::nimboost::mpl::placeholders::_1, EntryRegion>,
            ::nimboost::mpl::placeholders::_1
        >
    >::type type;
};
...
struct build_orthogonal_regions 
{
    typedef typename 
        ::nimboost::mpl::fold<
            InitStates, ::nimboost::mpl::vector0<>,
            ::nimboost::mpl::push_back< 
                ::nimboost::mpl::placeholders::_1, 
                build_one_orthogonal_region< typename Fsm::stt, ::nimboost::mpl::placeholders::_2 > >
        >::type without_entries;

    typedef typename 
        ::nimboost::mpl::fold<
        typename find_entry_states<Fsm>::type, ::nimboost::mpl::vector0<>,
            ::nimboost::mpl::push_back< 
                ::nimboost::mpl::placeholders::_1, 
                build_one_orthogonal_region< typename Fsm::stt, ::nimboost::mpl::placeholders::_2 > >
        >::type only_entries;
    ...
    typedef typename ::nimboost::mpl::fold<
        ...
        add_entry_region< ::nimboost::mpl::placeholders::_2, ::nimboost::mpl::placeholders::_1>
    >::type type;
};
...
struct find_region_index
{
    typedef typename 
        ::nimboost::mpl::fold<
            GraphAsSeqOfSets, ::nimboost::mpl::pair< ::nimboost::mpl::int_< -1 > /*res*/, ::nimboost::mpl::int_<0> /*counter*/ >,
            ::nimboost::mpl::if_<
                ::nimboost::mpl::has_key< ::nimboost::mpl::placeholders::_2, StateType >,
                ::nimboost::mpl::pair< 
                    ::nimboost::mpl::second< ::nimboost::mpl::placeholders::_1 >,
                    ::nimboost::mpl::next< ::nimboost::mpl::second< ::nimboost::mpl::placeholders::_1 > >
                >,
            ...
            >
        >::type result_pair;
    typedef typename ::nimboost::mpl::first<result_pair>::type type;
    enum {value = type::value};
};
...
struct check_regions_orthogonality
{
    ...
    typedef typename ::nimboost::mpl::fold<
        regions, ::nimboost::mpl::int_<0>,
        ::nimboost::mpl::plus< ::nimboost::mpl::placeholders::_1 , ::nimboost::mpl::size< ::nimboost::mpl::placeholders::_2> >
    ...
    enum {cumulated_states_in_regions_raw = ::nimboost::mpl::size<one_big_states_set>::value};
};
...
struct check_no_unreachable_state
{
    ...
    enum {states_in_fsm = ::nimboost::mpl::size< typename Fsm::substate_list >::value};
    enum {cumulated_states_in_regions = ::nimboost::mpl::size< with_explicit_creation >::value};
};
...
inline
typename ::nimboost::enable_if<typename ::nimboost::mpl::and_<typename is_composite_state<FSM>::type,
...
template <class StateType,class OwnerFct,class FSM>
inline
typename ::nimboost::disable_if<typename ::nimboost::mpl::and_<typename is_composite_state<FSM>::type,
                                                         typename is_pseudo_exit<StateType>::type>,bool >::type
...
{
    typedef nimboost::msm::EndInterruptFlag<Event> type;
};
...
struct apply_end_interrupt_flag 
{
    typedef typename 
        ::nimboost::mpl::transform<
        Events,transform_to_end_interrupt< ::nimboost::mpl::placeholders::_1> >::type type;
};
...
{
    typedef typename ::nimboost::mpl::eval_if<
        ::nimboost::mpl::is_sequence<Event>,
        nimboost::msm::back::apply_end_interrupt_flag<Event>,
        nimboost::mpl::vector1<nimboost::msm::EndInterruptFlag<Event> > >::type type;
};

template <class Events>
struct build_interrupt_state_flag_list
{
    typedef ::nimboost::mpl::vector<nimboost::msm::InterruptedFlag> first_part;
    typedef typename ::nimboost::mpl::insert_range< 
        first_part, 
        typename ::nimboost::mpl::end< first_part >::type,
        Events
    >::type type;
};
