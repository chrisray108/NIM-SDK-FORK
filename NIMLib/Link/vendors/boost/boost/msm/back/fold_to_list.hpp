...
define_states_creation<> const states_ = {{{}}};
 ...
 struct FoldToList
  : ::nimboost::proto::or_<
        ...
        ::nimboost::proto::when<
            ::nimboost::proto::terminal< state_copy_tag >
          , ::nimboost::proto::_state
        >
      ...
      , ::nimboost::proto::when<
            ::nimboost::proto::terminal< state_tag >
            , nimboost::fusion::cons< ::nimboost::proto::_, ::nimboost::proto::_state>(
                ::nimboost::proto::_, ::nimboost::proto::_state
            )
        >
        // then states from other front-ends
      , ::nimboost::proto::when<
      ::nimboost::proto::terminal< proto::_ >
            , nimboost::fusion::cons< ::nimboost::proto::_value, ::nimboost::proto::_state>(
                ::nimboost::proto::_value, ::nimboost::proto::_state
    )
        >
      ...
      , ::nimboost::proto::when<
            ::nimboost::proto::shift_left<FoldToList, FoldToList>
          , FoldToList(
                ::nimboost::proto::_left
              , ::nimboost::proto::call<FoldToList( ::nimboost::proto::_right, ::nimboost::proto::_state )>
            )
        >
    >
 {};
