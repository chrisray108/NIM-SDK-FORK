...
{
    process_any_event_helper(msm::back::HandledEnum& res_,Fsm* self_,::nimboost::any any_event_):
    res(res_),self(self_),any_event(any_event_),finished(false){}
    template <class Event>
    void operator()(nimboost::msm::wrap<Event> const&)
    {
        if ( ! finished && ::nimboost::any_cast<Event>(&any_event)!=0)
        {
            finished = true;
            res = self->process_event_internal(::nimboost::any_cast<Event>(any_event),false);
...
#define BOOST_MSM_BACK_GENERATE_PROCESS_EVENT(fsmname)                                              \
    namespace nimboost { namespace msm { namespace back{                                               \
    template<>                                                                                      \
    ::nimboost::msm::back::HandledEnum fsmname::process_any_event( ::nimboost::any const& any_event)      \
    {                                                                                               \
        typedef ::nimboost::msm::back::recursive_get_transition_table<fsmname>::type stt;              \
        typedef ::nimboost::msm::back::generate_event_set<stt>::type stt_events;                       \
        typedef ::nimboost::msm::back::recursive_get_internal_transition_table<fsmname, ::nimboost::mpl::true_ >::type istt;    \
        typedef ::nimboost::msm::back::generate_event_set<create_real_stt<fsmname,istt>::type >::type istt_events;  \
        typedef ::nimboost::msm::back::set_insert_range<stt_events,istt_events>::type all_events;      \
        ::nimboost::msm::back::HandledEnum res= ::nimboost::msm::back::HANDLED_FALSE;                     \
        ::nimboost::mpl::for_each<all_events, ::nimboost::msm::wrap< ::nimboost::mpl::placeholders::_1> >    \
        (::nimboost::msm::back::process_any_event_helper<fsmname>(res,this,any_event));                \
        return res;                                                                                 \
    }                                                                                               \
    }}}
...
struct favor_compile_time 
{
    ...
    typedef ::nimboost::mpl::false_ add_forwarding_rows;
};
...
struct dispatch_table < Fsm, Stt, Event, ::nimboost::msm::back::favor_compile_time>
{
 private:
    ...
    {
        return (fsm.template get_state<TransitionState&>()).process_any_event( ::nimboost::any(evt));
    }
    ...
    struct init_cell
    {
        ...
        ,void>::type
        init_event_base_case(Transition const&, ::nimboost::mpl::true_ const &) const
        {
        ...
        typename ::nimboost::disable_if<
            typename ::nimboost::is_same<typename Transition::current_state_type,Fsm>::type
        ,void>::type
        init_event_base_case(Transition const&, ::nimboost::mpl::false_ const &) const
        {
            typedef typename create_stt<Fsm>::type stt; 
            BOOST_STATIC_CONSTANT(int, state_id = 
                (get_state_id<stt,typename Transition::current_state_type>::value));
    ...
    struct default_init_cell
    {
        ...
        template <int some_dummy> struct helper<true,false,some_dummy> 
        {
            ...
            static void execute(nimboost::msm::wrap<State> const&,chain_row* tofill)
            {
                typedef typename create_stt<Fsm>::type stt; 
        ...
        template <int some_dummy> struct helper<false,true,some_dummy> 
        {
            ...
            ,void>::type
            execute(nimboost::msm::wrap<State> const&,chain_row* tofill,nimboost::msm::back::dummy<0> = 0)
            {
                // for internal tables
            ...
            typename ::nimboost::disable_if<
                typename ::nimboost::is_same<State,Fsm>::type
            ,void>::type
            execute(nimboost::msm::wrap<State> const&,chain_row* tofill,nimboost::msm::back::dummy<1> = 0)
            {
                typedef typename create_stt<Fsm>::type stt; 
                BOOST_STATIC_CONSTANT(int, state_id = (get_state_id<stt,State>::value));
        ...
        template <class State>
        void operator()(nimboost::msm::wrap<State> const& s)
        {
 ...
 public:
    ...
    dispatch_table()
    {
        ...
        ::nimboost::mpl::for_each<
            ::nimboost::mpl::filter_view<
                    Stt, ::nimboost::is_base_of<transition_event< ::nimboost::mpl::placeholders::_>, Event> > >
        (init_cell(this));
...
template <class Fsm,class Stt, class Event>
const nimboost::msm::back::dispatch_table<Fsm,Stt, Event,favor_compile_time>
