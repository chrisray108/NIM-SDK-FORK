...
const nimboost::msm::back::dispatch_table<Fsm,Stt, Event,CompilePolicy>
...
typedef ::nimboost::parameter::parameters<
    ::nimboost::parameter::required< ::nimboost::msm::back::tag::front_end >
  , ::nimboost::parameter::optional< 
        ::nimboost::parameter::deduced< ::nimboost::msm::back::tag::history_policy>, has_history_policy< ::nimboost::mpl::_ > 
    >
  , ::nimboost::parameter::optional< 
        ::nimboost::parameter::deduced< ::nimboost::msm::back::tag::compile_policy>, has_compile_policy< ::nimboost::mpl::_ > 
    >
  , ::nimboost::parameter::optional< 
        ::nimboost::parameter::deduced< ::nimboost::msm::back::tag::fsm_check_policy>, has_fsm_check< ::nimboost::mpl::_ > 
    >
  , ::nimboost::parameter::optional< 
        ::nimboost::parameter::deduced< ::nimboost::msm::back::tag::queue_container_policy>, 
        has_queue_container_policy< ::nimboost::mpl::_ > 
    >
...
struct make_euml_terminal<T,F,typename ::nimboost::disable_if<has_using_declared_table<F> >::type>
{};
template <class T,class F>
struct make_euml_terminal<T,F,typename ::nimboost::enable_if<has_using_declared_table<F> >::type>
    : public proto::extends<typename proto::terminal< nimboost::msm::state_tag>::type, T, nimboost::msm::state_domain>
{};
...
class state_machine : //public Derived
    public ::nimboost::parameter::binding<
            typename state_machine_signature::bind<A0,A1,A2,A3,A4>::type, ::nimboost::msm::back::tag::front_end
    >::type
    , public make_euml_terminal<state_machine<A0,A1,A2,A3,A4>,
                         typename ::nimboost::parameter::binding<
                                    typename state_machine_signature::bind<A0,A1,A2,A3,A4>::type, ::nimboost::msm::back::tag::front_end
                         >::type   
      >
{
public:
    ...
    typedef typename ::nimboost::parameter::binding<
        state_machine_args, ::nimboost::msm::back::tag::front_end>::type Derived;

    typedef typename ::nimboost::parameter::binding<
        state_machine_args, ::nimboost::msm::back::tag::history_policy, NoHistory >::type              HistoryPolicy;

    typedef typename ::nimboost::parameter::binding<
        state_machine_args, ::nimboost::msm::back::tag::compile_policy, favor_runtime_speed >::type    CompilePolicy;

    typedef typename ::nimboost::parameter::binding<
        state_machine_args, ::nimboost::msm::back::tag::fsm_check_policy, no_fsm_check >::type         FsmCheckPolicy;

    typedef typename ::nimboost::parameter::binding<
        state_machine_args, ::nimboost::msm::back::tag::queue_container_policy, 
        queue_container_deque >::type                                                               QueueContainerPolicy;

private: 

    typedef nimboost::msm::back::state_machine<
        A0,A1,A2,A3,A4>                             library_sm;

    typedef ::nimboost::function<
    ...
    typedef typename nimboost::mpl::eval_if<
        ...
        // default
        ::nimboost::mpl::identity<active_state_switch_after_entry>
    ...
    > friend class nimboost::msm::back::state_machine;
    ...
    struct visitor_fct_helper<StateType,typename ::nimboost::enable_if<has_accept_sig<StateType> >::type> 
    {
    public:
...
#undef MSM_VISITOR_HELPER_EXECUTE_SUB
    ...
    struct deferred_msg_queue_helper<StateType,
        typename ::nimboost::enable_if< 
            typename ::nimboost::msm::back::has_fsm_deferred_events<StateType>::type,int >::type> 
    {
    public:
 ...
 public: 
    ...
    typedef typename ::nimboost::mpl::eval_if< 
        ...
        ::nimboost::mpl::identity<InitEvent>
    ...
    typedef typename ::nimboost::mpl::eval_if< 
        ...
        ::nimboost::mpl::identity<ExitEvent>
    ...
    struct exit_pt : public ExitPoint
    {
        ...
        typedef ::nimboost::function<execute_return (Event const&)>
                                    forwarding_function;
        ...
        void forward_event(ForwardEvent const& incomingEvent)
        {
            ...
            ForwardHelper< ::nimboost::is_convertible<ForwardEvent,Event>::value>::helper(incomingEvent,m_forward);
        }
        void set_forward_fct(::nimboost::function<execute_return (Event const&)> fct)
        {
            m_forward = fct;
        }    
        exit_pt():m_forward(){}
    ...
    struct row_
    {
        ...
        typedef typename ::nimboost::mpl::eval_if<
                ...
                ::nimboost::mpl::identity<typename ROW::Source> >::type current_state_type;
        ...
        static bool check_guard(library_sm& fsm,transition_event const& evt)
        {
            if ( ROW::guard_call(fsm,evt,
                                 ::nimboost::fusion::at_key<current_state_type>(fsm.m_substate_list),
                                 ::nimboost::fusion::at_key<next_state_type>(fsm.m_substate_list),
                                 fsm.m_substate_list ) )
                return true;
            return false;
        }
        ...
        static HandledEnum execute(library_sm& fsm, int region_index, int state, transition_event const& evt)
        {
            ...
            execute_exit<current_state_type>
                (::nimboost::fusion::at_key<current_state_type>(fsm.m_substate_list),evt,fsm);
            ...
            convert_event_and_execute_entry<next_state_type,T2>
                (::nimboost::fusion::at_key<next_state_type>(fsm.m_substate_list),evt,fsm);
    ...
    struct internal_
    {
        ...
        {
            if ( ROW::guard_call(fsm,evt,
                ::nimboost::fusion::at_key<StateType>(fsm.m_substate_list),
                ::nimboost::fusion::at_key<StateType>(fsm.m_substate_list),
                fsm.m_substate_list) )
                return true;
            return false;
    ...
    struct frow
    {
        ...
        static HandledEnum execute(library_sm& fsm, int region_index, int , transition_event const& evt)
        {
            ...
            execute_return res = 
                (::nimboost::fusion::at_key<current_state_type>(fsm.m_substate_list)).process_event_internal(evt,false); 
    ...
    struct create_real_stt 
    {
        ...
        typedef typename ::nimboost::mpl::fold<
            ...
            ::nimboost::mpl::push_back< ::nimboost::mpl::placeholders::_1,
                                     make_row_tag< ::nimboost::mpl::placeholders::_2 , BaseType > >
        >::type type;
    };
    ...
    struct add_forwarding_row_helper
    {
        ...
        typedef typename ::nimboost::mpl::fold<
            ...
            ::nimboost::mpl::push_back< ::nimboost::mpl::placeholders::_1,
            frow<StateType, ::nimboost::mpl::placeholders::_2> > >::type type;
    };
    ...
    struct get_internal_transition_table
    {
        ...
        typedef typename recursive_get_internal_transition_table<StateType, ::nimboost::mpl::true_>::type recursive_istt;
        typedef typename ::nimboost::mpl::fold<
                    recursive_istt,::nimboost::mpl::vector0<>,
                    ::nimboost::mpl::push_back< ::nimboost::mpl::placeholders::_1,
                                             make_row_tag< ::nimboost::mpl::placeholders::_2 , StateType> >
                >::type recursive_istt_with_tag;

        typedef typename ::nimboost::mpl::insert_range< original_table, typename ::nimboost::mpl::end<original_table>::type, 
        ...
        typedef typename ::nimboost::mpl::eval_if<
                ...
                add_forwarding_row_helper<table_with_all_events,::nimboost::mpl::vector0<>,StateType>,
                ::nimboost::mpl::identity< ::nimboost::mpl::vector0<> >
        >::type type;
    };
    template <class StateType>
    struct get_internal_transition_table<StateType, ::nimboost::mpl::false_ >
    {
    ...
    typedef typename ::nimboost::fusion::result_of::as_set<state_list>::type substate_list;
    typedef typename ::nimboost::msm::back::generate_event_set<
    ...
    struct extend_table
    {
        ...
        typedef typename ::nimboost::mpl::fold<
            typename Composite::internal_transition_table,::nimboost::mpl::vector0<>,
            ::nimboost::mpl::push_back< ::nimboost::mpl::placeholders::_1,
                                     make_row_tag< ::nimboost::mpl::placeholders::_2 , Composite> >
        >::type internal_stt;

        typedef typename ::nimboost::mpl::insert_range<
            Stt,
            typename ::nimboost::mpl::end<Stt>::type,
            internal_stt
            //typename get_internal_transition_table<Composite, ::nimboost::mpl::true_ >::type
        >::type stt_plus_internal;

        // for every state, add its transition table (if any)
        // transformed as frow
        typedef typename ::nimboost::mpl::fold<state_list,stt_plus_internal,
                ::nimboost::mpl::insert_range< 
                        ::nimboost::mpl::placeholders::_1, 
                        ::nimboost::mpl::end< ::nimboost::mpl::placeholders::_1>,
                        get_internal_transition_table< 
                                ::nimboost::mpl::placeholders::_2,
                                is_composite_state< ::nimboost::mpl::placeholders::_2> > > 
        >::type type;
    };
    ...
    void start()
    {
         ...
         ::nimboost::mpl::for_each< seq_initial_states, ::nimboost::msm::wrap<mpl::placeholders::_1> >
                        (init_states(m_states));
        // call on_entry on this SM
        (static_cast<Derived*>(this))->on_entry(fsm_initial_event(),*this);
        ::nimboost::mpl::for_each<initial_states, nimboost::msm::wrap<mpl::placeholders::_1> >
    ...
    void enqueue_event_helper(EventType const& evt, ::nimboost::mpl::false_ const &)
    {
        execute_return (library_sm::*pf) (EventType const& evt) = 
            &library_sm::process_event; 

        transition_fct f = ::nimboost::bind(pf,this,evt);
        m_events_queue.m_events_queue.push_back(f);
    }
    template <class EventType>
    void enqueue_event_helper(EventType const& evt, ::nimboost::mpl::true_ const &)
    {
        // no queue
    }

    void execute_queued_events_helper(::nimboost::mpl::false_ const &)
    {
        transition_fct to_call = m_events_queue.m_events_queue.front();
        m_events_queue.m_events_queue.pop_front();
        to_call();
    }
    void execute_queued_events_helper(::nimboost::mpl::true_ const &)
    {
        // no queue required
    }
    ...
    void serialize(Archive & ar, const unsigned int)
    {
        ...
        (serialize_state<Archive>(ar))(nimboost::serialization::base_object<Derived>(*this));
        // now our attributes
        ar & m_states;
        ...
        ::nimboost::fusion::for_each(m_substate_list, serialize_state<Archive>(ar));
    }
    ...
    struct get_state_id_helper 
    {
        ...
        template <class StateType>
        void operator()(nimboost::msm::wrap<StateType> const&)
        {
            ...
            {
                *result_state = &::nimboost::fusion::at_key<StateType>(self->m_substate_list);
            }
        }
    ...
    BaseState* get_state_by_id(int id)
    {
        ...
        ::nimboost::mpl::for_each<state_list, 
            ::nimboost::msm::wrap< ::nimboost::mpl::placeholders::_1> > (get_state_id_helper(id,&result_state,this));
    ...
    typename ::nimboost::enable_if<typename ::nimboost::is_pointer<State>::type,State >::type
    get_state(::nimboost::msm::back::dummy<0> = 0) const
    {
        return const_cast<State >
            (&
                (::nimboost::fusion::at_key<
                    typename ::nimboost::remove_const<typename ::nimboost::remove_pointer<State>::type>::type>(m_substate_list)));
    }
    // as a reference
    template <class State>
    typename ::nimboost::enable_if<typename ::nimboost::is_reference<State>::type,State >::type
    get_state(::nimboost::msm::back::dummy<1> = 0) const
    {
        return const_cast<State >
            ( ::nimboost::fusion::at_key<
                typename ::nimboost::remove_const<typename ::nimboost::remove_reference<State>::type>::type>(m_substate_list) );
    }
    // get a state (non const version)
    // as a pointer
    template <class State>
    typename ::nimboost::enable_if<typename ::nimboost::is_pointer<State>::type,State >::type
    get_state(::nimboost::msm::back::dummy<0> = 0)
    {
        return &(static_cast<typename nimboost::add_reference<typename ::nimboost::remove_pointer<State>::type>::type > 
        (::nimboost::fusion::at_key<typename ::nimboost::remove_pointer<State>::type>(m_substate_list)));
    }
    // as a reference
    template <class State>
    typename ::nimboost::enable_if<typename ::nimboost::is_reference<State>::type,State >::type
    get_state(::nimboost::msm::back::dummy<1> = 0)
    {
        return ::nimboost::fusion::at_key<typename ::nimboost::remove_reference<State>::type>(m_substate_list);
    }
...
#undef MSM_VISIT_STATE_SUB
    ...
    void defer_event(Event const& e)
    {
        ...
        Event temp (e);
        ::nimboost::function<execute_return () > f= ::nimboost::bind(pf, this,temp);
 ...
 protected:    // interface for the derived class
     ...
     struct init_states
     {
         ...
         template <class State>
         void operator()(::nimboost::msm::wrap<State> const&)
         {
 ...
 public:
     struct update_state
     {
         ...
         {
             ::nimboost::fusion::at_key<StateType>(*to_overwrite)=astate;
         }
     ...
     {
         ::nimboost::fusion::for_each( 
             ::nimboost::fusion::as_vector(FoldToList()(expr, nimboost::fusion::nil())),update_state(this->m_substate_list));
     }
     ...
     template <class Expr>
     state_machine<A0,A1,A2,A3,A4 >
         (Expr const& expr,typename ::nimboost::enable_if<typename ::nimboost::proto::is_expr<Expr>::type >::type* =0)
         :Derived()
         ,m_events_queue() 
         ,m_deferred_events_queue()
         ,m_history()
         ...
         ,m_substate_list()
     {
         BOOST_MPL_ASSERT_MSG(
             ( ::nimboost::proto::matches<Expr, FoldToList>::value),
...
#define MSM_CONSTRUCTOR_HELPER_EXECUTE(z, n, unused)                                \
        ...
        typename ::nimboost::disable_if<typename ::nimboost::proto::is_expr<ARG0>::type >::type* =0 )                \
     ...
     {                                                                              \
        ...
        typename ::nimboost::enable_if<typename ::nimboost::proto::is_expr<Expr>::type >::type* =0 ) \
        :Derived(BOOST_PP_ENUM_PARAMS(n,t))                                         \
         ,m_events_queue()                                                          \
         ,m_deferred_events_queue()                                                 \
         ,m_history()                                                               \
...
#undef MSM_CONSTRUCTOR_HELPER_EXECUTE_SUB
    ...
    template <class Event>
    bool is_event_handling_blocked_helper( ::nimboost::mpl::true_ const &)
    {
        // if the state machine is terminated, do not handle any event
        if (is_flag_active< ::nimboost::msm::TerminateFlag>())
            return true;
        // if the state machine is interrupted, do not handle any event
        // unless the event is the end interrupt event
        if ( is_flag_active< ::nimboost::msm::InterruptedFlag>() && 
            !is_flag_active< ::nimboost::msm::EndInterruptFlag<Event> >())
            return true;
        return false;
    }
    // otherwise simple handling, no flag => continue
    template <class Event>
    bool is_event_handling_blocked_helper( ::nimboost::mpl::false_ const &)
    {
    ...
    bool do_pre_msg_queue_helper(EventType const& evt, ::nimboost::mpl::true_ const &)
    {
        // no message queue needed
        return true;
    }
    template <class StateType,class EventType>
    bool do_pre_msg_queue_helper(EventType const& evt, ::nimboost::mpl::false_ const &)
    {
        execute_return (library_sm::*pf) (EventType const& evt) = 
            &library_sm::process_event; 
    ...
    void do_post_msg_queue_helper( ::nimboost::mpl::true_ const &)
    {
        // no message queue needed
    }
    void do_post_msg_queue_helper( ::nimboost::mpl::false_ const &)
    {
        m_event_processing = false;
    ...
    template <class StateType,class EventType>
    HandledEnum do_process_helper(EventType const& evt, ::nimboost::mpl::true_ const &, bool is_direct_call)
    {
        return this->do_process_event(evt,is_direct_call);
    }
    template <class StateType,class EventType>
    HandledEnum do_process_helper(EventType const& evt, ::nimboost::mpl::false_ const &, bool is_direct_call)
    {
    ...
    template <class StateType>
    struct handle_defer_helper
        <StateType, typename enable_if< typename ::nimboost::msm::back::has_fsm_deferred_events<StateType>::type,int >::type>
    {
            ...
            else
            {
                ...
                typename deferred_events_queue_t::iterator it = 
                    std::find_if(events_queue.m_deferred_events_queue.begin(),
                                 ...
                                 nimboost::bind(&std::pair<deferred_fct,bool>::second, _1) == false);
    ...
    template <class StateType>
    struct handle_eventless_transitions_helper
        <StateType, typename enable_if< typename ::nimboost::msm::back::has_fsm_eventless_transition<StateType>::type >::type>
    {
        handle_eventless_transitions_helper(library_sm* self_, bool handled_):self(self_),handled(handled_){}
        void process_completion_event()
        {
            typedef typename ::nimboost::mpl::deref<
                typename ::nimboost::mpl::begin<
    ...
    {
        typedef typename ::nimboost::mpl::has_key<processable_events_internal_table,Event>::type is_event_processable;
    ...
    private:
        ...
        static void do_process(Event const& evt,library_sm* self_,HandledEnum& result, ::nimboost::mpl::true_)
        {
        ...
        static void do_process(Event const& ,library_sm* ,HandledEnum& , ::nimboost::mpl::false_)
        {
            // do nothing
        }
    };
    ...
    // version with visitors
    template <class StateType>
    struct region_processing_helper<StateType,typename ::nimboost::enable_if< 
                        ::nimboost::mpl::is_sequence<typename StateType::initial_state> >::type> 
    {
        private:
        ...
        struct In
        {
            ...
            static void process(Event const& evt,library_sm* self_,HandledEnum& result_)
            {
                ...
                In< ::nimboost::mpl::int_<region_id::value+1> >::process(evt,self_,result_);
            }
        };
        template <int Dummy>
        struct In< ::nimboost::mpl::int_<nr_regions::value>,Dummy>
        {
            // end of processing
            template<class Event>
            static void process(Event const& evt,library_sm* self_,HandledEnum& result_)
        ...
        void process(Event const& evt)
        {
            In< ::nimboost::mpl::int_<0> >::process(evt,self,result);
        }
    ...
    execute_return process_event_internal(Event const& evt, bool is_direct_call)
    {
        ...
        if (is_event_handling_blocked_helper<Event>
                ( ::nimboost::mpl::bool_<has_fsm_blocking_states<library_sm>::type::value>() ) )
            return HANDLED_TRUE;
        // if a message queue is needed and processing is on the way
        if (!do_pre_msg_queue_helper<Event>
                (evt,::nimboost::mpl::bool_<is_no_message_queue<library_sm>::type::value>()) )
        {
        ...
        else
        {
            ...
            HandledEnum handled = this->do_process_helper<Event>
                (evt,::nimboost::mpl::bool_<is_no_exception_thrown<library_sm>::type::value>(),is_direct_call);
            if (handled)
            {
                ret_handled = handled;
            }
            ...
            do_post_msg_queue_helper(::nimboost::mpl::bool_<is_no_message_queue<library_sm>::type::value>());
...
#ifndef BOOST_NO_RTTI
    HandledEnum process_any_event( ::nimboost::any const& evt);
#endif
...
#define MSM_COMPOSITE_ACCEPT_SUB2(z, n, unused) nimboost::ref( vis ## n )
...
#undef MSM_COMPOSITE_ACCEPT_SUB2
    ...
    struct call_init
    {
        ...
        void operator()(nimboost::msm::wrap<State> const&)
        {
            execute_entry(::nimboost::fusion::at_key<State>(self->m_substate_list),evt,*self);
        }
    private:
        Event const& evt;
        library_sm* self;
    ...
    struct FlagHandler
    {
        ...
        {
            return ::nimboost::fusion::at_key<StateType>(fsm.m_substate_list).template is_flag_active<Flag>();
        }
    };
    template <class Flag>
    struct init_flags
    ...
    private:
        ...
        template <class T>
        void helper (flag_handler* an_entry,int offset, ::nimboost::mpl::true_ const &  )
        {
            // composite => forward
            an_entry[offset] = &FlagHandler<T,Flag>::forward;
        }
        template <class T>
        void helper (flag_handler* an_entry,int offset, ::nimboost::mpl::false_ const &  )
        {
            // default no flag
    ...
    public:
        ...
        void operator()( ::nimboost::msm::wrap<StateType> const& )
        {
            ...
            typedef typename ::nimboost::mpl::contains<flags,Flag >::type found;
            ...
            {
                // false or forward
                typedef typename ::nimboost::mpl::and_<
                            typename is_composite_state<StateType>::type,
                            typename ::nimboost::mpl::not_<
                                    typename has_non_forwarding_flag<Flag>::type>::type >::type composite_no_forward;

                helper<StateType>(entries,state_id,::nimboost::mpl::bool_<composite_no_forward::type::value>());
            }
        }
    };
    ...
    flag_handler* get_entries_for_flag() const
    {
        ...
        // build a state list
        ::nimboost::mpl::for_each<state_list, nimboost::msm::wrap< ::nimboost::mpl::placeholders::_1> >
    ...
    template <class State>
    struct create_state_helper<State,typename nimboost::enable_if<typename State::needs_sm >::type>
    {
        static void set_sm(library_sm* sm)
        {
            // create and set the fsm
            ::nimboost::fusion::at_key<State>(sm->m_substate_list).set_sm_ptr(sm);
        }
    };
...
#define MSM_VISITOR_ARGS_EXECUTE(z, n, unused)                                              \
    ...
    {                                                                                       \
        ...
        {                                                                                   \
            sm->m_visitors.insert(id, nimboost::bind(&StateType::accept,                       \
                ::nimboost::ref(astate) BOOST_PP_COMMA_IF(n) BOOST_PP_ENUM(n, MSM_VISITOR_ARGS_SUB, ~) ));   \
        }                                                                                   \
        template <class State>                                                              \
        static typename enable_if_c<is_composite_state<State>::value,void >::type           \
        helper (library_sm* sm,                                                             \
        ...
        {                                                                                   \
            ...
            sm->m_visitors.insert(id, nimboost::bind(caccept,             \
            ::nimboost::ref(astate) BOOST_PP_COMMA_IF(n) BOOST_PP_ENUM(n, MSM_VISITOR_ARGS_SUB, ~) ));                 \
        }                                                                                   \
};
...
// and also to MS VC < 8
    ...
    {
        m_is_included=true;
        ::nimboost::fusion::for_each(m_substate_list,add_state<ContainingSM>(this,sm));
    }
#if defined (__IBMCPP__) || (__GNUC__ == 4 && __GNUC_MINOR__ < 1) || (defined(_MSC_VER) && (_MSC_VER < 1400))
     private:
#endif
    ...
    struct add_state
    {
        ...
        new_state_helper(nimboost::msm::back::dummy<0> = 0) const
        {
            ::nimboost::fusion::at_key<StateType>(self->m_substate_list).set_containing_sm(containing_sm);
        }
        ...
        template <class StateType>
        typename ::nimboost::enable_if<
            typename nimboost::mpl::and_<typename nimboost::mpl::not_
                                                    <typename is_composite_state<StateType>::type>::type,
                                      typename nimboost::mpl::not_
                                                    <typename is_pseudo_exit<StateType>::type>::type
                   >::type,void>::type
        new_state_helper( ::nimboost::msm::back::dummy<1> = 0) const
        {
            //nothing to do
        }
        // state is exit pseudo state and gets callback to target fsm
        template <class StateType>
        typename ::nimboost::enable_if<typename is_pseudo_exit<StateType>::type,void >::type
        new_state_helper( ::nimboost::msm::back::dummy<2> = 0) const
        {
            execute_return (ContainingSM::*pf) (typename StateType::event const& evt)= 
                &ContainingSM::process_event;
            ::nimboost::function<execute_return (typename StateType::event const&)> fct = 
                ::nimboost::bind(pf,containing_sm,_1);
            ::nimboost::fusion::at_key<StateType>(self->m_substate_list).set_forward_fct(fct);
        }
        ...
        void operator()( State const&) const
        {
            ...
            visitor_helper(state_id,::nimboost::fusion::at_key<State>(self->m_substate_list),
                           ::nimboost::mpl::bool_<has_accept_sig<State>::type::value>());
        }
    private:
        // support possible use of a visitor if accept_sig is defined
        template <class StateType>
        void visitor_helper(int id,StateType& astate, ::nimboost::mpl::true_ const & ) const
        {
            visitor_args<StateType,StateType::accept_sig::args_number>::
                template helper<StateType>(self,id,astate);
        }
        template <class StateType>
        void visitor_helper(int ,StateType& , ::nimboost::mpl::false_ const &) const
        {
            // nothing to do
        }
     ...
     struct copy_helper
     {
         ...
         template <class StateType>
         typename ::nimboost::enable_if<typename has_accept_sig<StateType>::type,void >::type
             visitor_helper(int id) const
         {
             visitor_args<StateType,StateType::accept_sig::args_number>::template helper<StateType>
                 (m_sm,id,::nimboost::fusion::at_key<StateType>(m_sm->m_substate_list));
         }
         template <class StateType>
         typename ::nimboost::disable_if<typename has_accept_sig<StateType>::type,void >::type
     ...
     struct region_copy_helper
     {
         static void do_copy(library_sm* self_,library_sm const& rhs)
         {
             ...
             region_copy_helper< ::nimboost::mpl::int_<region_id::value+1> >::do_copy(self_,rhs);
         }
     };
     template <int Dummy>
     struct region_copy_helper< ::nimboost::mpl::int_<nr_regions::value>,Dummy>
     {
         // end of processing
     ...
     void do_copy (library_sm const& rhs,
              ::nimboost::msm::back::dummy<0> = 0)
     {
         // deep copy simply assigns the data
         region_copy_helper< ::nimboost::mpl::int_<0> >::do_copy(this,rhs);
     ...
     struct entry_exit_helper
     {
         ...
         typename ::nimboost::enable_if<typename IsEntry::type,void >::type
         helper( ::nimboost::msm::back::dummy<0> = 0)
         {
             BOOST_STATIC_CONSTANT(int, id = (get_state_id<stt,State>::value));
             if (id == state_id)
             {
                 execute_entry<State>(::nimboost::fusion::at_key<State>(self->m_substate_list),evt,*self);
             }
         }
         // helper for exit actions
         template <class IsEntry,class State>
         typename nimboost::disable_if<typename IsEntry::type,void >::type
         helper( ::nimboost::msm::back::dummy<1> = 0)
         {
             BOOST_STATIC_CONSTANT(int, id = (get_state_id<stt,State>::value));
             if (id == state_id)
             {
                 execute_exit<State>(::nimboost::fusion::at_key<State>(self->m_substate_list),evt,*self);
             }
         }
         ...
         void operator()( ::nimboost::msm::wrap<State> const&)
         {
             entry_exit_helper<Event,is_entry>::template helper< ::nimboost::mpl::bool_<is_entry>,State >();
         }
     private:
         int            state_id;
         Event const&   evt;
     ...
     struct region_start_helper
     {
         ...
         static void do_start(library_sm* self_,Event const& incomingEvent)
         {
             ...
             region_start_helper
                 < ::nimboost::mpl::int_<region_id::value+1> >::do_start(self_,incomingEvent);
         }
     };
     template <int Dummy>
     struct region_start_helper< ::nimboost::mpl::int_<nr_regions::value>,Dummy>
     {
         // end of processing
         template<class Event>
     ...
     {
         region_start_helper< ::nimboost::mpl::int_<0> >::do_start(this,incomingEvent);
         // give a chance to handle an anonymous (eventless) transition
         handle_eventless_transitions_helper<library_sm> eventless_helper(this,true);
         eventless_helper.process_completion_event();
     }
     ...
     struct direct_event_start_helper 
     {
         ...
         typename ::nimboost::disable_if<typename has_direct_entry<EventType>::type,void>::type
             operator()(EventType const& evt,FsmType& fsm, ::nimboost::msm::back::dummy<0> = 0)
         {
         ...
         typename ::nimboost::enable_if<
             typename ::nimboost::mpl::and_<
                        typename ::nimboost::mpl::not_< typename is_pseudo_entry<
                                    typename EventType::active_state>::type >::type,
                        typename ::nimboost::mpl::and_<typename has_direct_entry<EventType>::type,
                                                    typename ::nimboost::mpl::not_<typename ::nimboost::mpl::is_sequence
                                                            <typename EventType::active_state>::type >::type 
                                                    >::type>::type,void
                                  >::type
         operator()(EventType const& evt,FsmType& fsm, ::nimboost::msm::back::dummy<1> = 0)
         {
             (static_cast<Derived*>(self))->on_entry(evt,fsm);
         ...
         typename ::nimboost::enable_if<
             typename ::nimboost::mpl::and_<
                    ...
                    typename ::nimboost::mpl::and_<typename has_direct_entry<EventType>::type,
                                                typename ::nimboost::mpl::is_sequence<
                                                                typename EventType::active_state>::type 
                                                >::type>::type,void 
                                >::type
         operator()(EventType const& evt,FsmType& fsm, ::nimboost::msm::back::dummy<2> = 0)
         {
             (static_cast<Derived*>(self))->on_entry(evt,fsm);
             ::nimboost::mpl::for_each<typename EventType::active_state, 
         ...
         typename ::nimboost::enable_if<
             typename is_pseudo_entry<typename EventType::active_state >::type,void
                                    >::type
         operator()(EventType const& evt,FsmType& fsm, ::nimboost::msm::back::dummy<3> = 0)
         {
             // entry on the FSM
             (static_cast<Derived*>(self))->on_entry(evt,fsm);
             int state_id = get_state_id<stt,typename EventType::active_state::wrapped_entry>::value;
     ...
     struct region_entry_exit_helper
     {
         ...
         static void do_entry(library_sm* self_,Event const& incomingEvent)
         {
             ...
             region_entry_exit_helper
                 < ::nimboost::mpl::int_<region_id::value+1> >::do_entry(self_,incomingEvent);
         }
         template<class Event>
         static void do_exit(library_sm* self_,Event const& incomingEvent)
         {
             ...
             region_entry_exit_helper
                 < ::nimboost::mpl::int_<region_id::value+1> >::do_exit(self_,incomingEvent);
         }
     };
     template <int Dummy>
     struct region_entry_exit_helper< ::nimboost::mpl::int_<nr_regions::value>,Dummy>
     {
         // end of processing
         template<class Event>
     ...
     void do_entry(Event const& incomingEvent,FsmType& fsm)
     {
        ...
        region_entry_exit_helper< ::nimboost::mpl::int_<0> >::do_entry(this,incomingEvent);
     ...
     void do_exit(Event const& incomingEvent,FsmType& fsm)
     {
        ...
        // forward the event for handling by sub state machines
        region_entry_exit_helper< ::nimboost::mpl::int_<0> >::do_exit(this,incomingEvent);
    ...
    void process_message_queue(StateType*, 
                               typename ::nimboost::disable_if<typename is_no_message_queue<StateType>::type,void >::type* = 0)
    {
    ...
    template <class StateType>
    void process_message_queue(StateType*, 
                               typename ::nimboost::enable_if<typename is_no_message_queue<StateType>::type,void >::type* = 0)
    {
        // nothing to process
    }
    ...
    template <class EventType>
    static 
    typename nimboost::enable_if<typename has_direct_entry<EventType>::type,typename EventType::contained_event const& >::type
    remove_direct_entry_event_wrapper(EventType const& evt,nimboost::msm::back::dummy<0> = 0)
    {
        return evt.m_event;
    }
    template <class EventType>
    static typename nimboost::disable_if<typename has_direct_entry<EventType>::type,EventType const& >::type
    remove_direct_entry_event_wrapper(EventType const& evt,nimboost::msm::back::dummy<1> = 0)
    {
        // identity. No wrapper
        return evt;
    }
    ...
    static
        typename nimboost::enable_if<typename is_composite_state<StateType>::type,void >::type
        execute_entry(StateType& astate,EventType const& evt,FsmType& fsm,nimboost::msm::back::dummy<0> = 0)
    {
    ...
    static
        typename ::nimboost::disable_if<
            typename ::nimboost::mpl::or_<typename is_composite_state<StateType>::type,
                                       typename is_pseudo_exit<StateType>::type >::type,void >::type
    execute_entry(StateType& astate,EventType const& evt,FsmType& fsm, ::nimboost::msm::back::dummy<1> = 0)
    {
    ...
    static
        typename ::nimboost::enable_if<typename is_pseudo_exit<StateType>::type,void >::type
    execute_entry(StateType& astate,EventType const& evt,FsmType& fsm, ::nimboost::msm::back::dummy<2> = 0)
    {
    ...
    static
        typename ::nimboost::enable_if<typename is_composite_state<StateType>::type,void >::type
    execute_exit(StateType& astate,EventType const& evt,FsmType& fsm, ::nimboost::msm::back::dummy<0> = 0)
    {
        astate.do_exit(evt,fsm);
    }
    template <class StateType,class EventType,class FsmType>
    static
        typename ::nimboost::disable_if<typename is_composite_state<StateType>::type,void >::type
    execute_exit(StateType& astate,EventType const& evt,FsmType& fsm, ::nimboost::msm::back::dummy<1> = 0)
    {
    ...
    static
        typename ::nimboost::disable_if<
            typename ::nimboost::mpl::or_<typename has_explicit_entry_state<TargetType>::type,
                                       ::nimboost::mpl::is_sequence<TargetType> >::type,void>::type
    convert_event_and_execute_entry(StateType& astate,EventType const& evt, FsmType& fsm, ::nimboost::msm::back::dummy<1> = 0)
    {
    ...
    static
        typename ::nimboost::enable_if<
            typename ::nimboost::mpl::or_<typename has_explicit_entry_state<TargetType>::type,
                                       ::nimboost::mpl::is_sequence<TargetType> >::type,void >::type
    convert_event_and_execute_entry(StateType& astate,EventType const& evt, FsmType& fsm, ::nimboost::msm::back::dummy<0> = 0)
    {
    ...
    void fill_states(ContainingSM* containing_sm=0)
    {
        ...
        ::nimboost::fusion::for_each(m_substate_list,add_state<ContainingSM>(this,containing_sm));
...
private:
    ...
    struct msg_queue_helper<StateType,
        typename ::nimboost::enable_if<typename is_no_message_queue<StateType>::type >::type> 
    {
    };
