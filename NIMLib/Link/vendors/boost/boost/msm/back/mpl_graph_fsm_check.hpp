...
namespace nimboost { namespace msm { namespace back
{
    struct mpl_graph_fsm_check
    {
        ...
        {
            BOOST_MPL_ASSERT_RELATION( ::nimboost::msm::back::check_regions_orthogonality<Fsm>::states_in_regions_raw,
                                       ==, 
                                       ::nimboost::msm::back::check_regions_orthogonality<Fsm>::cumulated_states_in_regions_raw );
        ...
        {
            BOOST_MPL_ASSERT_RELATION( ::nimboost::msm::back::check_no_unreachable_state<Fsm>::states_in_fsm,
                                       ==, 
                                       ::nimboost::msm::back::check_no_unreachable_state<Fsm>::cumulated_states_in_regions );
