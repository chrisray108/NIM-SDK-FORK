...
struct sm_domain
    : proto::domain< proto::generator<euml_terminal>, terminal_grammar, nimboost::msm::msm_domain >
{};
...
{};
struct state_domain
    : proto::domain< proto::generator<euml_terminal>, nimboost::msm::state_grammar,nimboost::msm::sm_domain >
{};

template<typename Expr>
struct euml_terminal
    : proto::extends<Expr, euml_terminal<Expr>, nimboost::msm::sm_domain>
{
    typedef
        proto::extends<Expr, euml_terminal<Expr>, nimboost::msm::sm_domain>
        base_type;
