...
*/
struct hex_decode_error : virtual nimboost::exception, virtual std::exception {};
struct not_enough_input : virtual hex_decode_error {};
struct non_hex_input    : virtual hex_decode_error {};
typedef nimboost::error_info<struct bad_char_,char> bad_char;
...
//      We are assuming ASCII for the values - but what about the storage?
    ...
    typename nimboost::enable_if<nimboost::is_integral<typename hex_iterator_traits<OutputIterator>::value_type>, OutputIterator>::type
...
typename nimboost::enable_if<nimboost::is_integral<typename detail::hex_iterator_traits<InputIterator>::value_type>, OutputIterator>::type
...
/// \note           Based on the MySQL function of the same name
template <typename T, typename OutputIterator>
typename nimboost::enable_if<nimboost::is_integral<T>, OutputIterator>::type
...
typename nimboost::enable_if<nimboost::is_integral<typename detail::hex_iterator_traits<typename Range::iterator>::value_type>, OutputIterator>::type
hex ( const Range &r, OutputIterator out ) {
    return hex (nimboost::begin(r), nimboost::end(r), out);
}
...
OutputIterator unhex ( const Range &r, OutputIterator out ) {
    return unhex (nimboost::begin(r), nimboost::end(r), out);
    }
