...
//  insert helpers  -------------------------------------------------//
            ...
            {
                ::nimboost::algorithm::detail::insert( Input, At, ::nimboost::begin(Insert), ::nimboost::end(Insert) );
            }
...
//  replace helper  -------------------------------------------------//
                ...
                const InsertT& Insert )
            {
                if(From!=To)
                {
                    ::nimboost::algorithm::detail::replace( Input, From, To, ::nimboost::begin(Insert), ::nimboost::end(Insert) );
                }
                else
                {
                    ::nimboost::algorithm::detail::insert( Input, From, ::nimboost::begin(Insert), ::nimboost::end(Insert) );
                }
            }
