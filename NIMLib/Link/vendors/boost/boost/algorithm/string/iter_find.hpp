...
//  iterate find ---------------------------------------------------//
        ...
        /*!
            ...
            \param Result A 'container container' to contain the result of search.
                ...
                Typical type of the result is 
                    \c std::vector<nimboost::iterator_range<iterator>>
        ...
        */
            ...
            FinderT Finder )
        {
            ...
            input_iterator_type InputEnd=::nimboost::end(lit_input);
            ...
            transform_iter_type itBegin=
                ::nimboost::make_transform_iterator( 
                    find_iterator_type( ::nimboost::begin(lit_input), InputEnd, Finder ),
                    copy_range_type());
