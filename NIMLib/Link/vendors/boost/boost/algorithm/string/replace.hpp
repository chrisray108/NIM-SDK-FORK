        ...
        */
            ...
            const Range2T& Format)
        {
            return ::nimboost::algorithm::find_format_copy(
                Output,
                Input,
                ::nimboost::algorithm::range_finder(SearchRange),
                ::nimboost::algorithm::const_formatter(Format));
        }
        ...
        */
            ...
            const Range3T& Format)
        {
            return ::nimboost::algorithm::find_format_copy(
                Output,
                Input,
                ::nimboost::algorithm::first_finder(Search),
                ::nimboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::nimboost::algorithm::find_format_copy(
                Output,
                Input,
                ::nimboost::algorithm::first_finder(Search, is_iequal(Loc)),
                ::nimboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::nimboost::algorithm::find_format_copy(
                Output,
                Input,
                ::nimboost::algorithm::last_finder(Search),
                ::nimboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::nimboost::algorithm::find_format_copy(
                Output,
                Input,
                ::nimboost::algorithm::last_finder(Search, is_iequal(Loc)),
                ::nimboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::nimboost::algorithm::find_format_copy(
                Output,
                Input,
                ::nimboost::algorithm::nth_finder(Search, Nth),
                ::nimboost::algorithm::const_formatter(Format) );
        }
       ...
       */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::nimboost::algorithm::find_format_copy(
                Output,
                Input,
                ::nimboost::algorithm::nth_finder(Search, Nth, is_iequal(Loc) ),
                ::nimboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::nimboost::algorithm::find_format_copy(
                Output,
                Input,
                ::nimboost::algorithm::head_finder(N),
                ::nimboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::nimboost::algorithm::find_format_copy(
                Output,
                Input,
                ::nimboost::algorithm::tail_finder(N),
                ::nimboost::algorithm::const_formatter(Format) );
        }
