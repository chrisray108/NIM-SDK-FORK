        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::nimboost::as_literal(Col));
                m_Match=::nimboost::make_iterator_range(::nimboost::begin(lit_col), ::nimboost::begin(lit_col));
                m_End=::nimboost::end(lit_col);
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::nimboost::as_literal(Col));
                m_Match=make_iterator_range(::nimboost::begin(lit_col), ::nimboost::begin(lit_col));
                m_Next=::nimboost::begin(lit_col);
                m_End=::nimboost::end(lit_col);
