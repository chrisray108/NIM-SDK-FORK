...
namespace nimboost {
    namespace algorithm {
        ...
        */
        ...
        {
            return 
                ::nimboost::find_format_all_copy(      
                    ::nimboost::trim_copy_if(Input, IsSpace),
                    ::nimboost::token_finder(IsSpace, ::nimboost::token_compress_on),
                    ::nimboost::dissect_formatter(::nimboost::head_finder(1)));
        }
        ...
        */
        ...
        {
            ::nimboost::trim_if(Input, IsSpace);
            ::nimboost::find_format_all(       
                Input,          
                ::nimboost::token_finder(IsSpace, ::nimboost::token_compress_on),
                ::nimboost::dissect_formatter(::nimboost::head_finder(1)));
        }
        ...
        */
        ...
        {
            return trim_all_copy_if(Input, ::nimboost::is_space(Loc));
        }
        ...
        */
        ...
        {
            trim_all_if(Input, ::nimboost::is_space(Loc));
        }
        ...
        inline SequenceT trim_fill_copy_if(const SequenceT& Input, const RangeT& Fill, PredicateT IsSpace)
        {
            return 
                ::nimboost::find_format_all_copy(      
                    ::nimboost::trim_copy_if(Input, IsSpace),
                    ::nimboost::token_finder(IsSpace, ::nimboost::token_compress_on),
                    ::nimboost::const_formatter(::nimboost::as_literal(Fill)));
        }
        ...
        */
        ...
        {
            return trim_fill_copy_if(Input, Fill, ::nimboost::is_space(Loc));
        }
        ...
        */
        ...
        {
            trim_fill_if(Input, Fill, ::nimboost::is_space(Loc));
        }
