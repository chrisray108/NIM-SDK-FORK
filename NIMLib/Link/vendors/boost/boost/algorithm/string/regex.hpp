...
//  find_regex  -----------------------------------------------//
        ...
        */
        ...
        {
            iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_input(::nimboost::as_literal(Input));

            return ::nimboost::algorithm::regex_finder(Rx,Flags)(
                ::nimboost::begin(lit_input), ::nimboost::end(lit_input) );
        }
...
//  replace_regex --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::nimboost::algorithm::find_format_copy( 
                Output,
                Input,
                ::nimboost::algorithm::regex_finder( Rx, Flags ),
                ::nimboost::algorithm::regex_formatter( Format, Flags ) );
        }
        ...
        */
        ...
        inline void replace_regex( 
            ...
            match_flag_type Flags=match_default | format_default )
        {
            ::nimboost::algorithm::find_format( 
                Input,
                ::nimboost::algorithm::regex_finder( Rx, Flags ),
                ::nimboost::algorithm::regex_formatter( Format, Flags ) );
        }
...
//  replace_all_regex --------------------------------------------------------------------//
        ...
        */
        ...
        inline OutputIteratorT replace_all_regex_copy(
            ...
            match_flag_type Flags=match_default | format_default )
        {
            return ::nimboost::algorithm::find_format_all_copy( 
                Output,
                Input,
                ::nimboost::algorithm::regex_finder( Rx, Flags ),
                ::nimboost::algorithm::regex_formatter( Format, Flags ) );
        ...
        */
        ...
        inline void replace_all_regex( 
            ...
            match_flag_type Flags=match_default | format_default )
        {
            ::nimboost::algorithm::find_format_all( 
                Input,
                ::nimboost::algorithm::regex_finder( Rx, Flags ),
                ::nimboost::algorithm::regex_formatter( Format, Flags ) );
        }
       ...
       */
            ...
            match_flag_type Flags=match_default )
        {
            return ::nimboost::algorithm::find_format_copy(
                ...
                Input,
                ::nimboost::algorithm::regex_finder( Rx, Flags ),
                ::nimboost::algorithm::empty_formatter( Input ) );
        }
...
//  find_all_regex ------------------------------------------------------------------//
        ...
        /*!
            ...
            or \c std::list<nimboost::iterator_range<std::string::iterator>>
        ...
        */
        ...
        inline SequenceSequenceT& find_all_regex(
            ...
            match_flag_type Flags=match_default )
        {
            return ::nimboost::algorithm::iter_find(
                Result,
                Input,
                ::nimboost::algorithm::regex_finder(Rx,Flags) );         
        }
...
//  split_regex ------------------------------------------------------------------//
        ...
        */
        ...
        inline SequenceSequenceT& split_regex(
            ...
            match_flag_type Flags=match_default )
        {
            return ::nimboost::algorithm::iter_split(
                Result,
                Input,
                ::nimboost::algorithm::regex_finder(Rx,Flags) );         
        }
...
//  join_if ------------------------------------------------------------------//
        ...
        */
            ...
            match_flag_type Flags=match_default )
        {
            ...
            // Parse input
            InputIteratorT itBegin=::nimboost::begin(Input);
            InputIteratorT itEnd=::nimboost::end(Input);
            ...
            while(
                itBegin!=itEnd && 
                !::nimboost::regex_match(::nimboost::begin(*itBegin), ::nimboost::end(*itBegin), Rx, Flags)) ++itBegin;

            // Add this element
            if(itBegin!=itEnd)
            {
                detail::insert(Result, ::nimboost::end(Result), *itBegin);
                ++itBegin;
            }

            for(;itBegin!=itEnd; ++itBegin)
            {
                if(::nimboost::regex_match(::nimboost::begin(*itBegin), ::nimboost::end(*itBegin), Rx, Flags))
                {
                    // Add separator
                    detail::insert(Result, ::nimboost::end(Result), ::nimboost::as_literal(Separator));
                    // Add element
                    detail::insert(Result, ::nimboost::end(Result), *itBegin);
                }
            }
