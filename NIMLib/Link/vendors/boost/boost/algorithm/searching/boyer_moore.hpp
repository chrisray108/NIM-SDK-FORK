...
///
        ...
        corpusIter corpus_first, corpusIter corpus_last, const PatternRange &pattern )
    {
        ...
        boyer_moore<pattern_iterator> bm ( nimboost::begin(pattern), nimboost::end (pattern));
        return bm ( corpus_first, corpus_last );
    }
    ...
    template <typename Range>
    nimboost::algorithm::boyer_moore<typename nimboost::range_iterator<const Range>::type>
    make_boyer_moore ( const Range &r ) {
        return nimboost::algorithm::boyer_moore
            <typename nimboost::range_iterator<const Range>::type> (nimboost::begin(r), nimboost::end(r));
        }
    
    template <typename Range>
    nimboost::algorithm::boyer_moore<typename nimboost::range_iterator<Range>::type>
