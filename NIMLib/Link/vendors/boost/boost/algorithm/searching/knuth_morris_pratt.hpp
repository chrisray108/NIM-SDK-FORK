...
///
        ...
        corpusIter corpus_first, corpusIter corpus_last, const PatternRange &pattern )
    {
        ...
        knuth_morris_pratt<pattern_iterator> kmp ( nimboost::begin(pattern), nimboost::end (pattern));
        return kmp ( corpus_first, corpus_last );
    }
    ...
    {
        knuth_morris_pratt<patIter> kmp ( pat_first, pat_last );
        return kmp (nimboost::begin (corpus), nimboost::end (corpus));
    }
    ...
    template <typename Range>
    nimboost::algorithm::knuth_morris_pratt<typename nimboost::range_iterator<const Range>::type>
    make_knuth_morris_pratt ( const Range &r ) {
        return nimboost::algorithm::knuth_morris_pratt
            <typename nimboost::range_iterator<const Range>::type> (nimboost::begin(r), nimboost::end(r));
        }
    
    template <typename Range>
    nimboost::algorithm::knuth_morris_pratt<typename nimboost::range_iterator<Range>::type>
