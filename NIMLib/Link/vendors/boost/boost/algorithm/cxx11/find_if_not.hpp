...
typename nimboost::range_iterator<const Range>::type find_if_not ( const Range &r, Predicate p )
{
    return nimboost::algorithm::find_if_not (nimboost::begin (r), nimboost::end(r), p);
}
