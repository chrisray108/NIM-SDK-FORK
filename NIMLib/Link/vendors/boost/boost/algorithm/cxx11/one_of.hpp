...
bool one_of ( InputIterator first, InputIterator last, Predicate p )
{
    ...
    return nimboost::algorithm::none_of (++i, last, p);
}
...
{
    return nimboost::algorithm::one_of ( nimboost::begin (r), nimboost::end (r), p );
}
...
bool one_of_equal ( InputIterator first, InputIterator last, const V &val )
{
    ...
    if (i == last)
        return false;                    // Didn't occur at all
    return nimboost::algorithm::none_of_equal (++i, last, val);
}
...
{
    return nimboost::algorithm::one_of_equal ( nimboost::begin (r), nimboost::end (r), val );
} 
