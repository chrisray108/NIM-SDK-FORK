...
namespace nimboost { namespace algorithm {
...
///
    ...
    ForwardIterator is_sorted_until ( ForwardIterator first, ForwardIterator last )
    {
        ...
        return nimboost::algorithm::is_sorted_until ( first, last, std::less<value_type>());
    }
...
///
    ...
    {
        return nimboost::algorithm::is_sorted_until (first, last, p) == last;
    }
...
///
    ...
    {
        return nimboost::algorithm::is_sorted_until (first, last) == last;
    }
#endif
...
///
    ...
    typename nimboost::lazy_disable_if_c<
        nimboost::is_same<R, Pred>::value, 
        typename nimboost::range_iterator<const R> 
    >::type is_sorted_until ( const R &range, Pred p )
    {
        return nimboost::algorithm::is_sorted_until ( nimboost::begin ( range ), nimboost::end ( range ), p );
    }
...
///
    template <typename R>
    typename nimboost::range_iterator<const R>::type is_sorted_until ( const R &range )
    {
        return nimboost::algorithm::is_sorted_until ( nimboost::begin ( range ), nimboost::end ( range ));
    }
...
///
    template <typename R, typename Pred>
    typename nimboost::lazy_disable_if_c< nimboost::is_same<R, Pred>::value, nimboost::mpl::identity<bool> >::type
    is_sorted ( const R &range, Pred p )
    {
        return nimboost::algorithm::is_sorted ( nimboost::begin ( range ), nimboost::end ( range ), p );
    }
...
///
    ...
    {
        return nimboost::algorithm::is_sorted ( nimboost::begin ( range ), nimboost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_strictly_increasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return nimboost::algorithm::is_sorted (first, last, std::less<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_strictly_increasing instead.
    ...
    {
        return is_increasing ( nimboost::begin ( range ), nimboost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_strictly_decreasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return nimboost::algorithm::is_sorted (first, last, std::greater<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_strictly_decreasing instead.
    ...
    {
        return is_decreasing ( nimboost::begin ( range ), nimboost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_increasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return nimboost::algorithm::is_sorted (first, last, std::less_equal<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_increasing instead.
    ...
    {
        return is_strictly_increasing ( nimboost::begin ( range ), nimboost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_decreasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return nimboost::algorithm::is_sorted (first, last, std::greater_equal<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_decreasing instead.
    ...
    {
        return is_strictly_decreasing ( nimboost::begin ( range ), nimboost::end ( range ));
    }
