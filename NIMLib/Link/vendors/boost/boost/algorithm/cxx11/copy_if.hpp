...
{
    return nimboost::algorithm::copy_if (nimboost::begin (r), nimboost::end(r), result, p);
}
...
///
template<typename Range, typename OutputIterator, typename Predicate>
std::pair<typename nimboost::range_iterator<const Range>::type, OutputIterator> 
copy_while ( const Range &r, OutputIterator result, Predicate p )
{
    return nimboost::algorithm::copy_while (nimboost::begin (r), nimboost::end(r), result, p);
}
...
{
    return nimboost::algorithm::copy_until (nimboost::begin (r), nimboost::end(r), result, p);
}

}} // namespace nimboost and algorithm
