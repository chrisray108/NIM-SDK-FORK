...
// **** exceptions -----------------------------------------------
        ...
        public:
            ...
            virtual const char *what() const throw() {
                return "nimboost::bad_format_string: format-string is ill-formed";
            }
        };
