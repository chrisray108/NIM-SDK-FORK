                     ...
                     const SinglePassRange2& rng2)
{
    ...
    return std::includes(nimboost::begin(rng1),nimboost::end(rng1),
                         nimboost::begin(rng2),nimboost::end(rng2));
}
                     ...
                     BinaryPredicate         pred)
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::includes(nimboost::begin(rng1), nimboost::end(rng1),
                         nimboost::begin(rng2), nimboost::end(rng2), pred);
}
                                ...
                                OutputIterator          out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_union(nimboost::begin(rng1), nimboost::end(rng1),
                          nimboost::begin(rng2), nimboost::end(rng2), out);
}
                                ...
                                BinaryPredicate         pred)
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_union(nimboost::begin(rng1), nimboost::end(rng1),
                          nimboost::begin(rng2), nimboost::end(rng2), out, pred);
}
                                       ...
                                       OutputIterator          out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_intersection(nimboost::begin(rng1), nimboost::end(rng1),
                                 nimboost::begin(rng2), nimboost::end(rng2), out);
}
                                     ...
                                     OutputIterator out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_difference(nimboost::begin(rng1), nimboost::end(rng1),
                               nimboost::begin(rng2), nimboost::end(rng2), out);
}
                                     ...
                                     BinaryPredicate         pred)
{
    ...
    return std::set_difference(
        nimboost::begin(rng1), nimboost::end(rng1),
        nimboost::begin(rng2), nimboost::end(rng2), out, pred);
}
                         ...
                         OutputIterator          out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_symmetric_difference(nimboost::begin(rng1), nimboost::end(rng1),
                                         nimboost::begin(rng2), nimboost::end(rng2), out);
}
