            ...
            */
            ...
            struct default_container_traits
            {
                ...
                typedef BOOST_STRING_TYPENAME 
                    ::nimboost::mpl::if_< ::nimboost::is_const<ContainerT>,
                        const_iterator,
                        iterator 
...
// Array container traits ---------------------------------------------------------------
            ...
            */
            ...
            struct array_traits_cv_selector
            {
                typedef BOOST_STRING_TYPENAME 
                    ::nimboost::mpl::eval_if< 
                        ::nimboost::is_convertible<T,BaseT*>,
                        array_traits_impl_selector<T,BaseT>,
                        ::nimboost::mpl::eval_if< 
                            ::nimboost::is_convertible<T,const BaseT*>,
                                array_traits_impl_selector<T, const BaseT>,
                                ::nimboost::mpl::eval_if< 
                                    ::nimboost::is_convertible<T, volatile BaseT*>,
            ...
            struct array_traits_select
            {
                ...
                struct apply
                {
                    typedef BOOST_STRING_TYPENAME
                        ::nimboost::mpl::eval_if< 
                            ::nimboost::is_convertible<T,const volatile T2*>,
                            array_traits_cv_selector<T,T2>,
                            ::nimboost::mpl::identity<T1> >::type type;
                };
            };
            ...
            private:
                ...
                typedef BOOST_STRING_TYPENAME
                    ::nimboost::mpl::vector10<
                        wchar_t,
#else // BOOST_NO_INTRINSIC_WCHAR_T
                typedef BOOST_STRING_TYPENAME
                    ::nimboost::mpl::vector9<
            ...
            public:
                typedef BOOST_STRING_TYPENAME
                    ::nimboost::mpl::fold<
                        array_base_types,
                        ::nimboost::algorithm::detail::array_traits_void,
                        ::nimboost::algorithm::detail::array_traits_select<T> >::type type;
            };
            ...
            */
            ...
            public:
                ...
                typedef BOOST_STRING_TYPENAME
                    ::nimboost::mpl::if_< ::nimboost::is_const<T>,
                        const_iterator,
                        iterator 
                    >::type result_iterator;
            ...
            private:
                // resolve array size
                typedef BOOST_STRING_TYPENAME
                    ::nimboost::remove_cv<value_type>::type char_type;
                typedef BOOST_STRING_TYPENAME
...
// Pointer container traits ---------------------------------------------------------------
            ...
            {
                typedef BOOST_STRING_TYPENAME
                    ::nimboost::remove_pointer<T>::type value_type;
