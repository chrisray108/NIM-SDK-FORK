...
public:
    ...
    join_iterator(Range1& r1, Range2& r2, join_iterator_begin_tag)
        : m_section(nimboost::empty(r1) ? 1u : 0u)
        , m_it(nimboost::empty(r1) ? 1u : 0u, nimboost::begin(r1), nimboost::begin(r2))
        , m_link(link_t(nimboost::end(r1), nimboost::begin(r2)))
    {
    }
    ...
    join_iterator(const Range1& r1, const Range2& r2, join_iterator_begin_tag)
        : m_section(nimboost::empty(r1) ? 1u : 0u)
        , m_it(nimboost::empty(r1) ? 1u : 0u, nimboost::const_begin(r1), nimboost::const_begin(r2))
        , m_link(link_t(nimboost::const_end(r1), nimboost::const_begin(r2)))
    {
    }
    ...
    join_iterator(Range1& r1, Range2& r2, join_iterator_end_tag)
        : m_section(1u)
        , m_it(1u, nimboost::end(r1), nimboost::end(r2))
        , m_link(link_t(nimboost::end(r1), nimboost::begin(r2)))
    {
    }
    ...
    join_iterator(const Range1& r1, const Range2& r2, join_iterator_end_tag)
        : m_section(1u)
        , m_it(1u, nimboost::const_end(r1), nimboost::const_end(r2))
        , m_link(link_t(nimboost::const_end(r1), nimboost::const_begin(r2)))
    {
    }
...
private:
    ...
    void decrement()
    {
        if (m_section)
        {
            ...
            {
                m_it.it1() = nimboost::prior(m_link.last1);
                m_section = 0u;
            }
            else
                --m_it.it2();
