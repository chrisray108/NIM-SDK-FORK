...
namespace nimboost
{
    namespace range_detail
    {
        ...
        // any_single_pass_iterator_interface<Reference> implementation
            ...
            {
                return m_it == nimboost::polymorphic_downcast<const any_single_pass_iterator_wrapper*>(&other)->m_it;
            }
        ...
        public:
            ...
            virtual bool equal(const any_single_pass_iterator_interface<Reference, Buffer>& other) const
            {
                return m_it == nimboost::polymorphic_downcast<const any_forward_iterator_wrapper*>(&other)->m_it;
            }
        ...
        public:
            ...
            virtual bool equal(const any_single_pass_iterator_interface<Reference, Buffer>& other) const
            {
                return m_it == nimboost::polymorphic_downcast<const any_bidirectional_iterator_wrapper*>(&other)->m_it;
            }
        ...
        public:
            ...
            virtual bool equal(const any_single_pass_iterator_interface<Reference, Buffer>& other) const
            {
                return m_it == nimboost::polymorphic_downcast<const any_random_access_iterator_wrapper*>(&other)->m_it;
            }
            ...
            {
                return nimboost::polymorphic_downcast<const any_random_access_iterator_wrapper*>(&other)->m_it - m_it;
            }
