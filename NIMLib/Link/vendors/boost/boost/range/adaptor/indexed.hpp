...
namespace nimboost
{
    ...
    namespace range_detail
    {
        ...
        class indexed_iterator
            : public nimboost::iterator_adaptor< indexed_iterator<Iter>, Iter >
        {
        private:
            typedef nimboost::iterator_adaptor< indexed_iterator<Iter>, Iter >
                  base;
        ...
        public:
            ...
            indexed_range( Index i, Rng& r )
              : base( iter_type(nimboost::begin(r), i), iter_type(nimboost::end(r),i) )
            { }
        };
