...
namespace nimboost
{
    namespace range_detail
    {
        ...
        struct filtered_range :
            nimboost::iterator_range<
                nimboost::filter_iterator< P,
        ...
        public:
            ...
            : base( make_filter_iterator( p, nimboost::begin(r), nimboost::end(r) ),
                    make_filter_iterator( p, nimboost::end(r), nimboost::end(r) ) )
            { }
        };
