...
namespace nimboost
{
    namespace range_detail
    {
        ...
        {
            return operator|( r,
                nimboost::adaptors::transformed( select_first<StdPairRng>() ) );
        }
        ...
        {
            return operator|( r,
                nimboost::adaptors::transformed( select_second_mutable<StdPairRng>() ) );
        }
        ...
        {
            return operator|( r,
                nimboost::adaptors::transformed( select_second_const<StdPairRng>() ) );
        }
