    ...
    namespace range_detail
    {
        ...
        public:
            ...
            strided_range(Difference stride, Rng& rng)
                : super_t(make_strided_iterator(nimboost::begin(rng), nimboost::begin(rng), nimboost::end(rng), stride),
                          make_strided_iterator(nimboost::begin(rng), nimboost::end(rng), nimboost::end(rng), stride))
            {
                BOOST_ASSERT( stride >= 0 );
            }
        };
