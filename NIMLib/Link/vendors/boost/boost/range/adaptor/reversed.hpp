...
namespace nimboost
{
    namespace range_detail
    {
        ...
        struct reversed_range : 
            public nimboost::iterator_range< 
                      nimboost::reverse_iterator<
        ...
        public:
            typedef nimboost::reverse_iterator<BOOST_DEDUCED_TYPENAME range_iterator<R>::type> iterator;

            explicit reversed_range( R& r ) 
                : base( iterator(nimboost::end(r)), iterator(nimboost::begin(r)) )
            { }
        };
