...
namespace nimboost
{
    ...
    inline Value accumulate( const SinglePassRange& rng, Value init )
    {
        ...
        return std::accumulate( nimboost::begin(rng), nimboost::end(rng), init );
    }
    ...
    {
        BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange> ));
        return std::accumulate( nimboost::begin(rng), nimboost::end(rng), init, op );
    }
    ...
    inline Value inner_product( const SinglePassRange1& rng1, const SinglePassRange2& rng2, Value init )
    {
        ...
        BOOST_ASSERT( nimboost::distance(rng2) >= nimboost::distance(rng1) );
        return std::inner_product( nimboost::begin(rng1), nimboost::end(rng1),
            nimboost::begin(rng2), init );
    }
                                ...
                                BinaryOperation1 op1, BinaryOperation2 op2 )
    {
        ...
        return std::inner_product( nimboost::begin(rng1), nimboost::end(rng1),
                                   nimboost::begin(rng2), init, op1, op2 );
    }
    ...
    {
        BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange> ));
        return std::partial_sum( nimboost::begin(rng), nimboost::end(rng), result );
    }
    ...
    {
        BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange> ));
        return std::partial_sum( nimboost::begin(rng), nimboost::end(rng), result, op );
    }
    ...
    {
        BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange> ));
        return std::adjacent_difference( nimboost::begin(rng), nimboost::end(rng),
                                         result );
    }
