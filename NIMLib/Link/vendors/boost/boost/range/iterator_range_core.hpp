...
namespace nimboost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return static_cast<IteratorT>( nimboost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return static_cast<IteratorT>( nimboost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( nimboost::begin(l),
                                                 nimboost::end(l),
                                                 nimboost::begin(r),
                                                 nimboost::end(r) );
        }
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                nimboost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
        ...
        */
        ...
        private: // for return value of operator()()
            typedef BOOST_DEDUCED_TYPENAME
                nimboost::mpl::if_< nimboost::mpl::or_< nimboost::is_abstract< value_type >, 
                                                  nimboost::is_array< value_type > >,
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        make_iterator_range( Range& r )
        {
            return iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<Range>::type >
                ( nimboost::begin( r ), nimboost::end( r ) );
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = nimboost::begin( r ),
                    new_end   = nimboost::end( r );
        ...
        */
        ...
        {
            return SeqT( nimboost::begin( r ), nimboost::end( r ) );
        }
