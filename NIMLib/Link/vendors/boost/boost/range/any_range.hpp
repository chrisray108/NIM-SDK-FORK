...
namespace nimboost
{
    namespace range_detail
    {
        ...
        // values when the user specified nimboost::use_default as a template
        // parameter.
        template<
            class T,
            class Default
...
# endif
        ...
        public:
            ...
            : base_type(nimboost::begin(wrapped_range),
                        nimboost::end(wrapped_range))
            {
            }
            ...
            any_range(const any_range<
                              ...
                              , Buffer
                            >& other)
            : base_type(nimboost::begin(other), nimboost::end(other))
            {
            }
