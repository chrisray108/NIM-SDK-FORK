...
{
    if((nimboost::math::isnan)(v1) || (nimboost::math::isnan)(v2)) return false;
    else return v1 > v2;
}
...
{
    return (nimboost::math::isnan)(v1) || (nimboost::math::isnan)(v2);
}

template<class Y>
inline Y fdim BOOST_PREVENT_MACRO_SUBSTITUTION(const Y& v1,const Y& v2)
{
    if((nimboost::math::isnan)(v1)) return v1;
    else if((nimboost::math::isnan)(v2)) return v2;
...
{
    if((nimboost::math::isnan)(v1)) return(v2);
    else if((nimboost::math::isnan)(v2)) return(v1);
