...
/// INTERNAL ONLY
template<>
struct less_impl<nimboost::units::scale_dim_tag, nimboost::units::scale_dim_tag>
{
...
/// INTERNAL ONLY
template<>
struct plus_impl<nimboost::units::scale_dim_tag, nimboost::units::scale_dim_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef nimboost::units::scale_list_dim<
            nimboost::units::scale<
                (T0::base),
...
/// INTERNAL ONLY
template<>
struct negate_impl<nimboost::units::scale_dim_tag>
{
    template<class T0>
    struct apply
    {
...
/// INTERNAL ONLY
template<>
struct times_impl<nimboost::units::scale_dim_tag, nimboost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
