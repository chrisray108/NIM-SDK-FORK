...
typedef nimboost::units::heterogeneous_system<
...
template<class T>
struct void_if_dimensionless<nimboost::units::homogeneous_system<T> > {
    typedef void type;
};
...
#define BOOST_UNITS_DIMENSIONLESS_UNIT(T)\
    nimboost::units::unit<\
        nimboost::units::dimensionless_type,\
        T,\
        typename ::nimboost::units::detail::void_if_dimensionless<T>::type\
    >
...
#define BOOST_UNITS_HETEROGENEOUS_DIMENSIONLESS_UNIT(T)\
    nimboost::units::unit<\
        nimboost::units::dimensionless_type,\
        T,\
        typename ::nimboost::units::detail::void_if_heterogeneous<T>::type\
    >
