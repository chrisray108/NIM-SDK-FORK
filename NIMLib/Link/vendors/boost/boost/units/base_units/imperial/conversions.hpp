...
// imperial units
    ...
    BOOST_UNITS_DEFINE_CONVERSION_FACTOR(nimboost::units::imperial::pint_base_unit,nimboost::units::imperial::gallon_base_unit, double, 1./8.);
#endif
    ...
    #include <boost/units/conversion.hpp>
    BOOST_UNITS_DEFINE_CONVERSION_FACTOR(nimboost::units::imperial::pint_base_unit,nimboost::units::imperial::quart_base_unit, double, 1./2.);
#endif
    ...
    #include <boost/units/conversion.hpp>
    BOOST_UNITS_DEFINE_CONVERSION_FACTOR(nimboost::units::imperial::pint_base_unit,nimboost::units::imperial::gill_base_unit, double, 4.);
#endif
    ...
    #include <boost/units/conversion.hpp>
    BOOST_UNITS_DEFINE_CONVERSION_FACTOR(nimboost::units::imperial::pint_base_unit,nimboost::units::imperial::fluid_ounce_base_unit, double, 20.);
#endif
