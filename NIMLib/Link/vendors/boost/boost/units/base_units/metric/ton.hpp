...
//typedef scaled_base_unit<nimboost::units::cgs::gram_base_unit, scale<10, static_rational<6> > > ton_base_unit;
typedef scaled_base_unit<nimboost::units::si::kilogram_base_unit, scale<1000, static_rational<1> > > ton_base_unit;
