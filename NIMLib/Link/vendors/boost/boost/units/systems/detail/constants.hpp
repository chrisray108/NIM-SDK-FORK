...
BOOST_UNITS_STATIC_CONSTANT(name, nimboost::units::constant<nimboost::units::physical_constant<name ## _t> >) = { }
...
{
    nimboost::io::ios_precision_saver precision_saver(os);
    //nimboost::io::ios_width_saver width_saver(os);
    nimboost::io::ios_flags_saver flags_saver(os);
