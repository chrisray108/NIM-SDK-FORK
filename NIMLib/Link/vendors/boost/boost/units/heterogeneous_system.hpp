...
#define BOOST_UNITS_MAKE_HETEROGENEOUS_UNIT(BaseUnit, Dimensions)   \
    nimboost::units::unit<                                             \
        Dimensions,                                                 \
        nimboost::units::heterogeneous_system<                         \
            nimboost::units::heterogeneous_system_impl<                \
                nimboost::units::list<                       \
                    nimboost::units::heterogeneous_system_dim<         \
                        BaseUnit,                                   \
                        nimboost::units::static_rational<1>            \
                    >,                                              \
                    nimboost::units::dimensionless_type                \
                >,                                                  \
                Dimensions,                                         \
                nimboost::units::no_scale                              \
            >                                                       \
        >                                                           \
    >
...
BOOST_TYPEOF_REGISTER_TEMPLATE(nimboost::units::heterogeneous_system_impl, (class)(class)(class))
BOOST_TYPEOF_REGISTER_TEMPLATE(nimboost::units::heterogeneous_system, (class))
BOOST_TYPEOF_REGISTER_TEMPLATE(nimboost::units::heterogeneous_system_dim, (class)(class))
...
/// INTERNAL ONLY
template<>
struct less_impl<nimboost::units::heterogeneous_system_dim_tag, nimboost::units::heterogeneous_system_dim_tag>
{
...
/// INTERNAL ONLY
template<>
struct plus_impl<nimboost::units::heterogeneous_system_dim_tag, nimboost::units::heterogeneous_system_dim_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef nimboost::units::heterogeneous_system_dim<
...
/// INTERNAL ONLY
template<>
struct times_impl<nimboost::units::heterogeneous_system_dim_tag, nimboost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
/// INTERNAL ONLY
template<>
struct divides_impl<nimboost::units::heterogeneous_system_dim_tag, nimboost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
/// INTERNAL ONLY
template<>
struct negate_impl<nimboost::units::heterogeneous_system_dim_tag>
{
    template<class T>
    struct apply
    {
        typedef nimboost::units::heterogeneous_system_dim<typename T::tag_type, typename mpl::negate<typename T::value_type>::type> type;
    };
};
...
struct make_heterogeneous_system
{
    ...
    BOOST_MPL_ASSERT_MSG((!nimboost::is_same<exponents, inconsistent>::value), the_specified_dimension_is_not_representible_in_the_given_system, (types<Dimensions, System>));
