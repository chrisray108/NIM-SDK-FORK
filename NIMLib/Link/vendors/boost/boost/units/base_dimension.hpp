...
/// This must be in namespace nimboost::units so that ADL
...
/// @code
/// struct my_dimension : nimboost::units::base_dimension<my_dimension, 1> {};
/// @endcode
    ...
    public ordinal<N> 
{
    public:
        ...
        /// A convenience typedef.  Equivalent to nimboost::units::derived_dimension<Derived,1>::type.
