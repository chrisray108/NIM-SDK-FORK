...
nimboost
    ...
    exception_ptr
        {
        typedef nimboost::shared_ptr<exception_detail::clone_base const> impl;
        impl ptr_;
...
# endif
    ...
    unknown_exception:
        ...
        explicit
        unknown_exception( nimboost::exception const & e ):
            nimboost::exception(e)
            {
            add_original_type(e);
            }
...
# endif
    ...
    exception_detail
        ...
        current_exception_std_exception_wrapper:
            ...
            current_exception_std_exception_wrapper( T const & e1, nimboost::exception const & e2 ):
                T(e1),
                nimboost::exception(e2)
                {
                add_original_type(e1);
                }
        ...
        get_boost_exception( T const * x )
            {
            return dynamic_cast<nimboost::exception const *>(x);
            }
#endif
        ...
        current_exception_std_exception( T const & e1 )
            {
            if( nimboost::exception const * e2 = get_boost_exception(&e1) )
                return nimboost::copy_exception(current_exception_std_exception_wrapper<T>(e1,*e2));
            else
                return nimboost::copy_exception(current_exception_std_exception_wrapper<T>(e1));
            }
        ...
        current_exception_unknown_exception()
            {
            return nimboost::copy_exception(unknown_exception());
            }

        inline
        exception_ptr
        current_exception_unknown_boost_exception( nimboost::exception const & e )
            {
            return nimboost::copy_exception(unknown_exception(e));
            }
        ...
        current_exception_unknown_std_exception( std::exception const & e )
            {
            if( nimboost::exception const * be = get_boost_exception(&e) )
