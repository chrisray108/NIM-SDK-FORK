...
namespace nimboost { namespace filesystem {
...
namespace path_traits {
  ...
  template <class Container> inline
    ...
    typename nimboost::disable_if<nimboost::is_array<Container>, bool>::type
  ...
  template <class Container, class U> inline
    ...
    typename nimboost::disable_if<nimboost::is_array<Container>, void>::type
...
}}} // namespace nimboost::filesystem::path_traits
