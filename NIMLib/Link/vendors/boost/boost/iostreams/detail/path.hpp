 ...
 *
 * Defines the class nimboost::iostreams::detail::path, for storing a 
...
namespace nimboost { namespace iostreams { namespace detail {
...
public:
    ...
    // Constructor taking a nimboost::filesystem2::path or
    // nimboost::filesystem2::wpath
    ...
    // Constructor taking a nimboost::filesystem3::path (boost filesystem v3)
    template<typename Path>
    ...
    // Assignment operator taking a nimboost::filesystem2::path or
    // nimboost::filesystem2::wpath
    ...
    // Assignment operator taking a nimboost::filesystem3::path
    template<typename Path>
...
private:
    ...
    // For wide-character paths, use a nimboost::filesystem::wpath instead of a
    // std::wstring
