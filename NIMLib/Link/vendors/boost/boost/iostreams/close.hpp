...
{ 
    try {
        nimboost::iostreams::close(t, BOOST_IOS::in);
    } catch (...) {
        try {
            nimboost::iostreams::close(t, BOOST_IOS::out);
        } catch (...) { }
        throw;
    }
    nimboost::iostreams::close(t, BOOST_IOS::out);
...
{ 
    try {
        nimboost::iostreams::close(t, snk, BOOST_IOS::in);
    } catch (...) {
        try {
            nimboost::iostreams::close(t, snk, BOOST_IOS::out);
        } catch (...) { }
        throw;
    }
    nimboost::iostreams::close(t, snk, BOOST_IOS::out);
