...
namespace nimboost {
     ...
     Buffer& Q, BFSVisitor vis, ColorMap color)
  {
    ...
    typedef typename property_traits<ColorMap>::value_type ColorValue;
    typedef color_traits<ColorValue> Color;
    typename nimboost::graph_traits<VertexListGraph>::vertex_iterator i, i_end;
    for (nimboost::tie(i, i_end) = vertices(g); i != i_end; ++i) {
  ...
  public:
    ...
    {
      invoke_visitors(m_vis, u, g, ::nimboost::on_examine_vertex());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::nimboost::on_tree_edge());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::nimboost::on_non_tree_edge());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::nimboost::on_gray_target());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::nimboost::on_black_target());
      return graph::bfs_visitor_event_not_overridden();
    }
  ...
  namespace detail {
       ...
       nimboost::mpl::false_)
    {
      ...
      typedef nimboost::queue<Vertex> queue_t;
      queue_t Q;
      breadth_first_search
        (g, s,
         choose_param(get_param(params, buffer_param_t()), nimboost::ref(Q)).get(),
         vis, color);
    }
     ...
     const bgl_named_params<P, T, R>& params)
  {
    ...
    typedef nimboost::queue<vertex_descriptor> queue_t;
    queue_t Q;
    ...
    namespace detail {
      ...
      struct breadth_first_search_impl {
        ...
        void operator()(const Graph& g, const Source& source, const ArgPack& arg_pack) {
          ...
          typename nimboost::graph_traits<Graph>::vertex_descriptor sources[1] = {source};
          nimboost::queue<typename nimboost::graph_traits<Graph>::vertex_descriptor> Q;
          nimboost::breadth_first_search(g,
                                      &sources[0],
                                      &sources[1], 
                                      nimboost::unwrap_ref(arg_pack[_buffer | nimboost::ref(Q)]),
