...
namespace read_graphviz_detail {
  ...
  void translate_results_to_graph(const parser_result& r, ::nimboost::detail::graph::mutate_graph* mg);

} // namespace read_graphviz_detail

namespace detail {
  namespace graph {
    BOOST_GRAPH_DECL bool read_graphviz_new(const std::string& str, nimboost::detail::graph::mutate_graph* mg);
  } // end namespace graph
} // end namespace detail

template <typename MutableGraph>
bool read_graphviz_new(const std::string& str,
                       MutableGraph& graph, nimboost::dynamic_properties& dp,
                       std::string const& node_id = "node_id") {
  nimboost::detail::graph::mutate_graph_impl<MutableGraph> mg(graph, dp, node_id);
