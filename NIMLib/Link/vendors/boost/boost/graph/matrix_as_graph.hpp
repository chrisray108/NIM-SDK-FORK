...
namespace nimboost { \
  ...
  struct graph_traits< Matrix > { \
    ...
    typedef nimboost::matrix_incidence_iterator<Iter, V> out_edge_iterator; \
    typedef nimboost::matrix_adj_iterator<Iter, V> adjacency_iterator; \
    typedef Matrix::size_type size_type; \
    typedef nimboost::int_iterator<size_type> vertex_iterator; \
    \
