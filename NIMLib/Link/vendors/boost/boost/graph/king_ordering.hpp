...
namespace nimboost {
  namespace detail {
    ...
    public:
      ...
      void finish_vertex(Vertex, Graph& g) {
        ...
        std::make_heap(rbegin, rend, nimboost::bind<bool>(comp, _2, _1));
        ...
        for( ; rbegin != rend; rend--){
          ...
          for (nimboost::tie(ei, ei_end) = out_edges(w, g); ei != ei_end; ++ei) {
            v = target(*ei, g);
                ...
                VertexIndexMap index_map)
  {
    ...
    typedef typename nimboost::sparse::sparse_ordering_queue<Vertex> queue;
