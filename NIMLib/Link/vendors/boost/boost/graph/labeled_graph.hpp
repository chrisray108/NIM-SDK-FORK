...
namespace graph_detail {
    ...
    { typedef nimboost::unordered_map<Label, Vertex> type; };

    template <typename Label, typename Vertex>
    struct generate_label_map<hash_multimapS, Label, Vertex>
    { typedef nimboost::unordered_multimap<Label, Vertex> type; };
                          ...
                          unique_associative_container_tag)
    {
        ...
        if(x.second) {
            ...
            put(nimboost::vertex_all, g, x.first->second, p);
        }
...
public:
    ...
    { return nimboost::remove_vertex(vertex(l), _graph); }
