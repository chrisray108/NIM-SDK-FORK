...
fi_adj_loop_k:++fi_adj.first;
  ...
  namespace detail {
    ...
    struct make_degree_invariant {
      ...
      typedef typename nimboost::graph_traits<G>::degree_size_type degree_size_type;
    ...
    namespace detail {
      ...
      struct isomorphism_impl {
        ...
        bool operator()(const Graph1& g1, const Graph2& g2, const ArgPack& arg_pack) const {
          ...
          typedef typename nimboost::detail::override_const_property_result<ArgPack, tag::vertex_index1_map, nimboost::vertex_index_t, Graph1>::type index1_map_type;
          typedef typename nimboost::detail::override_const_property_result<ArgPack, tag::vertex_index2_map, nimboost::vertex_index_t, Graph2>::type index2_map_type;
          index1_map_type index1_map = nimboost::detail::override_const_property(arg_pack, _vertex_index1_map, g1, nimboost::vertex_index);
          index2_map_type index2_map = nimboost::detail::override_const_property(arg_pack, _vertex_index2_map, g2, nimboost::vertex_index);
          typedef typename graph_traits<Graph2>::vertex_descriptor vertex2_t;
          typename std::vector<vertex2_t>::size_type n = (typename std::vector<vertex2_t>::size_type)num_vertices(g1);
          std::vector<vertex2_t> f(n);
          typename nimboost::parameter::lazy_binding<
                     ArgPack,
                     tag::vertex_invariant1,
                     nimboost::detail::make_degree_invariant<Graph1, index1_map_type> >::type
            invariant1 =
              arg_pack[_vertex_invariant1 || nimboost::detail::make_degree_invariant<Graph1, index1_map_type>(g1, index1_map)];
          typename nimboost::parameter::lazy_binding<
                     ArgPack,
                     tag::vertex_invariant2,
                     nimboost::detail::make_degree_invariant<Graph2, index2_map_type> >::type
            invariant2 =
              arg_pack[_vertex_invariant2 || nimboost::detail::make_degree_invariant<Graph2, index2_map_type>(g2, index2_map)];
          return nimboost::isomorphism
                   (g1, g2,
                    choose_param(arg_pack[_isomorphism_map | nimboost::param_not_found()],
