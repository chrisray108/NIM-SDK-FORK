...
public:
    ...
    virtual nimboost::any do_add_vertex() = 0;
    virtual std::pair<nimboost::any,bool> do_add_edge(nimboost::any source, nimboost::any target) = 0;

    virtual void
    set_graph_property(const std::string& name, const std::string& value, const std::string& value_type) = 0;

    virtual void
    set_vertex_property(const std::string& name, nimboost::any vertex, const std::string& value, const std::string& value_type) = 0;

    virtual void
    set_edge_property(const std::string& name, nimboost::any edge, const std::string& value, const std::string& value_type) = 0;
};
              ...
              const dynamic_properties& dp, bool ordered_vertices=false)
{
    ...
    using nimboost::property_tree::xml_parser::encode_char_entities;
    ...
    for (nimboost::tie(e, e_end) = edges(g); e != e_end; ++e)
    {
