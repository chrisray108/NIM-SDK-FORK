...
//
// It is needed in order to allow us to write using nimboost::vertices as
...
typename T::ThereReallyIsNoMemberByThisNameInT vertices(T const&);
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((nimboost::mpl::not_<nimboost::is_same<out_edge_iterator, void> >::value));
        BOOST_STATIC_ASSERT((nimboost::mpl::not_<nimboost::is_same<degree_size_type, void> >::value));
        ...
        : IncidenceGraph<G>
    {
        ...
        BOOST_STATIC_ASSERT((nimboost::mpl::not_<nimboost::is_same<in_edge_iterator, void> >::value));
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((nimboost::mpl::not_<nimboost::is_same<adjacency_iterator, void> >::value));
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((nimboost::mpl::not_<nimboost::is_same<vertex_iterator, void> >::value));
        BOOST_STATIC_ASSERT((nimboost::mpl::not_<nimboost::is_same<vertices_size_type, void> >::value));
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((nimboost::mpl::not_<nimboost::is_same<edge_iterator, void> >::value));
        BOOST_STATIC_ASSERT((nimboost::mpl::not_<nimboost::is_same<edges_size_type, void> >::value));
        ...
        : MutableGraph<G>
    {
        ...
        typename nimboost::graph_traits<G>::vertex_descriptor u;
        typename nimboost::graph_traits<G>::out_edge_iterator iter;
    };
...
using nimboost::concepts::MultiPassInputIteratorConcept;

// Graph concepts
using nimboost::concepts::GraphConcept;
using nimboost::concepts::IncidenceGraphConcept;
using nimboost::concepts::BidirectionalGraphConcept;
using nimboost::concepts::AdjacencyGraphConcept;
using nimboost::concepts::VertexListGraphConcept;
using nimboost::concepts::EdgeListGraphConcept;
using nimboost::concepts::VertexAndEdgeListGraphConcept;
using nimboost::concepts::EdgeMutableGraphConcept;
using nimboost::concepts::VertexMutableGraphConcept;
using nimboost::concepts::MutableGraphConcept;
using nimboost::concepts::MutableIncidenceGraphConcept;
using nimboost::concepts::MutableBidirectionalGraphConcept;
using nimboost::concepts::MutableEdgeListGraphConcept;
using nimboost::concepts::VertexMutablePropertyGraphConcept;
using nimboost::concepts::EdgeMutablePropertyGraphConcept;
using nimboost::concepts::AdjacencyMatrixConcept;
using nimboost::concepts::ReadablePropertyGraphConcept;
using nimboost::concepts::PropertyGraphConcept;
using nimboost::concepts::LvaluePropertyGraphConcept;
using nimboost::concepts::VertexIndexGraphConcept;
using nimboost::concepts::EdgeIndexGraphConcept;

// Utility concepts
using nimboost::concepts::ColorValueConcept;
using nimboost::concepts::BasicMatrixConcept;
using nimboost::concepts::NumericValueConcept;
using nimboost::concepts::DistanceMeasureConcept;
using nimboost::concepts::DegreeMeasureConcept;
