...
namespace nimboost {
  ...
  template <> struct graph_traits<sgb_graph_ptr> {
    ...
    typedef nimboost::sgb_edge edge_descriptor;
...
namespace nimboost {
  ...
  class sgb_out_edge_iterator
    : public nimboost::forward_iterator_helper<
        sgb_out_edge_iterator, nimboost::sgb_edge, 
        std::ptrdiff_t, nimboost::sgb_edge*, nimboost::sgb_edge>
  {
    typedef sgb_out_edge_iterator self;
  public:
    sgb_out_edge_iterator() : _src(0), _arc(0) {}
    sgb_out_edge_iterator(Vertex* s, Arc* d) : _src(s), _arc(d) {}
    nimboost::sgb_edge operator*() { return nimboost::sgb_edge(_arc, _src); }
...
namespace nimboost {
  ...
  inline nimboost::graph_traits<sgb_graph_ptr>::degree_size_type
  out_degree(Vertex* u, sgb_const_graph_ptr g)
  {
    nimboost::graph_traits<sgb_graph_ptr>::out_edge_iterator i, i_end;
    nimboost::tie(i, i_end) = out_edges(u, g);
  ...
  class sgb_vertex_id_map
    : public nimboost::put_get_helper<long, sgb_vertex_id_map>
  {
  public:
  ...
  class sgb_vertex_name_map
    : public nimboost::put_get_helper<char*, sgb_vertex_name_map>
  {
  public:
    typedef nimboost::readable_property_map_tag category;
...
#define SGB_GET_UTIL_FIELD(KIND,X) \
  ...
  class sgb_vertex_util_map
    : public nimboost::put_get_helper<Ref, sgb_vertex_util_map<Tag, Ref> >
  {
    Tag tag;
  public:
  ...
  class sgb_edge_util_map
    : public nimboost::put_get_helper<Ref, sgb_edge_util_map<Tag, Ref> >
  {
    Tag tag;
  public:
  ...
  class sgb_edge_length_map
    : public nimboost::put_get_helper<Ref, sgb_edge_length_map<Ref> >
  {
  public:
    typedef nimboost::lvalue_property_map_tag category;
    typedef long value_type;
