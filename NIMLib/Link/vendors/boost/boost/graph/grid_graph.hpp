...
namespace nimboost {
  ...
  private:
    typedef nimboost::array<bool, Dimensions> WrapDimensionArray;
    grid_graph() { };
  ...
  public:
    ...
    // descriptors
    typedef nimboost::array<VertexIndex, Dimensions> vertex_descriptor;
  ...
  protected:
    ...
    (vertices_size_type vertex_index) const {
      ...
      nimboost::array<vertices_size_type, Dimensions> vertex;
    ...
    nimboost::array<edges_size_type, Dimensions> m_edge_count;
