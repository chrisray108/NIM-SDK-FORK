...
// comparison.
       ...
       ColorMap color, TerminatorFunc func = TerminatorFunc())
    {
      ...
      typedef std::pair<Vertex, std::pair<nimboost::optional<Edge>, std::pair<Iter, Iter> > > VertexInfo;

      nimboost::optional<Edge> src_e;
      Iter ei, ei_end;
      ...
      if (func(u, g)) {
          ...
          stack.push_back(std::make_pair(u, std::make_pair(nimboost::optional<Edge>(), std::make_pair(ei_end, ei_end))));
      } else {
          stack.push_back(std::make_pair(u, std::make_pair(nimboost::optional<Edge>(), std::make_pair(ei, ei_end))));
      }
      while (!stack.empty()) {
        VertexInfo& back = stack.back();
        u = back.first;
        src_e = back.second.first;
        nimboost::tie(ei, ei_end) = back.second.second;
        stack.pop_back();
        while (ei != ei_end) {
                     ...
                     typename graph_traits<VertexListGraph>::vertex_descriptor start_vertex)
  {
    ...
    for (nimboost::tie(ui, ui_end) = vertices(g); ui != ui_end; ++ui) {
  ...
  depth_first_search(const VertexListGraph& g, DFSVisitor vis, ColorMap color)
  {
    typedef typename nimboost::graph_traits<VertexListGraph>::vertex_iterator vi;
  ...
  public:
    ...
    void discover_vertex(Vertex u, const Graph& g) {
      invoke_visitors(m_vis, u, g, ::nimboost::on_discover_vertex());
    }
    template <class Edge, class Graph>
    void examine_edge(Edge u, const Graph& g) {
      invoke_visitors(m_vis, u, g, ::nimboost::on_examine_edge());
    }
    template <class Edge, class Graph>
    void tree_edge(Edge u, const Graph& g) {
      invoke_visitors(m_vis, u, g, ::nimboost::on_tree_edge());
    }
    template <class Edge, class Graph>
    void back_edge(Edge u, const Graph& g) {
      invoke_visitors(m_vis, u, g, ::nimboost::on_back_edge());
    }
    template <class Edge, class Graph>
    void forward_or_cross_edge(Edge u, const Graph& g) {
      invoke_visitors(m_vis, u, g, ::nimboost::on_forward_or_cross_edge());
    }
    template <class Edge, class Graph>
    void finish_edge(Edge u, const Graph& g) {
      invoke_visitors(m_vis, u, g, ::nimboost::on_finish_edge());
    }
    template <class Vertex, class Graph>
    ...
    namespace detail {
      ...
      struct depth_first_search_impl {
        ...
        void operator()(const Graph& g, const ArgPack& arg_pack) const {
          ...
          nimboost::depth_first_search(g,
                                    arg_pack[_visitor | make_dfs_visitor(null_visitor())],
                                    nimboost::detail::make_color_map_from_arg_pack(g, arg_pack),
                                    arg_pack[_root_vertex || nimboost::detail::get_default_starting_vertex_t<Graph>(g)]);
        }
      };
    }
