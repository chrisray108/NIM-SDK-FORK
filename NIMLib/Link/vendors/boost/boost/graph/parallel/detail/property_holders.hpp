...
namespace nimboost { namespace detail { namespace parallel {
...
class pair_with_property
  : public nimboost::parallel::detail::untracked_pair<T, U>
  , public maybe_store_property<Property>
{
public:
  typedef nimboost::parallel::detail::untracked_pair<T, U>           pair_base;
...
private:
  ...
  void serialize(Archiver& ar, const unsigned int /*version*/) 
  { 
    ar & nimboost::serialization::base_object<pair_base>(*this)
       & nimboost::serialization::base_object<property_base>(*this);
  }
};
...
} } } // end namespace nimboost::parallel::detail

namespace nimboost { namespace mpi {

template<> 
struct is_mpi_datatype<nimboost::detail::parallel::maybe_store_property<no_property> > : mpl::true_ { };

template<typename Property>
struct is_mpi_datatype<nimboost::detail::parallel::maybe_store_property<Property> >
  : is_mpi_datatype<Property> { };

template<typename T, typename U, typename Property>
struct is_mpi_datatype<nimboost::detail::parallel::pair_with_property<T, U, Property> >
  : nimboost::mpl::and_<is_mpi_datatype<nimboost::parallel::detail::untracked_pair<T, U> >,
                     is_mpi_datatype<Property> > { };

} } // end namespace nimboost::mpi

BOOST_IS_BITWISE_SERIALIZABLE(nimboost::detail::parallel::maybe_store_property<no_property>)

namespace nimboost { namespace serialization {

template<typename Property>
struct is_bitwise_serializable<nimboost::detail::parallel::maybe_store_property<Property> >
  : is_bitwise_serializable<Property> { };

template<typename Property>
struct implementation_level<nimboost::detail::parallel::maybe_store_property<Property> >
 : mpl::int_<object_serializable> {} ;

template<typename Property>
struct tracking_level<nimboost::detail::parallel::maybe_store_property<Property> >
 : mpl::int_<track_never> {} ;

template<typename T, typename U, typename Property>
struct is_bitwise_serializable<
        nimboost::detail::parallel::pair_with_property<T, U, Property> >
  : nimboost::mpl::and_<is_bitwise_serializable<nimboost::parallel::detail::untracked_pair<T, U> >,
                     is_bitwise_serializable<Property> > { };
...
} } // end namespace nimboost::serialization
