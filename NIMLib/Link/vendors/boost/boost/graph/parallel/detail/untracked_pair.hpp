...
namespace nimboost { namespace parallel { namespace detail {
...
template<typename T, typename U>
struct is_mpi_datatype<nimboost::parallel::detail::untracked_pair<T, U> >
...
inline void serialize(
    Archive & ar,
    nimboost::parallel::detail::untracked_pair<F, S> & p,
    const unsigned int /* file_version */
){
    ar & nimboost::serialization::make_nvp("first", p.first);
    ar & nimboost::serialization::make_nvp("second", p.second);
}

template<typename T, typename U>
struct is_bitwise_serializable<
        nimboost::parallel::detail::untracked_pair<T, U> >
  : is_bitwise_serializable<std::pair<T, U> > {};

template<typename T, typename U>
struct implementation_level<nimboost::parallel::detail::untracked_pair<T, U> >
 : mpl::int_<object_serializable> {} ;

template<typename T, typename U>
struct tracking_level<nimboost::parallel::detail::untracked_pair<T, U> >
