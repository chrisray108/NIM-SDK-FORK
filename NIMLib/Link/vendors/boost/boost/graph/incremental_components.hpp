...
namespace nimboost {
  ...
  void incremental_components(EdgeListGraph& g, DisjointSets& ds)
  {
    ...
    for (nimboost::tie(e,end) = edges(g); e != end; ++e)
  ...
  template <class ParentIterator>
  typename nimboost::detail::iterator_traits<ParentIterator>::difference_type
  ...
  public:
    ...
    component_index(ParentIterator parent_start,
      ...
      build_index_lists(parent_start, nimboost::identity_property_map());
