         ...
         InEdgeIndex>
{
 ...
 public:
  ...
  typedef nimboost::parallel::variant_distribution<process_group_type, Vertex>
    distribution_type;
  ...
  {
    typename graph_traits<base_type>::vertex_descriptor v 
      = nimboost::add_vertices(count, m_base);
  ...
  { nimboost::add_edges_global(first, last, get(vertex_local, *this), m_base); }
  ...
  { nimboost::add_edges_global(first, last, ep_iter, ep_iter_end, 
                            get(vertex_local, *this), m_base); }

  template <typename InputIterator>
  void 
  add_edges_sorted(InputIterator first, InputIterator last)
  { nimboost::add_edges_sorted_global(first, last, 
                                   get(vertex_local, *this), m_base); }
  ...
  { nimboost::add_edges_sorted_global(first_sorted, last_sorted, ep_iter_sorted, 
                                   get(vertex_local, *this), m_base); }
...
nimboost::transform_iterator<index_to_vertex_func<Distribution, Graph>, IndexIterator>
make_index_to_vertex_iterator(IndexIterator it, const Distribution& dist, 
                              const Graph& g) {
  return nimboost::make_transform_iterator(
...
namespace mpi {
  ...
  struct is_mpi_datatype<nimboost::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
    : mpl::true_ { };
}

namespace serialization {
  template<typename Vertex, typename EdgeIndex>
  struct is_bitwise_serializable<nimboost::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
    : mpl::true_ { };

  template<typename Vertex, typename EdgeIndex>
  struct implementation_level<nimboost::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
   : mpl::int_<object_serializable> {} ;

  template<typename Vertex, typename EdgeIndex>
  struct tracking_level<nimboost::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
