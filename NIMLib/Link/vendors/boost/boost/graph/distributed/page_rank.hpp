               ...
               RankMap2 rank_map2)
{
  ...
  synchronize(nimboost::graph::parallel::process_group(g));
  ...
  rank_map.set_consistency_model(nimboost::parallel::cm_flush | nimboost::parallel::cm_reset);
  rank_map2.set_consistency_model(nimboost::parallel::cm_flush | nimboost::parallel::cm_reset);
                                                        ...
                                                        distributed_graph_tag))
{
  ...
  do {
    ...
    for (nimboost::tie(vi, vi_end) = vertices(g); vi != vi_end; /* in loop */) {
