...
namespace nimboost {
  ...
  namespace detail {
    ...
    serialize(Archiver& ar, edge_desc_impl<Directed, Vertex>& e,
              const unsigned int /*version*/)
    {
      ar & nimboost::serialization::base_object<edge_base<Directed, Vertex> >(e)
  ...
  namespace detail { namespace parallel {
    ...
    struct edge_descriptor
    {
      ...
      public:
        typedef typename nimboost::mpl::if_<is_same<DirectedS, bidirectionalS>,
                                         stored_in_edge<Edge>,
    ...
    private:
      friend class nimboost::serialization::access;
    ...
    struct adjacency_list_config
    {
      ...
      typedef typename nimboost::mpl::if_<is_same<DirectedS, undirectedS>,
      ...
      typedef typename inherited::vertices_size_type vertices_size_type;
          ...
          typedef typename ::nimboost::graph::distributed::select_distribution<
              in_distribution_type, VertexProperty, vertices_size_type, 
              ProcessGroup>::type 
        base_distribution_type;

          typedef ::nimboost::graph::distributed::shuffled_distribution<
    ...
    maybe_initialize_vertex_indices(IteratorPair p,
                                    ::nimboost::detail::error_property_not_found)
    { }
    ...
    public:
      ...
      void serialize(Archiver& ar, const unsigned int /*version*/)
      {
        ar & nimboost::serialization::base_object<inherited_data>(*this) 
           & nimboost::serialization::base_object<inherited_property>(*this);
      }
    };
    ...
    struct get_adj_list_pmap
    {
      ...
      public:
        typedef ::nimboost::parallel::distributed_property_map<
    ...
    struct get_adj_list_pmap<vertex_local_index_t>
    {
      template<typename Graph>
      struct apply
        : ::nimboost::property_map<typename Graph::inherited, vertex_index_t>
      { };
    };
    ...
    remove_in_edge(typename Graph::edge_descriptor e, Graph& g, undirectedS)
    {
      ...
      for (nimboost::tie(ei, ei_end) = out_edges(v.local, bg); ei != ei_end; ++ei)
      {
    ...
    add_local_edge(typename Config::vertex_descriptor u,
                   typename Config::vertex_descriptor v,
                   const typename Config::edge_property_type& p,
                   nimboost::adj_list_impl<Graph, Config, Base>& g)
    {
      return add_edge(u, v, p, g);
    }
      ...
      : public detail::parallel::maybe_store_property<EdgeProperty>
    {
      ...
      void serialize(Archiver& ar, const unsigned int /*version*/)
      {
        ar & nimboost::serialization::base_object<inherited>(*this) & e;
      }
    };
  ...
  public:
    ...
    typedef typename nimboost::mpl::if_<typename DirectedS::is_bidir_t,
      bidirectional_tag,
      typename nimboost::mpl::if_<typename DirectedS::is_directed_t,
...
//    typedef typename inherited::edge_descriptor   edge_descriptor;
    ...
    typedef typename nimboost::mpl::if_<
              ...
              typename nimboost::mpl::if_<is_same<DirectedS, bidirectionalS>,
  ...
  public:
    ...
    typedef nimboost::adjacency_iterator<
  ...
  public:
    ...
    nimboost::function<void(vertex_descriptor, adjacency_list&)> on_add_vertex;

    // Callback that will be invoked whenever a new edge is added locally
    nimboost::function<void(edge_descriptor, adjacency_list&)> on_add_edge;
  ...
  public:
    ...
    typedef  nimboost::detail::parallel::msg_nonlocal_edge_data<
      edge_property_type,local_edge_descriptor> msg_nonlocal_edge_data;

    typedef nimboost::detail::parallel::msg_remove_edge_data<edge_descriptor>
      msg_remove_edge_data;
    ...
    nimboost::parallel::detail::untracked_pair<edge_descriptor, bool>
  ...
  protected:
                    ...
                    processor_id_type other_proc, bidirectionalS)
    {
      ...
      nimboost::graph_detail::push(get(vertex_in_edges, base())[v], edge);
    }
                      ...
                      processor_id_type other_proc, bidirectionalS)
    {
      ...
      if (src.owner == process_id(process_group_)) {
        ...
        for (nimboost::tie(ei, ei_end) = out_edges(src.local, base());
             ei != ei_end; ++ei) {
        ...
        if (ei != ei_end) nimboost::remove_edge(ei, base());
                      ...
                      processor_id_type other_proc, undirectedS)
    {
      ...
      {
        base_out_edge_iterator ei, ei_end;
        for (nimboost::tie(ei, ei_end) = out_edges(local_vertex.local, base());
             ei != ei_end; ++ei) {
          // TBD: can't check the descriptor here, because it could
          // have changed if we're allowing the removal of
          // edges. Egads!
  ...
  PBGL_DISTRIB_ADJLIST_TYPE::lazy_add_edge::commit() const
  {
    ...
    if (source.owner == self.processor())
      ...
      nimboost::parallel::detail::untracked_pair<edge_descriptor, bool> result;
  ...
  add_local_edge(const edge_property_type& property, bidirectionalS) const
  {
    ...
    if (result.second) {
      if (target.owner == self.processor()) {
        ...
        nimboost::graph_detail::push(get(vertex_in_edges, 
       ...
       const PBGL_DISTRIB_ADJLIST_TYPE_CONFIG(directedS)& g)
  {
    ...
    for (nimboost::tie(ei, ei_end) = out_edges(u, g); ei != ei_end; ++ei) {
       ...
       const PBGL_DISTRIB_ADJLIST_TYPE& g)
  {
    ...
    if (u.owner == process_id(g.process_group())) {
      ...
      for (nimboost::tie(ei, ei_end) = in_edges(v, g); ei != ei_end; ++ei) {
      ...
      bool operator()(const argument_type& le)
      {
        ...
        if (predicate(e)) {
          if (source(e, g).owner != target(e, g).owner
            ...
            ::nimboost::detail::parallel::remove_in_edge(e, g,
                                                      directed_selector());
      ...
      bool operator()(const argument_type& e)
      {
        if (predicate(e)) {
          if (source(e, g).owner != target(e, g).owner)
            g.send_remove_edge_request(e);
          if (target(e, g).owner == g.processor())
            ::nimboost::detail::parallel::remove_in_edge(e, g, undirectedS());
          if (source(e, g).owner == g.processor())
            remove_edge(e.local, g.base());
          return true;
        } else return false;
                ...
                PBGL_DISTRIB_ADJLIST_TYPE& g)
  {
    ...
    static_cast<named_graph_mixin&>(static_cast<graph_type&>(g))
      .removing_vertex(u, nimboost::graph_detail::iterator_stability(g.base().m_vertices));
  ...
  struct property_map<PBGL_DISTRIB_ADJLIST_TYPE const, Property>
          : nimboost::detail::parallel::get_adj_list_pmap<Property>
// FIXME: in the original code the following was not const
  ...
  namespace mpi {
    ...
    struct is_mpi_datatype<nimboost::detail::edge_base<Directed, Vertex> >
      : is_mpi_datatype<Vertex> { };

    template<typename Directed, typename Vertex>
    struct is_mpi_datatype<nimboost::detail::edge_desc_impl<Directed, Vertex> >
      : is_mpi_datatype<nimboost::detail::edge_base<Directed, Vertex> > { };

    template<typename LocalDescriptor>
    struct is_mpi_datatype<nimboost::detail::parallel::global_descriptor<LocalDescriptor> >
      : is_mpi_datatype<LocalDescriptor> { };

    template<typename Edge>
    struct is_mpi_datatype<nimboost::detail::parallel::edge_descriptor<Edge> >
      : is_mpi_datatype<Edge> { };

    template<typename Vertex, typename LocalVertex>
    struct is_mpi_datatype<nimboost::detail::parallel::
                             msg_add_edge_data<Vertex, LocalVertex> >
      : is_mpi_datatype<Vertex> { };
   ...
   struct is_mpi_datatype<nimboost::detail::parallel::msg_nonlocal_edge_data<
                          EdgeProperty,EdgeDescriptor> >
           : mpl::and_<
               is_mpi_datatype<nimboost::detail::parallel::maybe_store_property<
                           EdgeProperty> >,
  ...
  {};
   ...
   struct is_mpi_datatype<
            nimboost::detail::parallel::msg_remove_edge_data<EdgeDescriptor> >
           : is_mpi_datatype<EdgeDescriptor> {};
  }
  ...
  namespace serialization {
    template<typename Directed, typename Vertex>
    struct is_bitwise_serializable<nimboost::detail::edge_base<Directed, Vertex> >
      : is_bitwise_serializable<Vertex> { };

    template<typename Directed, typename Vertex>
    struct is_bitwise_serializable<nimboost::detail::edge_desc_impl<Directed, Vertex> >
      : is_bitwise_serializable<nimboost::detail::edge_base<Directed, Vertex> > { };

    template<typename LocalDescriptor>
    struct is_bitwise_serializable<nimboost::detail::parallel::global_descriptor<LocalDescriptor> >
      : is_bitwise_serializable<LocalDescriptor> { };

    template<typename Edge>
    struct is_bitwise_serializable<nimboost::detail::parallel::edge_descriptor<Edge> >
      : is_bitwise_serializable<Edge> { };

    template<typename Vertex, typename LocalVertex>
    struct is_bitwise_serializable<nimboost::detail::parallel::
                             msg_add_edge_data<Vertex, LocalVertex> >
      : is_bitwise_serializable<Vertex> { };
   ...
   template<typename EdgeProperty, typename EdgeDescriptor>
   struct is_bitwise_serializable<nimboost::detail::parallel::msg_nonlocal_edge_data<
                                  EdgeProperty,EdgeDescriptor> >
           : mpl::and_<
               is_bitwise_serializable<
                nimboost::detail::parallel::maybe_store_property<EdgeProperty> >,
  ...
  {};
   ...
   struct is_bitwise_serializable<
    ...
    template<typename Directed, typename Vertex>
    struct implementation_level<nimboost::detail::edge_base<Directed, Vertex> >
      : mpl::int_<object_serializable> {};

    template<typename Directed, typename Vertex>
    struct implementation_level<nimboost::detail::edge_desc_impl<Directed, Vertex> >
      : mpl::int_<object_serializable> {};

    template<typename LocalDescriptor>
    struct implementation_level<nimboost::detail::parallel::global_descriptor<LocalDescriptor> >
      : mpl::int_<object_serializable> {};

    template<typename Edge>
    struct implementation_level<nimboost::detail::parallel::edge_descriptor<Edge> >
      : mpl::int_<object_serializable> {};

    template<typename Vertex, typename LocalVertex>
    struct implementation_level<nimboost::detail::parallel::
                             msg_add_edge_data<Vertex, LocalVertex> >
      : mpl::int_<object_serializable> {};
   ...
   template<typename EdgeProperty, typename EdgeDescriptor>
   struct implementation_level<nimboost::detail::parallel::msg_nonlocal_edge_data<
                               EdgeProperty,EdgeDescriptor> >
           : mpl::int_<object_serializable> {};
   ...
   struct implementation_level<
    ...
    template<typename Directed, typename Vertex>
    struct tracking_level<nimboost::detail::edge_base<Directed, Vertex> >
      : mpl::int_<track_never> {};

    template<typename Directed, typename Vertex>
    struct tracking_level<nimboost::detail::edge_desc_impl<Directed, Vertex> >
      : mpl::int_<track_never> {};

    template<typename LocalDescriptor>
    struct tracking_level<nimboost::detail::parallel::global_descriptor<LocalDescriptor> >
      : mpl::int_<track_never> {};

    template<typename Edge>
    struct tracking_level<nimboost::detail::parallel::edge_descriptor<Edge> >
      : mpl::int_<track_never> {};

    template<typename Vertex, typename LocalVertex>
    struct tracking_level<nimboost::detail::parallel::
                             msg_add_edge_data<Vertex, LocalVertex> >
      : mpl::int_<track_never> {};
   ...
   template<typename EdgeProperty, typename EdgeDescriptor>
   struct tracking_level<nimboost::detail::parallel::msg_nonlocal_edge_data<
                         EdgeProperty,EdgeDescriptor> >
           : mpl::int_<track_never> {};
