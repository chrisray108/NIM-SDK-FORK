...
namespace nimboost {
  ...
  namespace serialization {
    ...
    void serialize(Archive & ar,
                   nimboost::tuple<T1,T2,T3, T4>& t,
                   const unsigned int)
    {
      ar & nimboost::tuples::get<0>(t);
      ar & nimboost::tuples::get<1>(t);
      ar & nimboost::tuples::get<2>(t);
      ar & nimboost::tuples::get<3>(t);
    }
  ...
  public:
    ...
    owner_type get_owner(Tuple t) { return get(owner, nimboost::tuples::get<0>(t)); }
  ...
  class betweenness_centrality_delta_stepping_impl { 
    ...
    typedef typename nimboost::graph::parallel::process_group_type<Graph>::type 
      ProcessGroup;
  ...
  private:
    ...
    void synchronize()
    {
      using nimboost::graph::parallel::synchronize;
      synchronize(pg);
    }
    ...
    void setup_triggers()
    {
      using nimboost::graph::parallel::simple_trigger;
...
#endif
      delta(delta),
      pg(nimboost::graph::parallel::process_group_adl(g), attach_distributed_object()),
  ...
  run(Vertex s)
  {
    ...
    do {
      ...
      using nimboost::parallel::all_reduce;
      using nimboost::parallel::minimum;
      ...
      typedef nimboost::queue<queue_value_type> local_queue_type;
      typedef nimboost::graph::distributed::distributed_queue<process_group_type,
                                                           IndirectOwnerMap,
  ...
  private:
    ...
    {
      using nimboost::parallel::all_reduce;
      using nimboost::parallel::maximum;
      using std::max;
  ...
  do_brandes_sssp(const Graph& g, 
                  ...
                  typename graph_traits<Graph>::vertex_descriptor s)
  {
    using nimboost::detail::graph::update_centrality;      
    using nimboost::graph::parallel::process_group;
    ...
    typedef nimboost::tuple<vertex_descriptor, vertex_descriptor, dependency_type, path_count_type>
      queue_value_type;
    ...
    dependency_count.set_reduce(nimboost::graph::distributed::additive_reducer<dependency_type>());
    ...
    BGL_FORALL_VERTICES_T(v, g, Graph) {
      if (get(distance, v) < (std::numeric_limits<distance_type>::max)()
        ...
        Q.push(nimboost::make_tuple(v, v, get(dependency, v), get(path_count, v)));
    }
    ...
    while(!Q.empty()) {
      ...
      vertex_descriptor w = nimboost::tuples::get<0>(x);
      vertex_descriptor source = nimboost::tuples::get<1>(x);
      dependency_type dep = nimboost::tuples::get<2>(x);
      path_count_type pc = nimboost::tuples::get<3>(x);
      ...
      if (get(dependency_count, w) == 0) { 
        ...
        for (incoming_iterator vw = el.begin(); vw != el.end(); ++vw)
          Q.push(nimboost::make_tuple(*vw, w, get(dependency, w), get(path_count, w)));
      }
    }
  }
  ...
  brandes_betweenness_centrality_impl(const Graph& g, 
                                      ...
                                      Buffer sources)
  {
    using nimboost::detail::graph::init_centrality_map;
    using nimboost::detail::graph::divide_centrality_by_two;       
    using nimboost::graph::parallel::process_group;
    ...
    dependency.set_reduce(nimboost::graph::distributed::additive_reducer<dependency_type>()); 
    distance.set_reduce(nimboost::graph::distributed::choose_min_reducer<distance_type>());
    ...
    if (!sources.empty()) {
      ...
      n = nimboost::parallel::all_reduce(pg, n, std::plus<vertices_size_type>());
...
namespace graph { namespace parallel { namespace detail {
  ...
  struct brandes_betweenness_centrality_dispatch1
  {
    ...
    {
      nimboost::graph::parallel::detail::brandes_betweenness_centrality_dispatch2(
       g, centrality, edge_centrality_map, weight_map, vertex_index, sources, delta);
    }
  };

  template<>
  struct brandes_betweenness_centrality_dispatch1<nimboost::param_not_found> 
  {
    template<typename Graph, typename CentralityMap, typename EdgeCentralityMap, 
             typename VertexIndexMap, typename Buffer>
    static void 
                               ...
                               BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  graph::parallel::detail::brandes_betweenness_centrality_dispatch1<ew>::run(
    ...
    choose_param(get_param(params, buffer_param_t()), nimboost::ref(q)),
                               ...
                               BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  nimboost::graph::parallel::detail::brandes_betweenness_centrality_dispatch2(
    g, centrality, dummy_property_map(), get(vertex_index, g), nimboost::ref(q), 0);
}
                               ...
                               BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  nimboost::graph::parallel::detail::brandes_betweenness_centrality_dispatch2(
    g, centrality, edge_centrality_map, get(vertex_index, g), nimboost::ref(q), 0);
}
                                               ...
                                               CentralityMap centrality)
{
  ...
  detail::graph::non_distributed_brandes_betweenness_centrality_dispatch2(
    pg, g, centrality, dummy_property_map(), get(vertex_index, g), nimboost::ref(q));
}
                        ...
                        BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  typedef typename nimboost::graph::parallel::process_group_type<Graph>::type 
    process_group_type;
  process_group_type pg = nimboost::graph::parallel::process_group(g);
  ...
  for (nimboost::tie(v, v_end) = vertices(g); v != v_end; ++v) {
    max_centrality = (max)(max_centrality, get(centrality, *v));
  }

  // All reduce to get global max centrality
  max_centrality = all_reduce(pg, max_centrality, nimboost::parallel::maximum<centrality_type>());
