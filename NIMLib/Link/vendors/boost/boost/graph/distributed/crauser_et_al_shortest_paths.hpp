...
namespace detail {
  ...
  class crauser_et_al_dijkstra_queue
    : public graph::detail::remote_update_set<
               ...
               typename nimboost::graph::parallel::process_group_type<Graph>::type,
  ...
  public:
    ...
    crauser_et_al_dijkstra_queue(const Graph& g,
      ...
      : inherited(nimboost::graph::parallel::process_group(g), get(vertex_owner, g)),
   ...
   DijkstraVisitor vis)
{
  ...
  ::nimboost::detail::dijkstra_bfs_visitor<
      DijkstraVisitor, Queue, WeightMap,
      nimboost::parallel::caching_property_map<PredecessorMap>,
      nimboost::parallel::caching_property_map<DistanceMap>, Combine, Compare
    > bfs_vis(vis, Q, weight,
              nimboost::parallel::make_caching_property_map(predecessor),
              nimboost::parallel::make_caching_property_map(distance),
