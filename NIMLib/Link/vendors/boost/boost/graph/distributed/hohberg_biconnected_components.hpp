...
{
  using namespace nimboost::graph::parallel;
  using namespace hohberg_detail;
  ...
  do {
    ...
    minimum_phase = all_reduce(pg, minimum_phase, nimboost::mpi::minimum<char>());
    ...
    if (minimum_phase == 4
        && all_reduce(pg, maximum_phase, nimboost::mpi::maximum<char>()) == 4) {
