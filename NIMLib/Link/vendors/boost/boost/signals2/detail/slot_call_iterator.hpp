  ...
  namespace signals2 {
    namespace detail {
      ...
      class slot_call_iterator_t
        : public nimboost::iterator_facade<slot_call_iterator_t<Function, Iterator, ConnectionBody>,
        typename Function::result_type,
        nimboost::single_pass_traversal_tag,
        typename Function::result_type const&>
      {
        typedef nimboost::iterator_facade<slot_call_iterator_t<Function, Iterator, ConnectionBody>,
          typename Function::result_type,
          nimboost::single_pass_traversal_tag,
          typename Function::result_type const&>
        inherited;
