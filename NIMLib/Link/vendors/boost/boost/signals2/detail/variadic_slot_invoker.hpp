/*
  Helper class used by variadic implementation of variadic nimboost::signals2::signal.
...
// if compiler has std::tuple use it instead of nimboost::tuple
// because nimboost::tuple does not have variadic template support at present.
#ifdef BOOST_NO_CXX11_HDR_TUPLE
#include <boost/tuple/tuple.hpp>
#define BOOST_SIGNALS2_TUPLE nimboost::tuple
#define BOOST_SIGNALS2_GET nimboost::get
#else
#include <tuple>
