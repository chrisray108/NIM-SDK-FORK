...
namespace nimboost
{
  ...
  namespace signals2
  {
    ...
    {};
    template<typename T> struct weak_ptr_traits<nimboost::weak_ptr<T> >
    {
      typedef nimboost::shared_ptr<T> shared_type;
    };
#ifndef BOOST_NO_CXX11_SMART_PTR
    ...
    template<typename T> struct shared_ptr_traits<nimboost::shared_ptr<T> >
    {
      typedef nimboost::weak_ptr<T> weak_type;
    };
#ifndef BOOST_NO_CXX11_SMART_PTR
    ...
    namespace detail
    {
      ...
      private:
        nimboost::scoped_ptr<foreign_weak_ptr_impl_base> _p;
      };
    } // namespace detail
