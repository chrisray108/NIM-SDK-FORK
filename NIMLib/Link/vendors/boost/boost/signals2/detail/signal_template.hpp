...
// signalN::slot_function
      ...
      private:
        ...
        nimboost::shared_ptr<connection> _connection;
      };
    ...
    namespace detail
    {
      ...
      public:
        ...
        result_type operator ()(BOOST_SIGNALS2_SIGNATURE_FULL_ARGS(BOOST_SIGNALS2_NUM_ARGS))
        {
          ...
          if(shared_pimpl == 0) nimboost::throw_exception(expired_slot());
      ...
      private:
        nimboost::weak_ptr<detail::BOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(BOOST_SIGNALS2_NUM_ARGS)
...
// const nimboost::signals2::connection &,
...
#define BOOST_SIGNALS2_EXT_SIGNATURE(arity, Signature) \
  typename function_traits<Signature>::result_type ( \
  const nimboost::signals2::connection & BOOST_SIGNALS2_PP_COMMA_IF(BOOST_SIGNALS2_NUM_ARGS) \
