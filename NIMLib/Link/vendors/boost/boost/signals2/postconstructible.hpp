...
// The objects must inherit from nimboost::signals2::postconstructible, and
// have their lifetimes managed by
// nimboost::shared_ptr created with the nimboost::signals2::deconstruct_ptr()
// function.
//
...
namespace nimboost
{
  ...
  namespace signals2
  {
    ...
    namespace detail
    {
      void do_postconstruct(const nimboost::signals2::postconstructible_adl_barrier::postconstructible *ptr);
    } // namespace detail
