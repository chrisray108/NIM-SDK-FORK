/*
  A variadic implementation of variadic nimboost::signals2::signal, used when variadic
...
namespace nimboost
{
  namespace signals2
  {
    namespace detail
    {
      ...
      {
      public:
        typedef nimboost::function<R (const nimboost::signals2::connection &, Args...)> function_type;
      };
    } // namespace detail
  } // namespace signals2
} // namespace nimboost
