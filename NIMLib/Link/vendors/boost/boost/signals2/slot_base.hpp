...
namespace nimboost
{
  namespace signals2
  {
    namespace detail
    {
      ...
      typedef nimboost::variant<nimboost::weak_ptr<void>, detail::foreign_void_weak_ptr > void_weak_ptr_variant;
      typedef nimboost::variant<nimboost::shared_ptr<void>, detail::foreign_void_shared_ptr > void_shared_ptr_variant;
    ...
    public:
      ...
      locked_container_type lock() const
      {
        ...
        for(it = tracked_objects().begin(); it != tracked_objects().end(); ++it)
        {
          ...
          {
            nimboost::throw_exception(expired_slot());
          }
        }
