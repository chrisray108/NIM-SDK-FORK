/*
  ...
  the nimboost::signals2::signal class.
...
#ifdef BOOST_SIGNALS2_NAMED_SIGNATURE_PARAMETER
          parameter::required<keywords::tag::signature_type, is_function<nimboost::mpl::_> >,
#endif
    ...
    public:
      ...
      typedef typename parameter::value_type
        <
          ...
          optional_last_value
            <
              typename nimboost::function_traits<signature_type>::result_type
            >
        >::type combiner_type;
