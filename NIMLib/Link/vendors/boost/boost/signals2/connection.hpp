/*
  nimboost::signals2::connection provides a handle to a signal/slot connection.
...
namespace nimboost
{
  namespace signals2
  {
    ...
    public:
      ...
      {}
      connection(const nimboost::weak_ptr<detail::connection_body_base> &connectionBody):
        _weak_connection_body(connectionBody)
      {}
      ~connection() {}
      void disconnect() const
      {
        nimboost::shared_ptr<detail::connection_body_base> connectionBody(_weak_connection_body.lock());
      ...
      {
        nimboost::shared_ptr<detail::connection_body_base> connectionBody(_weak_connection_body.lock());
        nimboost::shared_ptr<detail::connection_body_base> otherConnectionBody(other._weak_connection_body.lock());
    ...
    protected:
      ...
      nimboost::weak_ptr<detail::connection_body_base> _weak_connection_body;
    };
