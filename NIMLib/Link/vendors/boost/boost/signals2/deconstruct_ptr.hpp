...
// and predestructors through the nimboost::signals2::postconstructible and
// nimboost::signals2::predestructible base classes.
//
...
namespace nimboost
{
  namespace signals2
  {
    ...
    shared_ptr<T> deconstruct_ptr(T *ptr)
    {
      ...
      shared_ptr<T> shared(ptr, nimboost::signals2::predestructing_deleter<T>());
