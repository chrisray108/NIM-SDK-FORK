...
struct make_map<T0, T...>
{
    typedef typename ::nimboost::mpl::insert<
        typename ::nimboost::type_erasure::detail::make_map<T...>::type,
        T0
    >::type type;
};
...
struct make_map<>
{
    typedef ::nimboost::mpl::map0<> type;
};
...
class tuple_iterator :
    public ::nimboost::fusion::iterator_facade<
        tuple_iterator<Tuple, N>,
        ::nimboost::fusion::random_access_traversal_tag
    >
{
public:
    typedef ::nimboost::mpl::int_<N> index;
    ...
    template<class It>
    struct next : advance<It, ::nimboost::mpl::int_<1> > {};
    template<class It>
    struct prior : advance<It, ::nimboost::mpl::int_<-1> > {};
    template<class It1, class It2>
    struct distance
    {
        typedef typename ::nimboost::mpl::minus<
            typename It2::index,
            typename It1::index
        >::type type;
...
template<class Concept, class... T>
class tuple :
    public ::nimboost::fusion::sequence_facade<
        ::nimboost::type_erasure::tuple<Concept, T...>,
        ::nimboost::fusion::forward_traversal_tag
    >
{
public:
    template<class... U>
    explicit tuple(U&&... args)
      : impl(
            ::nimboost::type_erasure::make_binding<
                typename ::nimboost::type_erasure::detail::make_map<
                    ::nimboost::mpl::pair<
    ...
    struct begin
    {
        typedef ::nimboost::type_erasure::tuple_iterator<
            Seq,
            0
        > type;
    ...
    struct size
    {
        typedef ::nimboost::mpl::int_<sizeof...(T)> type;
        static type call(Seq& seq) { return type(); }
    };
    template<class Seq>
    struct empty
    {
        typedef ::nimboost::mpl::bool_<sizeof...(T) == 0> type;
        static type call(Seq& seq) { return type(); }
    };
    template<class Seq, class N>
    struct at
    {
        typedef typename ::nimboost::type_erasure::detail::cons_advance<
            N::value,
            ::nimboost::type_erasure::cons<Concept, T...>
        >::type::value_type value_type;
        typedef typename ::nimboost::mpl::if_< ::nimboost::is_const<Seq>,
            const value_type&,
            value_type&
        >::type type;
        static type call(Seq& seq)
        {
            return const_cast<type>(
                ::nimboost::type_erasure::detail::cons_advance<
                    N::value,
                    ::nimboost::type_erasure::cons<Concept, T...>
                >::call(seq.impl).value
            );
    ...
    ::nimboost::type_erasure::cons<Concept, T...> impl;
};

template<int N, class Concept, class... T>
typename ::nimboost::type_erasure::detail::cons_advance<
    N,
    ::nimboost::type_erasure::cons<Concept, T...>
>::type::value_type& get(::nimboost::type_erasure::tuple<Concept, T...>& t)
{
    return const_cast<
        typename ::nimboost::type_erasure::detail::cons_advance<
            N,
        ...
        >::type::value_type&
    >(
        ::nimboost::type_erasure::detail::cons_advance<N,
            ::nimboost::type_erasure::cons<Concept, T...>
        >::call(t.impl).value
    );
}
...
template<int N, class Concept, class... T>
const typename ::nimboost::type_erasure::detail::cons_advance<
    N,
    ::nimboost::type_erasure::cons<Concept, T...>
>::type::value_type& get(const ::nimboost::type_erasure::tuple<Concept, T...>& t)
{
    return ::nimboost::type_erasure::detail::cons_advance<
        N,
        ::nimboost::type_erasure::cons<Concept, T...>
    >::call(t.impl).value;
}
...
template<class Concept,
    BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(
        BOOST_TYPE_ERASURE_MAX_TUPLE_SIZE, class T, ::nimboost::type_erasure::na)>
...
public:
    ...
    struct value_of
    {
        typedef typename ::nimboost::type_erasure::detail::get_impl<
            It::index::value,
            Tuple
        >::value_type type;
    };
    template<class It>
    struct deref :
        ::nimboost::type_erasure::detail::get_impl<It::index::value, Tuple>
    {
        typedef typename ::nimboost::type_erasure::detail::get_impl<
            It::index::value,
            Tuple
        ...
        static type call(It it)
        {
            return ::nimboost::type_erasure::detail::get_impl<
                It::index::value,
                Tuple
            >::call(*it.t);
        }
...
struct tuple_base :
    ::nimboost::fusion::sequence_facade<
        Derived,
        ::nimboost::fusion::random_access_traversal_tag
    >
{
    ...
    struct begin
    {
        typedef ::nimboost::type_erasure::tuple_iterator<Seq, 0> type;
        static type call(Seq& seq) { return type(seq); }
    };
    template<class Seq>
    struct end
    ...
    struct empty
    {
        typedef typename nimboost::mpl::equal_to<
    ...
    template<class Seq, class N>
    struct at : ::nimboost::type_erasure::detail::get_impl<N::value, Seq> {};
    template<class Seq, class N>
    struct value_at
    {
        typedef typename ::nimboost::type_erasure::detail::get_impl<
...
#define BOOST_TYPE_ERASURE_TAG_TYPEDEF(z, n, data)                          \
    ...
    typedef typename ::nimboost::remove_reference<BOOST_PP_CAT(T, n)>::type    \
        BOOST_PP_CAT(tag, n);

#define BOOST_TYPE_ERASURE_PAIR(z, n, data) \
    ::nimboost::mpl::pair<BOOST_PP_CAT(tag, n), BOOST_PP_CAT(U, n)>
...
#define BOOST_TYPE_ERASURE_TUPLE_MEMBER(z, n, data)\
    ::nimboost::type_erasure::any<Concept, BOOST_PP_CAT(T, n)> BOOST_PP_CAT(t, n);
...
public:
    typedef ::nimboost::mpl::int_<N> tuple_size;
#if N
...
private:
    ...
    friend struct ::nimboost::type_erasure::detail::get_impl;
    ::nimboost::type_erasure::detail::tuple_storage<
        Concept
