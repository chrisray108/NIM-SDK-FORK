...
struct is_placeholder_arg :
    ::nimboost::type_erasure::is_placeholder<
        typename ::nimboost::remove_cv<
            typename ::nimboost::remove_reference<T>::type
        >::type
    >
{};

template<class T, class Table>
int maybe_get_table(const T& arg, const Table*& table, nimboost::mpl::true_)
{
    if(table == 0) {
        table = &::nimboost::type_erasure::detail::access::table(arg);
    }
    return 0;
}

template<class T, class Table>
int maybe_get_table(const T&, const Table*&, nimboost::mpl::false_) { return 0; }

template<class T>
::nimboost::type_erasure::detail::storage& convert_arg(any_base<T>& arg, nimboost::mpl::true_)
{
    return ::nimboost::type_erasure::detail::access::data(arg);
}

template<class Concept, class T>
const ::nimboost::type_erasure::detail::storage&
convert_arg(any_base<any<Concept, const T&> >& arg, nimboost::mpl::true_)
{
    return ::nimboost::type_erasure::detail::access::data(arg);
}
...
template<class T>
const ::nimboost::type_erasure::detail::storage&
convert_arg(const any_base<T>& arg, nimboost::mpl::true_)
{
    return ::nimboost::type_erasure::detail::access::data(arg);
}

template<class Concept, class T>
::nimboost::type_erasure::detail::storage&
convert_arg(const any_base<any<Concept, T&> >& arg, nimboost::mpl::true_)
{
    return ::nimboost::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
const ::nimboost::type_erasure::detail::storage&
convert_arg(const any_base<any<Concept, const T&> >& arg, nimboost::mpl::true_)
{
    return ::nimboost::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
::nimboost::type_erasure::detail::storage&
convert_arg(param<Concept, T>& arg, nimboost::mpl::true_)
{
    return ::nimboost::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
const ::nimboost::type_erasure::detail::storage&
convert_arg(param<Concept, const T&>& arg, nimboost::mpl::true_)
{
    return ::nimboost::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
const ::nimboost::type_erasure::detail::storage&
convert_arg(const param<Concept, T>& arg, nimboost::mpl::true_)
{
    return ::nimboost::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
::nimboost::type_erasure::detail::storage&
convert_arg(any_base<any<Concept, T&> >&& arg, nimboost::mpl::true_)
{
    return ::nimboost::type_erasure::detail::access::data(arg);
}
...
convert_arg(any_base<any<Concept, T> >&& arg, nimboost::mpl::true_)
{
    return ::nimboost::type_erasure::detail::access::data(std::move(arg));
}
...
template<class T>
T&& convert_arg(T&& arg, nimboost::mpl::false_) { return std::forward<T>(arg); }

#else

template<class T>
T& convert_arg(T& arg, nimboost::mpl::false_) { return arg; }
...
typename ::nimboost::type_erasure::detail::call_impl<Sig, U..., Concept>::type
...
typename ::nimboost::type_erasure::detail::call_impl<Sig, U...>::type
...
template<class Sig, class Args, class Concept = void,
    bool Check = ::nimboost::type_erasure::detail::check_call<Sig, Args>::type::value>
struct call_impl {};

template<class Op, class Args, class Concept = void>
struct call_result :
    call_impl<
        typename ::nimboost::type_erasure::detail::get_signature<Op>::type,
        Args,
        Concept>
{};
...
struct call_result<
    ::nimboost::type_erasure::binding<C1>,
    Args,
    Concept
>
{};
...
const ::nimboost::type_erasure::binding<
    typename ::nimboost::type_erasure::detail::extract_concept<void(T...), U...>::type>*
extract_table(R(*)(T...), const U&... arg)
{
    const ::nimboost::type_erasure::binding<
        typename ::nimboost::type_erasure::detail::extract_concept<
            void(T...), U...>::type>* result = 0;

    // the order that we run maybe_get_table in doesn't matter
    ignore(::nimboost::type_erasure::detail::maybe_get_table(
        arg,
        result,
        ::nimboost::type_erasure::detail::is_placeholder_arg<T>())...);
...
struct call_impl_dispatch<R(T...), void(U...), Concept, false>
{
    typedef R type;
    template<class F>
    static R apply(const ::nimboost::type_erasure::binding<Concept>* table, U... arg)
    {
        return table->template find<F>()(
            ::nimboost::type_erasure::detail::convert_arg(
                ::std::forward<U>(arg),
                ::nimboost::type_erasure::detail::is_placeholder_arg<T>())...);
    }
};
...
{
    typedef ::nimboost::type_erasure::any<Concept, R> type;
    template<class F>
    static type apply(const ::nimboost::type_erasure::binding<Concept>* table, U... arg)
    {
        return type(table->template find<F>()(
            ::nimboost::type_erasure::detail::convert_arg(
                ::std::forward<U>(arg),
                ::nimboost::type_erasure::detail::is_placeholder_arg<T>())...), *table);
    }
};

template<class R, class... T, class... U, class Concept>
struct call_impl<R(T...), void(U...), Concept, true> :
    ::nimboost::type_erasure::detail::call_impl_dispatch<
        R(T...),
        void(U...),
        Concept,
        ::nimboost::type_erasure::detail::is_placeholder_arg<R>::value
    >
{
};
...
struct call_impl<R(T...), void(U...), void, true> :
    ::nimboost::type_erasure::detail::call_impl_dispatch<
        ...
        typename ::nimboost::type_erasure::detail::extract_concept<
            void(T...),
            typename ::nimboost::remove_reference<U>::type...
        >::type,
        ::nimboost::type_erasure::detail::is_placeholder_arg<R>::value
    >
{
...
template<
    ...
    class... U
>
typename ::nimboost::type_erasure::detail::call_result<
    Op,
    void(U&&...),
    Concept
>::type
unchecked_call(
    const ::nimboost::type_erasure::binding<Concept>& table,
    const Op&,
    U&&... arg)
{
    return ::nimboost::type_erasure::detail::call_impl<
        typename ::nimboost::type_erasure::detail::get_signature<Op>::type,
        void(U&&...),
        Concept
    >::template apply<
        typename ::nimboost::type_erasure::detail::adapt_to_vtable<Op>::type
...
call(
    ...
    U&&... arg)
{
    ::nimboost::type_erasure::require_match(table, f, std::forward<U>(arg)...);
    return ::nimboost::type_erasure::unchecked_call(table, f, std::forward<U>(arg)...);
}
    ...
    U&&... arg)
{
    ...
    >::template apply<
        typename ::nimboost::type_erasure::detail::adapt_to_vtable<Op>::type
    >(::nimboost::type_erasure::detail::extract_table(
        static_cast<typename ::nimboost::type_erasure::detail::get_signature<Op>::type*>(0), arg...),
        std::forward<U>(arg)...);
}
...
call(
    ...
    U&&... arg)
{
    ::nimboost::type_erasure::require_match(f, std::forward<U>(arg)...);
    return ::nimboost::type_erasure::unchecked_call(f, std::forward<U>(arg)...);
}
...
#define BOOST_TYPE_ERASURE_CONVERT_ARG(z, n, data)                      \
    ::nimboost::type_erasure::detail::convert_arg(                         \
        ...
        ::nimboost::type_erasure::detail::is_placeholder_arg<BOOST_PP_CAT(T, n)>())
...
#define BOOST_TYPE_ERASURE_GET_TABLE(z, n, data)                        \
    ::nimboost::type_erasure::detail::maybe_get_table(                     \
        BOOST_PP_CAT(arg, n),                                           \
        result,                                                         \
        ::nimboost::type_erasure::detail::is_placeholder_arg<BOOST_PP_CAT(T, n)>());
...
const ::nimboost::type_erasure::binding<
    typename ::nimboost::type_erasure::detail::BOOST_PP_CAT(extract_concept, N)<
...
#endif
    ,
    bool ReturnsAny = ::nimboost::type_erasure::detail::is_placeholder_arg<R>::value>
...
>
{
    typedef R type;
    template<class F>
    static R apply(const ::nimboost::type_erasure::binding<Concept>* table
...
>
{
    typedef ::nimboost::type_erasure::any<Concept, R> type;
    template<class F>
    static type apply(const ::nimboost::type_erasure::binding<Concept>* table
        BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, arg))
    {
        return type(table->template find<F>()(
...
call(
    ...
    BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
    ::nimboost::type_erasure::require_match(table, f BOOST_TYPE_ERASURE_FORWARD_ARGS(N, U, arg));
    return ::nimboost::type_erasure::unchecked_call(table, f BOOST_TYPE_ERASURE_FORWARD_ARGS(N, U, arg));
}
    ...
    BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
    ...
    >::template apply<
        typename ::nimboost::type_erasure::detail::adapt_to_vtable<Op>::type
    >(
        ::nimboost::type_erasure::detail::BOOST_PP_CAT(extract_table, N)(
            (typename ::nimboost::type_erasure::detail::get_signature<Op>::type*)0,
...
call(
    ...
    BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
    ::nimboost::type_erasure::require_match(f BOOST_TYPE_ERASURE_FORWARD_ARGS(N, U, arg));
    return ::nimboost::type_erasure::unchecked_call(f BOOST_TYPE_ERASURE_FORWARD_ARGS(N, U, arg));
}
