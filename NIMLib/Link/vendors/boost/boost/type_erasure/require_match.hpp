...
void require_match_impl(
    ...
    U&&... arg)
{
    if(!::nimboost::type_erasure::check_match(table, op, std::forward<U>(arg)...)) {
        BOOST_THROW_EXCEPTION(::nimboost::type_erasure::bad_function_call());
    }
}
...
void require_match_impl(
    ::nimboost::mpl::false_,
    const ::nimboost::type_erasure::binding<Concept>&,
    const Op&,
    U&&...)
{}
...
void require_match_impl(
    ...
    U&&... arg)
{
    if(!::nimboost::type_erasure::check_match(op, ::std::forward<U>(arg)...)) {
        BOOST_THROW_EXCEPTION(::nimboost::type_erasure::bad_function_call());
    }
}
...
void require_match(
    ...
    U&&... arg)
{
    ::nimboost::type_erasure::is_relaxed<Concept> cond;
    ::nimboost::type_erasure::detail::require_match_impl(cond, table, op, ::std::forward<U>(arg)...);
}
    ...
    U&&... arg)
{
    ::nimboost::type_erasure::is_relaxed<
        typename ::nimboost::type_erasure::detail::extract_concept<
            ...
            U...>::type
    > cond;
    ::nimboost::type_erasure::detail::require_match_impl(cond, op, ::std::forward<U>(arg)...);
}
...
{
    if(!::nimboost::type_erasure::check_match
...
{
    ::nimboost::type_erasure::is_relaxed<Concept> cond;
    ::nimboost::type_erasure::detail::require_match_impl
