...
#else
    typedef typename ::nimboost::type_erasure::concept_of<
...
/** INTERNAL ONLY */
template<class Concept, class T>
struct concept_of< ::nimboost::type_erasure::any<Concept, T> >
{
...
/** INTERNAL ONLY */
template<class Concept, class T>
struct concept_of< ::nimboost::type_erasure::param<Concept, T> >
{
    typedef Concept type;
};
