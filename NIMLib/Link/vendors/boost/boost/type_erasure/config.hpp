...
/** The maximum number of functions that an @ref nimboost::type_erasure::any "any" can have. */
...
/** The maximum number of elements in a @ref nimboost::type_erasure::tuple "tuple". */
