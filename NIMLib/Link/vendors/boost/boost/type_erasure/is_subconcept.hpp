...
struct is_subconcept_impl {
    ...
    typedef typename ::nimboost::mpl::eval_if< ::nimboost::is_same<PlaceholderMap, void>,
        nimboost::mpl::identity<void>,
        ::nimboost::type_erasure::detail::convert_deductions<
            PlaceholderMap,
    ...
    typedef typename ::nimboost::mpl::if_< ::nimboost::is_same<PlaceholderMap, void>,
        ::nimboost::mpl::_1,
    ...
    typedef typename ::nimboost::is_same<
        typename ::nimboost::mpl::find_if<normalized_sub,
            ::nimboost::mpl::not_<
            ...
            >
        >::type,
        typename ::nimboost::mpl::end<normalized_sub>::type
    >::type type;
};
...
struct is_subconcept : ::nimboost::type_erasure::detail::is_subconcept_impl<Sub, Super, PlaceholderMap>::type {
};

#ifndef BOOST_TYPE_ERASURE_DOXYGEN
template<class Sub, class Super, class PlaceholderMap>
struct is_subconcept<Sub, Super, static_binding<PlaceholderMap> > :
    ::nimboost::type_erasure::detail::is_subconcept_impl<Sub, Super, PlaceholderMap>::type
{};
#endif
