...
struct first_placeholder {
    typedef typename ::nimboost::mpl::eval_if<is_placeholder<T0>,
        ::nimboost::mpl::identity<T0>,
...
struct first_placeholder_index :
    ::nimboost::mpl::eval_if<is_placeholder<T0>,
        ::nimboost::mpl::int_<0>,
        ::nimboost::mpl::next<first_placeholder_index<BOOST_PP_ENUM_SHIFTED_PARAMS(BOOST_TYPE_ERASURE_MAX_ARITY, T)> >
    >::type
{};
...
#define BOOST_TYPE_ERASURE_FREE_UNQUALIFIED_PARAM_TYPE(z, n, data) \
    typename ::nimboost::remove_cv<typename ::nimboost::remove_reference<BOOST_PP_CAT(T, n)>::type>::type

/** INTERNAL ONLY */
#define BOOST_TYPE_ERASURE_FREE_PARAM_TYPE(z, n, data)                      \
    typename ::nimboost::mpl::eval_if_c<(_boost_type_erasure_free_p_idx::value == n), \
        ::nimboost::type_erasure::detail::maybe_const_this_param<BOOST_PP_CAT(T, n), Base>,    \
        ::nimboost::type_erasure::as_param<Base, BOOST_PP_CAT(T, n)>           \
...
#define BOOST_TYPE_ERASURE_FREE_FORWARD_PARAM_I(z, n, data) \
    ::std::forward<typename ::nimboost::mpl::eval_if_c<(_boost_type_erasure_free_p_idx::value == n), \
        ::nimboost::type_erasure::detail::maybe_const_this_param<BOOST_PP_CAT(T, n), Base>,    \
        ::nimboost::type_erasure::as_param<Base, BOOST_PP_CAT(T, n)>           \
    >::type>(BOOST_PP_CAT(t, n))
...
#define BOOST_TYPE_ERASURE_FREE_II(qual_name, concept_name, function_name, N)  \
    ...
    struct concept_interface<                                           \
        ...
        Base,                                                           \
        typename ::nimboost::type_erasure::detail::first_placeholder<      \
            BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_FREE_UNQUALIFIED_PARAM_TYPE, ~)>::type  \
    > : Base {                                                          \
        typedef typename ::nimboost::type_erasure::detail::first_placeholder_index<    \
            BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_FREE_UNQUALIFIED_PARAM_TYPE, ~)>::type  \
            _boost_type_erasure_free_p_idx;                             \
        friend typename ::nimboost::type_erasure::rebind_any<Base, R>::type function_name(  \
            BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_FREE_PARAM_TYPE, ~))    \
        {                                                               \
            return ::nimboost::type_erasure::call(                         \
                BOOST_TYPE_ERASURE_FREE_QUALIFIED_ID(qual_name, N)()    \
...
struct first_placeholder_index<T0, T...> :
    ::nimboost::mpl::eval_if<is_placeholder<T0>,
        ::nimboost::mpl::int_<0>,
        ::nimboost::mpl::next<first_placeholder_index<T...> >
    >::type
{};
...
#define BOOST_TYPE_ERASURE_FREE_II(qual_name, concept_name, function_name, N)  \
    ...
    struct inject ## concept_name<R(T...), Base, index_list<I...> > : Base {\
        ...
        friend typename ::nimboost::type_erasure::rebind_any<Base, R>::type\
        function_name(                                                  \
            typename ::nimboost::mpl::eval_if_c<(_boost_type_erasure_free_p_idx::value == I), \
                ::nimboost::type_erasure::detail::maybe_const_this_param<T, Base>, \
                ::nimboost::type_erasure::as_param<Base, T>                \
            >::type... t)                                               \
       {                                                                \
            return ::nimboost::type_erasure::call(                         \
                BOOST_TYPE_ERASURE_QUALIFIED_NAME(qual_name)<R(T...)>(),\
                std::forward<typename ::nimboost::mpl::eval_if_c<(_boost_type_erasure_free_p_idx::value == I), \
                    ::nimboost::type_erasure::detail::maybe_const_this_param<T, Base>, \
                    ::nimboost::type_erasure::as_param<Base, T>            \
                >::type>(t)...);                                        \
        }                                                               \
    ...
    struct concept_interface<                                           \
        ...
        Base,                                                           \
        typename ::nimboost::type_erasure::detail::first_placeholder<      \
            typename ::nimboost::remove_cv<typename ::nimboost::remove_reference<T>::type>::type...>::type  \
    > :  inject ## concept_name<R(T...), Base, typename ::nimboost::type_erasure::detail::make_index_list<sizeof...(T)>::type>\
    {};                                                                 \
                                                                        \
    }                                                                   \
    }
 ...
 *
 * \code
 * BOOST_TYPE_ERASURE_FREE((nimboost)(has_to_string), to_string, 1)
 * \endcode
 */
