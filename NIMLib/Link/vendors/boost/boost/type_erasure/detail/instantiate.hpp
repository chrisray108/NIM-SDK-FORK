...
struct make_instantiate_concept {
    ...
    typedef typename ::nimboost::type_erasure::detail::make_instantiate_concept_impl<
        (::nimboost::mpl::size<normalized>::value)
    >::type type;
};

#define BOOST_TYPE_ERASURE_INSTANTIATE(Concept, Map)            \
    (::nimboost::type_erasure::detail::make_instantiate_concept<   \
        Concept                                                 \
...
#define BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, P0, T0)        \
    ...
    >::type::apply(                                             \
        (Concept*)0,                                            \
        (::nimboost::mpl::map1< ::nimboost::mpl::pair<P0, T0> >*)0))
...
#define BOOST_TYPE_ERASURE_INSTANTIATE_IMPL(z, n, data)\
    (void)&::nimboost::mpl::at_c<data, n>::type::apply;
...
{
    typedef ::nimboost::type_erasure::detail::BOOST_PP_CAT(instantiate_concept, N) type;
};
