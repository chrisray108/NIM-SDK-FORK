...
struct maybe_extract_concept
{
    typedef typename ::nimboost::mpl::eval_if<
        ::nimboost::type_erasure::is_placeholder<
            ...
            >::type
        >,
        ::nimboost::type_erasure::concept_of<typename ::nimboost::remove_reference<U>::type>,
...
{
    typedef typename ::nimboost::type_erasure::detail::combine_concepts<
        typename ::nimboost::type_erasure::detail::maybe_extract_concept<
            T0, U0
        >::type,
