...
struct replace_param_for_vtable
{
    typedef typename ::nimboost::mpl::if_<
        ::nimboost::type_erasure::is_placeholder<typename ::nimboost::remove_cv<T>::type>,
...
struct is_internal_concept :
    ::nimboost::type_erasure::detail::has_type<T>
{};

template<class PrimitiveConcept>
struct adapt_to_vtable
{
    typedef ::nimboost::type_erasure::detail::vtable_adapter<
        PrimitiveConcept,
        typename ::nimboost::type_erasure::detail::get_vtable_signature<
            typename ::nimboost::type_erasure::detail::get_signature<
                PrimitiveConcept
            >::type
        >::type
    > type;
...
struct maybe_adapt_to_vtable
{
    typedef typename ::nimboost::mpl::eval_if<
        ::nimboost::type_erasure::detail::is_internal_concept<Concept>,
        ::nimboost::mpl::identity<Concept>,
        ::nimboost::type_erasure::detail::adapt_to_vtable<Concept>
    >::type type;
};
...
struct vtable_adapter_impl<PrimitiveConcept, R(T...), R2(U...)>
{
    ...
    static R value(T... arg)
    {
        return PrimitiveConcept::apply(
            ::nimboost::type_erasure::detail::extract<U>(std::forward<T>(arg))...);
    }
};

template<class PrimitiveConcept, class... T, class R2, class... U>
struct vtable_adapter_impl<PrimitiveConcept, ::nimboost::type_erasure::detail::storage&(T...), R2(U...)>
{
    typedef ::nimboost::type_erasure::detail::storage (*type)(T...);
    static ::nimboost::type_erasure::detail::storage value(T... arg)
    {
        ::nimboost::type_erasure::detail::storage result;
        typename ::nimboost::remove_reference<R2>::type* p =
            ::nimboost::addressof(
                PrimitiveConcept::apply(::nimboost::type_erasure::detail::extract<U>(std::forward<T>(arg))...));
...
struct vtable_adapter_impl<PrimitiveConcept, ::nimboost::type_erasure::detail::storage&&(T...), R2(U...)>
{
    ...
    {
        ::nimboost::type_erasure::detail::storage result;
        R2 tmp = PrimitiveConcept::apply(::nimboost::type_erasure::detail::extract<U>(std::forward<T>(arg))...);
        typename ::nimboost::remove_reference<R2>::type* p = ::nimboost::addressof(tmp);
        result.data = const_cast<void*>(static_cast<const void*>(p));
        return result;
    }
};
...
{
    typedef typename ::nimboost::type_erasure::detail::replace_result_for_vtable<
        R
    >::type type(typename ::nimboost::type_erasure::detail::replace_param_for_vtable<T>::type...);
};
...
#define BOOST_TYPE_ERASURE_EXTRACT(z, n, data)                  \
    ::nimboost::type_erasure::detail::extract<                     \
        typename traits::                                       \
...
#define BOOST_TYPE_ERASURE_REPLACE_PARAM(z, n, data)                    \
    typename ::nimboost::type_erasure::detail::replace_param_for_vtable<   \
...
struct vtable_adapter<PrimitiveConcept, R(BOOST_PP_ENUM_PARAMS(N, T))>
{
    ...
    {
        typedef typename ::nimboost::function_traits<
            typename ::nimboost::type_erasure::detail::get_signature<
                PrimitiveConcept
            >::type
        > traits;
...
template<class PrimitiveConcept
    BOOST_PP_ENUM_TRAILING_PARAMS(N, class T)>
struct vtable_adapter<PrimitiveConcept, ::nimboost::type_erasure::detail::storage&(BOOST_PP_ENUM_PARAMS(N, T))>
{
    typedef ::nimboost::type_erasure::detail::storage (*type)(BOOST_PP_ENUM_PARAMS(N, T));
    static ::nimboost::type_erasure::detail::storage value(BOOST_PP_ENUM_BINARY_PARAMS(N, T, arg))
    {
        typedef typename ::nimboost::function_traits<
            typename ::nimboost::type_erasure::detail::get_signature<
                PrimitiveConcept
        ...
        > traits;
        ::nimboost::type_erasure::detail::storage result;
        typename ::nimboost::remove_reference<typename traits::result_type>::type* p =
            ::nimboost::addressof(
