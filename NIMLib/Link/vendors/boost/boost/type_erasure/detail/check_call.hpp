...
struct check_call : ::nimboost::mpl::false_ {};
...
{
    typedef typename ::nimboost::type_erasure::placeholder_of<T>::type placeholder;
    typedef typename ::nimboost::remove_reference<placeholder>::type unref;
    typedef typename ::nimboost::mpl::if_< ::nimboost::is_const<T>,
        const unref,
        unref
    >::type add_const;
...
struct check_placeholder_arg_impl : ::nimboost::mpl::false_ {};

template<class P>
struct check_placeholder_arg_impl<P, P&> : ::nimboost::mpl::true_ {};

template<class P>
struct check_placeholder_arg_impl<P, const P&> : ::nimboost::mpl::true_ {};
...
template<class P>
struct check_placeholder_arg_impl<const P&, P&> : ::nimboost::mpl::true_ {};

template<class P>
struct check_placeholder_arg_impl<const P&, const P&> : ::nimboost::mpl::true_ {};
...
struct check_placeholder_arg :
    check_placeholder_arg_impl<
        P,
        typename ::nimboost::type_erasure::detail::qualified_placeholder<Arg>::type
    >::type
{};
    ...
    typedef typename ::nimboost::mpl::eval_if<
        is_placeholder<
            typename ::nimboost::remove_cv<
                typename ::nimboost::remove_reference<FormalArg>::type
            >::type
        >,
        ::nimboost::type_erasure::detail::check_placeholder_arg<FormalArg, ActualArg>,
#ifdef BOOST_TYPE_ERASURE_BROKEN_RVALUE_IS_CONVERTIBLE
        ::nimboost::mpl::true_
#else
        ::nimboost::is_convertible<ActualArg, FormalArg>
#endif
    >::type type;
};
...
#define BOOST_TYPE_ERASURE_CHECK_ARG(z, n, data)                \
    typedef typename ::nimboost::type_erasure::detail::check_arg<  \
        BOOST_PP_CAT(T, n),                                     \
        BOOST_PP_CAT(U, n)                                      \
...
struct check_call<R(BOOST_PP_ENUM_PARAMS(N, T)), void(BOOST_PP_ENUM_BINARY_PARAMS(N, U, u))> {
    typedef ::nimboost::mpl::true_ type0;
