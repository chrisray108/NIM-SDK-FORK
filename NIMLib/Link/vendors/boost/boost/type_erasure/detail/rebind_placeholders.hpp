...
struct rebind_placeholders_in_argument
{
    BOOST_MPL_ASSERT((nimboost::mpl::or_<
        ::nimboost::mpl::not_< ::nimboost::type_erasure::is_placeholder<T> >,
        ::nimboost::mpl::has_key<Bindings, T>
    >));
    typedef typename ::nimboost::mpl::eval_if<
        ::nimboost::type_erasure::is_placeholder<T>,
        ::nimboost::mpl::at<Bindings, T>,
        ::nimboost::type_erasure::detail::identity<T>
    >::type type;
};
...
{
    typedef const typename ::nimboost::type_erasure::detail::rebind_placeholders_in_argument<
        T,
        Bindings
    >::type type;
};
...
{
    typedef typename ::nimboost::type_erasure::deduced<
        typename ::nimboost::type_erasure::detail::rebind_placeholders<F, Bindings>::type
    >::type type;
};

template<class F, class Bindings>
struct rebind_placeholders_in_argument<
    ::nimboost::type_erasure::deduced<F>,
    Bindings
> 
{
    typedef typename ::nimboost::mpl::eval_if<
        ::nimboost::mpl::has_key<Bindings, ::nimboost::type_erasure::deduced<F> >,
        ::nimboost::mpl::at<Bindings, ::nimboost::type_erasure::deduced<F> >,
        ::nimboost::type_erasure::detail::rebind_placeholders_in_deduced<
            F,
            Bindings
        >
    >::type type;
