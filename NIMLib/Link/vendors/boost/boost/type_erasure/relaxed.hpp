    ...
    ::nimboost::mpl::not_<
        typename ::nimboost::is_same<
            typename ::nimboost::mpl::find_if<
                T,
                ::nimboost::type_erasure::is_relaxed< ::nimboost::mpl::_1>
            >::type,
            typename ::nimboost::mpl::end<T>::type
        >::type
    >::type
{};
 ...
 *   behavior.
 */
struct relaxed : ::nimboost::mpl::vector0<> {};
...
struct is_relaxed :
    ::nimboost::mpl::eval_if< ::nimboost::mpl::is_sequence<Concept>,
        ::nimboost::type_erasure::detail::is_relaxed_impl<Concept>,
        ::nimboost::mpl::false_
    >::type
{};
...
/** INTERNAL ONLY */
template<>
struct is_relaxed< ::nimboost::type_erasure::relaxed> :
    ::nimboost::mpl::true_
{};
