...
struct compute_bases
{
    typedef typename ::nimboost::mpl::fold<
        typename ::nimboost::type_erasure::detail::collect_concepts<
            Concept
        >::type,
        ::nimboost::type_erasure::any_base<Derived>,
        ::nimboost::type_erasure::concept_interface<
            ::nimboost::mpl::_2,
            ::nimboost::mpl::_1,
            T
        >
...
template<class T>
fallback make_fallback(const T&, nimboost::mpl::false_)
{
    return fallback();
}

template<class T>
const T& make_fallback(const T& arg, nimboost::mpl::true_)
{
    return arg;
}

template<class T>
struct is_any : ::nimboost::mpl::false_ {};

template<class Concept, class T>
struct is_any<any<Concept, T> > : ::nimboost::mpl::true_ {};
...
class any :
    public ::nimboost::type_erasure::detail::compute_bases<
        ::nimboost::type_erasure::any<Concept, T>,
        Concept,
        T
    >::type
{
    typedef ::nimboost::type_erasure::binding<Concept> table_type;
public:
    /** INTERNAL ONLY */
    typedef Concept _boost_type_erasure_concept_type;
    /** INTERNAL ONLY */
    any(const ::nimboost::type_erasure::detail::storage& data_arg, const table_type& table_arg)
      : table(table_arg),
        data(data_arg)
    {}
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    /** INTERNAL ONLY */
    any(::nimboost::type_erasure::detail::storage&& data_arg, const table_type& table_arg)
      : table(table_arg),
        data(data_arg)
    {}
#endif
    ...
    any()
    {
        BOOST_MPL_ASSERT((::nimboost::type_erasure::is_relaxed<Concept>));
        data.data = 0;
    }
    ...
    any(const U& data_arg)
      : table((
            ...
            ::nimboost::type_erasure::make_binding<
                ::nimboost::mpl::map< ::nimboost::mpl::pair<T, U> >
            >()
        )),
        data(data_arg)
    {}
    ...
    any(const U& data_arg, const static_binding<Map>& binding_arg)
      : table((
        ...
        data(data_arg)
    {
        BOOST_MPL_ASSERT((::nimboost::is_same<
            typename ::nimboost::mpl::at<Map, T>::type, U>));
    }
    ...
    any(U&& data_arg)
      : table((
            BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, T, typename ::nimboost::remove_cv<typename ::nimboost::remove_reference<U>::type>::type),
            ::nimboost::type_erasure::make_binding<
                ::nimboost::mpl::map< ::nimboost::mpl::pair<T, typename ::nimboost::remove_cv<typename ::nimboost::remove_reference<U>::type>::type> >
            >()
        )),
    ...
    {
        BOOST_MPL_ASSERT((::nimboost::is_same<
            typename ::nimboost::mpl::at<Map, T>::type, typename ::nimboost::remove_cv<typename ::nimboost::remove_reference<U>::type>::type>));
    }
    ...
    any(const any& other)
      : table(other.table),
        data(::nimboost::type_erasure::call(constructible<T(const T&)>(), other))
    {}
    /**
    ...
    any(const any<Concept2, Tag2>& other)
      : table(
            ::nimboost::type_erasure::detail::access::table(other),
            ::nimboost::mpl::map<
                ::nimboost::mpl::pair<
                    T,
                    typename ::nimboost::remove_const<
                        typename ::nimboost::remove_reference<Tag2>::type
                    >::type
                >
            >()
        ),
        data(::nimboost::type_erasure::call(
            constructible<
                typename ::nimboost::remove_const<
                    typename nimboost::remove_reference<Tag2>::type
                >::type(const typename nimboost::remove_reference<Tag2>::type&)
            >(), other)
        )
    {}
    /**
    ...
    any(const any<Concept2, Tag2>& other, const static_binding<Map>& binding_arg)
      : table(::nimboost::type_erasure::detail::access::table(other), binding_arg),
        data(::nimboost::type_erasure::call(
            constructible<
                typename ::nimboost::remove_const<
                    typename nimboost::remove_reference<Tag2>::type
    ...
    explicit any(const binding<Concept>& binding_arg, U&&... arg)
      : table(binding_arg),
        data(
            ::nimboost::type_erasure::detail::make(
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    any(any&& other)
      : table(::nimboost::type_erasure::detail::access::table(other)),
        data(::nimboost::type_erasure::call(
            ::nimboost::type_erasure::detail::make(
    ...
    explicit any(const binding<Concept>& binding_arg)
      : table(binding_arg),
        data(
            ::nimboost::type_erasure::call(
                binding_arg,
                ::nimboost::type_erasure::constructible<T()>()
            )
        )
    {}
    ...
    const table_type& _boost_type_erasure_extract_table(
        ::nimboost::type_erasure::constructible<R(A...)>*,
        U&&... u)
    {
        return *::nimboost::type_erasure::detail::extract_table(static_cast<void(*)(A...)>(0), u...);
    }
...
private:
    ...
    void _boost_type_erasure_resolve_assign(const Other& other)
    {
        _boost_type_erasure_assign_impl(
            ...
            false? this->_boost_type_erasure_deduce_assign(
                ::nimboost::type_erasure::detail::make_fallback(
                    other,
                    ::nimboost::mpl::bool_<
                        sizeof(
                            ::nimboost::type_erasure::detail::check_overload(
                                ::nimboost::declval<any&>().
                                    _boost_type_erasure_deduce_assign(other)
                            )
                        ) == sizeof(::nimboost::type_erasure::detail::yes)
                    >()
                )
            ) : 0,
    ...
    void _boost_type_erasure_assign_impl(
        ...
        ::nimboost::mpl::false_)
    {
        ::nimboost::type_erasure::call(assignable<T, U>(), *this, other);
    }
    /** INTERNAL ONLY */
    template<class Other, class U>
    void _boost_type_erasure_assign_impl(
    ...
    void _boost_type_erasure_assign_impl(
        ...
        ::nimboost::mpl::true_)
    {
        if(::nimboost::type_erasure::check_match(assignable<T, U>(), *this, other))
        {
            ::nimboost::type_erasure::unchecked_call(assignable<T, U>(), *this, other);
        }
        else
        {
            any temp(other);
    ...
    friend struct ::nimboost::type_erasure::detail::access;
    // The table has to be initialized first for exception
    // safety in some constructors.
    table_type table;
    ::nimboost::type_erasure::detail::storage data;
};
...
public:
    ...
    typedef Concept _boost_type_erasure_concept_type;
    /** INTERNAL ONLY */
    any(const ::nimboost::type_erasure::detail::storage& data_arg,
    ...
    any(U& arg
        ...
        ,  typename ::nimboost::disable_if<
            ::nimboost::mpl::or_<
                ::nimboost::is_const<U>,
                ::nimboost::type_erasure::detail::is_any<U>
            >
        >::type* = 0
#endif
        )
    ...
    {
        data.data = ::nimboost::addressof(arg);
    }
    /**
     * Constructs an @ref any from a reference.
     *
     ...
     */
    any(any<Concept, T>& other)
      : data(::nimboost::type_erasure::detail::access::data(other)),
        table(::nimboost::type_erasure::detail::access::table(other))
    {}
    /**
     * Constructs an @ref any from another reference.
    ...
    any(const any<Concept2, Tag2&>& other
        ...
        , typename ::nimboost::disable_if<
            ::nimboost::mpl::or_<
                ::nimboost::is_same<Concept, Concept2>,
                ::nimboost::is_const<Tag2>
            >
        >::type* = 0
#endif
        )
    ...
    any(any<Concept2, Tag2>& other
        ...
        , typename ::nimboost::disable_if<
            ::nimboost::mpl::or_<
                ::nimboost::is_same<Concept, Concept2>,
                ::nimboost::is_const<typename ::nimboost::remove_reference<Tag2>::type>
            >
        >::type* = 0
#endif
        )
    ...
    any(const any<Concept2, Tag2&>& other, const static_binding<Map>& binding_arg
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
        , typename ::nimboost::disable_if< ::nimboost::is_const<Tag2> >::type* = 0
#endif
        )
      : data(::nimboost::type_erasure::detail::access::data(other)),
        table(::nimboost::type_erasure::detail::access::table(other), binding_arg)
...
class any<Concept, const T&> :
    public ::nimboost::type_erasure::detail::compute_bases<
        ::nimboost::type_erasure::any<Concept, const T&>,
        Concept,
        T
    >::type
{
...
public:
    ...
    {
        data.data = const_cast<void*>(static_cast<const void*>(::nimboost::addressof(arg)));
    }
    /**
     * Constructs an @ref any from a reference.
     *
    ...
    any(const any<Concept2, Tag2>& other
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
        , typename ::nimboost::disable_if< ::nimboost::is_same<Concept, Concept2> >::type* = 0
#endif
        )
      : data(::nimboost::type_erasure::detail::access::data(other)),
        table(
...
public:
    ...
    any(any<Concept, T>&& other)
      : data(::nimboost::type_erasure::detail::access::data(other)),
        table(std::move(::nimboost::type_erasure::detail::access::table(other)))
    {}
    /**
     * Constructs an @ref any from another rvalue reference.
     *
    ...
    any(any<Concept2, Tag2&&>&& other
      ...
      : data(::nimboost::type_erasure::detail::access::data(other)),
        table(
            std::move(::nimboost::type_erasure::detail::access::table(other)),
            ::nimboost::mpl::map<
                ::nimboost::mpl::pair<
                    T,
                    Tag2
    ...
    any(const any<Concept2, Tag2&&>& other, const static_binding<Map>& binding_arg
      ...
      : data(::nimboost::type_erasure::detail::access::data(other)),
        table(std::move(::nimboost::type_erasure::detail::access::table(other)), binding_arg)
    {}
    /**
     * Constructs an @ref any from another @ref any.
     *
