...
struct can_optimize_conversion : ::nimboost::mpl::and_<
    ::nimboost::is_same<Source, Dest>,
        ::nimboost::is_same<
            typename ::nimboost::mpl::find_if<
                Map,
                ::nimboost::mpl::not_<
                    ::nimboost::is_same<
                        ::nimboost::mpl::first< ::nimboost::mpl::_1>,
                        ::nimboost::mpl::second< ::nimboost::mpl::_1>
                    >
                >
            >::type,
            typename ::nimboost::mpl::end<Map>::type
        >
    >::type
{};
...
class binding
{
    typedef typename ::nimboost::type_erasure::detail::normalize_concept<
        Concept>::type normalized;
    typedef typename ::nimboost::mpl::transform<normalized,
        ::nimboost::type_erasure::detail::maybe_adapt_to_vtable< ::nimboost::mpl::_1>
    >::type actual_concept;
    typedef typename ::nimboost::type_erasure::detail::make_vtable<
...
public:
     ...
     * \throws Nothing.
     */
    binding() { BOOST_MPL_ASSERT((::nimboost::type_erasure::is_relaxed<Concept>)); }
    ...
    binding(const binding<Concept2>& other, const Map&
        ...
        , typename ::nimboost::enable_if<
            ::nimboost::mpl::and_<
                ::nimboost::type_erasure::detail::check_map<Concept, Map>,
                ::nimboost::type_erasure::is_subconcept<Concept, Concept2, Map>
            >
        >::type* = 0
#endif
        )
      : impl(
            other,
            static_binding<Map>(),
            ::nimboost::type_erasure::detail::can_optimize_conversion<Concept2, Concept, Map>()
        )
    {}
...
private:
    ...
    {
        impl_type() {
            table = &::nimboost::type_erasure::detail::make_vtable_init<
                typename ::nimboost::mpl::transform<
                    actual_concept,
                    ::nimboost::type_erasure::detail::get_null_vtable_entry<
                        ::nimboost::mpl::_1
                    >
                >::type,
                table_type
            ...
            table = &::nimboost::type_erasure::detail::make_vtable_init<
                typename ::nimboost::mpl::transform<
                    ...
                    ::nimboost::type_erasure::detail::rebind_placeholders<
                        ::nimboost::mpl::_1,
                        typename ::nimboost::type_erasure::detail::add_deductions<
                            Map,
                            placeholder_subs
                        >::type
                    >
        ...
        template<class Concept2, class Map>
        impl_type(const binding<Concept2>& other, const static_binding<Map>&, nimboost::mpl::false_)
          : manager(new table_type)
        {
            manager->template convert_from<
                typename ::nimboost::type_erasure::detail::convert_deductions<
                    Map,
                    placeholder_subs,
        ...
        template<class Concept2, class Map>
        impl_type(const binding<Concept2>& other, const static_binding<Map>&, nimboost::mpl::true_)
          : table(other.impl.table),
            manager(other.impl.manager)
        {}
        const table_type* table;
        ::nimboost::shared_ptr<table_type> manager;
    } impl;
};
