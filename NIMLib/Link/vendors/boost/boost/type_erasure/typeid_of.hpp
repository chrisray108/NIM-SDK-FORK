...
{
    return ::nimboost::type_erasure::detail::access::table(arg).template find<
        ::nimboost::type_erasure::typeid_<
...
{
    return binding_arg.template find< ::nimboost::type_erasure::typeid_<T> >()();
}
