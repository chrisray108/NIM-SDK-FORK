  ...
  : Base
{
    template<class Sig>
    struct result :
        ::nimboost::type_erasure::detail::result_of_callable<Sig>
    {};
    typedef void _boost_type_erasure_is_callable;
    typedef ::nimboost::mpl::vector<R> _boost_type_erasure_callable_results;
    typedef char (&_boost_type_erasure_callable_size)[1];
    _boost_type_erasure_callable_size
    _boost_type_erasure_deduce_callable(
        typename ::nimboost::type_erasure::as_param<Base, T>::type...);
    typename ::nimboost::type_erasure::rebind_any<Base, R>::type
    operator()(typename ::nimboost::type_erasure::as_param<Base, T>::type... arg)
    {
        return ::nimboost::type_erasure::call(callable<R(T...), F>(), *this,
            ::std::forward<typename ::nimboost::type_erasure::as_param<Base, T>::type>(arg)...);
    }
};
  ...
  : Base
{
    ...
    _boost_type_erasure_callable_size
    _boost_type_erasure_deduce_callable(
        typename ::nimboost::type_erasure::as_param<Base, T>::type...) const;
    typename ::nimboost::type_erasure::rebind_any<Base, R>::type operator()(
        typename ::nimboost::type_erasure::as_param<Base, T>::type... arg) const
    {
        return ::nimboost::type_erasure::call(callable<R(T...), const F>(), *this,
            ::std::forward<typename ::nimboost::type_erasure::as_param<Base, T>::type>(arg)...);
    }
};
  ...
  : Base
{
    ...
    typedef char (&_boost_type_erasure_callable_size)[
        ::nimboost::mpl::size<_boost_type_erasure_callable_results>::value];
  ...
  : Base
{
    ...
    using Base::operator();
    typename ::nimboost::type_erasure::rebind_any<Base, R>::type
    operator()(typename ::nimboost::type_erasure::as_param<Base, T>::type... arg) const
    {
        return ::nimboost::type_erasure::call(callable<R(T...), const F>(), *this,
            ::std::forward<typename ::nimboost::type_erasure::as_param<Base, T>::type>(arg)...);
    }
...
{
    typedef typename ::nimboost::mpl::at_c<
        typename This::_boost_type_erasure_callable_results,
        sizeof(::nimboost::declval<This>().
            _boost_type_erasure_deduce_callable(::nimboost::declval<T>()...)) - 1
    >::type type;
};
...
#define BOOST_TYPE_ERASURE_DECLVAL(z, n, data) ::nimboost::declval<BOOST_PP_CAT(T, n)>()

#define BOOST_TYPE_ERASURE_REBIND(z, n, data)\
    typename ::nimboost::type_erasure::as_param<Base, BOOST_PP_CAT(T, n)>::type BOOST_PP_CAT(arg, n)
...
#define BOOST_TYPE_ERASURE_FORWARD_REBIND(z, n, data) ::std::forward<typename ::nimboost::type_erasure::as_param<Base, BOOST_PP_CAT(T, n)>::type>(BOOST_PP_CAT(arg, n))
#endif
