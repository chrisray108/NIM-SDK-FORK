...
struct placeholder_conversion : nimboost::mpl::false_ {};
template<class T>
struct placeholder_conversion<T, T> : nimboost::mpl::true_ {};
template<class T>
struct placeholder_conversion<T, T&> : nimboost::mpl::true_ {};
template<class T>
struct placeholder_conversion<T, const T&> : nimboost::mpl::true_ {};
template<class T>
struct placeholder_conversion<const T, T> : nimboost::mpl::true_ {};
template<class T>
struct placeholder_conversion<const T, const T&> : nimboost::mpl::true_ {};
template<class T>
struct placeholder_conversion<T&, T> : nimboost::mpl::true_ {};
template<class T>
struct placeholder_conversion<T&, T&> : nimboost::mpl::true_ {};
...
public:
    ...
    param(any<Concept, U>& a
        ...
        , typename nimboost::enable_if<
            ::nimboost::type_erasure::detail::placeholder_conversion<U, T>
        >::type* = 0
#endif
        )
      : _impl(a)
...
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
        , typename nimboost::enable_if<
            ::nimboost::type_erasure::detail::placeholder_conversion<
                typename ::nimboost::add_const<U>::type,
                T
            >
        >::type* = 0
#endif
...
public:
    ...
    param(const ::nimboost::type_erasure::detail::storage& data,
          const ::nimboost::type_erasure::binding<Concept>& table)
      : _impl(data, table)
    {}
    template<class U>
    param(U& u, typename nimboost::enable_if< ::nimboost::is_same<U, const any<Concept, T> > >::type* = 0) : _impl(u) {}
...
public:
    ...
    any<Concept, T&> get() const
    {
        return any<Concept, T&>(
            ::nimboost::type_erasure::detail::access::data(this->_impl),
            ::nimboost::type_erasure::detail::access::table(this->_impl));
    }
};
    ...
    typedef typename ::nimboost::mpl::if_<
        ::nimboost::type_erasure::is_placeholder<
            typename ::nimboost::remove_cv<
                typename ::nimboost::remove_reference<T>::type>::type>,
        param<typename ::nimboost::type_erasure::concept_of<Any>::type, T>,
        T
    >::type type;
#endif
};
