...
template<
    ...
    typename ScopedWriteLockT =
        ...
        typename mpl::if_c<
            nimboost::log::aux::is_exclusively_lockable< MutexT >::value,
            nimboost::log::aux::exclusive_lock_guard< MutexT >,
            void
        >::type,
#else
        void,
...
#ifndef BOOST_LOG_NO_THREADS
        typename mpl::if_c<
            nimboost::log::aux::is_shared_lockable< MutexT >::value,
            nimboost::log::aux::shared_lock_guard< MutexT >,
            ScopedWriteLockT
        >::type
#else
        ScopedWriteLockT
...
protected:
    ...
    public:
         ...
         * Initializing constructor
         */
        explicit impl(BOOST_RV_REF(value_type) value) : m_Value(new attr_value(nimboost::move(value)))
        {
        }
        ...
        {
            intrusive_ptr< attr_value > p = new attr_value(nimboost::move(value));
            scoped_write_lock lock(m_Mutex);
            m_Value.swap(p);
        }
...
public:
     ...
     * Constructor with the stored value initialization
     */
    explicit mutable_constant(BOOST_RV_REF(value_type) value) : attribute(new impl(nimboost::move(value)))
    {
    }
    /*!
    ...
    void set(BOOST_RV_REF(value_type) value)
    {
        get_impl()->set(nimboost::move(value));
    }
...
protected:
    ...
    public:
        ...
        void set(BOOST_RV_REF(value_type) value)
        {
            m_Value = new attr_value(nimboost::move(value));
        }
