...
public:
    ...
    result_type operator() (attribute_name const& name, attribute_value_set const& attrs) const
    {
        ...
        catch (exception& e)
        {
            ...
            nimboost::log::aux::attach_attribute_name_info(e, name);
            throw;
        }
    }
