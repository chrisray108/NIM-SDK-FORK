...
private:
    ...
    struct l1_visitor
    {
        ...
        {
            nimboost::log::visit< value_type >(m_owner.m_name, m_right, l2_visitor< LeftT >(static_cast< FunT const& >(m_owner), left, m_result));
        }
...
public:
    ...
    {
        bool result = false;
        if (!nimboost::log::visit< value_type >(m_name, left, l1_visitor(*this, right, result)))
        {
            return !nimboost::log::visit< value_type >(m_name, right, nop());
        }
        return result;
    }
};
