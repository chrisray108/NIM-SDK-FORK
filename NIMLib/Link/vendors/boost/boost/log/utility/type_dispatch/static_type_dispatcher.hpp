...
public:
    ...
    explicit type_sequence_dispatcher(VisitorT& visitor) :
        ...
        m_pVisitor((void*)nimboost::addressof(visitor)),
...
public:
    ...
    explicit single_type_dispatcher(VisitorT& visitor) :
        ...
        m_Callback(
            (void*)nimboost::addressof(visitor),
...
class static_type_dispatcher
    ...
    public mpl::if_<
        mpl::is_sequence< T >,
        nimboost::log::aux::type_sequence_dispatcher< T >,
        nimboost::log::aux::single_type_dispatcher< T >
    >::type
#endif
{
private:
