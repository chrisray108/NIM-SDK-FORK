...
private:
    ...
    public:
        ...
        {
            this->m_pVisitor = (void*)nimboost::addressof(m_Visitor);
...
public:
    ...
    {
        nimboost::shared_ptr< callback_base > p(
            nimboost::make_shared< callback_impl< T, VisitorT > >(nimboost::cref(visitor)));
