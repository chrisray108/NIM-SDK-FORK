...
template< typename MutexT >
struct thread_access_mode_of< nimboost::log::aux::exclusive_lock_guard< MutexT > > : mpl::integral_c< lock_access_mode, exclusive_access >
{
};

template< typename MutexT >
struct thread_access_mode_of< nimboost::log::aux::shared_lock_guard< MutexT > > : mpl::integral_c< lock_access_mode, shared_access >
{
};
...
{
    typedef typename strictest_lock<
        typename nimboost::log::aux::strictest_lock_impl< T, T0 >::type
