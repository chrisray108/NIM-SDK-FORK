...
{
    return nimboost::log::parse_filter(filter);
}
...
inline typename enable_if<
    nimboostphoenix::is_actor< FilterT >,
    FilterT const&
...
{
    return nimboost::log::parse_formatter(formatter);
}
template< typename CharT, typename TraitsT, typename AllocatorT >
...
inline typename enable_if<
    nimboostphoenix::is_actor< FormatterT >,
    FormatterT const&
