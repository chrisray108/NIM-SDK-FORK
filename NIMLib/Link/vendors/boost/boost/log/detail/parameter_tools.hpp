...
typedef nimboost::parameter::aux::empty_arg_list empty_arg_list;
...
{
    typedef nimboost::parameter::aux::arg_list< ArgT0, typename make_arg_list< ArgsT... >::type > type;
};

template< typename ArgT0 >
struct make_arg_list< ArgT0 >
{
    typedef nimboost::parameter::aux::arg_list< ArgT0 > type;
};
...
struct make_arg_list
{
    typedef nimboost::parameter::aux::arg_list< ArgT0, typename make_arg_list< BOOST_PP_ENUM_PARAMS(BOOST_PP_DEC(BOOST_LOG_MAX_PARAMETER_ARGS), T) >::type > type;
};
