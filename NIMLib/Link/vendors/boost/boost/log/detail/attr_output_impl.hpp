...
#define BOOST_LOG_AUX_OVERLOAD(left_ref, right_ref)\
    ...
    BOOST_FORCEINLINE typename aux::make_output_actor< nimboostphoenix::actor< LeftExprT >, attribute_actor< T, FallbackPolicyT, TagT, nimboostphoenix::actor > >::type\
    operator<< (nimboostphoenix::actor< LeftExprT > left_ref left, attribute_actor< T, FallbackPolicyT, TagT, nimboostphoenix::actor > right_ref right)\
    {\
        return aux::make_output_actor< nimboostphoenix::actor< LeftExprT >, attribute_actor< T, FallbackPolicyT, TagT, nimboostphoenix::actor > >::make(left, right);\
    }
