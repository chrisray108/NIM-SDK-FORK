...
public:
    ...
    struct result< this_type(ContextT) >
    {
        ...
        typedef typename nimboost::result_of< function_type(typename fusion::result_of::at_c< args_type, 0 >::type) >::type type;
    };
    ...
    struct result< const this_type(ContextT) >
    {
        ...
        typedef typename nimboost::result_of< const function_type(typename fusion::result_of::at_c< args_type, 0 >::type) >::type type;
    };
...
public:
    ...
    {
        return m_fun(fusion::at_c< 0 >(nimboostphoenix::env(ctx).args()));
    }
...
template< typename FunT >
struct is_nullary< custom_terminal< nimboost::log::expressions::aux::unary_function_terminal< FunT > > > :
    public mpl::false_
{
};
