...
public:
    ...
    struct result< this_type(ContextT) >
    {
        typedef typename remove_cv<
            typename remove_reference< typename nimboostphoenix::result_of::env< ContextT >::type >::type
        >::type env_type;
        typedef typename env_type::args_type args_type;

        typedef typename nimboost::result_of< value_extractor_type(attribute_name const&, typename fusion::result_of::at_c< args_type, 0 >::type) >::type type;
    };
    ...
    struct result< const this_type(ContextT) >
    {
        ...
        typedef typename nimboost::result_of< const value_extractor_type(attribute_name const&, typename fusion::result_of::at_c< args_type, 0 >::type) >::type type;
    };
...
public:
    ...
    {
        return m_value_extractor(m_name, fusion::at_c< 0 >(nimboostphoenix::env(ctx).args()));
    }
...
template< typename T, typename FallbackPolicyT, typename TagT >
struct is_nullary< custom_terminal< nimboost::log::expressions::attribute_terminal< T, FallbackPolicyT, TagT > > > :
    public mpl::false_
{
};
