...
public:
    ...
    result_type operator() (ContextT const& ctx) const
    {
        ...
        arg_type arg = fusion::at_c< 0 >(nimboostphoenix::env(ctx).args());
...
template<
    ...
    typename SeverityCompareT = greater_equal,
    typename AllocatorT = std::allocator< void >,
    template< typename > class ActorT = nimboostphoenix::actor
>
...
template<
    ...
    typename AllocatorT
>
struct is_nullary< custom_terminal< nimboost::log::expressions::channel_severity_filter_terminal< ChannelT, SeverityT, ChannelFallbackT, SeverityFallbackT, ChannelOrderT, SeverityCompareT, AllocatorT > > > :
    public mpl::false_
{
};
