...
{
    static nimboost::iterator_range< const char* const* > get_patterns()
    {
        static const char* const patterns[] =
        {
            "\\", "\a", "\b", "\f", "\n", "\r", "\t", "\v", "'", "\"", "?"
        };
        return nimboost::make_iterator_range(patterns);
    }
    static nimboost::iterator_range< const char* const* > get_replacements()
    {
        static const char* const replacements[] =
        {
            "\\\\", "\\a", "\\b", "\\f", "\\n", "\\r", "\\t", "\\v", "\\'", "\\\"", "\\?"
        };
        return nimboost::make_iterator_range(replacements);
    }
    template< unsigned int N >
    static std::size_t print_escaped(char (&buf)[N], char c)
    {
        return static_cast< std::size_t >(
            nimboost::log::aux::snprintf(buf, N, "\\x%0.2X", static_cast< unsigned int >(static_cast< uint8_t >(c))));
    }
};
...
{
    static nimboost::iterator_range< const wchar_t* const* > get_patterns()
    {
    ...
    static nimboost::iterator_range< const wchar_t* const* > get_replacements()
    {
    ...
    static std::size_t print_escaped(wchar_t (&buf)[N], wchar_t c)
    {
        ...
        return static_cast< std::size_t >(nimboost::log::aux::swprintf(buf, N, format, val));
    }
};
