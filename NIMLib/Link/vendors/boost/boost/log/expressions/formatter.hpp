...
private:
    ...
    typedef nimboost::log::aux::light_function< void (record_view const&, stream_type&) > formatter_type;
    ...
    struct default_formatter
    {
        ...
        {
            nimboost::log::visit< expressions::tag::message::value_type >(m_MessageName, rec, nimboost::log::bind_output(strm));
        }
...
public:
     ...
     */
    basic_formatter(BOOST_RV_REF(this_type) that) BOOST_NOEXCEPT : m_Formatter(nimboost::move(that.m_Formatter))
    {
    }
