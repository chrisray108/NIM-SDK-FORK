...
public:
    ...
    typedef nimboost::log::aux::light_function< void () > exception_handler_type;
...
public:
    ...
    basic_exception_handler_logger(BOOST_RV_REF(basic_exception_handler_logger) that) :
        ...
        m_ExceptionHandler(nimboost::move(that.m_ExceptionHandler))
    {
    }
    /*!
    ...
    {
#ifndef BOOST_LOG_NO_THREADS
        nimboost::log::aux::exclusive_lock_guard< threading_model > lock(this->get_threading_model());
#endif
...
private:
    ...
    void handle_exception()
    {
        ...
        typedef typename mpl::if_<
            ...
            nimboost::log::aux::shared_lock_guard< threading_model >,
            no_lock< threading_model >
        >::type lock_type;
