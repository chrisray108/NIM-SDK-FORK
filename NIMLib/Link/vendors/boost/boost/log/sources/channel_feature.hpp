...
public:
    ...
    typedef typename strictest_lock<
        ...
        nimboost::log::aux::exclusive_lock_guard< threading_model >
#else
...
public:
    ...
    {
        base_type::add_attribute_unlocked(nimboost::log::aux::default_attribute_names::channel(), m_ChannelAttr);
    }
    /*!
     * Copy constructor
     */
    ...
    {
        base_type::attributes()[nimboost::log::aux::default_attribute_names::channel()] = m_ChannelAttr;
    }
    /*!
     * Move constructor
     */
    basic_channel_logger(BOOST_RV_REF(basic_channel_logger) that) :
        ...
        m_ChannelAttr(nimboost::move(that.m_ChannelAttr))
    {
        base_type::attributes()[nimboost::log::aux::default_attribute_names::channel()] = m_ChannelAttr;
    }
    /*!
    ...
    {
        BOOST_LOG_EXPR_IF_MT(nimboost::log::aux::shared_lock_guard< const threading_model > lock(this->get_threading_model());)
    ...
    {
        BOOST_LOG_EXPR_IF_MT(nimboost::log::aux::exclusive_lock_guard< threading_model > lock(this->get_threading_model());)
...
#define BOOST_LOG_STREAM_CHANNEL(logger, chan)\
    BOOST_LOG_STREAM_WITH_PARAMS((logger), (::nimboost::log::keywords::channel = (chan)))
