...
namespace aux {
    ...
    public:
        ...
        //! Move constructor
        severity_level(BOOST_RV_REF(severity_level) that) : attribute(nimboost::move(static_cast< attribute& >(that)))
        {
        }
...
public:
    ...
    {
        base_type::add_attribute_unlocked(nimboost::log::aux::default_attribute_names::severity(), m_SeverityAttr);
    }
    /*!
     * Copy constructor
     */
    ...
    {
        base_type::attributes()[nimboost::log::aux::default_attribute_names::severity()] = m_SeverityAttr;
    }
    /*!
     * Move constructor
     */
    basic_severity_logger(BOOST_RV_REF(basic_severity_logger) that) :
        ...
        m_DefaultSeverity(nimboost::move(that.m_DefaultSeverity)),
        m_SeverityAttr(nimboost::move(that.m_SeverityAttr))
    {
        base_type::attributes()[nimboost::log::aux::default_attribute_names::severity()] = m_SeverityAttr;
    }
    /*!
...
#define BOOST_LOG_STREAM_SEV(logger, lvl)\
    BOOST_LOG_STREAM_WITH_PARAMS((logger), (::nimboost::log::keywords::severity = (lvl)))
