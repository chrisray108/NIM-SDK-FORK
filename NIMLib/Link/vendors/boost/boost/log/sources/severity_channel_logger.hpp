...
class severity_channel_logger_mt :
    public basic_composite_logger<
        ...
        multi_thread_model< nimboost::log::aux::light_rw_mutex >,
        features<
            severity< LevelT >,
            channel< ChannelT >
        >
...
#define BOOST_LOG_STREAM_CHANNEL_SEV(logger, chan, lvl)\
    BOOST_LOG_STREAM_WITH_PARAMS((logger), (::nimboost::log::keywords::channel = (chan))(::nimboost::log::keywords::severity = (lvl)))
