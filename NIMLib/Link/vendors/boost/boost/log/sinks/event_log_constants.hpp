...
namespace event_log {
    ...
    typedef nimboost::log::aux::tagged_integer< unsigned int, event_id_tag > event_id;
    /*!
    ...
    typedef nimboost::log::aux::tagged_integer< unsigned short, event_category_tag > event_category;
    /*!
