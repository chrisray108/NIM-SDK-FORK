...
namespace file {
    ...
    public:
        ...
        {
            nimboost::log::aux::cleanup_guard< stream_type > cleanup1(m_FormattingStream);
            nimboost::log::aux::cleanup_guard< result_type::string_type > cleanup2(m_FileName);
...
public:
    ...
    typedef nimboost::log::aux::light_function< filesystem::path (record_view const&) > file_name_composer_type;
