...
namespace nimboost
{
    ...
    #define BOOST_PROTO_DEFINE_ENV_VAR(TAG, NAME)                                                   \
        ...
        {                                                                                           \
            ...
            nimboost::proto::env<TAG, Value &> const                                                   \
                operator =(nimboost::reference_wrapper<Value> &value) const                            \
            {                                                                                       \
                return nimboost::proto::env<TAG, Value &>(value.get());                                \
            }                                                                                       \
            template<typename Value>                                                                \
            nimboost::proto::env<TAG, Value &> const                                                   \
                operator =(nimboost::reference_wrapper<Value> const &value) const                      \
            {                                                                                       \
                return nimboost::proto::env<TAG, Value &>(value.get());                                \
            }                                                                                       \
            template<typename Value>                                                                \
            typename nimboost::disable_if_c<                                                           \
                nimboost::is_const<Value>::value                                                       \
              , nimboost::proto::env<TAG, typename nimboost::proto::detail::value_type<Value>::type>      \
            >::type const operator =(Value &value) const                                            \
            {                                                                                       \
                return nimboost::proto::env<TAG, typename nimboost::proto::detail::value_type<Value>::type>(value); \
            }                                                                                       \
            template<typename Value>                                                                \
            nimboost::proto::env<TAG, typename nimboost::proto::detail::value_type<Value const>::type> const \
                operator =(Value const &value) const                                                \
            {                                                                                       \
                return nimboost::proto::env<TAG, typename nimboost::proto::detail::value_type<Value const>::type>(value); \
            }                                                                                       \
        };                                                                                          \
                                                                                                    \
        TAG const NAME = {}                                                                         \
