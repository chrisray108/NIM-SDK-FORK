...
namespace nimboost { namespace proto
{
    ...
    ///     <tt>nimboost::result_of\<when\<_,T\>(E,int,int)\>::type::value</tt>
    ...
    ///     \c E matches <tt>C::case_\<nimboost::result_of\<T(E)\>::type\></tt>.
    ...
    /// <tt>nimboost::result_of\<when\<_,If\>(E,int,int)\>::type::value</tt>
    /// is \c true and \c E matches \c U; or, if
    /// <tt>nimboost::result_of\<when\<_,If\>(E,int,int)\>::type::value</tt>
    ...
    /// if <tt>nimboost::result_of\<when\<_,If\>(E,S,V)\>::type::value</tt>
    ...
    /// matches <tt>C::case_\<nimboost::result_of\<T(E)\>::type\></tt>.
    ///
    ...
    /// <tt>C::case_\<nimboost::result_of\<T(E,S,D)\>::type\>()(e, s, d)</tt>.
