...
# define BOOST_PROTO_DECLTYPE_NESTED_TYPEDEF_TPL_(NESTED, EXPR)                                     \
    ...
    static int const BOOST_PP_CAT(sz, NESTED) = sizeof(nimboost::proto::detail::check_reference(EXPR));\
    struct NESTED                                                                                   \
      : nimboost::mpl::if_c<                                                                           \
...
namespace nimboost { namespace proto
{
    namespace detail
    {
        ...
        using namespace nimboost::proto::detail::get_pointerns                                         \
        /**/

        #define BOOST_PROTO_GET_POINTER(Type, Obj)                                                  \
        nimboost::proto::detail::proto_get_pointer<Type>(                                              \
            nimboost::proto::detail::lvalue(Obj)                                                       \
          , (true ? 0 : get_pointer(Obj))                                                           \
          , (true ? 0 : nimboost::addressof(nimboost::proto::detail::lvalue(Obj)))                        \
        )                                                                                           \
        /**/
        ...
        namespace get_pointerns
        {
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////
            // result_of_ is a wrapper around nimboost::result_of that also handles "invocations" of
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        // normalize a function type for use with nimboost::result_of
