    ...
    ///             in the \c nimboost::proto::tag namespace, but it doesn't
    ///             have to be.
    ///
    ...
    #endif
    {
        ...
        /// If \c Tag is \c nimboost::proto::tag::address_of and \c proto_child0 is
        ...
        /// \c nimboost::proto::tag::address_of. Otherwise, this function will
        /// fail to compile.
        ///
        ...
        {
            return nimboost::addressof(this->child0);
        }
    #else
        /// INTERNAL ONLY
        ///
        ...
        /// Encodes the return type of \c expr\<\>::operator(), for use with \c nimboost::result_of\<\>
        ///
