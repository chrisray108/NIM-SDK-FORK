...
# define BOOST_PROTO_DISABLE_IF_IS_CONST(T)\
    , typename nimboost::disable_if_c<nimboost::is_const<T>::value, nimboost::proto::detail::undefined>::type * = 0
#else
# define BOOST_PROTO_DISABLE_IF_IS_CONST(T)
#endif
...
# define BOOST_PROTO_DISABLE_IF_IS_FUNCTION(T)\
    , typename nimboost::disable_if_c<nimboost::is_function<T>::value, nimboost::proto::detail::undefined>::type * = 0
#else
# define BOOST_PROTO_DISABLE_IF_IS_FUNCTION(T)
#endif
...
# define BOOST_PROTO_RESULT_OF nimboost::result_of
#else
# define BOOST_PROTO_RESULT_OF nimboost::tr1_result_of
#endif
...
namespace nimboost { namespace proto
{
    namespace detail
    {
        ...
        #define BOOST_PROTO_UNCVREF(X)                                                              \
            typename nimboost::proto::detail::uncvref<X>::type                                         \
            /**/
