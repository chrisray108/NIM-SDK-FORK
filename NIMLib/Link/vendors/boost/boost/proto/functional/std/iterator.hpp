...
namespace nimboost { namespace proto { namespace functional
{
            ...
            typedef
                typename std::iterator_traits<
                    typename nimboost::remove_const<
                        typename nimboost::remove_reference<InputIter1>::type
                    >::type
                >::difference_type
            type;
        };
    ...
    struct next
    {
        ...
        struct result<This(ForwardIterator)>
        {
            typedef
                typename nimboost::remove_const<
                    typename nimboost::remove_reference<ForwardIterator>::type
                >::type
            type;
        };
    ...
    struct prior
    {
        ...
        struct result<This(BidirectionalIterator)>
        {
            typedef
                typename nimboost::remove_const<
                    typename nimboost::remove_reference<BidirectionalIterator>::type
                >::type
            type;
        };
