    ...
    struct push_back
    {
        ...
        struct result<This(Seq, T)>
          : fusion::result_of::push_back<
                typename nimboost::add_const<typename nimboost::remove_reference<Seq>::type>::type
              , typename nimboost::remove_const<typename nimboost::remove_reference<T>::type>::type
            >
        {};
