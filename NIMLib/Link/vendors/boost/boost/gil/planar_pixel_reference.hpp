...
void swap(const nimboost::gil::planar_pixel_reference<CR,CS> x, R& y) { 
    nimboost::gil::swap_proxy<typename nimboost::gil::planar_pixel_reference<CR,CS>::value_type>(x,y); 
}
...
void swap(typename nimboost::gil::planar_pixel_reference<CR,CS>::value_type& x, const nimboost::gil::planar_pixel_reference<CR,CS> y) { 
    nimboost::gil::swap_proxy<typename nimboost::gil::planar_pixel_reference<CR,CS>::value_type>(x,y); 
}
...
/// \ingroup PixelModelPlanarRef
template <typename CR, typename CS> inline
void swap(const nimboost::gil::planar_pixel_reference<CR,CS> x, const nimboost::gil::planar_pixel_reference<CR,CS> y) { 
    nimboost::gil::swap_proxy<typename nimboost::gil::planar_pixel_reference<CR,CS>::value_type>(x,y); 
}
}   // namespace std
