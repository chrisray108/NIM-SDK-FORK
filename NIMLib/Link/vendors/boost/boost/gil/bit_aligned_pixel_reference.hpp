...
struct bit_aligned_pixel_reference {
    ...
    typedef nimboost::gil::bit_range<bit_size,IsMutable>                                           bit_range_t;
...
void swap(const nimboost::gil::bit_aligned_pixel_reference<B,C,L,true> x, R& y) { 
    nimboost::gil::swap_proxy<typename nimboost::gil::bit_aligned_pixel_reference<B,C,L,true>::value_type>(x,y); 
}


template <typename B, typename C, typename L> inline
void swap(typename nimboost::gil::bit_aligned_pixel_reference<B,C,L,true>::value_type& x, const nimboost::gil::bit_aligned_pixel_reference<B,C,L,true> y) { 
    nimboost::gil::swap_proxy<typename nimboost::gil::bit_aligned_pixel_reference<B,C,L,true>::value_type>(x,y); 
}


template <typename B, typename C, typename L> inline
void swap(const nimboost::gil::bit_aligned_pixel_reference<B,C,L,true> x, const nimboost::gil::bit_aligned_pixel_reference<B,C,L,true> y) { 
    nimboost::gil::swap_proxy<typename nimboost::gil::bit_aligned_pixel_reference<B,C,L,true>::value_type>(x,y); 
}
}   // namespace std
#endif
