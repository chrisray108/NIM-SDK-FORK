...
struct DefaultConstructible {
    void constraints() {
        function_requires<nimboost::DefaultConstructibleConcept<T> >();
    }
};
...
struct CopyConstructible {
    void constraints() {
        function_requires<nimboost::CopyConstructibleConcept<T> >();
    }
};
...
struct Assignable {
    void constraints() {
        function_requires<nimboost::AssignableConcept<T> >();
    }
};
/// \ingroup BasicConcepts
/**
...
struct EqualityComparable {
    void constraints() {
        function_requires<nimboost::EqualityComparableConcept<T> >();
    }
};
...
struct SameType {
    void constraints() {
        BOOST_STATIC_ASSERT((nimboost::is_same<T,U>::value_core));
    }
};
...
struct Regular {
    void constraints() {
        gil_function_requires< nimboost::DefaultConstructibleConcept<T> >();
        gil_function_requires< nimboost::CopyConstructibleConcept<T> >();              
        gil_function_requires< nimboost::EqualityComparableConcept<T> >(); // ==, !=
        gil_function_requires< nimboost::AssignableConcept<T> >();
...
namespace detail {
    template <class TT> // Preconditions: TT Models nimboost_concepts::ForwardTraversalConcept
    ...
    template <class TT> // Preconditions: TT Models nimboost::BidirectionalIteratorConcept
    ...
    template <class TT> // Preconditions: TT Models nimboost_concepts::RandomAccessTraversalConcept
...
/**
\code
concept PixelDereferenceAdaptorConcept<nimboost::UnaryFunctionConcept D>
...
struct PixelDereferenceAdaptorConcept {
    void constraints() {
        gil_function_requires< nimboost::UnaryFunctionConcept<D, 
            typename remove_const_and_reference<typename D::result_type>::type, 
            typename D::argument_type> >();
        gil_function_requires< nimboost::DefaultConstructibleConcept<D> >();
        gil_function_requires< nimboost::CopyConstructibleConcept<D> >();              
        gil_function_requires< nimboost::AssignableConcept<D> >();
...
GIL's iterators must also provide the following metafunctions:
 ...
 \code
concept PixelIteratorConcept<typename Iterator> : nimboost_concepts::RandomAccessTraversalConcept<Iterator>, PixelBasedConcept<Iterator> {
...
struct PixelIteratorConcept {   
    void constraints() {
        gil_function_requires<nimboost_concepts::RandomAccessTraversalConcept<Iterator> >();
...
namespace detail {
    ...
    template <typename Iterator>  // Preconditions: Iterator Models nimboost_concepts::RandomAccessTraversalConcept
...
/**
\code
concept MemoryBasedIteratorConcept<nimboost_concepts::RandomAccessTraversalConcept Iterator> {
...
/**
\code
concept StepIteratorConcept<nimboost_concepts::ForwardTraversalConcept Iterator> {
...
struct StepIteratorConcept {
    void constraints() {
        gil_function_requires<nimboost_concepts::ForwardTraversalConcept<Iterator> >();
        it.set_step(0);
    }
    Iterator it;
};
...
\code
concept IteratorAdaptorConcept<nimboost_concepts::ForwardTraversalConcept Iterator> {
    where SameType<is_iterator_adaptor<Iterator>::type, mpl::true_>;

    typename iterator_adaptor_get_base<Iterator>;
        where Metafunction<iterator_adaptor_get_base<Iterator> >;
        where nimboost_concepts::ForwardTraversalConcept<iterator_adaptor_get_base<Iterator>::type>;
    
    typename another_iterator; 
    typename iterator_adaptor_rebind<Iterator,another_iterator>::type;
        where nimboost_concepts::ForwardTraversalConcept<another_iterator>;
...
struct IteratorAdaptorConcept {
    void constraints() {
        ...
        typedef typename iterator_adaptor_get_base<Iterator>::type base_t;
        gil_function_requires<nimboost_concepts::ForwardTraversalConcept<base_t> >();
...
struct RandomAccessNDLocatorConcept {
    void constraints() {
        ...
        gil_function_requires<nimboost_concepts::RandomAccessTraversalConcept<first_it_type> >();
        gil_function_requires<nimboost_concepts::RandomAccessTraversalConcept<last_it_type> >();
...
struct RandomAccessNDImageViewConcept {
    void constraints() {
        ...
        gil_function_requires<nimboost_concepts::RandomAccessTraversalConcept<iterator> >();
        gil_function_requires<nimboost_concepts::RandomAccessTraversalConcept<reverse_iterator> >();
