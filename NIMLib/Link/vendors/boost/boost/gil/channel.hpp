...
BOOST_STATIC_ASSERT((nimboost::is_integral<bits4>::value));
\endcode
*/
...
template <typename BitField,        // A type that holds the bits of the pixel from which the channel is referenced. Typically an integral type, like nimboost::uint16_t
...
void swap(const nimboost::gil::packed_channel_reference<BF,FB,NB,M> x, R& y) { 
    nimboost::gil::swap_proxy<typename nimboost::gil::packed_channel_reference<BF,FB,NB,M>::value_type>(x,y); 
}
...
void swap(typename nimboost::gil::packed_channel_reference<BF,FB,NB,M>::value_type& x, const nimboost::gil::packed_channel_reference<BF,FB,NB,M> y) { 
    nimboost::gil::swap_proxy<typename nimboost::gil::packed_channel_reference<BF,FB,NB,M>::value_type>(x,y); 
}
...
/// \brief swap for packed_channel_reference
template <typename BF, int FB, int NB, bool M> inline
void swap(const nimboost::gil::packed_channel_reference<BF,FB,NB,M> x, const nimboost::gil::packed_channel_reference<BF,FB,NB,M> y) { 
    nimboost::gil::swap_proxy<typename nimboost::gil::packed_channel_reference<BF,FB,NB,M>::value_type>(x,y); 
}
}   // namespace std
...
void swap(const nimboost::gil::packed_dynamic_channel_reference<BF,NB,M> x, R& y) { 
    nimboost::gil::swap_proxy<typename nimboost::gil::packed_dynamic_channel_reference<BF,NB,M>::value_type>(x,y); 
}
...
void swap(typename nimboost::gil::packed_dynamic_channel_reference<BF,NB,M>::value_type& x, const nimboost::gil::packed_dynamic_channel_reference<BF,NB,M> y) { 
    nimboost::gil::swap_proxy<typename nimboost::gil::packed_dynamic_channel_reference<BF,NB,M>::value_type>(x,y); 
}
...
/// \brief swap for packed_dynamic_channel_reference
template <typename BF, int NB, bool M> inline
void swap(const nimboost::gil::packed_dynamic_channel_reference<BF,NB,M> x, const nimboost::gil::packed_dynamic_channel_reference<BF,NB,M> y) { 
    nimboost::gil::swap_proxy<typename nimboost::gil::packed_dynamic_channel_reference<BF,NB,M>::value_type>(x,y); 
}
}   // namespace std
