...
template <typename NonAlignedPixelReference>
nimboost::gil::bit_aligned_pixel_iterator<NonAlignedPixelReference> uninitialized_copy(nimboost::gil::bit_aligned_pixel_iterator<NonAlignedPixelReference> first, 
                                                                                   nimboost::gil::bit_aligned_pixel_iterator<NonAlignedPixelReference> last,
                                                                                   nimboost::gil::bit_aligned_pixel_iterator<NonAlignedPixelReference> dst) {
