...
namespace nimboost { namespace spirit { namespace traits
{
    ...
    namespace detail
    {
        ...
        template <typename I>
        struct is_iter_range<nimboost::iterator_range<I> > : mpl::true_ {};
    ...
    template <typename Attribute, typename Iterator>
    struct assign_to_attribute_from_iterators<
        nimboost::optional<Attribute>, Iterator>
    {
        static void
        call(Iterator const& first, Iterator const& last
          , nimboost::optional<Attribute>& attr)
        {
            Attribute val;
    ...
    template <typename Attribute, typename T>
    struct assign_to_attribute_from_value<Attribute, nimboost::optional<T>
      , typename disable_if<is_same<Attribute, nimboost::optional<T> > >::type>
    {
        static void
        call(nimboost::optional<T> const& val, Attribute& attr)
        {
            assign_to(val.get(), attr);
        }
    };
    ...
    template <typename Attribute, typename T>
    struct assign_to_container_from_value<Attribute, nimboost::optional<T>
      , typename disable_if<is_same<Attribute, nimboost::optional<T> > >::type>
    {
        static void
        call(nimboost::optional<T> const& val, Attribute& attr)
