...
namespace nimboost { namespace spirit { namespace qi { namespace detail
{
    ...
    struct iterator_source
    {
        ...
        char_type;
        typedef nimboost::iostreams::seekable_device_tag category;
        ...
        // nimboost::iostreams::seekable_device. We need to have see support to
        ...
        std::streampos seek(nimboost::iostreams::stream_offset, std::ios_base::seekdir way) 
        {
