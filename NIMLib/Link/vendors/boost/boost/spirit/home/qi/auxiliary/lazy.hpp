...
namespace nimboost { namespace spirit
{
    ...
    struct use_terminal<qi::domain, nimboostphoenix::actor<Eval> >  // enables phoenix actors
        : mpl::true_ {};
...
namespace nimboost { namespace spirit { namespace qi
{
    ...
    struct lazy_parser : parser<lazy_parser<Function, Modifiers> >
    {
        ...
        {
            typedef typename
                nimboost::result_of<qi_modify(tag::lazy_eval, Modifiers)>::type
            modifier;

            typedef typename
                remove_reference<
                    typename nimboost::result_of<Function(unused_type, Context)>::type
                >::type
            expr_type;
    ...
    struct make_primitive<nimboostphoenix::actor<Eval>, Modifiers>
    {
        typedef lazy_parser<nimboostphoenix::actor<Eval>, Modifiers> result_type;
        result_type operator()(nimboostphoenix::actor<Eval> const& f
