...
{
    // nimboostphoenix::void_ is the same as fusion::void_
...
{
    template <typename Eval>
    struct result_of<nimboostphoenix::actor<Eval>()>
    {
        typedef typename nimboostphoenix::actor<Eval>::nullary_result type;
    };

    template <typename Eval>
    struct result_of<nimboostphoenix::actor<Eval> const()>
        : result_of<nimboostphoenix::actor<Eval>()>
    {};
}
