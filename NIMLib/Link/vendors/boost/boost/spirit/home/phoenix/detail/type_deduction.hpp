...
/*=============================================================================
    ...
    through a nimboost::mpl vector which holds each of the corresponding
    result types.
...
namespace nimboost { namespace type_deduction_detail
{
    ...
    {
        typedef typename nimboostphoenix::detail::unwrap_local_reference<X>::type x_type_;
        typedef typename nimboostphoenix::detail::unwrap_local_reference<Y>::type y_type_;
...
}} // namespace nimboost::type_deduction_detail
