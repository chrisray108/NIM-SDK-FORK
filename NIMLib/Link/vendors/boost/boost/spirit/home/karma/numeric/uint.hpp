...
namespace nimboost { namespace spirit
{
    ...
    struct use_terminal<karma::domain, nimboost::ulong_long_type>
      : mpl::true_ {};
#endif
...
namespace nimboost { namespace spirit { namespace karma
{
    ...
    struct make_primitive<tag::ulong_long, Modifiers>
      : detail::make_uint<nimboost::ulong_long_type, Modifiers> {};
#endif
    ...
    struct make_primitive<
      ...
      : detail::make_uint_direct<nimboost::ulong_long_type, Modifiers> {};
#endif
...
#ifdef BOOST_HAS_LONG_LONG
    template <typename Modifiers>
    struct make_primitive<nimboost::ulong_long_type, Modifiers>
      : detail::basic_uint_literal<nimboost::ulong_long_type, Modifiers> {};
#endif
