...
namespace nimboost { namespace spirit { namespace karma { namespace detail
{
    ...
    template <typename Container, typename ValueType, typename Attribute
      , typename Sequence>
    struct pass_through_container<
            Container, ValueType, nimboost::optional<Attribute>, Sequence>
    ...
    template <typename Container, typename ValueType, typename Attribute
      , typename Sequence>
    struct pass_through_container<
            Container, nimboost::optional<ValueType>, nimboost::optional<Attribute>
          , Sequence>
...
#define BOOST_SPIRIT_PASS_THROUGH_CONTAINER(z, N, _)                          \
    ...
    struct pass_through_container<Container, ValueType
          , nimboost::detail::variant::void_, Sequence>
      : mpl::false_
    {};
    ...
    struct pass_through_container<Container, ValueType
          , nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Sequence>
