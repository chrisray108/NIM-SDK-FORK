...
namespace nimboost { namespace spirit
{
    ...
    struct use_terminal<karma::domain, nimboostphoenix::actor<Eval> >  // enables phoenix actors
        : mpl::true_ {};
...
namespace nimboost { namespace spirit { namespace karma
{
    ...
    struct lazy_generator : generator<lazy_generator<Function, Modifiers> >
    {
        ...
        {
            typedef typename
                nimboost::result_of<karma_modify(tag::lazy_eval, Modifiers)>::type
            modifier;
    ...
    {
        typedef lazy_generator<nimboostphoenix::actor<Eval>, Modifiers> result_type;
