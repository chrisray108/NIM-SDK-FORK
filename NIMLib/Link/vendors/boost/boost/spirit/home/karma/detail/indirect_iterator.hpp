...
///////////////////////////////////////////////////////////////////////////////
namespace nimboost { namespace spirit { namespace karma { namespace detail
{
    ///////////////////////////////////////////////////////////////////////
    ...
    class indirect_iterator
      : public nimboost::iterator_facade<
          ...
          , typename nimboost::detail::iterator_traits<Iterator>::value_type
          , nimboost::forward_traversal_tag
          , typename nimboost::detail::iterator_traits<Iterator>::reference>
    {
        typedef typename nimboost::detail::iterator_traits<Iterator>::value_type
            base_value_type;
        typedef typename nimboost::detail::iterator_traits<Iterator>::reference
            base_reference_type;

        typedef nimboost::iterator_facade<
            indirect_iterator<Iterator>, base_value_type
          , nimboost::forward_traversal_tag, base_reference_type
        > base_type;
