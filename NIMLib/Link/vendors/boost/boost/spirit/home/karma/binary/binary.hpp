...
///////////////////////////////////////////////////////////////////////////////
namespace nimboost { namespace spirit { namespace karma
{
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
    using nimboost::spirit::byte_;
    using nimboost::spirit::word;
    using nimboost::spirit::big_word;
    using nimboost::spirit::little_word;
    using nimboost::spirit::dword;
    using nimboost::spirit::big_dword;
    using nimboost::spirit::little_dword;
#ifdef BOOST_HAS_LONG_LONG
    using nimboost::spirit::qword;
    using nimboost::spirit::big_qword;
    using nimboost::spirit::little_qword;
#endif
    using nimboost::spirit::bin_float;
    using nimboost::spirit::big_bin_float;
    using nimboost::spirit::little_bin_float;
    using nimboost::spirit::bin_double;
    using nimboost::spirit::big_bin_double;
    using nimboost::spirit::little_bin_double;
#endif

    using nimboost::spirit::byte_type;
    using nimboost::spirit::word_type;
    using nimboost::spirit::big_word_type;
    using nimboost::spirit::little_word_type;
    using nimboost::spirit::dword_type;
    using nimboost::spirit::big_dword_type;
    using nimboost::spirit::little_dword_type;
#ifdef BOOST_HAS_LONG_LONG
    using nimboost::spirit::qword_type;
    using nimboost::spirit::big_qword_type;
    using nimboost::spirit::little_qword_type;
#endif
    using nimboost::spirit::bin_float_type;
    using nimboost::spirit::big_bin_float_type;
    using nimboost::spirit::little_bin_float_type;
    using nimboost::spirit::bin_double_type;
    using nimboost::spirit::big_bin_double_type;
    using nimboost::spirit::little_bin_double_type;
    ...
    namespace detail
    {
        ...
        ///////////////////////////////////////////////////////////////////////
        template <BOOST_SCOPED_ENUM(nimboost::endian::endianness) bits>
        struct what;

        template <>
        struct what<nimboost::endian::endianness::native>
        {
            static info is()
            {
        ...
        template <>
        struct what<nimboost::endian::endianness::little>
        {
            static info is()
            {
        ...
        template <>
        struct what<nimboost::endian::endianness::big>
        {
            static info is()
            {
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename T, BOOST_SCOPED_ENUM(nimboost::endian::endianness) endian, int bits>
      ...
      : primitive_generator<any_binary_generator<T, endian, bits> >
    {
          ...
          , Delimiter const& d, Attribute const& attr)
        {
            ...
            nimboost::endian::endian<endian, typename T::type, bits> p;
...
#pragma warning(pop)
        ...
        typedef nimboost::endian::endian<endian, typename T::type,
            bits> data_type;
    ...
    namespace detail
    {
        template <typename T, BOOST_SCOPED_ENUM(nimboost::endian::endianness) endian
          , int bits>
        struct basic_binary
        {
        ...
        template <typename Modifiers, typename T
          , BOOST_SCOPED_ENUM(nimboost::endian::endianness) endian, int bits>
...
#define BOOST_SPIRIT_MAKE_BINARY_PRIMITIVE(name, endiantype, bits)            \
    ...
    struct make_primitive<tag::name, Modifiers>                               \
      : detail::basic_binary<detail::integer<bits>,                           \
        nimboost::endian::endianness::endiantype, bits> {};                      \
                                                                              \
