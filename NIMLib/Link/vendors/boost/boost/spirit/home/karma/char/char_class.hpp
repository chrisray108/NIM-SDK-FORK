...
namespace nimboost { namespace spirit { namespace karma
{
    ...
    // the same name
    namespace ascii { using namespace nimboost::spirit::ascii; }
    namespace iso8859_1 { using namespace nimboost::spirit::iso8859_1; }
    namespace standard { using namespace nimboost::spirit::standard; }
    namespace standard_wide { using namespace nimboost::spirit::standard_wide; }
#if defined(BOOST_SPIRIT_UNICODE)
    namespace unicode { using namespace nimboost::spirit::unicode; }
#endif
    ...
    using namespace nimboost::spirit::standard;
...
}}}  // namespace nimboost::spirit::karma
