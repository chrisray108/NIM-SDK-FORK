...
struct grammar_definition
{
    ...
    struct grammar_helper : private grammar_helper_base<GrammarT>
    {
        ...
        typedef nimboost::shared_ptr<helper_t> helper_ptr_t;
        typedef nimboost::weak_ptr<helper_t>   helper_weak_ptr_t;
...
#ifdef BOOST_SPIRIT_THREADSAFE
            nimboost::mutex::scoped_lock lock(helpers.mutex());
#endif
...
# ifdef BOOST_SPIRIT_THREADSAFE
        nimboost::thread_specific_ptr<ptr_t> & tld_helper
            = static_<nimboost::thread_specific_ptr<ptr_t>,
