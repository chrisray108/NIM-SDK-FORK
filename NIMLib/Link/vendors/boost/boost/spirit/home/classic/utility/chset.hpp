...
private:
    ...
    nimboost::shared_ptr<basic_chset<CharT> > ptr;
};
...
//////////////////////////////////
inline chset< ::nimboost::long_long_type>
chset_p( ::nimboost::long_long_type ch)
{ return chset< ::nimboost::long_long_type>(ch); }

//////////////////////////////////
inline chset< ::nimboost::ulong_long_type>
chset_p( ::nimboost::ulong_long_type ch)
{ return chset< ::nimboost::ulong_long_type>(ch); }
#endif
