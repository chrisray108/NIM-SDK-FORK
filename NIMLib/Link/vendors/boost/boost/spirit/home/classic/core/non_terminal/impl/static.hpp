...
BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    //      T::T() MUST not throw!
    //          this is a requirement of nimboost::call_once.
    //
    ...
    public:
        ...
        static_(Tag = Tag())
        {
            nimboost::call_once(&default_ctor::construct, constructed_);
        }
    ...
    private:
        typedef typename nimboost::add_pointer<value_type>::type pointer;
        ...
        typedef nimboost::aligned_storage<sizeof(value_type),
            nimboost::alignment_of<value_type>::value> storage_type;
