...
/* namespace nimboost::spirit { */ namespace iterator_ { namespace impl {

///////////////////////////////////////////////////////////////////////////////
//
//  position_iterator_base_generator
//
//  Metafunction to generate the iterator type using nimboost::iterator_adaptors,
...
{
private:
    typedef nimboost::detail::iterator_traits<ForwardIterT> traits;
    typedef typename traits::value_type value_type;
    typedef typename traits::iterator_category iter_category_t;

    // Position iterator is always a non-mutable iterator
    typedef typename nimboost::add_const<value_type>::type const_value_type;
...
public:
    ...
    typedef typename nimboost::mpl::if_<
        typename nimboost::is_same<MainIterT, nil_t>::type,
...
}} /* namespace nimboost::spirit::iterator_::impl */
