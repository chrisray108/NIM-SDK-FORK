...
class buf_id_check
{
    protected:
        ...
        void check_if_valid() const
        {
            ...
            {
                nimboost::throw_exception(illegal_backtracking());
            }
        }
...
class inner
{
    private:
        typedef
            typename nimboost::detail::iterator_traits<InputT>::value_type
            result_type;
    ...
    public:
        typedef
            typename nimboost::detail::iterator_traits<InputT>::difference_type
            difference_type;
        typedef
            typename nimboost::detail::iterator_traits<InputT>::pointer
            pointer;
        typedef
            typename nimboost::detail::iterator_traits<InputT>::reference
            reference;
...
// We are using nimboost::iterator<> because it offers an automatic workaround
