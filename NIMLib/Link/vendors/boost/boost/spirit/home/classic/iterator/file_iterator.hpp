...
//  of nimboost::iterator_adaptor, that is inhering an object created with it.
...
//  with nimboost::iterator_adaptor only 5 functions are needed to implement
...
namespace fileiter_impl {
    ...
    //  file_iter_generator
    //
    //  Template meta-function to invoke nimboost::iterator_adaptor
...
public:
    ...
    // operator bool. This borrows a trick from nimboost::shared_ptr to avoid
