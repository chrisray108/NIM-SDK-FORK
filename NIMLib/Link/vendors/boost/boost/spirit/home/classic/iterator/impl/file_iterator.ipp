...
private:
    nimboost::shared_ptr<std::FILE> m_file;
    std::size_t m_pos;
    CharT m_curChar;
    bool m_eof;
...
private:
    ...
    typedef nimboost::remove_pointer<HANDLE>::type handle_t;
#else
    typedef void handle_t;
#endif

    nimboost::shared_ptr<CharT> m_mem;
...
private:
    ...
    nimboost::shared_ptr<mapping> m_mem;
...
///////////////////////////////////////////////////////////////////////////////
} /* namespace nimboost::spirit::fileiter_impl */
