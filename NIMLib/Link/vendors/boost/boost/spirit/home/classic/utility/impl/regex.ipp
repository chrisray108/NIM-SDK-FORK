...
public:
    ...
    {
        nimboost::match_results<typename ScannerT::iterator_t> what;
        nimboost::regex_search(scan.first, scan.last, what, rxstr,
            nimboost::match_default);
...
private:
    ...
    nimboost::basic_regex<CharT> rxstr;       // regular expression to match
#else
    nimboost::reg_expression<CharT> rxstr;    // regular expression to match
#endif
};
