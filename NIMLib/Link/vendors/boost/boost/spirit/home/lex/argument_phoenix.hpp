...
namespace nimboost { namespace spirit { namespace lex
{
    ///////////////////////////////////////////////////////////////////////////
...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (nimboost)(spirit)(lex)(value_setter)
  , (nimboost::nimboostphoenix::meta_grammar)
)

BOOST_PHOENIX_DEFINE_EXPRESSION(
    (nimboost)(spirit)(lex)(state_setter)
  , (nimboost::nimboostphoenix::meta_grammar)
)
...
namespace nimboost { namespace nimboostphoenix
{
    ...
    {
        template <>
        struct is_nullary<custom_terminal<nimboost::spirit::lex::value_context> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<nimboost::spirit::lex::value_context, Dummy>: mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<nimboost::spirit::lex::value_context, Dummy>
      : proto::call<
            v2_eval(
                proto::make<nimboost::spirit::lex::value_getter()>
    ...
    struct actor<spirit::lex::value_context>
      : nimboost::nimboostphoenix::actor<proto::terminal<spirit::lex::value_context>::type>
    {
        typedef nimboost::nimboostphoenix::actor<
        ...
        typename spirit::lex::expression::value_setter<
            typename nimboostphoenix::as_actor<Expr>::type>::type const
        operator=(Expr const & expr) const
        {
            return
                spirit::lex::expression::value_setter<
                    typename nimboostphoenix::as_actor<Expr>::type
                >::make(nimboostphoenix::as_actor<Expr>::convert(expr));
        }
    };
    ...
    {
        template <>
        struct is_nullary<custom_terminal<nimboost::spirit::lex::state_context> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<nimboost::spirit::lex::state_context, Dummy>: mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<nimboost::spirit::lex::state_context, Dummy>
      : proto::call<
            v2_eval(
                proto::make<nimboost::spirit::lex::state_getter()>
              , proto::call<functional::env(proto::_state)>
            )
        >
    {};
    ...
    struct actor<spirit::lex::state_context>
      : nimboost::nimboostphoenix::actor<proto::terminal<spirit::lex::state_context>::type>
    {
        typedef nimboost::nimboostphoenix::actor<
    ...
    {
        template <>
        struct is_nullary<custom_terminal<nimboost::spirit::lex::eoi_getter> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<nimboost::spirit::lex::eoi_getter, Dummy>: mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<nimboost::spirit::lex::eoi_getter, Dummy>
      : proto::call<
            v2_eval(
                proto::make<nimboost::spirit::lex::eoi_getter()>
              , proto::call<functional::env(proto::_state)>
            )
        >
    {};
