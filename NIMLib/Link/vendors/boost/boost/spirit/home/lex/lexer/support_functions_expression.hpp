...
namespace nimboost { namespace spirit { namespace lex
{
    namespace expression
    {
        ...
        struct less
        {
            typedef nimboostphoenix::actor<lex::less_type<Eval> > type;
        ...
        struct lookahead
        {
            typedef nimboostphoenix::actor<lex::lookahead_type<IdType, State> > type;
...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (nimboost)(spirit)(lex)(less)
  , (nimboost::nimboostphoenix::meta_grammar)
)

BOOST_PHOENIX_DEFINE_EXPRESSION(
    (nimboost)(spirit)(lex)(lookahead)
  , (nimboost::nimboostphoenix::meta_grammar)
    (nimboost::nimboostphoenix::meta_grammar)
)
...
namespace nimboost { namespace nimboostphoenix
{
    ...
    {
        template <>
        struct is_nullary<custom_terminal<nimboost::spirit::lex::more_type> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<nimboost::spirit::lex::more_type, Dummy> : mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<nimboost::spirit::lex::more_type, Dummy>
        : proto::call<
            v2_eval(
                proto::make<nimboost::spirit::lex::more_type()>
