...
namespace nimboost { namespace spirit { namespace lex
{
    ...
    struct state_setter
    {
        ...
        state_setter(nimboostphoenix::actor<state_getter>, Actor const& actor)
          : actor_(actor) {}
#endif
...
#ifndef BOOST_SPIRIT_USE_PHOENIX_V3
        // see explanation for this constructor at the end of this file
        value_setter(nimboostphoenix::actor<value_getter>, Actor const& actor)
          : actor_(actor) {}
#endif
    ...
    typedef nimboostphoenix::arg_names::_1_type _start_type;
    typedef nimboostphoenix::arg_names::_2_type _end_type;
    ...
    // definition).
    // typedef nimboostphoenix::arg_names::_3_type _pass_type;
    using nimboost::spirit::_pass_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
    using nimboost::spirit::_pass;
#endif

    // '_tokenid' may be used to access and change the tokenid of the current 
    // token
    typedef nimboostphoenix::arg_names::_4_type _tokenid_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
    _tokenid_type const _tokenid = _tokenid_type();
#endif

    typedef nimboostphoenix::actor<value_context> _val_type;
    typedef nimboostphoenix::actor<state_context> _state_type;
    typedef nimboostphoenix::actor<eoi_getter> _eoi_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
