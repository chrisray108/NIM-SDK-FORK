...
namespace nimboost { namespace spirit
{
    template <
        BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(
            ...
            typename T, nimboost::detail::variant::void_)
...
namespace nimboost
{
    ...
    inline T const&
    get(nimboost::spirit::extended_variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& x)
    {
        return nimboost::get<T>(x.get());
    }

    template <typename T, BOOST_VARIANT_ENUM_PARAMS(typename T)>
    inline T&
    get(nimboost::spirit::extended_variant<BOOST_VARIANT_ENUM_PARAMS(T)>& x)
    {
        return nimboost::get<T>(x.get());
    }
