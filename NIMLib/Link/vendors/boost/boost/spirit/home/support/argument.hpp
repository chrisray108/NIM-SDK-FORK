...
#define SPIRIT_DECLARE_ARG(z, n, data)                                        \
    typedef nimboostphoenix::actor<argument<n> >                                      \
        BOOST_PP_CAT(BOOST_PP_CAT(_, BOOST_PP_INC(n)), _type);                \
    nimboostphoenix::actor<argument<n> > const                                        \
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <typename Dummy>
  , nimboost::spirit::attribute_context<Dummy>
  , mpl::false_                 // is not nullary
  , v2_eval(
        proto::make<
            nimboost::spirit::attribute_context<Dummy>()
...
namespace nimboost { namespace spirit
{
    ...
    typedef nimboostphoenix::actor<attribute_context<void> > _0_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
    ...
    typedef nimboostphoenix::actor<argument<0> > _1_type;
    typedef nimboostphoenix::actor<argument<1> > _2_type;
    typedef nimboostphoenix::actor<argument<2> > _3_type;
