...
{
    static const ::nimboost::uint8_t category_stage1[] = {
    ...
    static const ::nimboost::uint16_t category_stage2[] = {
    ...
    inline ::nimboost::uint16_t category_lookup(::nimboost::uint32_t ch)
    {
        ::nimboost::uint32_t block_offset = category_stage1[ch / 256] * 256;
