...
namespace nimboost { namespace spirit { namespace ucd { namespace detail
{
    static const ::nimboost::uint8_t lowercase_stage1[] = {
    ...
    static const ::nimboost::uint32_t lowercase_stage2[] = {
    ...
    inline ::nimboost::uint32_t lowercase_lookup(::nimboost::uint32_t ch)
    {
        ::nimboost::uint32_t block_offset = lowercase_stage1[ch / 256] * 256;
        return lowercase_stage2[block_offset + ch % 256];
    }

}}}} // namespace nimboost::spirit::unicode::detail
