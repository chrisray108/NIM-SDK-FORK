...
namespace nimboost { namespace spirit
{
  namespace detail
  {
    ...
    template <typename T, std::size_t n_bytes,
      bool sign=nimboost::is_signed<T>::value >
...
// import the namespace above into nimboost::endian
namespace nimboost { namespace endian
{
    using namespace nimboost::spirit::endian;
}}
