...
namespace nimboost { namespace nimboostphoenix { namespace detail
{
    namespace expression
    {
        ...
        {
            typedef nimboostphoenix::actor<
                typename nimboostphoenix::as_composite<
                    nimboostphoenix::detail::function_eval<1>, F, A0
                >::type
            > type;

            static type make(F f, A0 const & _0)
            {
                return nimboostphoenix::compose<
                    nimboostphoenix::detail::function_eval<1> >(f, _0);
            }
        };
        ...
        struct function_eval<F, A0, A1>
        {
            typedef nimboostphoenix::actor<
                typename nimboostphoenix::as_composite<
                    nimboostphoenix::detail::function_eval<2>, F, A0, A1
                >::type
            > type;
            ...
            {
                return nimboostphoenix::compose<
                    nimboostphoenix::detail::function_eval<2> >(f, _0, _1);
            }
        };
        ...
        struct function_eval<F, A0, A1, A2>
        {
            typedef nimboostphoenix::actor<
                typename nimboostphoenix::as_composite<
                    nimboostphoenix::detail::function_eval<3>, F, A0, A1, A2
                >::type
            > type;
            ...
            {
                return nimboostphoenix::compose<
                    nimboostphoenix::detail::function_eval<3> >(f, _0, _1, _2);
            }
        };
    }
}}}
