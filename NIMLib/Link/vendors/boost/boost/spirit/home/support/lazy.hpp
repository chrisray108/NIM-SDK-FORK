...
namespace nimboost { namespace spirit
{
    ...
    typename proto::terminal<nimboostphoenix::actor<Eval> >::type
    lazy(nimboostphoenix::actor<Eval> const& f)
    {
        return proto::terminal<nimboostphoenix::actor<Eval> >::type::make(f);
    }
