...
namespace nimboost { namespace spirit { namespace iterator_policies
{
    ...
    template <typename T
      ...
      , bool OwnershipIsEmpty = nimboost::is_empty<Ownership>::value
      , bool CheckingIsEmpty = nimboost::is_empty<Checking>::value
      , bool InputIsEmpty = nimboost::is_empty<Input>::value>
    struct multi_pass_unique;
