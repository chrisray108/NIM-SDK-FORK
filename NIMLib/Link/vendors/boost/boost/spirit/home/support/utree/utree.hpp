...
namespace nimboost { namespace spirit
{
    ...
    */
    struct utree_type
    {
        ...
        typedef nimboost::uint_t<sizeof(info)*8>::exact exact_integral_type; 
        typedef nimboost::uint_t<sizeof(info)*8>::fast fast_integral_type; 
    };
    //]
    ...
    {
        nimboost::io::ios_all_saver saver(out);
        switch (t) {
    ...
    */
    typedef basic_string<
        nimboost::iterator_range<char const*>, utree_type::binary_type
    > binary_range_type;
    typedef basic_string<
    ...
    */
    typedef basic_string<
        nimboost::iterator_range<char const*>, utree_type::string_type
    ...
    */
    typedef basic_string<
        nimboost::iterator_range<char const*>, utree_type::symbol_type
    ...
    public:
        ...
        typename nimboost::disable_if<
            nimboost::is_polymorphic<
                typename nimboost::remove_pointer<Ptr>::type>,
            Ptr>::type
        get() const
        {
            if (*i == typeid(Ptr))
            ...
            nimboost::throw_exception(std::bad_cast());
        }
    ...
    public:
        ...
        typedef detail::list::node_iterator<nimboost::reference_wrapper<utree> >
          ref_iterator;

        typedef nimboost::iterator_range<iterator> range;
        typedef nimboost::iterator_range<const_iterator> const_range;
        ...
        */
        ...
        // where a nimboost::optional is expected (i.e. as an attribute for the 
        ...
        utree(nimboost::reference_wrapper<utree>);
        reference operator=(nimboost::reference_wrapper<utree>);
        ...
        utree(nimboost::iterator_range<Iterator>);
        template <class Iterator>
        reference operator=(nimboost::iterator_range<Iterator>);
