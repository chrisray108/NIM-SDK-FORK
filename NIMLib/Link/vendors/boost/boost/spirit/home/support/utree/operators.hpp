...
namespace nimboost { namespace spirit 
{
    ...
    struct utree_is_equal
    {
        ...
        bool dispatch(const A&, const B&, nimboost::mpl::false_) const
        {
            return false; // cannot compare different types by default
        }

        template <typename A, typename B>
        bool dispatch(const A& a, const B& b, nimboost::mpl::true_) const
        {
        ...
        bool operator()(const A& a, const B& b) const
        {
            return dispatch(a, b,
                nimboost::mpl::and_<
                    nimboost::is_arithmetic<A>,
                    nimboost::is_arithmetic<B> >());
        }
    ...
    struct utree_print
    {
        ...
        void operator()(nimboost::iterator_range<Iterator> const& range) const
        {
            typedef typename nimboost::iterator_range<Iterator>::const_iterator iterator;
            (*this)('(');
            for (iterator i = range.begin(); i != range.end(); ++i)
            {
                nimboost::spirit::utree::visit(*i, *this);
            }
            (*this)(')');
        }
    ...
    struct logical_function
    {
        ...
        {
            return dispatch(a, nimboost::is_arithmetic<A>());
        }
    ...
    struct arithmetic_function
    {
        ...
        template <typename A, typename B>
        utree dispatch(A const&, B const&, nimboost::mpl::false_) const
        {
            return utree(); // cannot apply to non-arithmetic types
        }

        template <typename A, typename B>
        utree dispatch(A const& a, B const& b, nimboost::mpl::true_) const
        {
            return Base::eval(a, b); // for arithmetic types
        }
        ...
        template <typename A>
        utree dispatch(A const&, nimboost::mpl::false_) const
        {
            return utree(); // cannot apply to non-arithmetic types
        }

        template <typename A>
        utree dispatch(A const& a, nimboost::mpl::true_) const
        {
    ...
    struct integral_function
    {
        ...
        utree operator()(A const& a, B const& b) const
        {
            return dispatch(a, b,
                nimboost::mpl::and_<
                    nimboost::is_integral<A>,
                    nimboost::is_integral<B> >());
        }
        ...
        utree operator()(A const& a) const
        {
            return dispatch(a, nimboost::is_integral<A>());
        }
    };
