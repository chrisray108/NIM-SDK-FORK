...
namespace nimboost { namespace spirit { namespace iterator_policies
{
    ...
    struct input_iterator
    {
        ...
        private:
            typedef
                typename nimboost::detail::iterator_traits<T>::value_type
            result_type;

        public:
            typedef
                typename nimboost::detail::iterator_traits<T>::difference_type
            difference_type;
            typedef
                typename nimboost::detail::iterator_traits<T>::difference_type
            distance_type;
            typedef
                typename nimboost::detail::iterator_traits<T>::pointer
            pointer;
            typedef
                typename nimboost::detail::iterator_traits<T>::reference
            reference;
