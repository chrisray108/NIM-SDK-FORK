/*=============================================================================
    ...
    The class nimboost::spirit::hold_any is built based on the any class
...
namespace nimboost { namespace spirit
{
    struct bad_any_cast
      : std::bad_cast
    {
        bad_any_cast(nimboost::detail::sp_typeinfo const& src, nimboost::detail::sp_typeinfo const& dest)
    ...
    namespace detail
    {
        ...
        {
            nimboost::detail::sp_typeinfo const& (*get_type)();
        ...
        struct fxns<mpl::true_>
        {
            ...
            struct type
            {
                static nimboost::detail::sp_typeinfo const& get_type()
                {
    ...
    public:
        ...
        nimboost::detail::sp_typeinfo const& type() const
        {
...
// implicit casting is disabled by default for compatibility with nimboost::any
    ...
    T any_cast(basic_hold_any<Char>& operand)
    {
        ...
        if(!result)
            nimboost::throw_exception(bad_any_cast(operand.type(), BOOST_SP_TYPEID(T)));
        return *result;
    }
