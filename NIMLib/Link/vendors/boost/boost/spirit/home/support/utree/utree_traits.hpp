...
{
    template <typename T>
    inline T get(nimboost::spirit::utree const& x)
    {
        return x.get<T>();
    }
}
...
namespace nimboost { namespace spirit { namespace traits
{
    ...
    namespace detail
    {
        struct attribute_as_string_type
        {
            ...
            {
                return nimboost::get<utf8_string_range_type>(attr);
            }
    ...
    namespace detail
    {
        struct attribute_as_symbol_type
        {
            ...
            static type call(utree const& attr)
            {
                return nimboost::get<utf8_symbol_range_type>(attr);
            }
    ...
    namespace detail
    {
        struct attribute_as_binary_string_type
        {
            ...
            static type call(utree const& attr)
            {
                return nimboost::get<binary_range_type>(attr);
            }
    ...
    namespace detail
    {
        ...
        template <typename Attribute>
        struct handles_utree_list_container<nimboost::optional<Attribute> >
          : mpl::true_
        {};

        template <BOOST_VARIANT_ENUM_PARAMS(typename T)>
        struct handles_utree_list_container<
                nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
          : mpl::true_
        {};
    }
    ...
    namespace detail
    {
        ...
        template <typename Attribute>
        struct handles_utree_container<nimboost::optional<Attribute> >
          : mpl::true_
        {};
    ...
    struct symbols_lookup<utree, utf8_symbol_type>
    {
        ...
        {
            utf8_symbol_range_type r = nimboost::get<utf8_symbol_range_type>(t);
    ...
    namespace detail
    {
        ...
        {
            if (detail::is_list(t))
                return nimboost::get<T>(t.front());
            return nimboost::get<T>(t);
        }
    }
        ...
        iterator_range<Iterator> const, utree, karma::domain>
    {
        ...
        static type pre(iterator_range<Iterator> const& t)
        {
            ...
            Iterator it = nimboost::begin(t);
            utree result(nimboost::ref(*it));
            ++it;
            return result;
        }
    };
