...
///////////////////////////////////////////////////////////////////////////////
namespace nimboost { namespace spirit { namespace traits
{
    ///////////////////////////////////////////////////////////////////////////
...
#define BOOST_SPIRIT_IS_WEAK_SUBSTITUTE(z, N, _)                              \
    ...
    struct is_weak_substitute<nimboost::detail::variant::void_, Expected>
      : mpl::true_
    {};

    template <BOOST_VARIANT_ENUM_PARAMS(typename T), typename Expected>
    struct is_weak_substitute<
            nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Expected>
...
#undef BOOST_SPIRIT_IS_WEAK_SUBSTITUTE
    ...
    struct not_is_variant<nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Domain>
      : mpl::false_
    {};

    template <typename T, typename Domain>
    struct not_is_variant<nimboost::optional<T>, Domain>
    ...
    template <typename T>
    struct variant_type<nimboost::optional<T> >
      : variant_type<T>
    {};
    ...
    namespace detail
    {
        ...
        template <typename Expected, typename Attribute>
        struct attribute_is_compatible<Expected, nimboost::optional<Attribute> >
          : is_convertible<Attribute, Expected>
        {};
    ...
    struct variant_which<nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
    {
        static int call(nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& v)
        {
            return v.which();
        }
    };
    ...
    template <typename T, typename Domain>
    struct not_is_optional<nimboost::optional<T>, Domain>
      : mpl::false_
    {};
    ...
    {
        typedef typename nimboost::detail::iterator_traits<Iterator>::
            difference_type type;

        static type call(iterator_range<Iterator> const& r)
        {
            return nimboost::detail::distance(r.begin(), r.end());
        }
    };
    ...
    // build_optional
    //
    // Build a nimboost::optional from T. Return unused_type if T is unused_type.
    ///////////////////////////////////////////////////////////////////////////
    template <typename T>
    struct build_optional
    {
        typedef nimboost::optional<T> type;
    };

    template <typename T>
    struct build_optional<nimboost::optional<T> >
    {
        typedef nimboost::optional<T> type;
    };
    ...
    // build_variant
    //
    // Build a nimboost::variant from a fusion sequence. build_variant makes sure
    ...
    struct make_attribute
    {
        ...
        static Attribute call(unused_type)
        {
            ...
            return nimboost::get(value_initialized<attribute_type>());
        }
    ...
    // optionals
    template <typename T>
    struct clear_value<nimboost::optional<T> >
    {
        static void call(nimboost::optional<T>& val)
        {
            if (val)
    ...
    struct print_attribute_debug<Out, nimboost::optional<T> >
    {
        static void call(Out& out, nimboost::optional<T> const& val)
        {
            if (val)
                spirit::traits::print_attribute(out, *val);
            else
...
///////////////////////////////////////////////////////////////////////////////
namespace nimboost { namespace spirit { namespace result_of
{
    template <typename Exposed, typename Transformed, typename Domain>
