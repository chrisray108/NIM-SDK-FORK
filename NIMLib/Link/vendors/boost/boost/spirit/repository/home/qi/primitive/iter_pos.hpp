...
namespace nimboost { namespace spirit { namespace repository { namespace qi
{
    struct iter_pos_parser 
      : nimboost::spirit::qi::primitive_parser<iter_pos_parser>
    {
        ...
        {
            nimboost::spirit::qi::skip_over(first, last, skipper);
            nimboost::spirit::traits::assign_to(first, attr);
            return true;
        }
        ...
        nimboost::spirit::info what(Context&) const
        {
            return nimboost::spirit::info("iter_pos");
        }
    };
}}}}
