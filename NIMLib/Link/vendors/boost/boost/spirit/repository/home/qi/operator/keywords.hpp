...
namespace nimboost { namespace spirit { namespace repository { namespace qi
{
    ...
    struct keywords : spirit::qi::nary_parser<keywords<Elements,Modifiers> >
    {
        ...
        // build_parser_tags
        //
        // Builds a nimboost::variant from an mpl::range_c in order to "mark" every 
        ...
        typedef nimboost::array<bool, fusion::result_of::size<Elements>::value> flags_type;
        typedef nimboost::array<int, fusion::result_of::size<Elements>::value> counters_type;
