...
namespace nimboost { namespace property_tree
{
    ...
    namespace detail
    {
        ...
        struct is_inexact_impl<true>
        {
            ...
            struct test
            {
              typedef nimboost::integral_constant<bool,
        ...
        struct is_inexact
        {
            typedef typename nimboost::decay<F>::type decayed;
    ...
    struct customize_stream<Ch, Traits, F,
        typename nimboost::enable_if< detail::is_inexact<F> >::type
    >
    {
    ...
    public:
        ...
        nimboost::optional<E> get_value(const internal_type &v) {
            std::basic_istringstream<Ch, Traits, Alloc> iss(v);
            iss.imbue(m_loc);
            E e;
            customized::extract(iss, e);
            if(iss.fail() || iss.bad() || iss.get() != Traits::eof()) {
                return nimboost::optional<E>();
            }
            return e;
        }
        nimboost::optional<internal_type> put_value(const E &v) {
            ...
            return nimboost::optional<internal_type>();
        }
