...
namespace nimboost { namespace property_tree { namespace xml_parser
{

    template<class Ptree, class Ch>
    void read_xml_node(detail::nimboostrapidxml::xml_node<Ch> *node,
                       Ptree &pt, int flags)
    {
        using namespace detail::nimboostrapidxml;
        switch (node->type())
        {
            // Element nodes
            case node_element: 
