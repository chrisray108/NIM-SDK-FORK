...
namespace nimboost { namespace property_tree { namespace json_parser
{
    ...
    template<class Ptree>
    struct json_grammar :
        public nimboost::spirit::classic::grammar<json_grammar<Ptree> >
    {
        ...
        struct definition
        {
            ...
            nimboost::spirit::classic::rule<Scanner>
                root, object, member, array, item, value, string, number;
            nimboost::spirit::classic::rule<
                typename nimboost::spirit::classic::lexeme_scanner<Scanner>::type>
                character, escape;
            ...
            definition(const json_grammar &self)
            {
                ...
                // There's a nimboost::assertion too, so another explicit using
                // here:
                using nimboost::spirit::classic::assertion;
            ...
            const nimboost::spirit::classic::rule<Scanner> &start() const
            {
                return root;
            }
