...
namespace nimboost { namespace property_tree
{
    ...
    public:
        ...
        /** Equivalent to erase(nimboost::prior(end())). */
        void pop_back();
        ...
        /** Get the child at the given path, or return nimboost::null. */
        ...
        /** Take the value of this node and attempt to translate it to a
         * @c Type object using the supplied translator. Return nimboost::null if
         * this fails.
         */
        template<class Type, class Translator>
        ...
        /** Take the value of this node and attempt to translate it to a
         * @c Type object using the default translator. Return nimboost::null if
         * this fails.
         */
        template<class Type>
