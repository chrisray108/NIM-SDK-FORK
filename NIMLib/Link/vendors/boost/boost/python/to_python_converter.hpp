...
namespace detail
{
    ...
    template<class T>
    struct test_get_pytype : nimboost::mpl::bool_<test_get_pytype_base<T>::value> 
    {
    };
...
#else
    typedef nimboost::mpl::bool_<has_get_pytype> HasGetPytype;
#endif

    static PyTypeObject const* get_pytype_1(nimboost::mpl::true_ *)
    {
        return Conversion::get_pytype();
    }

    static PyTypeObject const* get_pytype_1(nimboost::mpl::false_ *)
    {
        return 0;
    }
