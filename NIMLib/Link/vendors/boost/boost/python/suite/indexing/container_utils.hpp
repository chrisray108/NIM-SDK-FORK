...
namespace nimboost { namespace python { namespace container_utils {
    ...
    extend_container(Container& container, object l)
    {
        ...
        BOOST_FOREACH(object elem,
            std::make_pair(
              nimboost::python::stl_input_iterator<object>(l),
              nimboost::python::stl_input_iterator<object>()
              ))
        {
...
}}} // namespace nimboost::python::container_utils
