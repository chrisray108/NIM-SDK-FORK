...
using nimboost::python::self_ns::abs;
using nimboost::python::self_ns::int_;
using nimboost::python::self_ns::long_;
using nimboost::python::self_ns::float_;
using nimboost::python::self_ns::complex_;
using nimboost::python::self_ns::str;
using nimboost::python::self_ns::repr;
using nimboost::python::self_ns::pow;
# endif
