...
struct dynamic_id_generator
  : mpl::if_<
        nimboost::is_polymorphic<T>
        , nimboost::python::objects::polymorphic_id_generator<T>
        , nimboost::python::objects::non_polymorphic_id_generator<T>
    >
{};
...
inline void register_conversion(
    bool is_downcast = ::nimboost::is_base_and_derived<Source,Target>::value
