...
namespace nimboost { namespace python { namespace converter {
...
struct back_reference_arg_from_python
    : nimboost::python::arg_from_python<typename T::type>
{
    typedef T result_type;
    ...
    T operator()();
 private:
    typedef nimboost::python::arg_from_python<typename T::type> base;
    PyObject* m_source;
};
          ...
          , if_2<
              ...
              , if_2<
                  ...
                  , if_2<
                      ...
                      , mpl::if_<
                            nimboost::python::is_back_reference<T>
...
}}} // namespace nimboost::python::converter
