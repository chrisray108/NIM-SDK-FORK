...
struct default_result_converter
{
    ...
    struct apply
    {
        typedef typename mpl::if_<
          ...
          , nimboost::python::to_python_value<
...
{
    typedef nimboost::python::to_python_value<char const*const&> type;
};

template <>
struct default_result_converter::apply<PyObject*>
{
    typedef nimboost::python::to_python_value<PyObject*const&> type;
};
