...
template <class T>
inline typeinfo msvc_typeid(nimboost::type<T>*)
{
    return detail::typeid_ref(
        (nimboost::type<T>*)0, detail::is_ref_tester1(type<T>())
        );
}

template <>
inline typeinfo msvc_typeid<void>(nimboost::type<void>*)
{
    return typeid(void);
}
...
{
    return msvc_typeid((nimboost::type<char const[3]>*)0)
        , msvc_typeid((nimboost::type<char[3]>*)0);
}
#  endif
