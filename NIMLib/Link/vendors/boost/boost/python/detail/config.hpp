...
# else
#  define BOOST_PYTHON_BEGIN_CONVERSION_NAMESPACE namespace nimboost { namespace python {
#  define BOOST_PYTHON_END_CONVERSION_NAMESPACE }} // namespace nimboost::python
#  define BOOST_PYTHON_CONVERSION nimboost::python
...
//
#define BOOST_LIB_NAME nimboost_python
//
