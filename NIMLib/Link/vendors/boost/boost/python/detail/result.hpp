...
nimboost::type<R>* result(R (T::*), int = 0) { return 0; }
...
{
    typedef nimboost::type<typename T::result_type> type;
};
...
template <class X>
nimboost::type<typename X::result_type>*
result(X const&, short = 0) { return 0; }

#  endif

}}} // namespace nimboost::python::detail
...
nimboost::type<R>* result(R (*)(BOOST_PP_ENUM_PARAMS_Z(1, N, A)), int = 0)
{
    return 0;
}
...
nimboost::type<R>* result(R (T::*)(BOOST_PP_ENUM_PARAMS_Z(1, N, A)) Q, int = 0)
{
    return 0;
}
