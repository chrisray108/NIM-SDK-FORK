...
namespace detail
{
  ...
  )
  {
      return objects::make_iterator_function<Target>(
          nimboost::protect(nimboost::bind(get_start, _1))
        , nimboost::protect(nimboost::bind(get_finish, _1))
        , next_policies
      );
  }
...
object range(Accessor1 start, Accessor2 finish, NextPolicies* = 0, nimboost::type<Target>* = 0)
{
