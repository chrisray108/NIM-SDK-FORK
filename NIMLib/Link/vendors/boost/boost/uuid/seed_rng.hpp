...
//  25 Feb 2008 - moved to namespace nimboost::uuids::detail
...
//#include <boost/nondet_random.hpp> //forward declare nimboost::random::random_device

// can't use nimboost::generator_iterator since nimboost::random number seed(Iter&, Iter)
...
namespace nimboost { namespace random {
class random_device;
}} //namespace nimboost::random
...
private:
    ...
    {
        nimboost::uuids::detail::sha1 sha;
...
// almost a copy of nimboost::generator_iterator
...
template <>
inline void seed<nimboost::random::random_device>(nimboost::random::random_device&) {}

// random_device does not / can not be seeded
template <>
inline void seed<seed_rng>(seed_rng&) {}

}}} //namespace nimboost::uuids::detail
