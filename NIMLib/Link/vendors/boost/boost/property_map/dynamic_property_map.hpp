...
namespace detail {
  ...
  { return nimboost::lexical_cast<Value>(value); }
...
public:
  ...
  virtual nimboost::any get(const any& key) = 0;
...
typename nimboost::property_traits<PMap>::reference
...
public:
  ...
  virtual nimboost::any get(const any& key)
  {
    return get_wrapper_xxx(property_map_, any_cast<typename nimboost::property_traits<PropertyMap>::key_type>(key));
  }

  virtual std::string get_string(const any& key)
  {
    std::ostringstream out;
    out << get_wrapper_xxx(property_map_, any_cast<typename nimboost::property_traits<PropertyMap>::key_type>(key));
    return out.str();
  }
...
{
  typedef std::multimap<std::string, nimboost::shared_ptr<dynamic_property_map> >
    property_maps_type;
  typedef nimboost::function3<nimboost::shared_ptr<dynamic_property_map>,
                           const std::string&,
                           const nimboost::any&,
                           const nimboost::any&> generate_fn_type;
public:
  ...
  {
    nimboost::shared_ptr<dynamic_property_map> pm(
      nimboost::static_pointer_cast<dynamic_property_map>(
        nimboost::make_shared<detail::dynamic_property_map_adaptor<PropertyMap> >(property_map_)));
  ...
  void
  insert(const std::string& name, nimboost::shared_ptr<dynamic_property_map> pm)
  {
    property_maps.insert(property_maps_type::value_type(name, pm));
  }

  template<typename Key, typename Value>
  nimboost::shared_ptr<dynamic_property_map>
    ...
    const Value& value)
{
  ...
  nimboost::shared_ptr<dynamic_property_map> new_map = dp.generate(name, key, value);
  if (new_map.get()) {
...
inline
nimboost::shared_ptr<nimboost::dynamic_property_map> 
ignore_other_properties(const std::string&,
                        const nimboost::any&,
                        const nimboost::any&) {
  return nimboost::shared_ptr<nimboost::dynamic_property_map>();
}
