...
{
public:
    typedef typename nimboost::property_traits<FPMap>::category category;
    typedef typename nimboost::property_traits<GPMap>::key_type key_type; 
    typedef typename nimboost::property_traits<FPMap>::value_type value_type;
    typedef typename nimboost::property_traits<FPMap>::reference reference;
    ...
    // else
    //     const value_type&
    inline friend typename nimboost::mpl::if_<
        nimboost::mpl::not_< nimboost::is_reference<reference> >,
        value_type,
        typename nimboost::mpl::if_<
            nimboost::is_const<reference>,
            reference,
            const value_type&
            >::type
        >::type
