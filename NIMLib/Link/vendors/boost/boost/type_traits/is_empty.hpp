    ...
    BOOST_STATIC_CONSTANT(
        bool, value = (
            ::nimboost::type_traits::ice_or<
              ::nimboost::detail::empty_helper<cvt,::nimboost::is_class<T>::value>::value
...
struct is_empty_impl
{
   ...
   BOOST_STATIC_CONSTANT(
       bool, value = (
           ::nimboost::type_traits::ice_or<
              ::nimboost::detail::empty_helper<
                  cvt
                , ::nimboost::is_class<T>::value
                , ::nimboost::is_convertible< r_type,int>::value
              >::value
              , BOOST_INTERNAL_IS_EMPTY(cvt)
           >::value));
};
...
struct is_empty_impl
{
   typedef ::nimboost::detail::empty_helper_chooser<
      ::nimboost::type_traits::ice_and<
         ::nimboost::type_traits::ice_not< ::nimboost::is_reference<T>::value >::value,
         ::nimboost::type_traits::ice_not< ::nimboost::is_convertible<T,double>::value >::value,
         ::nimboost::type_traits::ice_not< ::nimboost::is_pointer<T>::value >::value,
         ::nimboost::type_traits::ice_not< ::nimboost::is_member_pointer<T>::value >::value,
         ...
         ::nimboost::type_traits::ice_not<
            ::nimboost::is_convertible<T,void const volatile*>::value
            >::value
      >::value > chooser;
   ...
   BOOST_STATIC_CONSTANT(bool, value =
      (::nimboost::type_traits::ice_or<eh_type::value, BOOST_INTERNAL_IS_EMPTY(T)>::value));
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_empty,T,::nimboost::detail::is_empty_impl<T>::value)
