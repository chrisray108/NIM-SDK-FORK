...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::nimboost::detail::extent_imp<T, N-1>::value));
};
...
struct extent
   : public ::nimboost::integral_constant<std::size_t, ::nimboost::detail::extent_imp<T,N>::value>
{
#if BOOST_WORKAROUND(BOOST_MSVC, < 1300) 
   typedef ::nimboost::integral_constant<std::size_t, ::nimboost::detail::extent_imp<T,N>::value> base_; 
   using base_::value;
#endif
