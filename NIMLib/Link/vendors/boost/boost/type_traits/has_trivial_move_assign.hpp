...
struct has_trivial_move_assign_impl
{
   ...
   BOOST_STATIC_CONSTANT(bool, value =
           (::nimboost::type_traits::ice_and<
              ...
              ::nimboost::type_traits::ice_not< ::nimboost::is_const<T>::value >::value,
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_move_assign,T,::nimboost::detail::has_trivial_move_assign_impl<T>::value)
