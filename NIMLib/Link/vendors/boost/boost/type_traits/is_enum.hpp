...
# else
    template <class U> static ::nimboost::type_traits::yes_type is_class_or_union_tester(void(U::*)(void));

#  if BOOST_WORKAROUND(BOOST_MSVC, == 1300)                 \
    || BOOST_WORKAROUND(__MWERKS__, <= 0x3000) // no SFINAE
    static ::nimboost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester(0)) == sizeof(::nimboost::type_traits::yes_type));
#  else
    template <class U>
    static ::nimboost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester<T>(0)) == sizeof(::nimboost::type_traits::yes_type));
#  endif
# endif
};
#endif
...
{
    template <typename T> struct type
       : public ::nimboost::is_convertible<typename nimboost::add_reference<T>::type,::nimboost::detail::int_convertible>
    {
    };
};
...
{
   //typedef ::nimboost::add_reference<T> ar_t;
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
      (::nimboost::type_traits::ice_or<
           ::nimboost::is_arithmetic<T>::value
         , ::nimboost::is_reference<T>::value
         , ::nimboost::is_function<T>::value
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
    ...
    typedef ::nimboost::detail::is_enum_helper<
          ::nimboost::detail::is_enum_impl<T>::selector
        > se_t;
#else
    typedef ::nimboost::detail::is_enum_helper<selector> se_t;
#endif
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_enum,T,::nimboost::detail::is_enum_impl<T>::value)
