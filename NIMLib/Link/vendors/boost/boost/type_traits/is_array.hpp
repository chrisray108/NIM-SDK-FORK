...
{ 
    BOOST_STATIC_CONSTANT(bool, value = 
        sizeof(::nimboost::detail::is_array_tester2(
            ::nimboost::detail::is_array_tester1(
                ::nimboost::type_traits::wrap<T>()
                )
        )) == 1
    );
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_array,T,::nimboost::detail::is_array_impl<T>::value)
