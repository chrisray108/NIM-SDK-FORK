   ...
   ::nimboost::type_traits::ice_or<\
      ::nimboost::type_traits::ice_and<\
         ...
         ::nimboost::type_traits::ice_and<\
            ...
            ::nimboost::type_traits::ice_not< ::nimboost::is_convertible< Rhs_nocv, bool >::value >::value\
         >::value\
      >::value,\
      ::nimboost::type_traits::ice_and<\
         ...
         ::nimboost::type_traits::ice_and<\
            ...
            ::nimboost::type_traits::ice_not< ::nimboost::is_convertible< Lhs_nocv, bool >::value >::value\
         >::value\
      >::value\
   >::value
