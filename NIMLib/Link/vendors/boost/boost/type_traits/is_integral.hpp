...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::nimboost::ulong_long_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::nimboost::long_long_type,true)
...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,nimboost::int128_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,nimboost::uint128_type,true)
#endif
