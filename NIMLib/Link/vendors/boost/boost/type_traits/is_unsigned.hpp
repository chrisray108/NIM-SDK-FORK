...
{
   BOOST_STATIC_CONSTANT(bool, value = (::nimboost::detail::is_unsigned_values<T>::minus_one > ::nimboost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned_imp
{
   typedef is_ununsigned_select_helper< 
      ::nimboost::type_traits::ice_or<
         ...
         ::nimboost::is_enum<T>::value>::value 
   > selector;
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_unsigned,T,::nimboost::detail::is_unsigned_imp<T>::value)
#endif
