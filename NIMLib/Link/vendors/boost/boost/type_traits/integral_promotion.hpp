...
// 4.5/2
template <class T> struct need_promotion : public nimboost::is_enum<T> {};
...
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(nimboost::ulong_long_type)
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(nimboost::long_long_type )
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTE_FROM_INDEX(5, nimboost::long_long_type )
BOOST_TT_AUX_PROMOTE_FROM_INDEX(6, nimboost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(5, nimboost::long_long_type )
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(6, nimboost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
struct integral_promotion_impl
{
    typedef BOOST_DEDUCED_TYPENAME promote_from_index<
        (nimboost::type_traits::detail::promoted_index<T>::value)
      , (nimboost::is_const<T>::value)
      , (nimboost::is_volatile<T>::value)
      >::type type;
};

template<class T>
struct integral_promotion
  : public nimboost::mpl::eval_if<
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(
    ...
    , BOOST_DEDUCED_TYPENAME
        nimboost::type_traits::detail::integral_promotion<T>::type
    )
}
