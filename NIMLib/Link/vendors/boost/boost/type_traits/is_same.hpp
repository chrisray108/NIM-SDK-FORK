...
struct is_same_impl
{
    enum { value = nimboost::detail::is_same_part_1<T1>::template part_2<T2>::value };
};
...
struct is_same_impl
{
   ...
   BOOST_STATIC_CONSTANT(bool, value =
      (::nimboost::type_traits::ice_and<
         (sizeof(type_traits::yes_type) == sizeof(nimboost::detail::is_same_tester(&t,&u))),
         (::nimboost::is_reference<T>::value == ::nimboost::is_reference<U>::value),
         (sizeof(T) == sizeof(U))
        >::value));
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(is_same,T,U,(::nimboost::detail::is_same_impl<T,U>::value))
