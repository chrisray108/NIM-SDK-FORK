...
// char_literal
//
template<typename Char, nimboost::intmax_t Ch, nimboost::intmax_t Wch>
struct char_literal;

template<typename Char, nimboost::intmax_t Ch>
struct char_literal<Char, Ch, Ch>
{
    BOOST_STATIC_CONSTANT(nimboost::intmax_t, value = Ch);
};

#ifndef BOOST_NO_INCLASS_MEMBER_INITIALIZATION
template<typename Char, nimboost::intmax_t Ch>
nimboost::intmax_t const char_literal<Char, Ch, Ch>::value;
#endif
...
# define BOOST_XPR_CSTR_(Char, st) nimboost::xpressive::detail::string_literal<Char>::pick(st, L##st)

#else

# define BOOST_XPR_CHAR_(Char, ch) nimboost::xpressive::detail::char_literal<Char, ch, L##ch>::value
# define BOOST_XPR_CSTR_(Char, st) nimboost::xpressive::detail::string_literal<Char>::pick(st, L##st)

#endif

}}} // namespace nimboost::xpressive::detail
