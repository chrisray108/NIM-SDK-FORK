...
namespace nimboost { namespace xpressive
{
    ...
    namespace detail
    {
        ...
        struct let_domain
          : nimboost::proto::domain<nimboost::proto::pod_generator<let_> >
        {};
        ...
        typedef nimboost::proto::functional::make_expr<proto::tag::function, proto::default_domain> make_function;
    }
    ...
    namespace op
    {
        ...
        struct as
        {
            ...
            /// \return <tt>nimboost::lexical_cast\<T\>(val)</tt>
            template<typename Value>
            T operator()(Value const &val) const
            {
                return nimboost::lexical_cast<T>(val);
            }

            // Hack around some limitations in nimboost::lexical_cast
            /// INTERNAL ONLY
            T operator()(csub_match const &val) const
            {
                return val.matched
                  ? nimboost::lexical_cast<T>(nimboost::make_iterator_range(val.first, val.second))
                  : nimboost::lexical_cast<T>("");
            }
        ...
        private:
            ...
            {
                return val.matched
                  ? nimboost::lexical_cast<T>(nimboost::make_iterator_range(&*val.first, &*val.first + (val.second - val.first)))
                  : nimboost::lexical_cast<T>("");
            }
            ...
            {
                return nimboost::lexical_cast<T>(val.str());
            }
        };
        ...
        /// \brief \c unwrap_reference is a PolymorphicFunctionObject for unwrapping a <tt>nimboost::reference_wrapper\<\></tt>.
        struct unwrap_reference
        {
            ...
            {
                typedef typename nimboost::unwrap_reference<Ref>::type &type;
            };
            ...
            /// \param r The <tt>nimboost::reference_wrapper\<T\></tt> to unwrap.
            /// \return <tt>static_cast\<T &\>(r)</tt>
            template<typename T>
            T &operator()(nimboost::reference_wrapper<T> r) const
            {
    ...
    */
    ...
    ///
    /** \code
        namespace xp = nimboost::xpressive;
        using xp::_;
        std::list<int> result;
    ...
    */
    ...
    /// \brief \c unwrap_reference is a lazy PolymorphicFunctionObject for unwrapping a \c nimboost::reference_wrapper\<\> in an
    /// xpressive semantic action.
    ...
    ///
    /** \code
        sregex good_voodoo(nimboost::shared_ptr<int> pi)
        {
    ...
    */
      ...
      : proto::extends<typename proto::terminal<reference_wrapper<T> >::type, reference<T> >
    {
        ...
        explicit reference(T &t)
          : base_type(base_type::proto_base_expr::make(nimboost::ref(t)))
        {}
    ...
    */
      ...
      , proto::terminal<reference_wrapper<T> >::type
    {
        ...
        local()
          : detail::value_wrapper<T>()
          , base_type(base_type::make(nimboost::ref(detail::value_wrapper<T>::value)))
        {}
