...
namespace nimboost { namespace xpressive { namespace detail
{
...
public:
    ...
    {
        return this->format_(out, nimboost::as_literal(fmt), flags, mpl::size_t<0>());
    }
...
private:
    ...
    {
        return std::copy(nimboost::begin(result), nimboost::end(result), out);
    }
    ...
    ) const
    {
        ...
        iterator cur = nimboost::begin(format), end = nimboost::end(format);
    ...
    ) const
    {
        ...
        typedef typename nimboost::uint_t<CHAR_BIT * sizeof(char_type)>::least uchar_t;
    ...
    nimboost::optional<BidiIter> base_;
    nimboost::optional<sub_match<BidiIter> > prefix_;
    nimboost::optional<sub_match<BidiIter> > suffix_;
...
namespace std
{
    ...
    concept_map OutputIterator<
        nimboost::xpressive::detail::case_converting_iterator<Iter_, Char_>
      , Char_
    >
    {};
    ...
    concept_map OutputIterator<
        nimboost::xpressive::detail::noop_output_iterator<Char_>
      , Char_
    >
    {};
}
