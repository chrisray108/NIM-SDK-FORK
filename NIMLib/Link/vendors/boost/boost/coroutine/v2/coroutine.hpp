...
public:
    ...
    {
        push_coroutine tmp( nimboost::move( other) );
        swap( tmp);
        return * this;
    }
...
public:
    ...
    {
        pull_coroutine tmp( nimboost::move( other) );
        swap( tmp);
        return * this;
    }
...
template< typename R >
inline
typename nimboost::coroutines::pull_coroutine< R >::iterator
begin( nimboost::coroutines::pull_coroutine< R > & c)
{ return nimboost::begin( c); }

template< typename R >
inline
typename nimboost::coroutines::pull_coroutine< R >::iterator
end( nimboost::coroutines::pull_coroutine< R > & c)
{ return nimboost::end( c); }

template< typename R >
inline
typename nimboost::coroutines::pull_coroutine< R >::const_iterator
begin( nimboost::coroutines::pull_coroutine< R > const& c)
{ return nimboost::const_begin( c); }

template< typename R >
inline
typename nimboost::coroutines::pull_coroutine< R >::const_iterator
end( nimboost::coroutines::pull_coroutine< R > const& c)
{ return nimboost::const_end( c); }

template< typename R >
inline
typename nimboost::coroutines::push_coroutine< R >::iterator
begin( nimboost::coroutines::push_coroutine< R > & c)
{ return nimboost::begin( c); }

template< typename R >
inline
typename nimboost::coroutines::push_coroutine< R >::iterator
end( nimboost::coroutines::push_coroutine< R > & c)
{ return nimboost::end( c); }

template< typename R >
inline
typename nimboost::coroutines::push_coroutine< R >::const_iterator
begin( nimboost::coroutines::push_coroutine< R > const& c)
{ return nimboost::const_begin( c); }

template< typename R >
inline
typename nimboost::coroutines::push_coroutine< R >::const_iterator
end( nimboost::coroutines::push_coroutine< R > const& c)
{ return nimboost::const_end( c); }
