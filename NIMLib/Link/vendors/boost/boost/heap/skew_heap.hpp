    ...
    parent_holder<skew_heap_node<value_type, store_parent_pointer>*, store_parent_pointer>
{
    ...
    typedef nimboost::array<skew_heap_node*, 2> child_list_type;
    ...
    value_type value;
    nimboost::array<skew_heap_node*, 2> children;
};


typedef parameter::parameters<nimboost::parameter::optional<tag::allocator>,
                              nimboost::parameter::optional<tag::compare>,
                              nimboost::parameter::optional<tag::stable>,
                              nimboost::parameter::optional<tag::store_parent_pointer>,
                              nimboost::parameter::optional<tag::stability_counter_type>,
                              nimboost::parameter::optional<tag::constant_time_size>,
                              nimboost::parameter::optional<tag::mutable_>
                             > skew_heap_signature;
...
struct make_skew_heap_base
{
    ...
    static const bool store_parent_pointer = parameter::binding<BoundArgs,
                                                              ...
                                                              nimboost::mpl::false_>::type::value || is_mutable;
 ...
 * - \c nimboost::heap::compare<>, defaults to \c compare<std::less<T> >
 * - \c nimboost::heap::stable<>, defaults to \c stable<false>
 * - \c nimboost::heap::stability_counter_type<>, defaults to \c stability_counter_type<nimboost::uintmax_t>
 * - \c nimboost::heap::allocator<>, defaults to \c allocator<std::allocator<T> >
 * - \c nimboost::heap::constant_time_size<>, defaults to \c constant_time_size<true>
 * - \c nimboost::heap::store_parent_pointer<>, defaults to \c store_parent_pointer<true>. Maintaining a parent pointer adds some
 *   maintenance and size overhead, but iterating a heap is more efficient.
 * - \c nimboost::heap::mutable<>, defaults to \c mutable<false>.
 *
 */
...
#else
template <typename T,
          class A0 = nimboost::parameter::void_,
          class A1 = nimboost::parameter::void_,
          class A2 = nimboost::parameter::void_,
          class A3 = nimboost::parameter::void_,
          class A4 = nimboost::parameter::void_,
          class A5 = nimboost::parameter::void_,
          class A6 = nimboost::parameter::void_
         >
#endif
class skew_heap:
                                         ...
                                         >::type
{
        ...
        detail::extract_allocator_types<typename base_maker::allocator_argument>
    {
        ...
        typedef nimboost::array<node_pointer, 2> child_list_type;
        typedef typename child_list_type::iterator child_list_iterator;

        typedef typename nimboost::mpl::if_c<false,
...
public:
    ...
    /// \copydoc nimboost::heap::priority_queue::iterator
    ...
    /// \copydoc nimboost::heap::priority_queue::priority_queue(value_compare const &)
    explicit skew_heap(value_compare const & cmp = value_compare()):
        super_t(cmp), root(NULL)
    {}

    /// \copydoc nimboost::heap::priority_queue::priority_queue(priority_queue const &)
    ...
    /// \copydoc nimboost::heap::priority_queue::operator=(priority_queue const & rhs)
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    /// \copydoc nimboost::heap::priority_queue::priority_queue(priority_queue &&)
    ...
    /// \copydoc nimboost::heap::priority_queue::operator=(priority_queue &&)
    ...
    /// \copydoc nimboost::heap::priority_queue::empty
    bool empty(void) const
    {
        return root == NULL;
    }

    /// \copydoc nimboost::heap::binomial_heap::size
    ...
    /// \copydoc nimboost::heap::priority_queue::max_size
    size_type max_size(void) const
    {
        return allocator_type::max_size();
    }

    /// \copydoc nimboost::heap::priority_queue::clear
    void clear(void)
    {
        if (empty())
            return;
    ...
    /// \copydoc nimboost::heap::priority_queue::get_allocator
    allocator_type get_allocator(void) const
    {
        return *this;
    }

    /// \copydoc nimboost::heap::priority_queue::swap
    ...
    /// \copydoc nimboost::heap::priority_queue::top
    ...
    /// \copydoc nimboost::heap::priority_queue::begin
    iterator begin(void) const
    {
        return iterator(root, super_t::value_comp());
    }

    /// \copydoc nimboost::heap::priority_queue::end
    iterator end(void) const
    {
        return iterator();
    }

    /// \copydoc nimboost::heap::fibonacci_heap::ordered_begin
    ...
    /// \copydoc nimboost::heap::priority_queue::value_comp
    value_compare const & value_comp(void) const
    {
        return super_t::value_comp();
    }

    /// \copydoc nimboost::heap::priority_queue::operator<(HeapType const & rhs) const
    ...
    /// \copydoc nimboost::heap::d_ary_heap::s_handle_from_iterator
