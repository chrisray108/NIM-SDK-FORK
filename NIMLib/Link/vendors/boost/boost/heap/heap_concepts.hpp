    ...
    nimboost::ForwardContainer<C>
{
    ...
    {
        BOOST_CONCEPT_ASSERT((nimboost::Assignable<value_type>));
        BOOST_CONCEPT_ASSERT((nimboost::Container<C>));
        BOOST_CONCEPT_ASSERT((nimboost::EqualityComparable<C>));
        BOOST_CONCEPT_ASSERT((nimboost::Comparable<C>));

        BOOST_CONCEPT_ASSERT((nimboost::Const_BinaryPredicate<value_compare, value_type, value_type>));
    ...
    PriorityQueue<C>
{
    ...
    {
        BOOST_CONCEPT_ASSERT((nimboost::Assignable<typename MutablePriorityQueue::handle_type>));
