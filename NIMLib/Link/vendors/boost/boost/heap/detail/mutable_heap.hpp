...
public:
    ...
    class iterator_base:
        public nimboost::iterator_adaptor<iterator_base<iterator_type>,
                                       iterator_type,
                                       value_type const,
                                       nimboost::bidirectional_traversal_tag>
    {
        typedef nimboost::iterator_adaptor<iterator_base<iterator_type>,
                                       iterator_type,
                                       value_type const,
                                       nimboost::bidirectional_traversal_tag> super_t;
    ...
    class ordered_iterator:
        public nimboost::iterator_adaptor<ordered_iterator,
                                       const_list_iterator,
                                       value_type const,
    ...
    {
        typedef nimboost::iterator_adaptor<ordered_iterator,
                                        const_list_iterator,
                                        value_type const,
                                        nimboost::forward_traversal_tag
                                      > adaptor_type;
