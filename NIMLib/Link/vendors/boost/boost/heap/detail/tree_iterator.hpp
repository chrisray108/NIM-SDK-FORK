...
template <typename Node,
         ...
         >
class tree_iterator:
    public nimboost::iterator_adaptor<tree_iterator<Node,
                                                 ValueType,
                                                 Alloc,
                                                 ValueExtractor,
                                                 PointerExtractor,
    ...
    PointerExtractor
{
    typedef nimboost::iterator_adaptor<tree_iterator<Node,
                                                  ValueType,
                                                  Alloc,
                                                  ValueExtractor,
                                                  PointerExtractor,
    ...
    typedef typename nimboost::mpl::if_c< ordered_iterator,
...
class recursive_tree_iterator:
    public nimboost::iterator_adaptor<recursive_tree_iterator<Node,
                                                           NodeIterator,
                                                           ValueType,
                                                           ValueExtractor,
                                                           IteratorCoverter
...
{
    typedef nimboost::iterator_adaptor<recursive_tree_iterator<Node,
                                                            NodeIterator,
                                                            ValueType,
                                                            ValueExtractor,
                                                            IteratorCoverter
                                    ...
                                    NodeIterator,
                                    ValueType const,
                                    nimboost::bidirectional_traversal_tag> adaptor_type;
