...
typedef parameter::parameters<nimboost::parameter::required<tag::arity>,
                              nimboost::parameter::optional<tag::allocator>,
...
private:
    ...
    template<typename U,
             ...
             typename X>
    struct rebind {
        typedef d_ary_heap<U, typename d_ary_heap_signature::bind<nimboost::heap::stable<heap_base_maker::is_stable>,
                                                                  nimboost::heap::stability_counter_type<typename heap_base_maker::stability_counter_type>,
                                                                  nimboost::heap::arity<D>,
                                                                  nimboost::heap::compare<V>,
                                                                  nimboost::heap::allocator<W>
                                                                    >::type,
                           X
                          > other;
    };
 ...
 * - \c nimboost::heap::arity<>, required
 ...
 * - \c nimboost::heap::mutable_<>, defaults to \c mutable_<false>
 *
 */
...
public:
    ...
    /// \copydoc nimboost::heap::priority_queue::operator=(priority_queue const &)
    d_ary_heap & operator=(d_ary_heap const & rhs)
    {
    ...
    /// \copydoc nimboost::heap::priority_queue::size
    size_type size(void) const
    {
        return super_t::size();
    }
    ...
    /// \copydoc nimboost::heap::priority_queue::push
...
#if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES) && !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
    /// \copydoc nimboost::heap::priority_queue::emplace
    template <class... Args>
    ...
    /// \copydoc nimboost::heap::priority_queue::pop
    void pop(void)
    {
        super_t::pop();
    }
    ...
    /// \copydoc nimboost::heap::fibonacci_heap::ordered_end
    ordered_iterator ordered_end(void) const
    {
        return super_t::ordered_end();
    }

    /// \copydoc nimboost::heap::priority_queue::reserve
    void reserve (size_type element_count)
    {
