...
template <bool T>
struct stable:
    nimboost::parameter::template_keyword<tag::stable, nimboost::mpl::bool_<T> >
{};
...
template <bool T>
struct mutable_:
    nimboost::parameter::template_keyword<tag::mutable_, nimboost::mpl::bool_<T> >
{};
...
struct constant_time_size:
    nimboost::parameter::template_keyword<tag::constant_time_size, nimboost::mpl::bool_<T> >
{};
...
struct store_parent_pointer:
    nimboost::parameter::template_keyword<tag::store_parent_pointer, nimboost::mpl::bool_<T> >
{};
...
struct arity:
    nimboost::parameter::template_keyword<tag::arity, nimboost::mpl::int_<T> >
{};
...
struct objects_per_page:
    nimboost::parameter::template_keyword<tag::objects_per_page, nimboost::mpl::int_<T> >
{};
...
namespace mpl = nimboost::mpl;

template <typename bound_args, typename tag_type>
struct has_arg
{
    typedef typename nimboost::parameter::binding<bound_args, tag_type, mpl::void_>::type type;
