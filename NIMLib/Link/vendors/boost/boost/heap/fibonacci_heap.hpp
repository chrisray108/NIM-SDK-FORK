...
public:
    ...
    /** \copydoc nimboost::heap::fibonacci_heap::update(handle_type, const_reference)
     *
    ...
    /** \copydoc nimboost::heap::fibonacci_heap::update (handle_type handle)
     *
     * \b Rationale: The lazy update function is a modification of the traditional update, that just invalidates
     *               the iterator to the object referred to by the handle.
     * */
    ...
    /// \copydoc nimboost::heap::d_ary_heap_mutable::s_handle_from_iterator
...
private:
    ...
    void consolidate(void)
    {
        ...
        nimboost::array<node_pointer, max_log2> aux;
        aux.assign(NULL);
