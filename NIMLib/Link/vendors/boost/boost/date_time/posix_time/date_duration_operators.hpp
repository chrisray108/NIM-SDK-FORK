...
namespace posix_time {
  ...
  inline
  ptime 
  operator+(const ptime& t, const nimboost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const nimboost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+(const ptime& t, const nimboost::gregorian::years& y)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const nimboost::gregorian::years& y)
  {
    return t += y.get_offset(t.date());
  }
