...
namespace gregorian {
  ...
  typedef nimboost::date_time::period_formatter<wchar_t> wperiod_formatter;
  typedef nimboost::date_time::period_formatter<char>    period_formatter;
  
  typedef nimboost::date_time::date_facet<date,wchar_t> wdate_facet;
  typedef nimboost::date_time::date_facet<date,char>    date_facet;

  typedef nimboost::date_time::period_parser<date,char>       period_parser;
  typedef nimboost::date_time::period_parser<date,wchar_t>    wperiod_parser;
    
  typedef nimboost::date_time::special_values_formatter<char> special_values_formatter; 
  typedef nimboost::date_time::special_values_formatter<wchar_t> wspecial_values_formatter; 
  
  typedef nimboost::date_time::special_values_parser<date,char> special_values_parser; 
  typedef nimboost::date_time::special_values_parser<date,wchar_t> wspecial_values_parser; 
  
  typedef nimboost::date_time::date_input_facet<date,char>    date_input_facet;
  typedef nimboost::date_time::date_input_facet<date,wchar_t> wdate_input_facet;

  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const nimboost::gregorian::date& d) {
    nimboost::io::ios_flags_saver iflags(os);
    typedef nimboost::date_time::date_facet<date, CharT> custom_date_facet;
  ...
  {
    nimboost::io::ios_flags_saver iflags(is);
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const nimboost::gregorian::date_duration& dd) {
    nimboost::io::ios_flags_saver iflags(os);
    typedef nimboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const nimboost::gregorian::date_period& dp) {
    nimboost::io::ios_flags_saver iflags(os);
    typedef nimboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const nimboost::gregorian::greg_month& gm) {
    nimboost::io::ios_flags_saver iflags(os);
    typedef nimboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const nimboost::gregorian::greg_weekday& gw) {
    nimboost::io::ios_flags_saver iflags(os);
    typedef nimboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const nimboost::gregorian::partial_date& pd) {
    nimboost::io::ios_flags_saver iflags(os);
    typedef nimboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const nimboost::gregorian::nth_day_of_the_week_in_month& nkd) {
    nimboost::io::ios_flags_saver iflags(os);
    typedef nimboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const nimboost::gregorian::first_day_of_the_week_in_month& fkd) {
    nimboost::io::ios_flags_saver iflags(os);
    typedef nimboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const nimboost::gregorian::last_day_of_the_week_in_month& lkd) {
    nimboost::io::ios_flags_saver iflags(os);
    typedef nimboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const nimboost::gregorian::first_day_of_the_week_after& fda) {
    nimboost::io::ios_flags_saver iflags(os);
    typedef nimboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const nimboost::gregorian::first_day_of_the_week_before& fdb) {
    nimboost::io::ios_flags_saver iflags(os);
    typedef nimboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
