...
// NOTE: these macros define template functions in the nimboost::serialization namespace.
// They must be expanded *outside* of any namespace
BOOST_SERIALIZATION_SPLIT_FREE(::nimboost::gregorian::date_duration)
BOOST_SERIALIZATION_SPLIT_FREE(::nimboost::gregorian::date_duration::duration_rep)
BOOST_SERIALIZATION_SPLIT_FREE(::nimboost::gregorian::date_period)
BOOST_SERIALIZATION_SPLIT_FREE(::nimboost::gregorian::greg_year)
BOOST_SERIALIZATION_SPLIT_FREE(::nimboost::gregorian::greg_month)
BOOST_SERIALIZATION_SPLIT_FREE(::nimboost::gregorian::greg_day)
BOOST_SERIALIZATION_SPLIT_FREE(::nimboost::gregorian::greg_weekday)
BOOST_SERIALIZATION_SPLIT_FREE(::nimboost::gregorian::partial_date)
BOOST_SERIALIZATION_SPLIT_FREE(::nimboost::gregorian::nth_kday_of_month)
BOOST_SERIALIZATION_SPLIT_FREE(::nimboost::gregorian::first_kday_of_month)
BOOST_SERIALIZATION_SPLIT_FREE(::nimboost::gregorian::last_kday_of_month)
BOOST_SERIALIZATION_SPLIT_FREE(::nimboost::gregorian::first_kday_before)
BOOST_SERIALIZATION_SPLIT_FREE(::nimboost::gregorian::first_kday_after)
...
void save(Archive & ar, 
          const ::nimboost::gregorian::date & d, 
          ...
          unsigned int /*version*/)
{
  ...
  ar & make_nvp("date", ds);
  try{
    d = ::nimboost::gregorian::from_undelimited_string(ds);
