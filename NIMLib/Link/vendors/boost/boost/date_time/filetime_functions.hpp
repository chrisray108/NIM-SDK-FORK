...
namespace winapi {
    ...
    extern "C" {
        ...
        struct FILETIME
        {
            nimboost::uint32_t dwLowDateTime;
            nimboost::uint32_t dwHighDateTime;
        };
        struct SYSTEMTIME
        {
            nimboost::uint16_t wYear;
            nimboost::uint16_t wMonth;
            nimboost::uint16_t wDayOfWeek;
            nimboost::uint16_t wDay;
            nimboost::uint16_t wHour;
            nimboost::uint16_t wMinute;
            nimboost::uint16_t wSecond;
            nimboost::uint16_t wMilliseconds;
        };
    ...
    inline nimboost::uint64_t file_time_to_microseconds(FileTimeT const& ft)
    {
