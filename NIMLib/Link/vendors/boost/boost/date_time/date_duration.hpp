...
namespace date_time {
  ...
  class date_duration : private
              nimboost::less_than_comparable1< date_duration< duration_rep_traits >
            , nimboost::equality_comparable1< date_duration< duration_rep_traits >
            , nimboost::addable1< date_duration< duration_rep_traits >
            , nimboost::subtractable1< date_duration< duration_rep_traits >
            , nimboost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  {
  public:
  ...
  {
    typedef long int_type;
    typedef nimboost::date_time::int_adapter<long> impl_type;
