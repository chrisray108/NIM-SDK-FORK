...
namespace local_time {
  ...
  typedef nimboost::date_time::period<local_date_time, 
                                   nimboost::posix_time::time_duration> local_time_period;
  ...
  typedef nimboost::shared_ptr<time_zone> time_zone_ptr;
  typedef nimboost::shared_ptr<wtime_zone> wtime_zone_ptr;
