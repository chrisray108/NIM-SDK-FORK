...
namespace local_time {
  ...
  //typedef nimboost::date_time::time_zone_names time_zone_names;
  typedef nimboost::date_time::dst_adjustment_offsets<nimboost::posix_time::time_duration> dst_adjustment_offsets;
  //typedef nimboost::date_time::time_zone_base<nimboost::posix_time::ptime> time_zone;
  typedef nimboost::shared_ptr<dst_calc_rule> dst_calc_rule_ptr;
  ...
  public:
    ...
    custom_time_zone_base(const time_zone_names& zone_names,
                     ...
                     nimboost::shared_ptr<dst_calc_rule> calc_rule) :
