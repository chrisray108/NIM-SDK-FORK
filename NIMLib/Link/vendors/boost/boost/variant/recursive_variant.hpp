...
struct substitute<
      ::nimboost::variant<
          ::nimboost::detail::variant::over_sequence< T0 >
        , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
        >
    , RecursiveVariant
    , ::nimboost::recursive_variant_
...
public:
    ...
    typedef typename mpl::if_<
          mpl::equal<initial_types, types, ::nimboost::is_same<mpl::_1, mpl::_2> >
        , ::nimboost::variant<
              ::nimboost::detail::variant::over_sequence< T0 >
            , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
            >
        , ::nimboost::variant< over_sequence<types> >
        >::type type;
};
...
public: // metafunction result
    ...
    typedef ::nimboost::variant< BOOST_VARIANT_ENUM_PARAMS(wknd_T) > type;
};
