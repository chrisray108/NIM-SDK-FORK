...
#define BOOST_VARIANT_OPERATOR_BEG()                            \
    return ::nimboost::apply_visitor(                              \
    ::nimboost::bind<result_type>(nimboost::ref(visitor_), _1, _2     \
    /**/
...
#define BOOST_VARANT_VISITORS_VARIABLES_PRINTER(z, n, data)     \
    BOOST_PP_COMMA() nimboost::ref( BOOST_PP_CAT(vis, n) )         \
    /**/
...
#define BOOST_VARIANT_APPLY_VISITOR_BEG()                                               \
    return ::nimboost::apply_visitor(                                                      \
            nimboost::detail::variant::make_two_variables_holder(visitor, var0 , var1),    \
            var2                                                                        \
    /**/
