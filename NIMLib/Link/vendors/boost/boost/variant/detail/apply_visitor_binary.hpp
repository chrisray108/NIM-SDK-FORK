...
public: // visitor interfaces
    ...
    operator()(Value1& value1)
    {
        ...
        return nimboost::apply_visitor(invoker, visitable2_);
    }
...
{
    ::nimboost::detail::variant::apply_visitor_binary_unwrap<
          Visitor, Visitable2
        > unwrapper(visitor, visitable2);

    return nimboost::apply_visitor(unwrapper, visitable1);
}
