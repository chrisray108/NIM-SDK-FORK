...
struct make_initializer_node
{
    ...
    private: // helpers, for metafunction result (below)
        ...
        private: // helpers, for static functions (below)
            ...
            typedef nimboost::is_reference<public_T> 
                is_reference_content_t;

            typedef typename nimboost::mpl::if_<is_reference_content_t, public_T, const public_T& >::type 
                param_T;

            template <class T> struct disable_overload{};

            typedef typename nimboost::mpl::if_<is_reference_content_t, disable_overload<public_T>, public_T&& >::type 
                param2_T;
#else
        ...
        public: // static functions
            ...
            {
                typedef typename nimboost::detail::make_reference_content<
                      recursive_enabled_T
                    >::type internal_T;
            ...
            static int initialize(void* dest, param2_T operand)
            {
                ...
                typedef typename nimboost::mpl::if_<is_reference_content_t, param2_T, recursive_enabled_T>::type value_T;
                new(dest) value_T( nimboost::detail::variant::move(operand) );
                return BOOST_MPL_AUX_VALUE_WKND(index)::value; // which
            }
#endif
        };
...
#define BOOST_VARIANT_AUX_INITIALIZER_T( mpl_seq, typename_base ) \
    ::nimboost::mpl::iter_fold< \
          mpl_seq \
        , ::nimboost::mpl::pair< \
              ::nimboost::detail::variant::initializer_root \
            , ::nimboost::mpl::int_<0> \
            > \
        , ::nimboost::mpl::protect< \
              ::nimboost::detail::variant::make_initializer_node \
            > \
        >::type::first \
    /**/
...
#   else // MSVC7 and below
    ...
    #define BOOST_VARIANT_AUX_PP_INITIALIZER_ENUM_PARAM_TYPE(z,N,T) \
        ::nimboost::call_traits< \
              ::nimboost::unwrap_recursive<BOOST_PP_CAT(T,N)>::type \
            >::param_type \
        /**/
...
#define BOOST_VARIANT_AUX_INITIALIZER_T( mpl_seq, typename_base ) \
    ::nimboost::detail::variant::preprocessor_list_initializer< \
