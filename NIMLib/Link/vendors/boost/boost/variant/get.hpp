...
public: // std::exception implementation
    ...
    {
        return "nimboost::bad_get: "
               "failed value get using nimboost::get";
    }
...
public: // visitor interfaces
    ...
    {
        return nimboost::addressof(operand);
    }
...
get(
      nimboost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >* operand
...
get(
      const nimboost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >* operand
      BOOST_VARIANT_AUX_GET_EXPLICIT_TEMPLATE_TYPE(U)
    )
{
    ...
    )
{
    ...
    if (!result)
        nimboost::throw_exception(bad_get());
    return *result;
}
