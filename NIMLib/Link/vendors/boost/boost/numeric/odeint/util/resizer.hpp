...
bool adjust_size_by_resizeability( ResizeWrappedState &x , const State &y , nimboost::true_type )
{
...
template< class ResizeWrappedState , class State >
bool adjust_size_by_resizeability( ResizeWrappedState & /* x */ , const State & /* y */ , nimboost::false_type )
{
    return false;
}
