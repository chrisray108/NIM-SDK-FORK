...
namespace detail {
    ...
    void do_copying( const Container1 &from , Container2 &to , nimboost::mpl::true_ )
    {
        nimboost::range::copy( from , nimboost::begin( to ) );
    }

    template< class Container1 , class Container2 >
    void do_copying( const Container1 &from , Container2 &to , nimboost::mpl::false_ )
    {
        to = from;
    }
...
struct copy_impl
{
    ...
    {
        typedef typename nimboost::numeric::odeint::detail::is_range< Container1 >::type is_range_type;
