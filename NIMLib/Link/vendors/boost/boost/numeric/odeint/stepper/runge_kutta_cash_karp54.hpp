...
struct rk54_ck_coefficients_a1 : nimboost::array< Value , 1 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_a2 : nimboost::array< Value , 2 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_a3 : nimboost::array< Value , 3 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_a4 : nimboost::array< Value , 4 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_a5 : nimboost::array< Value , 5 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_b : nimboost::array< Value , 6 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_db : nimboost::array< Value , 6 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_c : nimboost::array< Value , 6 >
{
...
public:
    ...
    runge_kutta_cash_karp54( const algebra_type &algebra = algebra_type() ) : stepper_base_type(
        nimboost::fusion::make_vector( rk54_ck_coefficients_a1<Value>() ,
