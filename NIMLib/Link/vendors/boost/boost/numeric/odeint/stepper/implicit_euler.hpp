...
public:
    ...
    void do_step( System system , state_type &x , time_type t , time_type dt )
    {
        ...
        m_jacobi.m_v *= dt;
        m_jacobi.m_v -= nimboost::numeric::ublas::identity_matrix< value_type >( x.size() );
        ...
        while( nimboost::numeric::ublas::norm_2( m_b.m_v ) > m_epsilon )
        {
            ...
            //            m_jacobi *= dt;
            //            m_jacobi -= nimboost::numeric::ublas::identity_matrix< value_type >( x.size() );
...
private:
    ...
    {
        int res = nimboost::numeric::ublas::lu_factorize( m , m_pm.m_v );
        if( res != 0 ) exit(0);
        nimboost::numeric::ublas::lu_substitute( m , m_pm.m_v , x );
    }
