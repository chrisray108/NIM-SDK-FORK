...
{
    typedef const typename nimboost::array< T , Constant::value > type;
};
...
public:
    ...
    typedef typename nimboost::fusion::result_of::as_vector
            <
            typename nimboost::mpl::copy
            <
            stage_indices ,
            nimboost::mpl::inserter
            <
            nimboost::mpl::vector0< > ,
            nimboost::mpl::push_back< nimboost::mpl::_1 , array_wrapper< Value , nimboost::mpl::_2 > >
    >
    >::type
    >::type coef_a_type;

    typedef nimboost::array< Value , StageCount > coef_b_type;
    typedef nimboost::array< Value , StageCount > coef_c_type;
    ...
    typedef typename nimboost::fusion::result_of::as_vector
            ...
            <
            nimboost::mpl::vector0<> ,
            nimboost::mpl::push_back< nimboost::mpl::_1 , stage_wrapper< Value , nimboost::mpl::_2 > >
    >
    >::type ,
    ...
    struct stage_vector : public stage_vector_base
    {
        struct do_insertion
        {
            ...
            {
                //nimboost::fusion::at< Index >( m_base ) = stage< double , Index::value+1 , intermediate_stage >( m_c[ Index::value ] , nimboost::fusion::at< Index >( m_a ) );
                nimboost::fusion::at< Index >( m_base ).c  = m_c[ Index::value ];
                nimboost::fusion::at< Index >( m_base ).a = nimboost::fusion::at< Index >( m_a );
            }
        };
        ...
        struct print_butcher
        {
            ...
            template<class Index>
            void operator()(Index) const {
                m_os << nimboost::fusion::at<Index>(m_base).c << " | ";
                for( size_t i=0 ; i<Index::value ; ++i )
                    m_os << nimboost::fusion::at<Index>(m_base).a[i] << " ";
                m_os << std::endl;
            }
        };
        ...
        {
            typedef nimboost::mpl::range_c< size_t , 0 , StageCount-1 > indices;
            nimboost::mpl::for_each< indices >( do_insertion( *this , a , c ) );
            nimboost::fusion::at_c< StageCount - 1 >( *this ).c = c[ StageCount - 1 ];
            nimboost::fusion::at_c< StageCount - 1 >( *this ).a = b;
        }

        void print( std::ostream &os ) const
        {
            typedef nimboost::mpl::range_c< size_t , 0 , StageCount > indices;
            nimboost::mpl::for_each< indices >( print_butcher( *this , os ) );
        }
    };
...
#pragma warning( default : 4307 34 )
            ...
            StateTemp &x_tmp , Deriv F[StageCount-1] ) const
    {
        ...
        nimboost::fusion::for_each( m_stages , calculate_stage<
