...
public:
    ...
    controlled_step_result try_step( System system , StateInOut &x , const DerivIn &dxdt , time_type &t , time_type &dt )
    {
        ...
        if( res == success )
        {
            nimboost::numeric::odeint::copy( m_xnew.m_v , x );
        }
        return res;
    }
    ...
    typename nimboost::disable_if< nimboost::is_same< StateIn , time_type > , controlled_step_result >::type
...
public:
     ...
     *
     * This version does not solve the forwarding problem, nimboost::range can not be used.
     * 
    ...
    controlled_step_result try_step( System system , StateInOut &x , DerivInOut &dxdt , time_type &t , time_type &dt )
    {
        ...
        {
            nimboost::numeric::odeint::copy( m_xnew.m_v , x );
            nimboost::numeric::odeint::copy( m_dxdtnew.m_v , dxdt );
        }
        return res;
    }
    ...
    {
        nimboost::numeric::odeint::copy( deriv , m_dxdt.m_v );
        m_first_call = false;
    }
