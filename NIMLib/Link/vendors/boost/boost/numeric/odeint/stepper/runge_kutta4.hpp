...
struct rk4_coefficients_a1 : nimboost::array< Value , 1 >
{
...
template< class Value = double >
struct rk4_coefficients_a2 : nimboost::array< Value , 2 >
{
...
template< class Value = double >
struct rk4_coefficients_a3 : nimboost::array< Value , 3 >
{
...
template< class Value = double >
struct rk4_coefficients_b : nimboost::array< Value , 4 >
{
...
template< class Value = double >
struct rk4_coefficients_c : nimboost::array< Value , 4 >
{
...
public:
    ...
    runge_kutta4( const algebra_type &algebra = algebra_type() ) : stepper_base_type(
            nimboost::fusion::make_vector( rk4_coefficients_a1<Value>() , rk4_coefficients_a2<Value>() , rk4_coefficients_a3<Value>() ) ,
