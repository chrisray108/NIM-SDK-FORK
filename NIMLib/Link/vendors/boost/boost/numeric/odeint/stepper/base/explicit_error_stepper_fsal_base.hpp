...
public:
    ...
    typename nimboost::disable_if< nimboost::is_same< StateInOut , time_type > , void >::type
    ...
    typename nimboost::disable_if< nimboost::is_same< StateIn , time_type > , void >::type
 ...
 *      case it can be used with `nimboost::ref` or `std::ref`, for example `stepper.do_step( nimboost::ref( sys ) , x , t , dt );`
 *
