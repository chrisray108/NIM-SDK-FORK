...
struct rk78_coefficients_a1 : nimboost::array< Value , 1 >
{
...
template< class Value = double >
struct rk78_coefficients_a2 : nimboost::array< Value , 2 >
{
...
template< class Value = double >
struct rk78_coefficients_a3 : nimboost::array< Value , 3 >
{
...
template< class Value = double >
struct rk78_coefficients_a4 : nimboost::array< Value , 4 >
{
...
template< class Value = double >
struct rk78_coefficients_a5 : nimboost::array< Value , 5 >
{
...
template< class Value = double >
struct rk78_coefficients_a6 : nimboost::array< Value , 6 >
{
...
template< class Value = double >
struct rk78_coefficients_a7 : nimboost::array< Value , 7 >
{
...
template< class Value = double >
struct rk78_coefficients_a8 : nimboost::array< Value , 8 >
{
...
template< class Value = double >
struct rk78_coefficients_a9 : nimboost::array< Value , 9 >
{
...
template< class Value = double >
struct rk78_coefficients_a10 : nimboost::array< Value , 10 >
{
...
template< class Value = double >
struct rk78_coefficients_a11 : nimboost::array< Value , 11 >
{
...
template< class Value = double >
struct rk78_coefficients_a12 : nimboost::array< Value , 12 >
{
...
template< class Value = double >
struct rk78_coefficients_b : nimboost::array< Value , 13 >
{
...
template< class Value = double >
struct rk78_coefficients_db : nimboost::array< Value , 13 >
{
...
template< class Value = double >
struct rk78_coefficients_c : nimboost::array< Value , 13 >
{
...
public:
    ...
    runge_kutta_fehlberg78( const algebra_type &algebra = algebra_type() ) : stepper_base_type(
            nimboost::fusion::make_vector( rk78_coefficients_a1<Value>() , rk78_coefficients_a2<Value>() , rk78_coefficients_a3<Value>() ,
