...
class adams_bashforth_coefficients< Value , 1 > : public nimboost::array< Value , 1 >
{
public:
    adams_bashforth_coefficients( void )
    : nimboost::array< Value , 1 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 2 > : public nimboost::array< Value , 2 >
{
public:
    adams_bashforth_coefficients( void )
    : nimboost::array< Value , 2 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 3 > : public nimboost::array< Value , 3 >
{
public:
    adams_bashforth_coefficients( void )
    : nimboost::array< Value , 3 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 4 > : public nimboost::array< Value , 4 >
{
public:
    adams_bashforth_coefficients( void )
    : nimboost::array< Value , 4 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 5 > : public nimboost::array< Value , 5 >
{
public:
    adams_bashforth_coefficients( void )
    : nimboost::array< Value , 5 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 6 > : public nimboost::array< Value , 6 >
{
public:
    adams_bashforth_coefficients( void )
    : nimboost::array< Value , 6 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 7 > : public nimboost::array< Value , 7 >
{
public:
    adams_bashforth_coefficients( void )
    : nimboost::array< Value , 7 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 8 > : public nimboost::array< Value , 8 >
{
public:
    adams_bashforth_coefficients( void )
    : nimboost::array< Value , 8 >()
      {
