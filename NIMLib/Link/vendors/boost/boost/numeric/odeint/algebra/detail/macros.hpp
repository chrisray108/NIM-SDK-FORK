...
#define BOOST_ODEINT_CHECK_CONTAINER_TYPE( Type1 , Type2 ) \
        BOOST_STATIC_ASSERT(( nimboost::is_same< typename nimboost::remove_const< Type1 >::type , Type2 >::value ))
...
#define BOOST_ODEINT_CHECK_OPERATION_ARITY( Operation , Arity ) \
        BOOST_STATIC_ASSERT(( nimboost::function_traits< Operation >::arity == Arity ))
 */
