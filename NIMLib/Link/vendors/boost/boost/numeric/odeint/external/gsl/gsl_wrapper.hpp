 ...
 */
class gsl_vector_iterator : public nimboost::iterator_facade< gsl_vector_iterator , double , nimboost::random_access_traversal_tag >
{
public :
 ...
 */
class const_gsl_vector_iterator : public nimboost::iterator_facade< const_gsl_vector_iterator , const double , nimboost::random_access_traversal_tag >
{
public :
