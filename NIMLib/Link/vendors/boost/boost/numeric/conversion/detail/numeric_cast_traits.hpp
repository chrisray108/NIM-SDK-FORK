...
namespace nimboost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(nimboost::long_long_type)(nimboost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (nimboost::long_long_type)(nimboost::ulong_long_type)
