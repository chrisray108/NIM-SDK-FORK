...
//             nimboost::detail::type to boost/type.hpp. Made it compile with
...
#  define BOOST_EXPLICIT_DEFAULT_TARGET , ::nimboost::type<Target>* = 0
# else
...
//  numeric_cast  ------------------------------------------------------------//
    ...
    namespace detail
    {
      ...
      // Move to namespace nimboost in utility.hpp?
...
# ifdef BOOST_HAS_LONG_LONG
      ...
      template <>
      struct fixed_numeric_limits_base< ::nimboost::long_long_type, false>
      {
          BOOST_STATIC_CONSTANT(bool, is_specialized = true);
          BOOST_STATIC_CONSTANT(bool, is_signed = true);
          static  ::nimboost::long_long_type max BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MAX
              return LONGLONG_MAX;
#  else
...
#  endif
          ...
          static  ::nimboost::long_long_type min BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MIN
              return LONGLONG_MIN;
#  else
...
#  endif
      ...
      template <>
      struct fixed_numeric_limits_base< ::nimboost::ulong_long_type, false>
      {
          BOOST_STATIC_CONSTANT(bool, is_specialized = true);
          BOOST_STATIC_CONSTANT(bool, is_signed = false);
          static  ::nimboost::ulong_long_type max BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef ULONGLONG_MAX
...
#  endif
          ...
          static  ::nimboost::ulong_long_type min BOOST_PREVENT_MACRO_SUBSTITUTION () { return 0; }
      };
# endif
    } // namespace detail
