...
namespace nimboost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename nimboost::mpl::if_<nimboost::is_const<M>,
    ...
    public:
        ...
        public:
            ...
            BOOST_STATIC_ASSERT ((nimboost::is_same<typename M::const_iterator1::iterator_category, typename M::const_iterator2::iterator_category>::value ));
     ...
     * - \c nimboost::numeric::ublas::indirect_array<A> where \c A can be \c int, \c size_t, \c long, etc...
     * - \c nimboost::numeric::ublas::matrix<int> can work too (\c int can be replaced by another integer type)
     * - etc...
     *
