...
namespace nimboost { namespace numeric { namespace ublas {
    ...
    template<>
    struct type_traits<nimboost::numeric::interval<float> > : scalar_traits<nimboost::numeric::interval<float> > {
        typedef type_traits<nimboost::numeric::interval<float> > self_type;
        typedef nimboost::numeric::interval<float> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef nimboost::numeric::interval<double> precision_type;

    };
    template<>
    struct type_traits<nimboost::numeric::interval<double> > : scalar_traits<nimboost::numeric::interval<double> > {
        typedef type_traits<nimboost::numeric::interval<double> > self_type;
        typedef nimboost::numeric::interval<double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef nimboost::numeric::interval<long double> precision_type;
    };
    template<>
    struct type_traits<nimboost::numeric::interval<long double> > : scalar_traits<nimboost::numeric::interval<long double> > {
        typedef type_traits<nimboost::numeric::interval<long double> > self_type;
        typedef nimboost::numeric::interval<long double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef value_type precision_type;
    ...
    namespace detail {
        ...
        template<typename T>
        struct has_trivial_constructor : public nimboost::has_trivial_constructor<T> {};

        template<typename T>
        struct has_trivial_destructor : public nimboost::has_trivial_destructor<T> {};
