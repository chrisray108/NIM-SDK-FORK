...
protected:
   ...
   */
  explicit basic_io_object(nimboost::asio::io_service& io_service)
    : service(nimboost::asio::use_service<IoObjectService>(io_service))
  {
...
protected:
  explicit basic_io_object(nimboost::asio::io_service& io_service)
    : service_(&nimboost::asio::use_service<IoObjectService>(io_service))
  {
