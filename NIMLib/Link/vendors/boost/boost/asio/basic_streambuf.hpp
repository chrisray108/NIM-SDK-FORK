 ...
 * nimboost::asio::streambuf::mutable_buffers_type bufs = b.prepare(512);
 *
...
public:
...
#else
  typedef nimboost::asio::const_buffers_1 const_buffers_type;
  typedef nimboost::asio::mutable_buffers_1 mutable_buffers_type;
#endif
  ...
  {
    return nimboost::asio::buffer(nimboost::asio::const_buffer(gptr(),
  ...
  {
    reserve(n);
    return nimboost::asio::buffer(nimboost::asio::mutable_buffer(
...
protected:
  ...
  void reserve(std::size_t n)
  {
    ...
    if (n > pend - pnext)
    {
      ...
      {
        std::length_error ex("nimboost::asio::streambuf too long");
