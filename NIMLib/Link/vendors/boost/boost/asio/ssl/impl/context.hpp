...
template <typename VerifyCallback>
nimboost::system::error_code context::set_verify_callback(
    VerifyCallback callback, nimboost::system::error_code& ec)
{
...
void context::set_password_callback(PasswordCallback callback)
{
  ...
  nimboost::asio::detail::throw_error(ec, "set_password_callback");
}

template <typename PasswordCallback>
nimboost::system::error_code context::set_password_callback(
