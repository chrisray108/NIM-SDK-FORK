  ...
  : handle_(0)
{
  ...
  case context::sslv2_server:
    nimboost::asio::detail::throw_error(
        nimboost::asio::error::invalid_argument, "context");
    break;
  ...
  if (handle_ == 0)
  {
    nimboost::system::error_code ec(
        ...
        nimboost::asio::error::get_ssl_category());
    nimboost::asio::detail::throw_error(ec, "context");
  }

  set_options(no_compression);
}

context::context(nimboost::asio::io_service&, context::method m)
  : handle_(0)
{
  context tmp(m);
  handle_ = tmp.handle_;
...
void context::clear_options(context::options o)
{
  nimboost::system::error_code ec;
  clear_options(o, ec);
  nimboost::asio::detail::throw_error(ec, "clear_options");
}

nimboost::system::error_code context::clear_options(
    context::options o, nimboost::system::error_code& ec)
{
...
void context::set_options(context::options o)
{
  nimboost::system::error_code ec;
  set_options(o, ec);
  nimboost::asio::detail::throw_error(ec, "set_options");
}

nimboost::system::error_code context::set_options(
    context::options o, nimboost::system::error_code& ec)
{
#if !defined(SSL_OP_NO_COMPRESSION)
  if ((o & context::no_compression) != 0)
  {
    ...
    handle_->comp_methods =
      nimboost::asio::ssl::detail::openssl_init<>::get_null_compression_methods();
#endif // (OPENSSL_VERSION_NUMBER >= 0x00908000L)
    o ^= context::no_compression;
  }
#endif // !defined(SSL_OP_NO_COMPRESSION)
...
void context::set_verify_mode(verify_mode v)
{
  ...
  nimboost::asio::detail::throw_error(ec, "set_verify_mode");
}

nimboost::system::error_code context::set_verify_mode(
    verify_mode v, nimboost::system::error_code& ec)
{
...
void context::set_verify_depth(int depth)
{
  ...
  nimboost::asio::detail::throw_error(ec, "set_verify_depth");
}

nimboost::system::error_code context::set_verify_depth(
    int depth, nimboost::system::error_code& ec)
{
...
void context::load_verify_file(const std::string& filename)
{
  ...
  nimboost::asio::detail::throw_error(ec, "load_verify_file");
}

nimboost::system::error_code context::load_verify_file(
    const std::string& filename, nimboost::system::error_code& ec)
{
...
void context::add_certificate_authority(const const_buffer& ca)
{
  ...
  nimboost::asio::detail::throw_error(ec, "add_certificate_authority");
}

nimboost::system::error_code context::add_certificate_authority(
    const const_buffer& ca, nimboost::system::error_code& ec)
{
  ::ERR_clear_error();
...
void context::set_default_verify_paths()
{
  ...
  nimboost::asio::detail::throw_error(ec, "set_default_verify_paths");
}

nimboost::system::error_code context::set_default_verify_paths(
    nimboost::system::error_code& ec)
{
...
void context::add_verify_path(const std::string& path)
{
  ...
  nimboost::asio::detail::throw_error(ec, "add_verify_path");
}

nimboost::system::error_code context::add_verify_path(
    const std::string& path, nimboost::system::error_code& ec)
{
    ...
    const const_buffer& certificate, file_format format)
{
  ...
  nimboost::asio::detail::throw_error(ec, "use_certificate");
}

nimboost::system::error_code context::use_certificate(
    const const_buffer& certificate, file_format format,
    nimboost::system::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, file_format format)
{
  ...
  nimboost::asio::detail::throw_error(ec, "use_certificate_file");
}

nimboost::system::error_code context::use_certificate_file(
    const std::string& filename, file_format format,
    nimboost::system::error_code& ec)
{
  int file_type;
...
void context::use_certificate_chain(const const_buffer& chain)
{
  ...
  nimboost::asio::detail::throw_error(ec, "use_certificate_chain");
}

nimboost::system::error_code context::use_certificate_chain(
    const const_buffer& chain, nimboost::system::error_code& ec)
{
  ::ERR_clear_error();
  ...
  if (bio.p)
  {
    ...
    if (!cert.p)
    {
      ec = nimboost::system::error_code(ERR_R_PEM_LIB,
          nimboost::asio::error::get_ssl_category());
      return ec;
    }
...
void context::use_certificate_chain_file(const std::string& filename)
{
  ...
  nimboost::asio::detail::throw_error(ec, "use_certificate_chain_file");
}

nimboost::system::error_code context::use_certificate_chain_file(
    const std::string& filename, nimboost::system::error_code& ec)
{
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  nimboost::asio::detail::throw_error(ec, "use_private_key");
}

nimboost::system::error_code context::use_private_key(
    const const_buffer& private_key, context::file_format format,
    nimboost::system::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, context::file_format format)
{
  ...
  nimboost::asio::detail::throw_error(ec, "use_private_key_file");
}
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  nimboost::asio::detail::throw_error(ec, "use_rsa_private_key");
}

nimboost::system::error_code context::use_rsa_private_key(
    const const_buffer& private_key, context::file_format format,
    nimboost::system::error_code& ec)
{
  ::ERR_clear_error();
...
nimboost::system::error_code context::use_private_key_file(
    const std::string& filename, context::file_format format,
    nimboost::system::error_code& ec)
{
  int file_type;
    ...
    const std::string& filename, context::file_format format)
{
  ...
  nimboost::asio::detail::throw_error(ec, "use_rsa_private_key_file");
}

nimboost::system::error_code context::use_rsa_private_key_file(
    const std::string& filename, context::file_format format,
    nimboost::system::error_code& ec)
{
  int file_type;
...
void context::use_tmp_dh(const const_buffer& dh)
{
  nimboost::system::error_code ec;
  use_tmp_dh(dh, ec);
  nimboost::asio::detail::throw_error(ec, "use_tmp_dh");
}

nimboost::system::error_code context::use_tmp_dh(
    const const_buffer& dh, nimboost::system::error_code& ec)
{
...
void context::use_tmp_dh_file(const std::string& filename)
{
  ...
  nimboost::asio::detail::throw_error(ec, "use_tmp_dh_file");
}

nimboost::system::error_code context::use_tmp_dh_file(
    const std::string& filename, nimboost::system::error_code& ec)
{
...
nimboost::system::error_code context::do_use_tmp_dh(
    BIO* bio, nimboost::system::error_code& ec)
{
  ::ERR_clear_error();
...
nimboost::system::error_code context::do_set_verify_callback(
    detail::verify_callback_base* callback, nimboost::system::error_code& ec)
{
  if (SSL_CTX_get_app_data(handle_))
  {
...
nimboost::system::error_code context::do_set_password_callback(
    detail::password_callback_base* callback, nimboost::system::error_code& ec)
{
  if (handle_->default_passwd_callback_userdata)
