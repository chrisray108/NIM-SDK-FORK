...
public:
  do_init()
  {
    ...
    for (size_t i = 0; i < mutexes_.size(); ++i)
      mutexes_[i].reset(new nimboost::asio::detail::mutex);
...
private:
  ...
  std::vector<nimboost::asio::detail::shared_ptr<
        nimboost::asio::detail::mutex> > mutexes_;

#if !defined(BOOST_ASIO_WINDOWS) && !defined(__CYGWIN__)
  // The thread identifiers to be used by openssl.
  nimboost::asio::detail::tss_ptr<void> thread_id_;
#endif // !defined(BOOST_ASIO_WINDOWS) && !defined(__CYGWIN__)
...
nimboost::asio::detail::shared_ptr<openssl_init_base::do_init>
openssl_init_base::instance()
{
  static nimboost::asio::detail::shared_ptr<do_init> init(new do_init);
  return init;
}
