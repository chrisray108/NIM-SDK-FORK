...
#else
  : public nimboost::asio::detail::service_base<stream_service>
#endif
{
private:
...
public:
  ...
  explicit stream_service(nimboost::asio::io_service& io_service)
    : nimboost::asio::detail::service_base<stream_service>(io_service),
