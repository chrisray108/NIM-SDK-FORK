...
class openssl_context_service
  : public nimboost::asio::detail::service_base<openssl_context_service>
{
public:
  ...
  typedef nimboost::function<std::string(std::size_t,
      context_base::password_purpose)> password_callback_type;

  // Constructor.
  openssl_context_service(nimboost::asio::io_service& io_service)
    : nimboost::asio::detail::service_base<openssl_context_service>(io_service)
  {
  }
  ...
  void create(impl_type& impl, context_base::method m)
  {
    ...
    case context_base::sslv2_server:
      nimboost::asio::detail::throw_error(nimboost::asio::error::invalid_argument);
      break;
  ...
  nimboost::system::error_code set_options(impl_type& impl,
      context_base::options o, nimboost::system::error_code& ec)
  {
  ...
  nimboost::system::error_code set_verify_mode(impl_type& impl,
      context_base::verify_mode v, nimboost::system::error_code& ec)
  {
  ...
  nimboost::system::error_code load_verify_file(impl_type& impl,
  ...
  nimboost::system::error_code add_verify_path(impl_type& impl,
  ...
  nimboost::system::error_code use_certificate_file(impl_type& impl,
  ...
  nimboost::system::error_code use_certificate_chain_file(impl_type& impl,
      const std::string& filename, nimboost::system::error_code& ec)
  {
  ...
  nimboost::system::error_code use_private_key_file(impl_type& impl,
      const std::string& filename, context_base::file_format format,
      nimboost::system::error_code& ec)
  {
    int file_type;
  ...
  nimboost::system::error_code use_rsa_private_key_file(impl_type& impl,
      const std::string& filename, context_base::file_format format,
      nimboost::system::error_code& ec)
  {
    int file_type;
  ...
  nimboost::system::error_code use_tmp_dh_file(impl_type& impl,
      const std::string& filename, nimboost::system::error_code& ec)
  {
  ...
  nimboost::system::error_code set_password_callback(impl_type& impl,
      Password_Callback callback, nimboost::system::error_code& ec)
  {
