...
public:
  ...
  /// Constructor.
  basic_context(nimboost::asio::io_service& io_service, method m)
    : service_(nimboost::asio::use_service<Service>(io_service)),
      impl_(service_.null())
  {
  ...
  void set_options(options o)
  {
    ...
    nimboost::asio::detail::throw_error(ec);
  }
   ...
   */
  nimboost::system::error_code set_options(options o,
      nimboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  nimboost::system::error_code set_verify_mode(verify_mode v,
      nimboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  nimboost::system::error_code load_verify_file(const std::string& filename,
      nimboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  nimboost::system::error_code add_verify_path(const std::string& path,
      nimboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  nimboost::system::error_code use_certificate_file(const std::string& filename,
      file_format format, nimboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  nimboost::system::error_code use_certificate_chain_file(
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  nimboost::system::error_code use_private_key_file(const std::string& filename,
      file_format format, nimboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  nimboost::system::error_code use_rsa_private_key_file(
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  nimboost::system::error_code use_tmp_dh_file(const std::string& filename,
      nimboost::system::error_code& ec)
  {
