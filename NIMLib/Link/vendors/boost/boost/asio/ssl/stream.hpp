...
using nimboost::asio::ssl::old::stream;
 ...
 * nimboost::asio::ssl::context ctx(nimboost::asio::ssl::context::sslv23);
 * nimboost::asio::ssl::stream<asio:ip::tcp::socket> sock(io_service, ctx);
 * @endcode
 *
 * @par Concepts:
...
public:
   ...
   * @note Calls @c SSL_set_verify.
   */
  nimboost::system::error_code set_verify_mode(
   ...
   * @note Calls @c SSL_set_verify_depth.
   */
  nimboost::system::error_code set_verify_depth(
  ...
  void set_verify_callback(VerifyCallback callback)
  {
    ...
    nimboost::asio::detail::throw_error(ec, "set_verify_callback");
  }
  ...
  void handshake(handshake_type type)
  {
    nimboost::system::error_code ec;
    handshake(type, ec);
    nimboost::asio::detail::throw_error(ec, "handshake");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  nimboost::system::error_code handshake(handshake_type type,
      nimboost::system::error_code& ec)
  {
  ...
  template <typename ConstBufferSequence>
  nimboost::system::error_code handshake(handshake_type type,
      const ConstBufferSequence& buffers, nimboost::system::error_code& ec)
  {
      ...
      BOOST_ASIO_MOVE_ARG(HandshakeHandler) handler)
  {
    ...
    nimboost::asio::detail::async_result_init<
      HandshakeHandler, void (nimboost::system::error_code)> init(
      ...
      BOOST_ASIO_MOVE_ARG(BufferedHandshakeHandler) handler)
  {
    ...
    nimboost::asio::detail::async_result_init<BufferedHandshakeHandler,
      void (nimboost::system::error_code, std::size_t)> init(
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  nimboost::system::error_code shutdown(nimboost::system::error_code& ec)
  {
  ...
  async_shutdown(BOOST_ASIO_MOVE_ARG(ShutdownHandler) handler)
  {
    ...
    nimboost::asio::detail::async_result_init<
      ShutdownHandler, void (nimboost::system::error_code)> init(
