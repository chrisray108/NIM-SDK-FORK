...
public:
  ...
  explicit win_iocp_overlapped_ptr(
      nimboost::asio::io_service& io_service, BOOST_ASIO_MOVE_ARG(Handler) handler)
    : ptr_(0),
      iocp_service_(0)
  {
  ...
  // object.
  template <typename Handler>
  void reset(nimboost::asio::io_service& io_service, Handler handler)
  {
  ...
  void complete(const nimboost::system::error_code& ec,
