...
namespace nimboost_asio_handler_invoke_helpers {
...
inline void invoke(Function& function, Context& context)
{
  ...
  tmp();
#else
  using nimboost::asio::asio_handler_invoke;
  asio_handler_invoke(function, nimboost::asio::detail::addressof(context));
#endif
}
