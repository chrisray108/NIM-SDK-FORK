...
public:
  ...
  public:
    ...
    BOOST_ASIO_DECL void invocation_begin(const nimboost::system::error_code& ec);
...
# define BOOST_ASIO_INHERIT_TRACKED_HANDLER \
  : public nimboost::asio::detail::handler_tracking::tracked_handler

# define BOOST_ASIO_ALSO_INHERIT_TRACKED_HANDLER \
  , public nimboost::asio::detail::handler_tracking::tracked_handler

# define BOOST_ASIO_HANDLER_TRACKING_INIT \
  nimboost::asio::detail::handler_tracking::init()

# define BOOST_ASIO_HANDLER_CREATION(args) \
  nimboost::asio::detail::handler_tracking::creation args

# define BOOST_ASIO_HANDLER_COMPLETION(args) \
  nimboost::asio::detail::handler_tracking::completion tracked_completion args
...
# define BOOST_ASIO_HANDLER_OPERATION(args) \
  nimboost::asio::detail::handler_tracking::operation args
