...
select_reactor::select_reactor(nimboost::asio::io_service& io_service)
  : nimboost::asio::detail::service_base<select_reactor>(io_service),
...
{
#if defined(BOOST_ASIO_HAS_IOCP)
  nimboost::asio::detail::signal_blocker sb;
  thread_ = new nimboost::asio::detail::thread(
...
void select_reactor::fork_service(nimboost::asio::io_service::fork_event fork_ev)
{
