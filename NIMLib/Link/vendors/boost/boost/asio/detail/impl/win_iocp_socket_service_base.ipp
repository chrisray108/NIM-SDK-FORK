...
nimboost::system::error_code win_iocp_socket_service_base::close(
    win_iocp_socket_service_base::base_implementation_type& impl,
...
nimboost::system::error_code win_iocp_socket_service_base::cancel(
    win_iocp_socket_service_base::base_implementation_type& impl,
    nimboost::system::error_code& ec)
{
  if (!is_open(impl))
...
nimboost::system::error_code win_iocp_socket_service_base::do_open(
    win_iocp_socket_service_base::base_implementation_type& impl,
    int family, int type, int protocol, nimboost::system::error_code& ec)
{
  if (is_open(impl))
  {
...
nimboost::system::error_code win_iocp_socket_service_base::do_assign(
    win_iocp_socket_service_base::base_implementation_type& impl,
    int type, socket_type native_socket, nimboost::system::error_code& ec)
{
  if (is_open(impl))
  {
    ec = nimboost::asio::error::already_open;
    ...
    int protocol, void* output_buffer, DWORD address_length, operation* op)
{
  ...
  if (!is_open(impl))
    ...
    iocp_service_.on_completion(op, nimboost::asio::error::already_open);
  else
  {
    nimboost::system::error_code ec;
    ...
    reactor_op* op, const socket_addr_type* addr, std::size_t addrlen)
{
        ...
        impl.socket_, impl.state_, true, op->ec_))
  {
    ...
    {
      if (op->ec_ == nimboost::asio::error::in_progress
          || op->ec_ == nimboost::asio::error::would_block)
      {
