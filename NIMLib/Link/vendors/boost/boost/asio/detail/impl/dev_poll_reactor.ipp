...
dev_poll_reactor::dev_poll_reactor(nimboost::asio::io_service& io_service)
  : nimboost::asio::detail::service_base<dev_poll_reactor>(io_service),
...
void dev_poll_reactor::fork_service(nimboost::asio::io_service::fork_event fork_ev)
{
  if (fork_ev == nimboost::asio::io_service::fork_child)
  {
...
{
  nimboost::asio::detail::mutex::scoped_lock lock(mutex_);
  cancel_ops_unlocked(descriptor, nimboost::asio::error::operation_aborted);
}
...
void dev_poll_reactor::run(bool block, op_queue<operation>& ops)
{
  ...
  if (events_size > 0)
  {
    ...
    {
      nimboost::system::error_code ec = nimboost::system::error_code(
...
int dev_poll_reactor::do_dev_poll_create()
{
  ...
  if (fd == -1)
  {
    nimboost::system::error_code ec(errno,
        nimboost::asio::error::get_system_category());
    nimboost::asio::detail::throw_error(ec, "/dev/poll");
  }
  return fd;
}
