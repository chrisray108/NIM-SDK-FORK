...
struct task_io_service::task_cleanup
{
  ~task_cleanup()
  {
    ...
    {
      nimboost::asio::detail::increment(
...
task_io_service::task_io_service(
    nimboost::asio::io_service& io_service, std::size_t concurrency_hint)
  : nimboost::asio::detail::service_base<task_io_service>(io_service),
...
std::size_t task_io_service::run(nimboost::system::error_code& ec)
{
...
std::size_t task_io_service::run_one(nimboost::system::error_code& ec)
{
  ec = nimboost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll(nimboost::system::error_code& ec)
{
  ec = nimboost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll_one(nimboost::system::error_code& ec)
{
  ec = nimboost::system::error_code();
  if (outstanding_work_ == 0)
  {
