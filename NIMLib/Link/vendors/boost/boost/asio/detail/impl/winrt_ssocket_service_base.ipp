...
void winrt_ssocket_service_base::shutdown_service()
{
  ...
  nimboost::asio::detail::mutex::scoped_lock lock(mutex_);
    ...
    winrt_ssocket_service_base::base_implementation_type& other_impl)
{
  ...
  {
    // Insert implementation into linked list of all implementations.
    nimboost::asio::detail::mutex::scoped_lock lock(other_service.mutex_);
...
nimboost::system::error_code winrt_ssocket_service_base::close(
    winrt_ssocket_service_base::base_implementation_type& impl,
...
nimboost::system::error_code winrt_ssocket_service_base::do_set_option(
    winrt_ssocket_service_base::base_implementation_type& impl,
...
nimboost::system::error_code winrt_ssocket_service_base::do_connect(
    winrt_ssocket_service_base::base_implementation_type& impl,
    ...
    const void* addr, winrt_async_op<void>* op, bool is_continuation)
{
  if (!is_open(impl))
  {
    op->ec_ = nimboost::asio::error::bad_descriptor;
  ...
  case BOOST_ASIO_OS_DEF(AF_INET6):
    ...
    break;
  default:
    op->ec_ = nimboost::asio::error::address_family_not_supported;
    break;
  }
  ...
  {
    op->ec_ = nimboost::system::error_code(
        e->HResult, nimboost::system::system_category());
    io_service_.post_immediate_completion(op, is_continuation);
  }
}
    ...
    socket_base::message_flags flags, nimboost::system::error_code& ec)
{
  ...
  try
  {
    buffer_sequence_adapter<nimboost::asio::const_buffer,
      nimboost::asio::const_buffers_1> bufs(nimboost::asio::buffer(data));
      ...
      winrt_async_op<unsigned int>* op, bool is_continuation)
{
  if (flags)
  {
    op->ec_ = nimboost::asio::error::operation_not_supported;
    io_service_.post_immediate_completion(op, is_continuation);
    return;
  }
  ...
  {
    op->ec_ = nimboost::system::error_code(e->HResult,
        nimboost::system::system_category());
    io_service_.post_immediate_completion(op, is_continuation);
  }
}
    ...
    socket_base::message_flags flags, nimboost::system::error_code& ec)
{
  ...
  try
  {
    buffer_sequence_adapter<nimboost::asio::mutable_buffer,
        nimboost::asio::mutable_buffers_1> bufs(nimboost::asio::buffer(data));
