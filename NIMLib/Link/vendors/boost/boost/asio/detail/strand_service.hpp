...
class strand_service
  : public nimboost::asio::detail::service_base<strand_service>
{
private:
...
public:
  ...
  BOOST_ASIO_DECL explicit strand_service(nimboost::asio::io_service& io_service);
...
private:
  ...
  BOOST_ASIO_DECL static void do_complete(io_service_impl* owner,
      operation* base, const nimboost::system::error_code& ec,
