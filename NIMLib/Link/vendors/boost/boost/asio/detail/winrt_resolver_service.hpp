...
public:
  ...
  // The query type.
  typedef nimboost::asio::ip::basic_resolver_query<Protocol> query_type;

  // The iterator type.
  typedef nimboost::asio::ip::basic_resolver_iterator<Protocol> iterator_type;

  // Constructor.
  winrt_resolver_service(nimboost::asio::io_service& io_service)
  ...
  void fork_service(nimboost::asio::io_service::fork_event)
  {
  }
  ...
  iterator_type resolve(implementation_type&,
      const query_type& query, nimboost::system::error_code& ec)
  {
    try
    {
      ...
      const query_type& query, Handler& handler)
  {
    ...
    {
      p.p->ec_ = nimboost::system::error_code(
