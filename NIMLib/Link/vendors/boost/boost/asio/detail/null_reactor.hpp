...
class null_reactor
  : public nimboost::asio::detail::service_base<null_reactor>
{
public:
  // Constructor.
  null_reactor(nimboost::asio::io_service& io_service)
    : nimboost::asio::detail::service_base<null_reactor>(io_service)
  {
  }
