...
class winrt_timer_scheduler
  : public nimboost::asio::detail::service_base<winrt_timer_scheduler>
{
public:
  // Constructor.
  BOOST_ASIO_DECL winrt_timer_scheduler(nimboost::asio::io_service& io_service);
...
private:
  ...
  nimboost::asio::detail::event event_;

  // The timer queues.
  timer_queue_set timer_queues_;

  // The background thread that is waiting for timers to expire.
  nimboost::asio::detail::thread* thread_;
