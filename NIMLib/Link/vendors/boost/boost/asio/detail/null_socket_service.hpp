...
public:
  ...
  // Constructor.
  null_socket_service(nimboost::asio::io_service& io_service)
  ...
  nimboost::system::error_code open(implementation_type&,
      const protocol_type&, nimboost::system::error_code& ec)
  {
  ...
  nimboost::system::error_code assign(implementation_type&, const protocol_type&,
      const native_handle_type&, nimboost::system::error_code& ec)
  {
    ec = nimboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Destroy a socket implementation.
  nimboost::system::error_code close(implementation_type&,
  ...
  nimboost::system::error_code cancel(implementation_type&,
      nimboost::system::error_code& ec)
  {
    ec = nimboost::asio::error::operation_not_supported;
    return ec;
  ...
  nimboost::system::error_code listen(implementation_type&,
      int, nimboost::system::error_code& ec)
  {
    ec = nimboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  nimboost::system::error_code io_control(implementation_type&,
  ...
  nimboost::system::error_code non_blocking(implementation_type&,
  ...
  nimboost::system::error_code native_non_blocking(implementation_type&,
      bool, nimboost::system::error_code& ec)
  {
    ec = nimboost::asio::error::operation_not_supported;
    return ec;
  ...
  nimboost::system::error_code shutdown(implementation_type&,
  ...
  nimboost::system::error_code bind(implementation_type&,
      const endpoint_type&, nimboost::system::error_code& ec)
  {
    ec = nimboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  nimboost::system::error_code set_option(implementation_type&,
      const Option&, nimboost::system::error_code& ec)
  {
    ec = nimboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Set a socket option.
  template <typename Option>
  nimboost::system::error_code get_option(const implementation_type&,
      Option&, nimboost::system::error_code& ec) const
  {
    ec = nimboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  nimboost::system::error_code accept(implementation_type&,
      Socket&, endpoint_type*, nimboost::system::error_code& ec)
  {
    ec = nimboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  nimboost::system::error_code connect(implementation_type&,
      const endpoint_type&, nimboost::system::error_code& ec)
  {
    ec = nimboost::asio::error::operation_not_supported;
    return ec;
