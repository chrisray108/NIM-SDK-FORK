...
public:
  ...
  BOOST_ASIO_DECL win_iocp_handle_service(nimboost::asio::io_service& io_service);
...
private:
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers& buffers, nimboost::system::error_code& ec);
  size_t write_some_at(implementation_type& impl, uint64_t offset,
      const null_buffers& buffers, nimboost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL size_t do_write(implementation_type& impl,
      uint64_t offset, const nimboost::asio::const_buffer& buffer,
      nimboost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL size_t do_read(implementation_type& impl,
      uint64_t offset, const nimboost::asio::mutable_buffer& buffer,
      nimboost::system::error_code& ec);
