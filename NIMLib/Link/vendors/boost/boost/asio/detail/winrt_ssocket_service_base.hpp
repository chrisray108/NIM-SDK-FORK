...
public:
  ...
  // Destroy a socket implementation.
  BOOST_ASIO_DECL nimboost::system::error_code close(
      base_implementation_type& impl, nimboost::system::error_code& ec);
  ...
  nimboost::system::error_code cancel(base_implementation_type&,
  ...
  nimboost::system::error_code io_control(base_implementation_type&,
      IO_Control_Command&, nimboost::system::error_code& ec)
  {
    ec = nimboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  nimboost::system::error_code non_blocking(base_implementation_type&,
      bool, nimboost::system::error_code& ec)
  {
    ec = nimboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  nimboost::system::error_code native_non_blocking(base_implementation_type&,
      bool, nimboost::system::error_code& ec)
  {
    ec = nimboost::asio::error::operation_not_supported;
    return ec;
  ...
  nimboost::system::error_code shutdown(base_implementation_type&,
      socket_base::shutdown_type, nimboost::system::error_code& ec)
  {
    ec = nimboost::asio::error::operation_not_supported;
    return ec;
  }
      ...
      socket_base::message_flags flags, Handler& handler)
  {
    bool is_continuation =
      nimboost_asio_handler_cont_helpers::is_continuation(handler);

    // Allocate and construct an operation to wrap the handler.
    typedef winrt_socket_send_op<ConstBufferSequence, Handler> op;
    typename op::ptr p = { nimboost::asio::detail::addressof(handler),
      nimboost_asio_handler_alloc_helpers::allocate(
        sizeof(op), handler), 0 };
  ...
  {
    nimboost::system::error_code ec = nimboost::asio::error::operation_not_supported;
      ...
      socket_base::message_flags flags, nimboost::system::error_code& ec)
  {
    return do_receive(impl,
        buffer_sequence_adapter<nimboost::asio::mutable_buffer,
...
protected:
  ...
  BOOST_ASIO_DECL std::size_t do_get_endpoint(
      ...
      void* addr, std::size_t addr_len, nimboost::system::error_code& ec) const;

  // Helper function to set a socket option.
  BOOST_ASIO_DECL nimboost::system::error_code do_set_option(
  ...
  BOOST_ASIO_DECL void do_get_option(
      ...
      std::size_t* optlen, nimboost::system::error_code& ec) const;

  // Helper function to perform a synchronous connect.
  BOOST_ASIO_DECL nimboost::system::error_code do_connect(
      base_implementation_type& impl,
      const void* addr, nimboost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL std::size_t do_send(
      base_implementation_type& impl, const nimboost::asio::const_buffer& data,
      socket_base::message_flags flags, nimboost::system::error_code& ec);

  // Helper function to start an asynchronous send.
  BOOST_ASIO_DECL void start_send_op(base_implementation_type& impl,
      const nimboost::asio::const_buffer& data, socket_base::message_flags flags,
  ...
  BOOST_ASIO_DECL std::size_t do_receive(
      base_implementation_type& impl, const nimboost::asio::mutable_buffer& data,
      socket_base::message_flags flags, nimboost::system::error_code& ec);

  // Helper function to start an asynchronous receive.
  BOOST_ASIO_DECL void start_receive_op(base_implementation_type& impl,
      const nimboost::asio::mutable_buffer& data, socket_base::message_flags flags,
  ...
  nimboost::asio::detail::mutex mutex_;
