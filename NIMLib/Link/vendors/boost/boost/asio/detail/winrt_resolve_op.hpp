...
public:
  ...
  static void do_complete(io_service_impl* owner, operation* base,
      const nimboost::system::error_code&, std::size_t)
  {
    // Take ownership of the operation object.
    winrt_resolve_op* o(static_cast<winrt_resolve_op*>(base));
    ptr p = { nimboost::asio::detail::addressof(o->handler_), o, o };
    ...
    if (!o->ec_)
    {
      ...
      {
        o->ec_ = nimboost::system::error_code(e->HResult,
    ...
    detail::binder2<Handler, nimboost::system::error_code, iterator_type>
      handler(o->handler_, o->ec_, iterator);
    p.h = nimboost::asio::detail::addressof(handler.handler_);
    p.reset();
    ...
    if (owner)
    {
      ...
      nimboost_asio_handler_invoke_helpers::invoke(handler, handler.handler_);
