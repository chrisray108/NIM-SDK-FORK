...
#define BOOST_ASIO_COMPLETION_HANDLER_CHECK( \
  ...
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(nimboost::asio::detail::zero_arg_handler_test( \
          nimboost::asio::detail::clvref< \
            asio_true_handler_type>(), 0)) == 1, \
      "CompletionHandler type requirements not met") \
  \
  typedef nimboost::asio::detail::handler_type_requirements< \
      sizeof( \
        nimboost::asio::detail::argbyv( \
          nimboost::asio::detail::clvref< \
            asio_true_handler_type>())) + \
      sizeof( \
        nimboost::asio::detail::lvref< \
          asio_true_handler_type>()(), \
...
#define BOOST_ASIO_READ_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(nimboost::asio::detail::two_arg_handler_test( \
          nimboost::asio::detail::clvref< \
            asio_true_handler_type>(), \
          static_cast<const nimboost::system::error_code*>(0), \
  ...
  typedef nimboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        nimboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            nimboost::asio::detail::lvref<const nimboost::system::error_code>(), \
            nimboost::asio::detail::lvref<const std::size_t>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_ACCEPT_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(nimboost::asio::detail::one_arg_handler_test( \
          nimboost::asio::detail::clvref< \
            asio_true_handler_type>(), \
          static_cast<const nimboost::system::error_code*>(0))) == 1, \
...
#define BOOST_ASIO_COMPOSED_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(nimboost::system::error_code, iter_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(nimboost::asio::detail::two_arg_handler_test( \
  ...
  typedef nimboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        nimboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            nimboost::asio::detail::lvref<const nimboost::system::error_code>(), \
            nimboost::asio::detail::lvref<const iter_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
  ...
  typedef nimboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        nimboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            nimboost::asio::detail::lvref<const nimboost::system::error_code>(), \
            nimboost::asio::detail::lvref<const int>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
