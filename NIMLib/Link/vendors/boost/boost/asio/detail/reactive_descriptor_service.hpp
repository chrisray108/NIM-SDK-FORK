...
public:
  ...
  class implementation_type
    : private nimboost::asio::detail::noncopyable
  {
  public:
    // Default constructor.
    implementation_type()
  ...
  BOOST_ASIO_DECL nimboost::system::error_code assign(implementation_type& impl,
  ...
  // Destroy a descriptor implementation.
  BOOST_ASIO_DECL nimboost::system::error_code close(implementation_type& impl,
      nimboost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL nimboost::system::error_code cancel(implementation_type& impl,
      nimboost::system::error_code& ec);
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers&, nimboost::system::error_code& ec)
  {
