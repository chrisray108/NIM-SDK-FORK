...
class winrt_async_manager
  : public nimboost::asio::detail::service_base<winrt_async_manager>
{
public:
  // Constructor.
  winrt_async_manager(nimboost::asio::io_service& io_service)
    : nimboost::asio::detail::service_base<winrt_async_manager>(io_service),
      ...
      nimboost::system::error_code& ec)
  {
    ...
    auto promise = std::make_shared<std::promise<nimboost::system::error_code>>();
    ...
    action->Completed = ref new AsyncActionCompletedHandler(
      [promise](IAsyncAction^ action, AsyncStatus status)
      {
        ...
        case AsyncStatus::Canceled:
          promise->set_value(nimboost::asio::error::operation_aborted);
          break;
      ...
      winrt_async_op<void>* handler)
  {
    ...
    auto on_completed = ref new AsyncActionCompletedHandler(
      [this, handler](IAsyncAction^ action, AsyncStatus status)
      {
        ...
        {
        case AsyncStatus::Canceled:
          handler->ec_ = nimboost::asio::error::operation_aborted;
          break;
        case AsyncStatus::Started:
          return;
        case AsyncStatus::Completed:
        case AsyncStatus::Error:
        default:
          handler->ec_ = nimboost::system::error_code(
              action->ErrorCode.Value,
              nimboost::system::system_category());
          break;
        }
