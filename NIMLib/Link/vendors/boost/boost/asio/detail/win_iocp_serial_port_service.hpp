...
public:
  ...
  BOOST_ASIO_DECL nimboost::system::error_code open(implementation_type& impl,
      const std::string& device, nimboost::system::error_code& ec);

  // Assign a native handle to a serial port implementation.
  nimboost::system::error_code assign(implementation_type& impl,
      const native_handle_type& handle, nimboost::system::error_code& ec)
  {
  ...
  nimboost::system::error_code set_option(implementation_type& impl,
      const SettableSerialPortOption& option, nimboost::system::error_code& ec)
  {
  ...
  nimboost::system::error_code get_option(const implementation_type& impl,
      GettableSerialPortOption& option, nimboost::system::error_code& ec) const
  {
  ...
  nimboost::system::error_code send_break(implementation_type&,
      nimboost::system::error_code& ec)
  {
  ...
  size_t read_some(implementation_type& impl,
      const MutableBufferSequence& buffers, nimboost::system::error_code& ec)
  {
...
private:
  ...
  typedef nimboost::system::error_code (*store_function_type)(
      const void*, ::DCB&, nimboost::system::error_code&);

  // Helper function template to store a serial port option.
  template <typename SettableSerialPortOption>
  static nimboost::system::error_code store_option(const void* option,
      ::DCB& storage, nimboost::system::error_code& ec)
  {
  ...
  BOOST_ASIO_DECL nimboost::system::error_code do_set_option(
      ...
      const void* option, nimboost::system::error_code& ec);

  // Function pointer type for loading a serial port option.
  typedef nimboost::system::error_code (*load_function_type)(
      void*, const ::DCB&, nimboost::system::error_code&);

  // Helper function template to load a serial port option.
  template <typename GettableSerialPortOption>
  static nimboost::system::error_code load_option(void* option,
      const ::DCB& storage, nimboost::system::error_code& ec)
  {
    return static_cast<GettableSerialPortOption*>(option)->load(storage, ec);
  }

  // Helper function to get a serial port option.
  BOOST_ASIO_DECL nimboost::system::error_code do_get_option(
      const implementation_type& impl, load_function_type load,
      void* option, nimboost::system::error_code& ec) const;
