...
public:
   ...
   */
  explicit strand(nimboost::asio::io_service& io_service)
    : service_(nimboost::asio::use_service<
        nimboost::asio::detail::strand_service>(io_service))
  {
   ...
   * @code strand.dispatch(nimboost::bind(f, a1, ... an)); @endcode
   */
...
private:
  nimboost::asio::detail::strand_service& service_;
  nimboost::asio::detail::strand_service::implementation_type impl_;
};

/// Typedef for backwards compatibility.
typedef nimboost::asio::io_service::strand strand;
