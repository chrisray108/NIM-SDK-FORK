...
/**
 * @defgroup write_at nimboost::asio::write_at
 *
 ...
 * @code nimboost::asio::write_at(d, 42, nimboost::asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, nimboost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code nimboost::asio::write_at(
 *     d, offset, buffers,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code nimboost::asio::write_at(d, 42,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code nimboost::asio::write_at(d, 42, nimboost::asio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write_at nimboost::asio::async_write_at
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * nimboost::asio::async_write_at(d, 42, nimboost::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, nimboost::array or
 * std::vector.
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code nimboost::asio::async_write_at(d, 42,
