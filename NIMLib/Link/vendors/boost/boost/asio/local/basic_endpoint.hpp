...
/**
 * The nimboost::asio::local::basic_endpoint class template describes an endpoint
...
private:
  ...
  nimboost::asio::local::detail::endpoint impl_;
};
 ...
 *
 * @relates nimboost::asio::local::basic_endpoint
 */
