...
#else
  : public nimboost::asio::detail::service_base<object_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit object_handle_service(nimboost::asio::io_service& io_service)
    : nimboost::asio::detail::service_base<object_handle_service>(io_service),
  ...
  void wait(implementation_type& impl, nimboost::system::error_code& ec)
  {
      ...
      BOOST_ASIO_MOVE_ARG(WaitHandler) handler)
  {
    nimboost::asio::detail::async_result_init<
      WaitHandler, void (nimboost::system::error_code)> init(
