...
public:
   ...
   */
  explicit basic_handle(nimboost::asio::io_service& io_service)
   ...
   */
  basic_handle(nimboost::asio::io_service& io_service,
   ...
   */
  nimboost::system::error_code assign(const native_handle_type& handle,
      nimboost::system::error_code& ec)
  {
