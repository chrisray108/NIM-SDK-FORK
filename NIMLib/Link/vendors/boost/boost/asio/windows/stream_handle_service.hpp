...
#else
  : public nimboost::asio::detail::service_base<stream_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_handle_service(nimboost::asio::io_service& io_service)
    : nimboost::asio::detail::service_base<stream_handle_service>(io_service),
