    ...
    nimboost::asio::basic_streambuf<Allocator>& b, char delim)
{
  ...
  nimboost::asio::detail::throw_error(ec, "read_until");
    ...
    nimboost::system::error_code& ec)
{
  ...
  for (;;)
  {
    ...
    typedef typename nimboost::asio::basic_streambuf<
      Allocator>::const_buffers_type const_buffers_type;
    typedef nimboost::asio::buffers_iterator<const_buffers_type> iterator;
    ...
    nimboost::system::error_code& ec)
{
  ...
  for (;;)
  {
    ...
    // Look for a match.
    nimboost::match_results<iterator,
      typename std::vector<nimboost::sub_match<iterator> >::allocator_type>
        match_results;
    if (regex_search(start_pos, end, match_results, expr,
          nimboost::match_default | nimboost::match_partial))
    {
  ...
  public:
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      case 1:
        ...
        const nimboost::system::error_code result_ec =
          (search_position_ == not_found)
          ? error::not_found : ec;
...
namespace detail
{
  ...
  public:
    read_until_expr_op(AsyncReadStream& stream,
        nimboost::asio::basic_streambuf<Allocator>& streambuf,
        const nimboost::regex& expr, ReadHandler& handler)
      : stream_(stream),
        streambuf_(streambuf),
        expr_(expr),
        start_(0),
    ...
    BOOST_ASIO_MOVE_ARG(ReadHandler) handler)
{
  ...
  detail::read_until_expr_op<AsyncReadStream, Allocator,
    nimboost::regex, BOOST_ASIO_HANDLER_TYPE(ReadHandler,
      void (nimboost::system::error_code, std::size_t))>(
