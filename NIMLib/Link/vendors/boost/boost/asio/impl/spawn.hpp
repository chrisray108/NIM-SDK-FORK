...
namespace detail {
  ...
  public:
    ...
    {
      *ec_ = nimboost::system::error_code();
      *value_ = value;
      (*coro_)();
    }

    void operator()(nimboost::system::error_code ec, T value)
    {
      *ec_ = ec;
      *value_ = value;
      (*coro_)();
  ...
  public:
    ...
    void operator()(nimboost::system::error_code ec)
    {
      *ec_ = ec;
      (*coro_)();
    }
...
struct handler_type<basic_yield_context<Handler>,
    ReturnType(nimboost::system::error_code)>
{
  typedef detail::coro_handler<Handler, void> type;
};
...
struct handler_type<basic_yield_context<Handler>,
    ReturnType(nimboost::system::error_code, Arg2)>
{
...
public:
  ...
  {
    ca_();
    if (!out_ec_ && ec_) throw nimboost::system::system_error(ec_);
    return value_;
  }

private:
  typename basic_yield_context<Handler>::caller_type& ca_;
  nimboost::system::error_code* out_ec_;
  nimboost::system::error_code ec_;
  type value_;
};
...
namespace detail {
  ...
  struct spawn_helper
  {
    ...
    shared_ptr<spawn_data<Handler, Function> > data_;
    nimboost::coroutines::attributes attributes_;
  };
...
void spawn(BOOST_ASIO_MOVE_ARG(Handler) handler,
    ...
    const nimboost::coroutines::attributes& attributes)
{
  ...
  nimboost_asio_handler_invoke_helpers::invoke(helper, helper.data_->handler_);
}
...
void spawn(nimboost::asio::io_service::strand strand,
    BOOST_ASIO_MOVE_ARG(Function) function,
    const nimboost::coroutines::attributes& attributes)
{
  nimboost::asio::spawn(strand.wrap(&detail::default_spawn_handler),
      BOOST_ASIO_MOVE_CAST(Function)(function), attributes);
}

template <typename Function>
void spawn(nimboost::asio::io_service& io_service,
    BOOST_ASIO_MOVE_ARG(Function) function,
    const nimboost::coroutines::attributes& attributes)
{
  nimboost::asio::spawn(nimboost::asio::io_service::strand(io_service),
      BOOST_ASIO_MOVE_CAST(Function)(function), attributes);
}
