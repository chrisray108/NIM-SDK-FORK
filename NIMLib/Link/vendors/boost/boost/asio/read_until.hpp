...
struct is_match_condition
{
  ...
  enum
  {
    value = nimboost::asio::is_function<
        typename nimboost::asio::remove_pointer<T>::type>::value
...
/**
 * @defgroup read_until nimboost::asio::read_until
 *
 ...
 * @code nimboost::asio::streambuf b;
 * nimboost::asio::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
...
std::size_t read_until(SyncReadStream& s,
    nimboost::asio::basic_streambuf<Allocator>& b, char delim);
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    nimboost::asio::basic_streambuf<Allocator>& b, const std::string& delim);
 ...
 * @code nimboost::asio::streambuf b;
 * nimboost::asio::read_until(s, b, nimboost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    nimboost::asio::basic_streambuf<Allocator>& b, const nimboost::regex& expr);
 ...
 * @code typedef nimboost::asio::buffers_iterator<
 *     nimboost::asio::streambuf::const_buffers_type> iterator;
 *
 ...
 * }
 * ...
 * nimboost::asio::streambuf b;
 * nimboost::asio::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 *     : public nimboost::true_type {};
 * } // namespace asio
 * ...
 * nimboost::asio::streambuf b;
 * nimboost::asio::read_until(s, b, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    nimboost::asio::basic_streambuf<Allocator>& b, MatchCondition match_condition,
...
std::size_t read_until(SyncReadStream& s,
    ...
    MatchCondition match_condition, nimboost::system::error_code& ec,
    typename enable_if<is_match_condition<MatchCondition>::value>::type* = 0);

/*@}*/
/**
 * @defgroup async_read_until nimboost::asio::async_read_until
 *
 ...
 * @code void handler(
 *   // Result of operation.
 *   const nimboost::system::error_code& error,
 *
 ...
 * @code nimboost::asio::streambuf b;
 * ...
 * void handler(const nimboost::system::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::istream is(&b);
 ...
 * }
 * ...
 * nimboost::asio::async_read_until(s, b, '\n', handler); @endcode
 ...
 * }
 * ...
 * nimboost::asio::async_read_until(s, b, nimboost::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * nimboost::asio::streambuf b;
 * nimboost::asio::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * nimboost::asio::streambuf b;
 * nimboost::asio::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 */
