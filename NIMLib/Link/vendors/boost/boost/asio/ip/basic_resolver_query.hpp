...
/**
 * The nimboost::asio::ip::basic_resolver_query class template describes a query
...
public:
  ...
  const nimboost::asio::detail::addrinfo_type& hints() const
  {
    return hints_;
  }
...
private:
  nimboost::asio::detail::addrinfo_type hints_;
