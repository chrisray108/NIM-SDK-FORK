...
/**
 * The nimboost::asio::ip::address_v6 class provides the ability to use and
...
#else
  typedef nimboost::asio::detail::array<unsigned char, 16> bytes_type;
#endif
...
private:
  ...
  nimboost::asio::detail::in6_addr_type addr_;
 ...
 *
 * @relates nimboost::asio::ip::address_v6
 */
