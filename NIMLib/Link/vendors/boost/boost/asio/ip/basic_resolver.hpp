...
public:
   ...
   */
  explicit basic_resolver(nimboost::asio::io_service& io_service)
   ...
   * will be invoked with the nimboost::asio::error::operation_aborted error code.
   */
  void cancel()
  {
  ...
  iterator resolve(const query& q)
  {
    ...
    nimboost::asio::detail::throw_error(ec, "resolve");
    return i;
  }
   ...
   * entry.
   */
  iterator resolve(const query& q, nimboost::system::error_code& ec)
  {
   ...
   * entry.
   */
  iterator resolve(const endpoint_type& e, nimboost::system::error_code& ec)
  {
