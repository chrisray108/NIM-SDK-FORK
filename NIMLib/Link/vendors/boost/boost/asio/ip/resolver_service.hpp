...
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
  typedef nimboost::asio::detail::winrt_resolver_service<InternetProtocol>
    service_impl_type;
#else
  typedef nimboost::asio::detail::resolver_service<InternetProtocol>
    service_impl_type;
#endif
...
public:
  ...
  explicit resolver_service(nimboost::asio::io_service& io_service)
  ...
  BOOST_ASIO_INITFN_RESULT_TYPE(ResolveHandler,
      void (nimboost::system::error_code, iterator_type))
      ...
      BOOST_ASIO_MOVE_ARG(ResolveHandler) handler)
  {
    nimboost::asio::detail::async_result_init<
      ResolveHandler, void (nimboost::system::error_code, iterator_type)> init(
