...
/**
 * The nimboost::asio::ip::address_v4 class provides the ability to use and
...
#else
  typedef nimboost::asio::detail::array<unsigned char, 4> bytes_type;
#endif
...
private:
  ...
  nimboost::asio::detail::in4_addr_type addr_;
};
 ...
 *
 * @relates nimboost::asio::ip::address_v4
 */
