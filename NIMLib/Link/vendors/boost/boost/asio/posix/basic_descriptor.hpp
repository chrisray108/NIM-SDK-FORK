...
public:
   ...
   * descriptor.
   */
  explicit basic_descriptor(nimboost::asio::io_service& io_service)
   ...
   */
  basic_descriptor(nimboost::asio::io_service& io_service,
   ...
   */
  nimboost::system::error_code assign(const native_handle_type& native_descriptor,
      nimboost::system::error_code& ec)
  {
   ...
   * nimboost::asio::posix::descriptor_base::bytes_readable @n
   * nimboost::asio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   * Getting the number of bytes ready to read:
   * @code
   * nimboost::asio::posix::stream_descriptor descriptor(io_service);
   * ...
   * nimboost::asio::posix::stream_descriptor::bytes_readable command;
