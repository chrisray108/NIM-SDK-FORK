 ...
 *
 * Most applications will use the nimboost::asio::signal_set typedef.
 *
 * @par Thread Safety
 ...
 * nimboost::asio::signal_set signals(io_service, SIGINT, SIGTERM);
 *
...
public:
   ...
   */
  explicit basic_signal_set(nimboost::asio::io_service& io_service)
   ...
   * @code nimboost::asio::signal_set signals(io_service);
   * signals.add(signal_number_1); @endcode
   */
  basic_signal_set(nimboost::asio::io_service& io_service, int signal_number_1)
    : basic_io_object<SignalSetService>(io_service)
  {
    nimboost::system::error_code ec;
    this->service.add(this->implementation, signal_number_1, ec);
    nimboost::asio::detail::throw_error(ec, "add");
  }
   ...
   */
  nimboost::system::error_code add(int signal_number,
      nimboost::system::error_code& ec)
  {
  ...
  void remove(int signal_number)
  {
    ...
    nimboost::asio::detail::throw_error(ec, "remove");
  }
   ...
   * signal number.
   */
  nimboost::system::error_code remove(int signal_number,
      nimboost::system::error_code& ec)
  {
  ...
  void clear()
  {
    ...
    nimboost::asio::detail::throw_error(ec, "clear");
  }
   ...
   * @note Removes all queued notifications.
   */
  nimboost::system::error_code clear(nimboost::system::error_code& ec)
  {
   ...
   * operation will be invoked with the nimboost::asio::error::operation_aborted
   * error code.
   *
   ...
   * error code nimboost::asio::error::operation_aborted.
   *
  ...
  BOOST_ASIO_INITFN_RESULT_TYPE(SignalHandler,
      void (nimboost::system::error_code, int))
