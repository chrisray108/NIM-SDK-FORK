...
struct tuple_size< ::nimboost::array<T, N> >
   : public ::nimboost::integral_constant< ::std::size_t, N>{};


template <int I, class T, size_t N>
struct tuple_element<I, ::nimboost::array<T, N> >
{
