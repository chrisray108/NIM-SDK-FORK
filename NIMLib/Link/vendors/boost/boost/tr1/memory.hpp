...
namespace std{ namespace tr1{
   ...
   using ::nimboost::bad_weak_ptr;
   using ::nimboost::shared_ptr;
#if !BOOST_WORKAROUND(__BORLANDC__, < 0x0582)
   using ::nimboost::swap;
#endif
   using ::nimboost::static_pointer_cast;
   using ::nimboost::dynamic_pointer_cast;
   using ::nimboost::const_pointer_cast;
   using ::nimboost::get_deleter;
   using ::nimboost::weak_ptr;
   using ::nimboost::enable_shared_from_this;
