...
namespace std{ namespace tr1{
   ...
   using ::nimboost::reference_wrapper;
   using ::nimboost::ref;
   using ::nimboost::cref;
...
namespace std{ namespace tr1{
   ...
   using ::nimboost::is_bind_expression;
   using ::nimboost::is_placeholder;
   using ::nimboost::bind;
...
namespace std{ namespace tr1{
   ...
   using ::nimboost::bad_function_call;
   using ::nimboost::function;
   using ::nimboost::swap;
...
// we forward declare nimboost::hash and include
...
namespace std{ namespace tr1{
   ...
   template <class T>
   struct hash : public nimboost::hash<T>
   {
   };
