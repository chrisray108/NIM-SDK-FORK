...
struct Requires_ : ::nimboost::parameter::aux::unaryfunptr_arg_type<Result>
{
# if BOOST_WORKAROUND(BOOST_MSVC, <= 1300)
    typedef typename ::nimboost::parameter::aux::unaryfunptr_arg_type<Result>::type type;
# endif 
};

# if BOOST_WORKAROUND(BOOST_INTEL_WIN, BOOST_TESTED_AT(1010))
#  define BOOST_CONCEPT_REQUIRES_(r,data,t) | (::nimboost::_requires_<void(*)t>::value)
# else 
#  define BOOST_CONCEPT_REQUIRES_(r,data,t) + (::nimboost::_requires_<void(*)t>::value)
# endif
...
# define BOOST_CONCEPT_REQUIRES(models, result)                                    \
    typename ::nimboost::parameter::aux::unaryfunptr_arg_type<void(*)result>::type
...
# define BOOST_CONCEPT_REQUIRES(models, result)                                \
    ::nimboost::Requires_<                                                        \
      ...
      ::nimboost::parameter::aux::unaryfunptr_arg_type<void(*)result>          \
                     >::type
...
} // namespace nimboost::concept_check
