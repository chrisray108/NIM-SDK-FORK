...
struct return_type_1<other_action<addressof_action>, A> { 
  ...
  typedef typename detail::IF<
    nimboost::is_same<type1, detail::unspecified>::value, 
...
template <class A> struct contentsof_type {
  typedef typename nimboost::indirect_reference<A>::type type; 
};
...
struct pointer_arithmetic_traits<plus_action, A, B> { 
  ...
  typedef typename 
    array_to_pointer<typename nimboost::remove_reference<A>::type>::type AP;
  typedef typename 
    array_to_pointer<typename nimboost::remove_reference<B>::type>::type BP;

  static const bool is_pointer_A = nimboost::is_pointer<AP>::value;
  static const bool is_pointer_B = nimboost::is_pointer<BP>::value;  
  ...
  static const bool same_pointer_type =
    ...
    nimboost::is_same<
      typename nimboost::remove_const<
        typename nimboost::remove_pointer<
          typename nimboost::remove_const<AP>::type
        >::type
      >::type,
      typename nimboost::remove_const<
        typename nimboost::remove_pointer<
          typename nimboost::remove_const<BP>::type
        >::type
      >::type
    >::value;
...
struct return_type_2<bitwise_action<Act>, A, B>
{
  ...
  // the apply function
  BOOST_STATIC_ASSERT(!(nimboost::is_float<plain_A>::value && nimboost::is_float<plain_B>::value));
...
struct leftshift_type {
private:
  typedef typename nimboost::remove_reference<A>::type plainA;
public:
...
struct return_type_2<arithmetic_assignment_action<Act>, A, B> { 
  ...
  typedef typename 
    detail::IF<
      nimboost::is_same<type1, detail::unspecified>::value, 
      typename nimboost::add_reference<A>::type,
      type1
    >::RET type;
};
...
struct return_type_2<other_action<subscript_action>, A, B> {
  ...
  typedef typename nimboost::remove_reference<A>::type nonref_A;
  typedef typename nimboost::remove_reference<B>::type nonref_B;
