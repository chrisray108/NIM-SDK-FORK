...
//     switch( detail::select(::nimboost::tuples::get<0>(args), a, b, c) )  
//     {
//       case Case1:                
//         detail::select(::nimboost::tuples::get<1>(args), a, b, c);
//         break;
//     }
//   }
// };
...
//         break;
//       case Case2:                
//         detail::select(::nimboost::tuples::get<2>(args), a, b, c);
//         break;
//     }
//   }
// };
...
#define BOOST_LAMBDA_SWITCH_CASE_BLOCK(z, N, A) \
  case Case##N: \
  detail::select(::nimboost::tuples::get<BOOST_PP_INC(N)>(args), CALL_ACTUAL_ARGS); \
  break;
...
public:                                                                       \
  ...
  template<class RET, CALL_TEMPLATE_ARGS>                                     \
  RET call(CALL_FORMAL_ARGS) const {                                          \
    switch( detail::select(::nimboost::tuples::get<0>(args), CALL_ACTUAL_ARGS) ) \
    {                                                                         \
...
public:                                                                       \
  ...
  RET call(CALL_FORMAL_ARGS) const {                                          \
    ...
    {                                                                         \
      ...
      default:                                                                \
        detail::select(::nimboost::tuples::get<N>(args), CALL_ACTUAL_ARGS);      \
        break;                                                                \
    }                                                                         \
  }                                                                           \
};
