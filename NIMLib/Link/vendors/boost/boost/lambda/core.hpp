...
using ::nimboost::tuples::tuple;
using ::nimboost::tuples::null_type;
...
namespace {
  ...
  nimboost::lambda::placeholder1_type free1 = nimboost::lambda::placeholder1_type();
  nimboost::lambda::placeholder2_type free2 = nimboost::lambda::placeholder2_type();
  nimboost::lambda::placeholder3_type free3 = nimboost::lambda::placeholder3_type();

  nimboost::lambda::placeholder1_type& _1 = free1;
  nimboost::lambda::placeholder2_type& _2 = free2;
  nimboost::lambda::placeholder3_type& _3 = free3;
