...
struct for_each {
  ...
  struct sig { 
    typedef typename nimboost::remove_const<
        typename nimboost::tuples::element<3, Args>::type 
     >::type type; 
  };
...
struct transform {
  ...
  struct sig { 
    typedef typename nimboost::remove_const<
        typename nimboost::tuples::element<
          nimboost::tuples::length<Args>::value - 2, 
          Args
      >::type
     >::type type; 
  };
...
struct merge {
  ...
  struct sig { 
    typedef typename nimboost::remove_const<
        typename nimboost::tuples::element<5, Args>::type 
     >::type type; 
  };
