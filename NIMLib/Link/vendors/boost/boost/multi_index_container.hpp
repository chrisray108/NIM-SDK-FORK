...
class multi_index_container:
  private ::nimboost::base_from_member<
    typename nimboost::detail::allocator::rebind_to<
      Allocator,
...
private:
  ...
  typedef typename
  nimboost::detail::allocator::rebind_to<
      Allocator,
      typename super::node_type
  >::type                                         node_allocator;
  typedef ::nimboost::base_from_member<
    ...
    BOOST_TRY{
      ...
      BOOST_TRY{
        ...
        if(res==x){
          ...
          nimboost::detail::allocator::destroy(&x->value());
          deallocate_node(x);
          return std::pair<node_type*,bool>(res,false);
        }
      }
...
>
typename ::nimboost::multi_index::index<
  ...
  BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(Tag))
{
  typedef multi_index_container<
    Value,IndexSpecifierList,Allocator>         multi_index_type;
  typedef typename ::nimboost::multi_index::index<
    multi_index_container<
      Value,IndexSpecifierList,Allocator>,
    Tag
  >::type                                       index;
...
template<
  typename Tag,typename Value,typename IndexSpecifierList,typename Allocator
>
const typename ::nimboost::multi_index::index<
  multi_index_container<Value,IndexSpecifierList,Allocator>,Tag>::type&
get(
  const multi_index_container<Value,IndexSpecifierList,Allocator>& m
  BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(Tag))
 ...
 * nimboost::serialization::collection_size_type.
...
template<typename Value,typename IndexSpecifierList,typename Allocator>
struct version<
  nimboost::multi_index_container<Value,IndexSpecifierList,Allocator>
>
{
...
/* Associated global functions are promoted to namespace nimboost, except
