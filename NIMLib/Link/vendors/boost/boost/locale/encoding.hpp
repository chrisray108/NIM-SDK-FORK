    ...
    namespace locale {
        ...
        namespace conv {
                                ...
                                method_type how=default_method)
            {
                ...
                return nimboost::locale::conv::between(text,end,to_encoding,from_encoding,how);
            }
            ...
            std::string between(std::string const &text,
                                ...
                                method_type how=default_method)
            {
                return nimboost::locale::conv::between(text.c_str(),text.c_str()+text.size(),to_encoding,from_encoding,how);
            }
