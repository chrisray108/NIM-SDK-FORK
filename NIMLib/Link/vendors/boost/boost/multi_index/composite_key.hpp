 ...
 * nimboost::tuple. In Boost 1.32, the limit is 10.
 */
...
BOOST_MULTI_INDEX_CK_NTH_COMPOSITE_KEY_FUNCTOR(hash,nimboost::hash)
...
struct hash_ckey_normal
{
  ...
  {
    /* same hashing formula as nimboost::hash_combine */
...
public:
  ...
  bool operator()(
    ...
    const Value& y)const
  {
    return operator()(x,nimboost::make_tuple(nimboost::cref(y)));
  }
#endif
  ...
  bool operator()(
    ...
    const composite_key_result<CompositeKey>& y)const
  {
    return operator()(nimboost::make_tuple(nimboost::cref(x)),y);
  }
#endif
 ...
 * composite_key_result_hash     uses nimboost::hash.
 */
...
/* Specializations of std::equal_to, std::less, std::greater and nimboost::hash
...
template<typename CompositeKey>
struct equal_to<nimboost::multi_index::composite_key_result<CompositeKey> >:
  nimboost::multi_index::composite_key_result_equal_to<
    nimboost::multi_index::composite_key_result<CompositeKey>
  >
{
};

template<typename CompositeKey>
struct less<nimboost::multi_index::composite_key_result<CompositeKey> >:
  nimboost::multi_index::composite_key_result_less<
    nimboost::multi_index::composite_key_result<CompositeKey>
  >
{
};
...
template<typename CompositeKey>
struct greater<nimboost::multi_index::composite_key_result<CompositeKey> >:
  nimboost::multi_index::composite_key_result_greater<
    nimboost::multi_index::composite_key_result<CompositeKey>
  >
{
};
...
template<typename CompositeKey>
struct hash<nimboost::multi_index::composite_key_result<CompositeKey> >:
  nimboost::multi_index::composite_key_result_hash<
    nimboost::multi_index::composite_key_result<CompositeKey>
  >
{
};
 ...
 * nimboost::hash, we define the appropriate hash_value overload.
 */
...
inline std::size_t hash_value(
  const nimboost::multi_index::composite_key_result<CompositeKey>& x)
{
  nimboost::multi_index::composite_key_result_hash<
    nimboost::multi_index::composite_key_result<CompositeKey> > h;
  return h(x);
}
