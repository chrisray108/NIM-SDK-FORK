...
protected:
  ...
  {
    nimboost::detail::allocator::construct(&x->value(),v);
    return x;
  }
  ...
  node_type* insert_(const value_type& v,node_type* x,rvalue_tag)
  {
     ...
     * nimboost::detail::allocator::construct, but 
    ...
    new (&x->value()) value_type(nimboost::move(const_cast<value_type&>(v)));
    return x;
  }
  ...
  {
    x->value()=nimboost::move(const_cast<value_type&>(v));
    return true;
  }
