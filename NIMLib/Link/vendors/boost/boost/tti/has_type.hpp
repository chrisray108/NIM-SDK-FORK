...
/**
  ...
  LookFor<EnclosingType,nimboost::is_same<_,SomeOtherType> >::value is true if MyType is an inner type
...
/**
  ...
  has_type_MyType<EnclosingType,nimboost::is_same<_,SomeOtherType> >::value is true if MyType is an inner type
    of EnclosingType and is the same type as SomeOtherType.
