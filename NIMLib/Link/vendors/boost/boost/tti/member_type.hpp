...
/**
    ...
    generates a metafunction called "trait" where 'trait' is the macro parameter.
              ...
              template<class BOOST_TTI_TP_T,class BOOST_TTI_TP_MARKER_TYPE = nimboost::tti::detail::notype>
              struct trait
                {
              ...
              The metafunction types and return:
                ...
                BOOST_TTI_TP_MARKER_TYPE = (optional) a type to use as the marker type.
                                  defaults to the internal nimboost::tti::detail::notype.
                ...
                returns         = 'type' is the inner type of 'name' if the inner type exists
                                  ...
                                  an internal nimboost::tti::detail::notype marker type is used.
...
#define BOOST_TTI_TRAIT_MEMBER_TYPE(trait,name) \
    ...
    struct trait : \
      nimboost::mpl::eval_if \
        ...
        nimboost::mpl::identity<BOOST_TTI_TP_MARKER_TYPE> \
        > \
      { \
      typedef BOOST_TTI_TP_MARKER_TYPE boost_tti_marker_type; \
      }; \
  ...
  namespace tti
    ...
    */
    ...
    struct valid_member_type :
      nimboost::mpl::not_
        <
        nimboost::is_same<BOOST_TTI_TP_T,BOOST_TTI_TP_MARKER_TYPE>
        >
      {
      };
    ...
    */
    ...
    struct valid_member_metafunction :
      nimboost::mpl::not_
        <
        nimboost::is_same<typename TTI_METAFUNCTION::type,typename TTI_METAFUNCTION::boost_tti_marker_type>
        >
      {
      };
    }
