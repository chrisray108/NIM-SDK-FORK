...
#define BOOST_TTI_DETAIL_TRAIT_HAS_TYPES_MEMBER_FUNCTION(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_types) \
    ...
    static ::nimboost::type_traits::yes_type chkt(helper<&BOOST_TTI_DETAIL_TP_EC::name> *); \
    \
    template<class BOOST_TTI_DETAIL_TP_EC> \
    static ::nimboost::type_traits::no_type chkt(...); \
    \
    BOOST_STATIC_CONSTANT(bool,value=sizeof(chkt<BOOST_TTI_DETAIL_TP_C>(BOOST_TTI_DETAIL_NULLPTR))==sizeof(::nimboost::type_traits::yes_type)); \
    \
...
#define BOOST_TTI_DETAIL_TRAIT_CHECK_HAS_COMP_MEMBER_FUNCTION(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_check_comp) : \
    ...
    { \
    BOOST_MPL_ASSERT((nimboost::function_types::is_member_function_pointer<BOOST_TTI_DETAIL_TP_T>)); \
    }; \
/**/
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_MEMBER_FUNCTION(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_hmf) \
    ...
    nimboost::mpl::eval_if \
      ...
      nimboost::mpl::and_ \
        < \
        nimboost::is_same<BOOST_TTI_DETAIL_TP_R,BOOST_TTI_NAMESPACE::detail::deftype>, \
        nimboost::is_same<BOOST_TTI_DETAIL_TP_FS,nimboost::mpl::vector<> >, \
        nimboost::is_same<BOOST_TTI_DETAIL_TP_TAG,nimboost::function_types::null_tag> \
        >, \
