...
#define BOOST_TTI_DETAIL_TRAIT_IMPL_HAS_STATIC_MEMBER_FUNCTION(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_ihsmf) \
    ...
    \
    BOOST_STATIC_CONSTANT(bool,value=sizeof(chkt<BOOST_TTI_DETAIL_TP_T>(BOOST_TTI_DETAIL_NULLPTR))==sizeof(::nimboost::type_traits::yes_type)); \
    \
  ...
  struct BOOST_PP_CAT(trait,_detail_hsmf) : \
    BOOST_PP_CAT(trait,_detail_ihsmf) \
      ...
      nimboost::mpl::eval_if \
        ...
        nimboost::mpl::and_ \
          < \
          nimboost::function_types::is_function<BOOST_TTI_DETAIL_TP_R>, \
          ...
          >, \
        nimboost::mpl::identity<BOOST_TTI_DETAIL_TP_R>, \
