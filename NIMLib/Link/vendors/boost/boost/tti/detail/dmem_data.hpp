...
#define BOOST_TTI_DETAIL_TRAIT_HAS_MEMBER_DATA(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_hmd) \
    ...
    static ::nimboost::type_traits::yes_type check2(BOOST_TTI_DETAIL_TP_V BOOST_TTI_DETAIL_TP_U::*); \
    \
    template<typename BOOST_TTI_DETAIL_TP_U,typename BOOST_TTI_DETAIL_TP_V> \
    ...
    struct ttc_md \
      { \
      typedef nimboost::mpl::bool_<sizeof(has_matching_member<BOOST_TTI_DETAIL_TP_V,typename return_of<BOOST_TTI_DETAIL_TP_U>::type>(0))==sizeof(::nimboost::type_traits::yes_type)> type; \
      }; \
    \
  ...
  namespace tti
    ...
    namespace detail
      ...
      struct dmem_check_ptmd :
        nimboost::mpl::identity<BOOST_TTI_DETAIL_TP_T>
        {
        BOOST_MPL_ASSERT((nimboost::function_types::is_member_object_pointer<BOOST_TTI_DETAIL_TP_T>));
        };
      ...
      struct dmem_get_type :
        nimboost::mpl::eval_if
          <
          nimboost::is_same<BOOST_TTI_DETAIL_TP_T2,BOOST_TTI_NAMESPACE::detail::deftype>,
