  ...
  namespace tti
    ...
    namespace detail
      ...
      struct tfunction_seq
        {
        typedef typename nimboost::mpl::push_front<BOOST_TTI_DETAIL_TP_FS,BOOST_TTI_DETAIL_TP_R>::type ftseq;
        typedef typename nimboost::function_types::function_type<ftseq,BOOST_TTI_DETAIL_TP_TAG>::type type;
        };
      }
    }
  }
