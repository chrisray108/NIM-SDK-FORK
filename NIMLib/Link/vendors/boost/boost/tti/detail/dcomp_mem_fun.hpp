...
#define BOOST_TTI_DETAIL_TRAIT_HAS_COMP_MEMBER_FUNCTION(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_hcmf) \
    ...
    \
    BOOST_STATIC_CONSTANT(bool,value=sizeof(chkt<typename cl_type<BOOST_TTI_DETAIL_TP_T>::type>(BOOST_TTI_DETAIL_NULLPTR))==sizeof(::nimboost::type_traits::yes_type)); \
    \
