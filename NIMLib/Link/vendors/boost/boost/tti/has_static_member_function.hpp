...
/**
    ...
    generates a metafunction called "trait" where 'trait' is the macro parameter.
              ...
              The metafunction types and return:
                ...
                BOOST_TTI_TP_FS  = (optional) the parameters of the static member function as a nimboost::mpl forward sequence
                          if the second parameter is a return type and the function parameters exist.
                
                BOOST_TTI_TP_TAG = (optional) a nimboost::function_types tag to apply to the static member function
...
#define BOOST_TTI_TRAIT_HAS_STATIC_MEMBER_FUNCTION(trait,name) \
  ...
  template<class BOOST_TTI_TP_T,class BOOST_TTI_TP_R,class BOOST_TTI_TP_FS = nimboost::mpl::vector<>,class BOOST_TTI_TP_TAG = nimboost::function_types::null_tag> \
  struct trait : \
