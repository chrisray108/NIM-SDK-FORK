...
namespace assign_detail
{
    ...
    struct assign_decay
    {
        ...
        typedef BOOST_DEDUCED_TYPENAME mpl::eval_if<
            ::nimboost::is_array<T>,
            ::nimboost::decay<const T>,
            ::nimboost::decay<T> >::type type;
    };
...
// old Dinkumware doesn't support iterator type as template
    ...
    {
        return ::nimboost::iterator_range_detail::equal( l, r );
    }
    ...
    inline bool operator<( const converter<T,I>& l, const Range& r )
    {
        return ::nimboost::iterator_range_detail::less_than( l, r );
    }
    ...
    {
        return Os << ::nimboost::make_iterator_range( r.begin(), r.end() );
    }
...
#include BOOST_PP_LOCAL_ITERATE()
        ...
        {
            return range( nimboost::begin(r), nimboost::end(r) );
        }
