...
#   pragma warning (push)
#   pragma warning (disable:4251) // class 'nimboost::shared_ptr<T>' needs to have dll-interface to be used by clients of class 'nimboost::program_options::option_description'
#endif
