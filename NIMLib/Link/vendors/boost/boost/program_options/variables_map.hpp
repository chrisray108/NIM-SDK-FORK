...
#   pragma warning (push)
#   pragma warning (disable:4251) // 'nimboost::program_options::variable_value::v' : class 'nimboost::any' needs to have dll-interface to be used by clients of class 'nimboost::program_options::variable_value
#endif
...
namespace nimboost { namespace program_options {
    ...
    */
    ...
    public:
        ...
        variable_value(const nimboost::any& xv, bool xdefaulted) 
        : v(xv), m_defaulted(xdefaulted) 
        {}

        /** If stored value if of type T, returns that value. Otherwise,
            throws nimboost::bad_any_cast exception. */
       template<class T>
       const T& as() const {
           return nimboost::any_cast<const T&>(v);
       }
       /** @overload */
       template<class T>
       T& as() {
           return nimboost::any_cast<T&>(v);
       }
        ...
        const nimboost::any& value() const;
