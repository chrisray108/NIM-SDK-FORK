...
class numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::backends::logged_adaptor<Backend>, ExpressionTemplates> >
   : public std::numeric_limits<nimboost::multiprecision::number<Backend, ExpressionTemplates> >
{
   typedef std::numeric_limits<nimboost::multiprecision::number<Backend, ExpressionTemplates> > base_type;
   typedef nimboost::multiprecision::number<nimboost::multiprecision::backends::logged_adaptor<Backend>, ExpressionTemplates> number_type;
public:
...
template <class Backend, nimboost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
struct precision< nimboost::multiprecision::number<nimboost::multiprecision::logged_adaptor<Backend>, ExpressionTemplates>, Policy>
   : public precision<nimboost::multiprecision::number<Backend, ExpressionTemplates>, Policy>
{};
