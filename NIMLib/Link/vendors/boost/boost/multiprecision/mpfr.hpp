...
struct mpfr_float_imp<digits10, allocate_dynamic>
{
   ...
   std::string str(std::streamsize digits, std::ios_base::fmtflags f)const
   {
      ...
      nimboost::multiprecision::detail::format_float_string(result, e, org_digits, f, 0 != mpfr_zero_p(m_data));
      return result;
   }
...
inline void eval_trunc(mpfr_float_backend<Digits10, AllocateType>& result, const mpfr_float_backend<Digits10, AllocateType>& val)
{
   ...
   {
      result = nimboost::math::policies::raise_rounding_error("nimboost::multiprecision::trunc<%1%>(%1%)", 0, number<mpfr_float_backend<Digits10, AllocateType> >(val), number<mpfr_float_backend<Digits10, AllocateType> >(val), nimboost::math::policies::policy<>()).backend();
      return;
   }
...
using nimboost::multiprecision::backends::mpfr_float_backend;
...
template <>
inline int digits<nimboost::multiprecision::mpfr_float>()
{
   return nimboost::multiprecision::backends::detail::get_default_precision();
}
template <>
inline int digits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, nimboost::multiprecision::et_off> >()
{
   return nimboost::multiprecision::backends::detail::get_default_precision();
}
...
template<unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_pi<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result_type;
   template<int N>
   static inline const result_type& get(const mpl::int_<N>&)
   {
      detail::mpfr_constant_initializer<constant_pi<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >, N>::force_instantiate();
...
template<unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_ln_two<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result_type;
   template<int N>
   static inline const result_type& get(const mpl::int_<N>&)
   {
      detail::mpfr_constant_initializer<constant_ln_two<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >, N>::force_instantiate();
      static result_type result;
...
template<unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_euler<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result_type;
   template<int N>
   static inline const result_type& get(const mpl::int_<N>&)
   {
      detail::mpfr_constant_initializer<constant_euler<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >, N>::force_instantiate();
      static result_type result;
      static bool init = false;
      if(!init)
      {
...
template<unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_catalan<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result_type;
   template<int N>
   static inline const result_type& get(const mpl::int_<N>&)
   {
      detail::mpfr_constant_initializer<constant_catalan<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >, N>::force_instantiate();
      static result_type result;
      static bool init = false;
      if(!init)
      {
...
//
template<unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> number_type;
public:
...
private:
   struct data_initializer
   {
      data_initializer()
      {
         std::numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::epsilon();
         std::numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::round_error();
         (std::numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::min)();
         (std::numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::max)();
         std::numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::infinity();
         std::numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::quiet_NaN();
      }
...
template<unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
const typename numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::data_initializer numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::initializer;

#ifndef BOOST_NO_INCLASS_MEMBER_INITIALIZATION

template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::digits;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::digits10;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::max_digits10;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_signed;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_integer;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_exact;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::radix;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::min_exponent;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::min_exponent10;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::max_exponent;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::max_exponent10;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_infinity;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_quiet_NaN;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_signaling_NaN;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_denorm;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_denorm_loss;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_iec559;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_bounded;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_modulo;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::traps;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::tinyness_before;
template <unsigned Digits10, nimboost::multiprecision::mpfr_allocation_type AllocateType, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::round_style;

#endif


template<nimboost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >
{
   typedef nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> number_type;
public:
...
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::digits;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::digits10;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::max_digits10;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_signed;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_integer;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_exact;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::radix;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::min_exponent;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::min_exponent10;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::max_exponent;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::max_exponent10;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_infinity;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_quiet_NaN;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_signaling_NaN;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_denorm;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_denorm_loss;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_iec559;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_bounded;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_modulo;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::traps;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::tinyness_before;
template <nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::round_style;
