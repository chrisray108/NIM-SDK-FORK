...
// be recognised by nimboost::int_t because they're larger than long long),
...
struct double_integer
{
   ...
   typedef typename mpl::if_c<
      ...
      typename mpl::if_c<
         is_signed<I>::value,
         typename nimboost::int_t<int_t_digits>::least,
         typename nimboost::uint_t<int_t_digits>::least
      >::type,
      typename mpl::if_c<
