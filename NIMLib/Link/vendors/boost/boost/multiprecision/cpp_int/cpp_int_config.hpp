...
// of bits.  Note that intN_t and nimboost::int_t<N> find the first
   ...
   typedef typename mpl::if_c<
      ...
      typename mpl::if_c<
         ...
         typename mpl::if_c<
            ...
            int,
            typename nimboost::int_t<N>::exact
         >::type
      >::type
   >::type type;
};
   ...
   typedef typename mpl::if_c<
      ...
      typename mpl::if_c<
         ...
         typename mpl::if_c<
            ...
            unsigned int,
            typename nimboost::uint_t<N>::exact
         >::type
      >::type
   >::type type;
};
...
typedef nimboost::uint128_type double_limb_type;
typedef nimboost::int128_type signed_double_limb_type;
...
typedef nimboost::uint64_t double_limb_type;
typedef nimboost::int64_t signed_double_limb_type;
