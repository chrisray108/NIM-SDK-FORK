...
namespace mp = nimboost::multiprecision;

namespace cpp_int_detail{

using namespace nimboost::multiprecision;
using namespace nimboost::multiprecision::backends;

template <class T>
struct is_binary_archive : public mpl::false_ {};
template <>
struct is_binary_archive<nimboost::archive::binary_oarchive> : public mpl::true_ {};
template <>
struct is_binary_archive<nimboost::archive::binary_iarchive> : public mpl::true_ {};
