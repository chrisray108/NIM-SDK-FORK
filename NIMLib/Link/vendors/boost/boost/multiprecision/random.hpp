...
namespace nimboost{ namespace random{ namespace detail{
//
...
//
template<class Engine, class Backend, nimboost::multiprecision::expression_template_option ExpressionTemplates>
nimboost::multiprecision::number<Backend, ExpressionTemplates> 
   generate_uniform_int(Engine& eng, const nimboost::multiprecision::number<Backend, ExpressionTemplates>& min_value, const nimboost::multiprecision::number<Backend, ExpressionTemplates>& max_value);
...
template<class Backend, nimboost::multiprecision::expression_template_option ExpressionTemplates>
struct subtract<nimboost::multiprecision::number<Backend, ExpressionTemplates>, true> 
{ 
  typedef nimboost::multiprecision::number<Backend, ExpressionTemplates> result_type;
  result_type operator()(result_type const& x, result_type const& y) { return x - y; }
};

}

template<class Engine, std::size_t w, class Backend, nimboost::multiprecision::expression_template_option ExpressionTemplates>
class independent_bits_engine<Engine, w, nimboost::multiprecision::number<Backend, ExpressionTemplates> >
{
public:
    ...
    void discard(nimboost::uintmax_t z)
    {
        for(nimboost::uintmax_t i = 0; i < z; ++i) {
            (*this)();
        }
    }
...
template<class Backend, nimboost::multiprecision::expression_template_option ExpressionTemplates>
class uniform_smallint<nimboost::multiprecision::number<Backend, ExpressionTemplates> >
{
public:
    typedef nimboost::multiprecision::number<Backend, ExpressionTemplates> input_type;
    typedef nimboost::multiprecision::number<Backend, ExpressionTemplates> result_type;
    ...
    result_type operator()(Engine& eng) const
    {
        ...
        return generate(eng, nimboost::is_integral<base_result>());
    }
...
private:
    ...
    // \cond show_private
    template<class Engine>
    result_type generate(Engine& eng, nimboost::mpl::true_) const
    {
        // equivalent to (eng() - eng.min()) % (_max - _min + 1) + _min,
        // but guarantees no overflow.
        typedef typename Engine::result_type base_result;
        typedef typename nimboost::make_unsigned<base_result>::type base_unsigned;
        ...
        if(range >= base_range) {
            return nimboost::random::detail::add<range_type, result_type>()(
    ...
    template<class Engine>
    result_type generate(Engine& eng, nimboost::mpl::false_) const
    {
        typedef typename Engine::result_type base_result;
        typedef result_type                  range_type;
        range_type range = random::detail::subtract<result_type>()(_max, _min);
        base_result val = nimboost::uniform_01<base_result>()(eng);
        ...
        return nimboost::random::detail::add<range_type, result_type>()(offset , _min);
    }
    // \endcond
...
template<class Backend, nimboost::multiprecision::expression_template_option ExpressionTemplates>
struct select_uniform_01<nimboost::multiprecision::number<Backend, ExpressionTemplates> >
{
  template<class RealType>
  struct apply
  {
    typedef new_uniform_01<nimboost::multiprecision::number<Backend, ExpressionTemplates> > type;
  };
};
...
nimboost::multiprecision::number<Backend, ExpressionTemplates> 
   generate_uniform_int(
    Engine& eng, const nimboost::multiprecision::number<Backend, ExpressionTemplates>& min_value, const nimboost::multiprecision::number<Backend, ExpressionTemplates>& max_value,
    nimboost::mpl::true_ /** is_integral<Engine::result_type> */)
{
    typedef nimboost::multiprecision::number<Backend, ExpressionTemplates> result_type;
...
template<class Engine, class Backend, nimboost::multiprecision::expression_template_option ExpressionTemplates>
inline nimboost::multiprecision::number<Backend, ExpressionTemplates> 
   generate_uniform_int(Engine& eng, const nimboost::multiprecision::number<Backend, ExpressionTemplates>& min_value, const nimboost::multiprecision::number<Backend, ExpressionTemplates>& max_value)
{
    typedef typename Engine::result_type base_result;
    typedef typename mpl::or_<nimboost::is_integral<base_result>, mpl::bool_<nimboost::multiprecision::number_category<Backend>::value == nimboost::multiprecision::number_kind_integer> >::type tag_type;
