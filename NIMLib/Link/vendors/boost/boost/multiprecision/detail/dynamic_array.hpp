...
//
  ...
  namespace nimboost { namespace multiprecision { namespace backends { namespace detail
  {
    template <class value_type, const nimboost::uint32_t elem_number, class my_allocator>
  ...
  } } } } // namespace nimboost::multiprecision::backends::detail
