...
namespace nimboost{ namespace multiprecision{ namespace detail{
...
#pragma warning(disable:4127)
   ...
   static const int shift = std::numeric_limits<nimboost::intmax_t>::digits - 1;
   ...
   while(!eval_is_zero(f))
   {
      ...
      typename nimboost::multiprecision::detail::canonical<nimboost::intmax_t, To>::type ll;
