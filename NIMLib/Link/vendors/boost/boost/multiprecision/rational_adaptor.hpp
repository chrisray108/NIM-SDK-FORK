...
struct rational_adaptor
{
   ...
   typedef nimboost::rational<integer_type>        rational_type;
   ...
   explicit rational_adaptor(const U& u, 
      typename enable_if_c<
         nimboost::multiprecision::detail::is_explicitly_convertible<U, IntBackend>::value && !is_convertible<U, IntBackend>::value
      >::type* = 0) 
      : m_value(IntBackend(u)){}
   template <class U>
   typename enable_if_c<(nimboost::multiprecision::detail::is_explicitly_convertible<U, IntBackend>::value && !is_arithmetic<U>::value), rational_adaptor&>::type operator = (const U& u) 
   {
      m_value = IntBackend(u);
   }
...
using nimboost::multiprecision::backends::rational_adaptor;
...
template <class IntBackend, nimboost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> > : public std::numeric_limits<nimboost::multiprecision::number<IntBackend, ExpressionTemplates> >
{
   typedef std::numeric_limits<nimboost::multiprecision::number<IntBackend> > base_type;
   typedef nimboost::multiprecision::number<nimboost::multiprecision::rational_adaptor<IntBackend> > number_type;
public:
...
template <class IntBackend, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> >::is_integer;
template <class IntBackend, nimboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> >::is_exact;
