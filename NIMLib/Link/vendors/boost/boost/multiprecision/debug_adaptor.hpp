...
class numeric_limits<nimboost::multiprecision::number<nimboost::multiprecision::backends::debug_adaptor<Backend>, ExpressionTemplates> >
   : public std::numeric_limits<nimboost::multiprecision::number<Backend, ExpressionTemplates> >
{
   ...
   typedef nimboost::multiprecision::number<nimboost::multiprecision::backends::debug_adaptor<Backend>, ExpressionTemplates> number_type;
public:
...
struct precision< nimboost::multiprecision::number<nimboost::multiprecision::debug_adaptor<Backend>, ExpressionTemplates>, Policy>
