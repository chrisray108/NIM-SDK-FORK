...
#define BOOST_PHOENIX_ADAPT_CALLABLE_NULLARY(NAME, FUNC)                        \
    nimboost::nimboostphoenix::detail::expression::function_eval<FUNC>::type const         \
    inline NAME()                                                               \
    {                                                                           \
        return nimboost::nimboostphoenix::detail::expression::                             \
...
#define BOOST_PHOENIX_ADAPT_CALLABLE(NAME, FUNC, N)                             \
    ...
    typename                                                                    \
        nimboost::nimboostphoenix::detail::expression::function_eval<                      \
            FUNC                                                                \
