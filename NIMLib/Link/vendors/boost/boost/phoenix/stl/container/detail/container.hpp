...
namespace nimboost { namespace nimboostphoenix { namespace stl
{
///////////////////////////////////////////////////////////////////////////////
//
...
///////////////////////////////////////////////////////////////////////////////
    namespace stl_impl
    {
        ...
        struct map_insert_returns_pair
        {
            ...
            typedef nimboost::mpl::bool_<value == sizeof(one)> type;
        };
    }
...
}}} // namespace nimboost::nimboostphoenix::stl
