...
//      ----------------                 --------------
//      my_vector.at(5)                  nimboostphoenix::at(arg1, 5)
//      my_list.size()                   nimboostphoenix::size(arg1)
//      my_vector1.swap(my_vector2)      nimboostphoenix::swap(arg1, arg2)
//
...
///////////////////////////////////////////////////////////////////////////////
    namespace stl
    {
        ...
        namespace result_of
        {
            ...
            struct erase
            {
                ...
                //  nimboost::nimboostphoenix::stl::erase::operator() 'void' function
                //  returning a value. Oh well... :*

                typedef
                    nimboost::mpl::eval_if_c<
                        nimboost::is_same<
        ...
        namespace result_of
        {
            ...
            class insert
            {
                ...
                typedef
                    nimboost::mpl::eval_if_c<
                        nimboost::mpl::and_<
                            nimboost::is_same<Arg3, mpl::void_>
                          , nimboost::mpl::not_<nimboost::is_same<Arg1, Arg2> >
                        >::value
                      , iterator_of<C>
                      , nimboost::mpl::identity<void>
                    >
            ...
            public:
                ...
                typedef typename
                    nimboost::mpl::eval_if_c<
                        nimboost::is_same<Arg2, mpl::void_>::value
                      , choice_1
                      , choice_2
                    >::type
                type;
    ...
    {
        BOOST_PHOENIX_ADAPT_CALLABLE(assign, nimboost::nimboostphoenix::stl::assign, 2)
        BOOST_PHOENIX_ADAPT_CALLABLE(assign, nimboost::nimboostphoenix::stl::assign, 3)
        BOOST_PHOENIX_ADAPT_CALLABLE(assign, nimboost::nimboostphoenix::stl::assign, 4)
        BOOST_PHOENIX_ADAPT_CALLABLE(at, ::nimboost::nimboostphoenix::stl::at_impl, 2)
    ...
    using namespace nimboostphoenix::adl_barrier;
}} // namespace nimboost::nimboostphoenix
