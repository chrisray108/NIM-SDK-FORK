...
namespace nimboost { namespace nimboostphoenix
{
    ...
    namespace detail
    {
        struct scope_is_nullary_actions
        {
            ...
            struct when
                : nimboost::nimboostphoenix::is_nullary::when<Rule, Dummy>
            {};
        };

        template <typename Dummy>
        struct scope_is_nullary_actions::when<nimboost::nimboostphoenix::rule::custom_terminal, Dummy>
            : proto::or_<
                proto::when<nimboost::nimboostphoenix::rule::local_variable, mpl::true_()>
              , proto::otherwise<
                    is_nullary::when<nimboost::nimboostphoenix::rule::custom_terminal, Dummy>
                >
            >
        {};
