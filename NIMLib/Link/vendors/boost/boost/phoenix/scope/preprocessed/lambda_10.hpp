...
==============================================================================*/
namespace nimboost { namespace nimboostphoenix { namespace tag { struct lambda_actor {}; template <typename Ostream> inline Ostream &operator<<( Ostream & os , lambda_actor) { os << "lambda_actor"; return os; } } namespace expression { template <typename A0 , typename A1 , typename A2> struct lambda_actor : nimboost::nimboostphoenix::expr< :: nimboost :: nimboostphoenix :: tag:: lambda_actor , A0 , A1 , A2> {}; } namespace rule { struct lambda_actor : expression:: lambda_actor <proto::terminal<proto::_>, proto::terminal<proto::_>, meta_grammar> {}; } namespace functional { typedef nimboost::proto::functional::make_expr< tag:: lambda_actor > make_lambda_actor; } namespace result_of { template <typename A0 , typename A1 , typename A2> struct make_lambda_actor : nimboost::result_of< functional:: make_lambda_actor(A0 , A1 , A2) > {}; } template <typename A0 , typename A1 , typename A2> inline typename result_of::make_lambda_actor< A0 , A1 , A2 >::type const make_lambda_actor( A0 const& a0 , A1 const& a1 , A2 const& a2 ) { return functional::make_lambda_actor()( a0 , a1 , a2 ); } } } namespace nimboost { namespace nimboostphoenix { template <typename Dummy> struct meta_grammar::case_< :: nimboost :: nimboostphoenix :: tag:: lambda_actor , Dummy > : enable_rule< :: nimboost :: nimboostphoenix :: rule:: lambda_actor , Dummy > {}; } }
namespace nimboost { namespace nimboostphoenix { namespace tag { struct lambda {}; template <typename Ostream> inline Ostream &operator<<( Ostream & os , lambda) { os << "lambda"; return os; } } namespace expression { template <typename A0 , typename A1 , typename A2 , typename A3> struct lambda : nimboost::nimboostphoenix::expr< :: nimboost :: nimboostphoenix :: tag:: lambda , A0 , A1 , A2 , A3> {}; } namespace rule { struct lambda : expression:: lambda <proto::terminal<proto::_>, proto::terminal<proto::_>, proto::terminal<proto::_>, meta_grammar> {}; } namespace functional { typedef nimboost::proto::functional::make_expr< tag:: lambda > make_lambda; } namespace result_of { template <typename A0 , typename A1 , typename A2 , typename A3> struct make_lambda : nimboost::result_of< functional:: make_lambda(A0 , A1 , A2 , A3) > {}; } template <typename A0 , typename A1 , typename A2 , typename A3> inline typename result_of::make_lambda< A0 , A1 , A2 , A3 >::type const make_lambda( A0 const& a0 , A1 const& a1 , A2 const& a2 , A3 const& a3 ) { return functional::make_lambda()( a0 , a1 , a2 , a3 ); } } } namespace nimboost { namespace nimboostphoenix { template <typename Dummy> struct meta_grammar::case_< :: nimboost :: nimboostphoenix :: tag:: lambda , Dummy > : enable_rule< :: nimboost :: nimboostphoenix :: rule:: lambda , Dummy > {}; } }
    ...
    struct lambda_eval
    {
        ...
        operator()(OuterEnv const & outer_env, Locals const & locals, Map const &, Lambda const & lambda, Context const & ctx) const
        {
            ...
            typedef
              ...
              , map_type
            >
            env(nimboostphoenix::env(ctx), proto::value(outer_env), proto::value(locals));
            return eval(lambda, nimboostphoenix::context(env, nimboostphoenix::actions(ctx)));
        }
    };
            ...
            return
                expression::
                    lambda<env_type, locals_type, Map, Lambda>::
                        make(nimboostphoenix::env(ctx), locals, map, lambda);
        }
    };
    template <typename Dummy>
