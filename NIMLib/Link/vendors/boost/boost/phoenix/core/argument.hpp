...
namespace nimboost {
    template <int I>
    struct is_placeholder<nimboostphoenix::argument<I> >
        : mpl::int_<I>
    {};
}
...
namespace nimboost { namespace nimboostphoenix
{
    namespace expression
    {
        template <int I>
        struct argument
            : expression::terminal<nimboostphoenix::argument<I> >
        {
            typedef typename expression::terminal<nimboostphoenix::argument<I> >::type type;
