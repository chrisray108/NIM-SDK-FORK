...
namespace nimboost
{
    // specialize nimboost::result_of to return the proper result type
    template <typename Expr>
    struct result_of<nimboostphoenix::actor<Expr>()>
        : nimboostphoenix::result_of::actor<typename nimboostphoenix::actor<Expr>::proto_base_expr>
    {};
    
    template <typename Expr>
    struct result_of<nimboostphoenix::actor<Expr> const()>
        : nimboostphoenix::result_of::actor<typename nimboostphoenix::actor<Expr>::proto_base_expr>
    {};
}
