...
namespace nimboost { namespace nimboostphoenix
{
    namespace detail
    {
        ...
        {
            typedef
                typename nimboost::nimboostphoenix::result_of::context<State, Data>::type
                context_type;
            ...
            {
                return Fun()(e, nimboost::nimboostphoenix::context(s, d));
            }
        };
    }
    ...
    namespace proto
    {
        ...
        struct is_callable<nimboostphoenix::call<Fun, Dummy> > : mpl::true_ {};
    }
}
