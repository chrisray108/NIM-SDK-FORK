...
BOOST_PHOENIX_DEFINE_EXPRESSION_VARARG(
    (nimboost)(nimboostphoenix)(detail)(function_eval)
  , (meta_grammar)
    (meta_grammar)
...
namespace nimboost { namespace nimboostphoenix {
    namespace detail
    {
                ...
                typename nimboost::add_reference<                                  \
                    typename nimboost::add_const<                                  \
                        typename nimboost::result_of<                              \
                            nimboost::nimboostphoenix::evaluator(                          \
                                BOOST_PP_CAT(A, n)                              \
                              , Context                                         \
                            )                                                   \
                        >::type                                                 \
        ...
        #define PHOENIX_EVAL_ARG(z, n, data)                                    \
            help_rvalue_deduction(nimboost::nimboostphoenix::eval(BOOST_PP_CAT(a, n), ctx))
...
#pragma wave option(output: null)
            ...
            struct result<This(F, BOOST_PHOENIX_A, Context)>
            {
                ...
                typedef typename
                    nimboost::result_of<fn(BOOST_PHOENIX_a)>::type
                    type;
                /*
                typedef typename
                    mpl::eval_if_c<
            ...
            {
                return nimboost::nimboostphoenix::eval(f, ctx)(BOOST_PP_ENUM(BOOST_PHOENIX_ITERATION, PHOENIX_EVAL_ARG, _));
            }
