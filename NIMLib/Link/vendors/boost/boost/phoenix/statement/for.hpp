...
namespace nimboost { namespace nimboostphoenix
{
    struct for_eval
    {
        ...
        {
            for(nimboost::nimboostphoenix::eval(init, ctx); nimboost::nimboostphoenix::eval(cond, ctx); nimboost::nimboostphoenix::eval(step, ctx))
                nimboost::nimboostphoenix::eval(do_, ctx);
        }
    };
