...
BOOST_PHOENIX_DEFINE_EXPRESSION_EXT(
    if_actor
  , (nimboost)(nimboostphoenix)(if_)
  , (meta_grammar) // Cond
    (meta_grammar) // Then
)
    
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (nimboost)(nimboostphoenix)(if_else_statement)
  , (meta_grammar) // Cond
    (meta_grammar) // Then
    (meta_grammar) // Else
)
...
namespace nimboost { namespace nimboostphoenix
{
    ...
    struct if_else_eval
    {
        ...
        {
            if(nimboost::nimboostphoenix::eval(cond, ctx))
                nimboost::nimboostphoenix::eval(then, ctx);
        }
        ...
        ) const
        {
            if(nimboost::nimboostphoenix::eval(cond, ctx))
                ...
                nimboost::nimboostphoenix::eval(else_, ctx);
        }
    };
