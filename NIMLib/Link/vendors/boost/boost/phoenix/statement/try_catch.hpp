...
namespace nimboost { namespace nimboostphoenix
{
    ...
    namespace detail
    {
        struct try_catch_is_nullary
            : proto::or_<
                proto::when<
                    nimboostphoenix::rule::catch_all
                  , proto::call<
                        evaluator(
                            proto::_child_c<0>
                          , proto::_data
              ...
              , proto::when<
                ...
                >
              , proto::when<
                    nimboostphoenix::rule::try_catch
                  , proto::make<
                        mpl::and_<
                            proto::call<
                                evaluator(
        ...
        struct catch_push_back<TryCatch, Exception, Expr, 1>
        {
            ...
            typedef
                nimboostphoenix::expression::try_catch<
                    TryCatch
                  , catch_expr
                >
                gen_type;
