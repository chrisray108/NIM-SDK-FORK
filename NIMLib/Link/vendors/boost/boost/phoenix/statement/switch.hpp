...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (nimboost)(nimboostphoenix)(switch_case)
  , (proto::terminal<proto::_>)
    (meta_grammar)
)

BOOST_PHOENIX_DEFINE_EXPRESSION(
    (nimboost)(nimboostphoenix)(switch_default_case)
  , (meta_grammar)
)
...
namespace nimboost { namespace nimboostphoenix
{
    ...
    namespace detail
    {
            ...
            : proto::or_<
                proto::when<
                    proto::comma<
                      ...
                      , proto::or_<nimboostphoenix::rule::switch_default_case, nimboostphoenix::rule::switch_case>
                    >
                  , mpl::and_<
                        switch_case_is_nullary(
                            proto::_child_c<0>
        ...
        struct switch_case_grammar
            : proto::or_<
                proto::comma<switch_case_grammar, nimboostphoenix::rule::switch_case>
              , proto::when<nimboostphoenix::rule::switch_case, proto::_>
            >
        {};

        struct switch_case_with_default_grammar
            : proto::or_<
                proto::comma<switch_case_grammar, nimboostphoenix::rule::switch_default_case>
              , proto::when<nimboostphoenix::rule::switch_default_case, proto::_>
            >
        {};
...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (nimboost)(nimboostphoenix)(switch_)
  , (meta_grammar)           // Cond
    ...
    struct switch_eval
    {
        ...
        private:
            ...
            ) const
            {
                ...
                switch(nimboost::nimboostphoenix::eval(cond, ctx))
                {
                    case case_label::value:
                        nimboost::nimboostphoenix::eval(proto::child_c<1>(cases), ctx);
                }
            }
            ...
            ) const
            {
                ...
                {
                    default:
                        nimboost::nimboostphoenix::eval(proto::child_c<0>(cases), ctx);
                }
            }
