...
namespace nimboost{namespace icl
{
    ...
    {
        inline static Type identity_element() { return nimboost::icl::identity_element<Type>::value(); }
    };
    ...
    template <typename Type> struct unit_element_based_inplace_combine 
        : public std::binary_function<Type&, const Type&, void>
    {
        inline static Type identity_element() { return nimboost::icl::unit_element<Type>::value(); }
    };
