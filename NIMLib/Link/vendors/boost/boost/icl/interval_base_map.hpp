...
public:
    ...
    typedef typename nimboost::call_traits<DomainT>::param_type domain_param;
    /// Domain type (type of the keys) of the map
    ...
    typedef nimboost::icl::element_iterator<iterator> element_iterator; 
    /// const element iterator: Depreciated, see documentation.
    typedef nimboost::icl::element_iterator<const_iterator> element_const_iterator; 
    /// element reverse iterator: Depreciated, see documentation.
    typedef nimboost::icl::element_iterator<reverse_iterator> element_reverse_iterator; 
    /// element const reverse iterator: Depreciated, see documentation.
    typedef nimboost::icl::element_iterator<const_reverse_iterator> element_const_reverse_iterator; 
...
#   ifndef BOOST_ICL_NO_CXX11_RVALUE_REFERENCES
    ...
    /** Move constructor */
    interval_base_map(interval_base_map&& src): _map(nimboost::move(src._map))
    {
        BOOST_CONCEPT_ASSERT((DefaultConstructibleConcept<DomainT>));
        BOOST_CONCEPT_ASSERT((LessThanComparableConcept<DomainT>));
        BOOST_CONCEPT_ASSERT((DefaultConstructibleConcept<CodomainT>));
    ...
    { 
        this->_map = nimboost::move(src._map);
        return *this; 
    }
...
inline void interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc>
    ::insert_main(const interval_type& inter_val, const CodomainT& co_val, 
                  iterator& it_, const iterator& last_)
{
    iterator end_   = nimboost::next(last_);
