...
namespace nimboost{ namespace re_detail{
...
inline bool is_separator(charT c)
{
   return BOOST_REGEX_MAKE_BOOL(
      ...
      || (static_cast<nimboost::uint16_t>(c) == 0x2028u)
      || (static_cast<nimboost::uint16_t>(c) == 0x2029u)
      || (static_cast<nimboost::uint16_t>(c) == 0x85u));
}
template <>
