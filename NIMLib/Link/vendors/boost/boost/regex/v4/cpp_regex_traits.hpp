...
void cpp_regex_traits_implementation<charT>::init()
{
   ...
   if((int)cat >= 0)
   {
      ...
      static const char_class_type masks[16] = 
      {
         ::nimboost::re_detail::char_class_alnum,
         ::nimboost::re_detail::char_class_alpha,
         ::nimboost::re_detail::char_class_cntrl,
         ::nimboost::re_detail::char_class_digit,
         ::nimboost::re_detail::char_class_graph,
         ::nimboost::re_detail::char_class_horizontal_space,
         ::nimboost::re_detail::char_class_lower,
         ::nimboost::re_detail::char_class_print,
         ::nimboost::re_detail::char_class_punct,
         ::nimboost::re_detail::char_class_space,
         ::nimboost::re_detail::char_class_upper,
         ::nimboost::re_detail::char_class_vertical_space,
         ::nimboost::re_detail::char_class_xdigit,
         ::nimboost::re_detail::char_class_blank,
         ::nimboost::re_detail::char_class_word,
         ::nimboost::re_detail::char_class_unicode,
      };
#endif
   ...
   cpp_regex_traits_implementation<charT>::lookup_classname_imp(const charT* p1, const charT* p2) const
{
   ...
   static const char_class_type masks[22] = 
   {
      ...
      ::nimboost::re_detail::char_class_upper,
      ::nimboost::re_detail::char_class_vertical_space,
      ::nimboost::re_detail::char_class_alnum | ::nimboost::re_detail::char_class_word, 
      ::nimboost::re_detail::char_class_alnum | ::nimboost::re_detail::char_class_word, 
      ::nimboost::re_detail::char_class_xdigit,
   };
#endif
...
{
   return
      ((mask & ::nimboost::re_detail::char_class_space) && (this->m_pctype->is(std::ctype<charT>::space, c)))
      || ((mask & ::nimboost::re_detail::char_class_print) && (this->m_pctype->is(std::ctype<charT>::print, c)))
      || ((mask & ::nimboost::re_detail::char_class_cntrl) && (this->m_pctype->is(std::ctype<charT>::cntrl, c)))
      || ((mask & ::nimboost::re_detail::char_class_upper) && (this->m_pctype->is(std::ctype<charT>::upper, c)))
      || ((mask & ::nimboost::re_detail::char_class_lower) && (this->m_pctype->is(std::ctype<charT>::lower, c)))
      || ((mask & ::nimboost::re_detail::char_class_alpha) && (this->m_pctype->is(std::ctype<charT>::alpha, c)))
      || ((mask & ::nimboost::re_detail::char_class_digit) && (this->m_pctype->is(std::ctype<charT>::digit, c)))
      || ((mask & ::nimboost::re_detail::char_class_punct) && (this->m_pctype->is(std::ctype<charT>::punct, c)))
      || ((mask & ::nimboost::re_detail::char_class_xdigit) && (this->m_pctype->is(std::ctype<charT>::xdigit, c)))
      || ((mask & ::nimboost::re_detail::char_class_blank) && (this->m_pctype->is(std::ctype<charT>::space, c)) && !::nimboost::re_detail::is_separator(c))
      || ((mask & ::nimboost::re_detail::char_class_word) && (c == '_'))
      || ((mask & ::nimboost::re_detail::char_class_unicode) && ::nimboost::re_detail::is_extended(c))
      || ((mask & ::nimboost::re_detail::char_class_vertical_space) && (is_separator(c) || (c == '\v')))
      || ((mask & ::nimboost::re_detail::char_class_horizontal_space) && this->m_pctype->is(std::ctype<charT>::space, c) && !(is_separator(c) || (c == '\v')));
}
#endif


template <class charT>
inline nimboost::shared_ptr<const cpp_regex_traits_implementation<charT> > create_cpp_regex_traits(const std::locale& l BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(charT))
{
   cpp_regex_traits_base<charT> key(l);
   return ::nimboost::object_cache<cpp_regex_traits_base<charT>, cpp_regex_traits_implementation<charT> >::get(key, 5);
}
...
private:
   nimboost::shared_ptr<const re_detail::cpp_regex_traits_implementation<charT> > m_pimpl;
   //
