...
struct default_wrapper : public BaseT
{
   ...
   std::string error_string(::nimboost::regex_constants::error_type e)const
   {
      return ::nimboost::re_detail::get_default_error_string(e);
   }
   ::nimboost::regex_constants::syntax_type syntax_type(char_type c)const
   {
      return ((c & 0x7f) == c) ? get_default_syntax_type(static_cast<char>(c)) : ::nimboost::regex_constants::syntax_char;
   }
   ::nimboost::regex_constants::escape_syntax_type escape_syntax_type(char_type c)const
   {
      return ((c & 0x7f) == c) ? get_default_escape_syntax_type(static_cast<char>(c)) : ::nimboost::regex_constants::escape_type_identity;
   }
...
struct regex_traits_wrapper 
   : public ::nimboost::re_detail::compute_wrapper_base<
               BaseT, 
               ::nimboost::re_detail::has_boost_extensions_tag<BaseT>::value
            >::type
{
