...
inline void intrusive_ptr_add_ref( const ::nimboost::statechart::event_base * pBase )
{
  pBase->add_ref();
}

inline void intrusive_ptr_release( const ::nimboost::statechart::event_base * pBase )
{
  if ( pBase->release() )
  {
    ::nimboost::statechart::detail::delete_helper::delete_object( pBase );
  }
}
