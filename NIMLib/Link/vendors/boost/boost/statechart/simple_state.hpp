...
#include <boost/cast.hpp> // nimboost::polymorphic_downcast
  ...
  typename Context::inner_context_type, InnerInitial >::type
{
  ...
  public:
    ...
    // If you receive a
    // "use of undefined type 'nimboost::STATIC_ASSERTION_FAILURE<x>'" or similar
  ...
  private:
    ...
    result transit_impl( const TransitionAction & transitionAction )
    {
      ...
      // If you receive a
      // "use of undefined type 'nimboost::STATIC_ASSERTION_FAILURE<x>'" or
...
inline void intrusive_ptr_release( const ::nimboost::statechart::simple_state<
