...
namespace closures {
    ...
    :   nimboost::spirit::classic::closure<intlit_closure, uint_literal_type> 
    {
        member1 val;
    };
}
...
struct intlit_grammar :
    nimboost::spirit::classic::grammar<intlit_grammar, closures::intlit_closure::context_t>
{
    ...
    struct definition
    {
        ...
        rule_t int_lit;
        nimboost::spirit::classic::subrule<0> sub_int_lit;
        nimboost::spirit::classic::subrule<1> oct_lit;
        nimboost::spirit::classic::subrule<2> hex_lit;
        nimboost::spirit::classic::subrule<3> dec_lit;
