...
struct predefined_macros_grammar : 
    public nimboost::spirit::classic::grammar<predefined_macros_grammar>
{
...
nimboost::spirit::classic::tree_parse_info<LexIteratorT>
    ...
    LexIteratorT const &first, LexIteratorT const &last)
{
    ...
    return nimboost::spirit::classic::pt_parse (first, last, g);
}
