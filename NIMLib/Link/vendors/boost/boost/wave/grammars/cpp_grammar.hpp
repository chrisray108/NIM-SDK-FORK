...
///////////////////////////////////////////////////////////////////////////////
    ...
    :   public nimboost::spirit::classic::parser<flush_underlying_parser>
    {
        typedef flush_underlying_parser this_t;

        template <typename ScannerT>
        typename nimboost::spirit::classic::parser_result<this_t, ScannerT>::type
...
struct cpp_grammar : 
    public nimboost::spirit::classic::grammar<cpp_grammar<TokenT, ContainerT> >
{
    ...
    // non-parse_tree generating rule type
        ...
        typedef nimboost::spirit::classic::match_policy match_policy_t;
        typedef typename ScannerT::action_policy_t action_policy_t;
        typedef 
            nimboost::spirit::classic::scanner_policies<
                iteration_policy_t, match_policy_t, action_policy_t> 
            policies_t;
        typedef 
            nimboost::spirit::classic::scanner<typename ScannerT::iterator_t, policies_t> 
            non_tree_scanner_t;
        typedef 
            nimboost::spirit::classic::rule<
                non_tree_scanner_t, nimboost::spirit::classic::dynamic_parser_tag> 
            no_tree_rule_type;

    // 'normal' (parse_tree generating) rule type
        typedef 
            nimboost::spirit::classic::rule<
                ScannerT, nimboost::spirit::classic::dynamic_parser_tag> 
            rule_type;
...
//         rule_type ppelse, ppendif;
        ...
        // import the spirit and cpplexer namespaces here
            ...
            using namespace nimboost::wave::util;
...
// helper function and data to get readable names of the rules known to us
    struct map_ruleid_to_name :
        public std::map<nimboost::spirit::classic::parser_id, std::string> 
    {
        typedef std::map<nimboost::spirit::classic::parser_id, std::string> base_type;
        ...
        // initialize parser_id to rule_name map
            for (int i = 0; 0 != init_ruleid_name_map[i].parser_id; ++i)
                base_type::insert(base_type::value_type(
                    nimboost::spirit::classic::parser_id(init_ruleid_name_map[i].parser_id), 
...
inline nimboost::spirit::classic::tree_parse_info<IteratorT, NodeFactoryT>
parsetree_parse(IteratorT const& first_, IteratorT const& last,
    nimboost::spirit::classic::parser<ParserT> const& p)
{
    using namespace nimboost::spirit::classic;
...
nimboost::spirit::classic::tree_parse_info<
    LexIteratorT, 
