...
#define spirit_append_actor(actor) nimboost::spirit::classic::push_back_a(actor)
#define spirit_assign_actor(actor) nimboost::spirit::classic::assign_a(actor)
...
///////////////////////////////////////////////////////////////////////////////
    ...
    :   nimboost::spirit::classic::closure<cpp_expr_closure, closure_value> 
    {
        member1 val;
    };
...
///////////////////////////////////////////////////////////////////////////////
    struct convert_intlit {
        ...
        struct result { 
            ...
            typedef nimboost::wave::grammars::closures::closure_value type; 
        };

        template <typename TokenT>
        nimboost::wave::grammars::closures::closure_value 
        operator()(TokenT const &token) const
        { 
            typedef nimboost::wave::grammars::closures::closure_value return_type;
    ...
    nimboostphoenix::function<convert_intlit> const as_intlit;
...
///////////////////////////////////////////////////////////////////////////////
    ...
    nimboostphoenix::function<convert_chlit> const as_chlit;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    nimboostphoenix::function<operator_questionmark> const questionmark;
...
///////////////////////////////////////////////////////////////////////////////
    struct operator_to_bool {
        ...
        { 
            typedef nimboost::wave::grammars::closures::closure_value return_type;
            return return_type(
                nimboost::wave::grammars::closures::as_bool(val), val.is_valid());
        }
    };
    nimboostphoenix::function<operator_to_bool> const to_bool;
...
///////////////////////////////////////////////////////////////////////////////
    struct operator_as_bool {
        ...
        operator()(ArgT &val) const
        { 
            return nimboost::wave::grammars::closures::as_bool(val);
        }
    };
    nimboostphoenix::function<operator_as_bool> const as_bool;
...
#define BOOST_WAVE_BINARYOP(op, optok)                                        \
    ...
    nimboostphoenix::function<operator_binary_ ## op> const binary_ ## op             \
    /**/
...
#define BOOST_WAVE_UNARYOP(op, optok)                                         \
    ...
    nimboostphoenix::function<operator_unary_ ## op> const unary_ ## op               \
    /**/
...
struct expression_grammar :
    public nimboost::spirit::classic::grammar<
        expression_grammar, 
    ...
    >
{
    ...
    struct definition
    {
        ...
        typedef nimboost::spirit::classic::rule<ScannerT, closure_type::context_t> rule_t;
        typedef nimboost::spirit::classic::rule<ScannerT> simple_rule_t;
        ...
        nimboost::spirit::classic::subrule<0, closure_type::context_t> const_exp_subrule;
        ...
        definition(expression_grammar const &self)
        {
            ...
            using nimboost::wave::util::pattern_p;
    ...
    bool if_block_status, value_error &status)
{
    using namespace nimboost::spirit::classic;
    using namespace nimboost::wave;
    using namespace nimboost::wave::grammars::closures;
    
    using nimboost::wave::util::impl::as_string;
