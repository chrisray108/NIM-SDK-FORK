...
struct BOOST_WAVE_DECL cpp_grammar_gen
{
    ...
    typedef nimboost::spirit::classic::node_val_data_factory<
//             nimboost::spirit::nil_t,
//             nimboost::pool_allocator<nimboost::spirit::nil_t> 
        > node_factory_type;

//  parse the cpp_grammar and return the resulting parse tree    
    static nimboost::spirit::classic::tree_parse_info<iterator_type, node_factory_type> 
