...
#define BOOST_WAVE_STRINGTYPE nimboost::wave::util::flex_string<                 \
        char, std::char_traits<char>, std::allocator<char>,                   \
        nimboost::wave::util::CowString<                                         \
            nimboost::wave::util::AllocatorStringStorage<char>                   \
        >                                                                     \
    >                                                                         \
    /**/
...
namespace nimboost { namespace wave 
{
#if defined(BOOST_HAS_LONG_LONG) && \
    BOOST_WAVE_SUPPORT_LONGLONG_INTEGER_LITERALS != 0
    typedef nimboost::long_long_type int_literal_type;
    typedef nimboost::ulong_long_type uint_literal_type;
#else
...
#define BOOST_LIB_NAME nimboost_wave
