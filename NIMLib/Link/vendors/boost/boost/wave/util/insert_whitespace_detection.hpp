...
// T_IDENTIFIER
    ...
    template <typename StringT>
    inline bool 
    handle_identifier(nimboost::wave::token_id prev, 
        nimboost::wave::token_id before, StringT const &value)
    {
...
// T_INTLIT
    inline bool 
    handle_intlit(nimboost::wave::token_id prev, nimboost::wave::token_id /*before*/)
    {
        using namespace nimboost::wave;
        switch (static_cast<unsigned int>(prev)) {
        case T_IDENTIFIER:
...
// T_FLOATLIT
    inline bool 
    handle_floatlit(nimboost::wave::token_id prev, 
        nimboost::wave::token_id /*before*/)
    {
        using namespace nimboost::wave;
        switch (static_cast<unsigned int>(prev)) {
        case T_IDENTIFIER:
...
// <% T_LEFTBRACE
    inline bool 
    handle_alt_leftbrace(nimboost::wave::token_id prev, 
        nimboost::wave::token_id /*before*/)
    {
        using namespace nimboost::wave;
        switch (static_cast<unsigned int>(prev)) {
...
// <: T_LEFTBRACKET
    inline bool 
    handle_alt_leftbracket(nimboost::wave::token_id prev, 
        nimboost::wave::token_id /*before*/)
    {
        using namespace nimboost::wave;
        switch (static_cast<unsigned int>(prev)) {
...
// T_FIXEDPOINTLIT
    inline bool 
    handle_fixedpointlit(nimboost::wave::token_id prev, 
        nimboost::wave::token_id /*before*/)
    {
        using namespace nimboost::wave;
        switch (static_cast<unsigned int>(prev)) {
...
// T_DOT
    inline bool 
    handle_dot(nimboost::wave::token_id prev, nimboost::wave::token_id before)
    {
        using namespace nimboost::wave;
        switch (static_cast<unsigned int>(prev)) {
        case T_DOT:
...
// T_QUESTION_MARK
    inline bool 
    handle_questionmark(nimboost::wave::token_id prev, 
        nimboost::wave::token_id /*before*/)
    {
        using namespace nimboost::wave;
        switch(static_cast<unsigned int>(prev)) {
...
// T_NEWLINE
    inline bool
    handle_newline(nimboost::wave::token_id prev, 
        nimboost::wave::token_id before)
    {
        using namespace nimboost::wave;
        switch(static_cast<unsigned int>(prev)) {
    ...
    inline bool 
    handle_parens(nimboost::wave::token_id prev)
    {
        switch (static_cast<unsigned int>(prev)) {
        case T_LEFTPAREN:
        case T_RIGHTPAREN:
...
public:
    ...
    :   insert_whitespace(insert_whitespace_),
        prev(nimboost::wave::T_EOF), beforeprev(nimboost::wave::T_EOF) 
    {}
    
    template <typename StringT>
    bool must_insert(nimboost::wave::token_id current, StringT const &value)
    {
...
//         }
    ...
    void shift_tokens (nimboost::wave::token_id next_id)
    {
        if (insert_whitespace) {
            beforeprev = prev;
            prev = next_id;
...
private:
    ...
    nimboost::wave::token_id prev;        // the previous analyzed token
    nimboost::wave::token_id beforeprev;  // the token before the previous
};
