...
//
// #HK030306: 
//      - Moved into the namespace nimboost::wave::util 
...
public:
    ...
    pointer allocate(size_type n, const_pointer = 0) 
    {
        ...
        if (!p) nimboost::throw_exception(std::bad_alloc());
...
private:
    ...
    void Init(size_type size, size_type capacity)
    {
        ...
        else
        {
            ...
            if (!pData_) nimboost::throw_exception(std::bad_alloc());
...
class flex_string : private Storage
{
    ...
    { if (!condition) nimboost::throw_exception(Exception(msg)); }
#else
    template <typename Exception>
...
template <typename E, class T, class A, class S>
struct implementation_level<nimboost::wave::util::flex_string<E, T, A, S> >
{
    typedef mpl::integral_c_tag tag;
    typedef mpl::int_<nimboost::serialization::primitive_type> type;
...
inline void save(Archive & ar, 
    nimboost::wave::util::flex_string<E, T, A, S> const &t,
...
template<class Archive, typename E, class T, class A, class S>
inline void load(Archive & ar, nimboost::wave::util::flex_string<E, T, A, S> &t,
    const unsigned int file_version)
{
    nimboost::serialization::stl::load_collection<
        Archive, nimboost::wave::util::flex_string<E, T, A, S>,
        nimboost::serialization::stl::archive_input_seq<
            Archive, nimboost::wave::util::flex_string<E, T, A, S> >,
        nimboost::serialization::stl::reserve_imp<
            nimboost::wave::util::flex_string<E, T, A, S> >
    >(ar, t);
}
...
template<class Archive, typename E, class T, class A, class S>
inline void serialize(Archive & ar, nimboost::wave::util::flex_string<E, T, A, S> &t,
    const unsigned int file_version)
{
