...
//  specialization of the nimboost::spirit::classic::position_policy class is 
//  provided below.
//
///////////////////////////////////////////////////////////////////////////////
...
:   nimboost::spirit::classic::position_iterator<IteratorT, PositionT>
{
    typedef nimboost::spirit::classic::position_iterator<IteratorT, PositionT> base_type;
...
///////////////////////////////////////////////////////////////////////////////
//
//  The nimboost::spirit::classic::position_policy has to be specialized for our 
//  file_position class
//
///////////////////////////////////////////////////////////////////////////////

    template <>
    class position_policy<nimboost::wave::util::file_position_type> {
    ...
    public:
        ...
        void next_line(nimboost::wave::util::file_position_type &pos)
        {
        ...
        void next_char(nimboost::wave::util::file_position_type &pos)
        {
            pos.set_column(pos.get_column() + 1);
        }

        void tabulation(nimboost::wave::util::file_position_type &pos)   
        {
