...
#undef TOKEN_FROM_ID
#define TOKEN_FROM_ID(id, cat)   nimboost::wave::token_id((id) | (cat))

#undef ID_FROM_TOKEN
#define ID_FROM_TOKEN(tok)                                                    \
    nimboost::wave::token_id((tok) &                                             \
        ~(nimboost::wave::TokenTypeMask|nimboost::wave::PPTokenFlag))               \
    /**/

#undef BASEID_FROM_TOKEN
#define BASEID_FROM_TOKEN(tok)                                                \
    nimboost::wave::token_id((tok) &                                             \
         ~(nimboost::wave::ExtTokenTypeMask|nimboost::wave::PPTokenFlag))           \
    /**/
#define BASE_TOKEN(tok)                                                       \
    nimboost::wave::token_id((tok) & nimboost::wave::MainTokenMask)                 \
    /**/
#define CATEGORY_FROM_TOKEN(tok) ((tok) & nimboost::wave::TokenTypeMask)
#define EXTCATEGORY_FROM_TOKEN(tok) ((tok) & nimboost::wave::ExtTokenTypeMask)
...
inline bool is_pp_token(nimboost::wave::token_id id)
{
    return (id & nimboost::wave::PPTokenFlag) ? true : false;
}

template <typename TokenT>
inline bool is_pp_token(TokenT const& tok)
{
    return is_pp_token(nimboost::wave::token_id(tok));
}
