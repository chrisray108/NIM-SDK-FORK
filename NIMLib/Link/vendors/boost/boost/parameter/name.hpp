...
namespace nimboost { namespace mpl {
...
#  define BOOST_PARAMETER_NAME_OBJECT(tag, name)                    \
    static ::nimboost::parameter::keyword<tag> const& name             \
       = ::nimboost::parameter::keyword<tag>::instance;
# else
#  define BOOST_PARAMETER_NAME_OBJECT(tag, name)                    \
    namespace                                                       \
    {                                                               \
       ::nimboost::parameter::keyword<tag> const& name                 \
       = ::nimboost::parameter::keyword<tag>::instance;                \
    }
# endif
      ...
      {                                                             \
          ...
          {                                                         \
              return BOOST_PP_STRINGIZE(tag);                       \
                                                                    ...
                                                                    \
          typedef nimboost::parameter::value_type<                     \
              nimboost::mpl::_2, tag, nimboost::parameter::void_          \
          > _;                                                      \
                                                                    \
          typedef nimboost::parameter::value_type<                     \
              nimboost::mpl::_2, tag, nimboost::parameter::void_          \
...
# define BOOST_PARAMETER_TEMPLATE_KEYWORD(name)                     \
    ...
    template <class T>                                              \
    struct name                                                     \
      : nimboost::parameter::template_keyword<tag::name, T>            \
    {};                                                             \
/**/
