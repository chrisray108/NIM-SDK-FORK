...
namespace nimboost { namespace parameter { namespace python 
{
  namespace python_ = nimboost::python;
}}}

namespace nimboost { namespace parameter { namespace python { namespace aux 
{
...
}}}} // namespace nimboost::parameter::python::aux
...
namespace aux
{
      ...
      Def def, F f, Iter, End, Keywords const& keywords, mpl::false_)
  {
      ...
      def_combination_aux(
        ...
        , (
              keywords, nimboost::python::arg(kw::keyword_name())
          )
      );
  }
      ...
      Def def, F f, Iter, End, Keywords const& keywords, mpl::true_)
  {
      ...
      def_combination_aux(
          def, f, typename mpl::next<Iter>::type(), End()
        , (
              keywords, nimboost::python::arg(kw::keyword_name()) = empty_tag()
          )
      );
  }
  ...
  template <class Class, class CallPolicies = nimboost::python::default_call_policies>
  struct def_init
  {
      ...
      void operator()(F f) const
      {
          cl.def(
              "__init__"
            , nimboost::python::make_constructor(f, call_policies)
          );
      }
      ...
      void operator()(F f, Keywords const& keywords) const
      {
          cl.def(
              "__init__"
            , nimboost::python::make_constructor(f, call_policies, keywords)
          );
      }
  ...
  struct def_function
  {
      ...
      void operator()(F f) const
      {
          nimboost::python::def(name, f);
      }

      template <class F, class Keywords>
      void operator()(F f, Keywords const& keywords) const
      {
          nimboost::python::def(name, f, keywords);
      }
...
template <class ParameterSpecs, class CallPolicies = nimboost::python::default_call_policies>
struct init 
  : nimboost::python::def_visitor<init<ParameterSpecs, CallPolicies> >
{
    ...
    {
        cl.def(nimboost::python::init<>()[call_policies]);
    }
...
template <class ParameterSpecs, class CallPolicies = nimboost::python::default_call_policies>
struct call 
  : nimboost::python::def_visitor<call<ParameterSpecs, CallPolicies> >
{
...
struct function 
  : nimboost::python::def_visitor<function<Fwd, ParameterSpecs> >
{
...
}}} // namespace nimboost::parameter::python
