...
struct cast<void(T), Args>
{
    ...
    typedef typename nimboost::add_reference<
        typename nimboost::remove_const<type0>::type 
    >::type reference;
...
#  define BOOST_PARAMETER_FUNCTION_CAST(value, predicate, args) \
    nimboost::parameter::aux::cast<void predicate, args>::remove_const( \
        nimboost::parameter::aux::cast<void predicate, args>::execute(value) \
    )
