...
#define BOOST_ASSERT(expr) (BOOST_LIKELY(!!(expr)) \
  ? ((void)0) \
  : ::nimboost::assertion_failed(#expr, BOOST_CURRENT_FUNCTION, __FILE__, __LINE__))
...
# undef BOOST_ASSERT_MSG
  ...
  #define BOOST_ASSERT_MSG(expr, msg) (BOOST_LIKELY(!!(expr)) \
    ? ((void)0) \
    : ::nimboost::assertion_failed_msg(#expr, msg, BOOST_CURRENT_FUNCTION, __FILE__, __LINE__))
  ...
  #define BOOST_ASSERT_MSG(expr, msg) (BOOST_LIKELY(!!(expr)) \
    ? ((void)0) \
    : ::nimboost::assertion::detail::assertion_failed_msg(#expr, msg, \
