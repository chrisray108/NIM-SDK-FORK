...
namespace ptr_container_detail
{
    ...
    public:
        ...
        { 
            ...
            return nimboost::ptr_container::move( old );
        }
            ...
            {                                            
                if( this->find( first->first ) == this->end() )
                {
                    ...
                    this->safe_insert( p.first, 
                                       nimboost::ptr_container::move( ptr ) );
                                                           // strong, commit 
                }
                ++first;                                                      
            }                                                                 
    ...
    public:
        ...
        {
            insert( nimboost::begin(r), nimboost::end(r) );
        }
    ...
    public:
        ...
        {
            return transfer( nimboost::begin(r), nimboost::end(r), from );
        }
