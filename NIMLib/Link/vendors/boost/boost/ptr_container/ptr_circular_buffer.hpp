...
namespace nimboost
{
    ...
    class ptr_circular_buffer : public 
        ptr_sequence_adapter< T, 
                              nimboost::circular_buffer<void*,Allocator>, 
                              CloneAllocator >
    {  
        ...
        typedef nimboost::circular_buffer<void*,Allocator>         circular_buffer_type;
    ...
    public: // circular buffer functions
        ...
        {
            rinsert( before, nimboost::begin(r), nimboost::end(r) );
        }
        ...
        {
            return rerase( nimboost::begin(r), nimboost::end(r) );
        }
