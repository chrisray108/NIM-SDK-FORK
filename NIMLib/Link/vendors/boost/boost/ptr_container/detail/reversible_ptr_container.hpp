...
namespace ptr_container_detail
{
    ...
    public: // typedefs
        ...
        typedef  BOOST_DEDUCED_TYPENAME Config::const_iterator
                                   const_iterator;
        typedef  nimboost::reverse_iterator< iterator > 
                                   reverse_iterator;  
        typedef  nimboost::reverse_iterator< const_iterator >     
    ...
    public: // modifiers
        ...
        {
            return erase( nimboost::begin(r), nimboost::end(r) );
        }
    ...
    public: // access interface
        ...
        { 
            ...
            return nimboost::ptr_container_detail::move( ptr ); 
        }
        ...
        { 
            ...
            return nimboost::ptr_container_detail::move( old );
        }
...
#define BOOST_PTR_CONTAINER_DEFINE_RELEASE( base_type ) \
    ...
    {                                               \
        return nimboost::ptr_container_detail::move(base_type::release(i)); \
    }                                               
#else
#define BOOST_PTR_CONTAINER_DEFINE_RELEASE( base_type ) \
