...
{
public:
    typedef nimboost::uint32_t result_type;
    ...
    /** Advances the state of the generator by @c z. */
    void discard(nimboost::uintmax_t z) { lcf.discard(z); }
...
private:
    ...
    static nimboost::uint64_t cnv(nimboost::uint32_t x)
