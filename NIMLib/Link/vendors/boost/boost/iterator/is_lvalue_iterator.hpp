...
#undef BOOST_LVALUE_PRESERVER
  ...
  {
      template <class It>
      struct rebind : nimboost::mpl::false_
      {};
  };
  ...
  struct is_readable_lvalue_iterator_impl
    : is_lvalue_iterator_impl<
          BOOST_DEDUCED_TYPENAME nimboost::detail::iterator_traits<It>::value_type const
      >::template rebind<It>
  {};
  ...
  struct is_non_const_lvalue_iterator_impl
    : is_lvalue_iterator_impl<
          BOOST_DEDUCED_TYPENAME nimboost::detail::iterator_traits<It>::value_type
      >::template rebind<It>
  {};
} // namespace detail
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(
    is_lvalue_iterator,T,::nimboost::detail::is_readable_lvalue_iterator_impl<T>::value)
    
BOOST_TT_AUX_BOOL_TRAIT_DEF1(
    is_non_const_lvalue_iterator,T,::nimboost::detail::is_non_const_lvalue_iterator_impl<T>::value)
