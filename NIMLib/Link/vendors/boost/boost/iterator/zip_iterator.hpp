...
namespace nimboost {
  ...
  namespace detail
  {
    ...
    namespace tuple_impl_specific
    {
      ...
      struct tuple_meta_transform
        : mpl::eval_if<
              nimboost::is_same<Tuple, tuples::null_type>
...
# define BOOST_TUPLE_ALGO_RECURSE
      ...
      { 
        ...
        >( 
            f(nimboost::tuples::get<0>(t)), tuple_transform(t.get_tail(), f)
        );
      }
...
# endif 
  ...
  private:
    ...
    { 
        return nimboost::tuples::get<0>(other.get_iterator_tuple()) - 
            nimboost::tuples::get<0>(this->get_iterator_tuple());
    }
