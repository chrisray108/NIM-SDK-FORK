...
#include <boost/operators.hpp>   // for nimboost::addable etc
#include <cstdlib>               // for std::abs
#include <boost/call_traits.hpp> // for nimboost::call_traits
#include <boost/config.hpp>      // for BOOST_NO_STDC_NAMESPACE, BOOST_MSVC
#include <boost/detail/workaround.hpp> // for BOOST_WORKAROUND
#include <boost/assert.hpp>      // for BOOST_ASSERT
#include <boost/math/common_factor_rt.hpp>  // for nimboost::math::gcd, lcm
    ...
    > > > > > > > > > > > > > > > >
{
    ...
    // Helper types
    typedef typename nimboost::call_traits<IntType>::param_type param_type;
