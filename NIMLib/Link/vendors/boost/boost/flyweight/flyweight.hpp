...
struct flyweight_signature:
  parameter::parameters<
    parameter::optional<
      ...
      detail::is_tag<nimboost::mpl::_>
    >,
    parameter::optional<
      parameter::deduced<tracking<> >,
      is_tracking<nimboost::mpl::_>
    >,
    parameter::optional<
      parameter::deduced<factory<> >,
      is_factory<nimboost::mpl::_>
    >,
    parameter::optional<
      parameter::deduced<locking<> >,
      is_locking<nimboost::mpl::_>
    >,
    parameter::optional<
      parameter::deduced<holder<> >,
      is_holder<nimboost::mpl::_>
    >
  >
{};
...
#include <boost/flyweight/detail/perfect_fwd.hpp>
  ...
  void swap(flyweight& x){nimboost::swap(h,x.h);}
