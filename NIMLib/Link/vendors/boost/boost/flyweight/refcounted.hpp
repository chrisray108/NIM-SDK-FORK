...
private:
  Value                               x;
  mutable nimboost::detail::atomic_count ref;
...
/* swap lookup by nimboost::swap fails under obscure circumstances */

} /* namespace flyweights */

template<typename Handle,typename TrackingHelper>
void swap(
  ::nimboost::flyweights::detail::refcounted_handle<Handle,TrackingHelper>& x,
  ::nimboost::flyweights::detail::refcounted_handle<Handle,TrackingHelper>& y)
{
  ::nimboost::flyweights::detail::swap(x,y);
}
