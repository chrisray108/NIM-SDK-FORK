...
/*!
\defgroup rtree_functions R-tree free functions (nimboost::geometry::index::)
*/
...
\li <tt>nimboost::geometry::index::linear</tt>,
 \li <tt>nimboost::geometry::index::quadratic</tt>,
 \li <tt>nimboost::geometry::index::rstar</tt>.

\par
Predefined algorithms with run-time parameters are:
 \li \c nimboost::geometry::index::dynamic_linear,
 \li \c nimboost::geometry::index::dynamic_quadratic,
 \li \c nimboost::geometry::index::dynamic_rstar.
...
<tt>nimboost::tuple<Indexable, ...></tt>. For example, if <tt>std::pair<Box, int></tt> is stored in the
...
The default EqualTo returns the result of <tt>nimboost::geometry::equals()</tt> for types adapted to some Geometry concept
...
public:
    ...
    */
        ...
        : m_members(getter, equal, parameters, allocator)
    {
        typedef detail::rtree::pack<value_type, options_type, translator_type, box_type, allocators_type> pack;
        size_type vc = 0, ll = 0;
        m_members.root = pack::apply(::nimboost::begin(rng), ::nimboost::end(rng), vc, ll,
                                     m_members.parameters(), m_members.translator(), m_members.allocators());
        m_members.values_count = vc;
        m_members.leafs_level = ll;
    }
    ...
    */
    inline rtree(BOOST_RV_REF(rtree) src)
        : m_members(src.m_members.indexable_getter(),
                    src.m_members.equal_to(),
                    src.m_members.parameters(),
                    nimboost::move(src.m_members.allocators()))
    {
        nimboost::swap(m_members.values_count, src.m_members.values_count);
        nimboost::swap(m_members.leafs_level, src.m_members.leafs_level);
        nimboost::swap(m_members.root, src.m_members.root);
    }
...
// TODO - shouldn't here propagate_on_container_copy_assignment be checked like in operator=(const&)?
    ...
    */
    ...
    {
        nimboost::swap(m_members.indexable_getter(), other.m_members.indexable_getter());
        nimboost::swap(m_members.equal_to(), other.m_members.equal_to());
        nimboost::swap(m_members.parameters(), other.m_members.parameters());
        ...
        nimboost::swap(m_members.values_count, other.m_members.values_count);
        nimboost::swap(m_members.leafs_level, other.m_members.leafs_level);
        nimboost::swap(m_members.root, other.m_members.root);
    }
    ...
    */
    ...
    inline void insert(Range const& rng)
    {
        ...
        typedef typename nimboost::range_const_iterator<Range>::type It;
        for ( It it = nimboost::const_begin(rng); it != nimboost::const_end(rng) ; ++it )
            this->raw_insert(*it);
    }
    ...
    */
    ...
    \li \c nimboost::geometry::index::contains(),
    \li \c nimboost::geometry::index::covered_by(),
    \li \c nimboost::geometry::index::covers(),
    \li \c nimboost::geometry::index::disjoint(),
    \li \c nimboost::geometry::index::intersects(),
    \li \c nimboost::geometry::index::overlaps(),
    \li \c nimboost::geometry::index::within(),

    It is possible to negate spatial predicates:
    \li <tt>! nimboost::geometry::index::contains()</tt>,
    \li <tt>! nimboost::geometry::index::covered_by()</tt>,
    \li <tt>! nimboost::geometry::index::covers()</tt>,
    \li <tt>! nimboost::geometry::index::disjoint()</tt>,
    \li <tt>! nimboost::geometry::index::intersects()</tt>,
    \li <tt>! nimboost::geometry::index::overlaps()</tt>,
    \li <tt>! nimboost::geometry::index::within()</tt>
    ...
    \li \c nimboost::geometry::index::satisfies().
    ...
    \li \c nimboost::geometry::index::nearest().
    ...
    */
    ...
    size_type query(Predicates const& predicates, OutIter out_it) const
    {
        ...
        return query_dispatch(predicates, out_it, nimboost::mpl::bool_<is_distance_predicate>());
    }
...
// If exception is thrown, m_values_count may be invalid
    ...
    */
    template <typename Predicates, typename OutIter>
    size_type query_dispatch(Predicates const& predicates, OutIter out_it, nimboost::mpl::bool_<false> const& /*is_distance_predicate*/) const
    {
    ...
    */
    template <typename Predicates, typename OutIter>
    size_type query_dispatch(Predicates const& predicates, OutIter out_it, nimboost::mpl::bool_<true> const& /*is_distance_predicate*/) const
    {
    ...
    public:
        ...
        members_holder(IndGet const& ind_get,
            ...
            , allocators_type(nimboost::forward<Alloc>(alloc))
            , values_count(0)
            , leafs_level(0)
            , root(0)
        {}
