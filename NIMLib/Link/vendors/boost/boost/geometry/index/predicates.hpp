...
/*!
\defgroup predicates Predicates (nimboost::geometry::index::)
*/
...
nimboost::tuples::cons<
    Pred1,
    nimboost::tuples::cons<Pred2, nimboost::tuples::null_type>
>
operator&&(Pred1 const& p1, Pred2 const& p2)
{
    /*typedef typename nimboost::mpl::if_c<is_predicate<Pred1>::value, Pred1, Pred1 const&>::type stored1;
    typedef typename nimboost::mpl::if_c<is_predicate<Pred2>::value, Pred2, Pred2 const&>::type stored2;*/
    namespace bt = nimboost::tuples;
...
>::type
operator&&(nimboost::tuples::cons<Head, Tail> const& t, Pred const& p)
{
    //typedef typename nimboost::mpl::if_c<is_predicate<Pred>::value, Pred, Pred const&>::type stored;
    namespace bt = nimboost::tuples;
