...
namespace nimboost { namespace geometry { namespace index { namespace detail { namespace rtree { namespace utilities {
...
nimboost::tuple<std::size_t, std::size_t, std::size_t, std::size_t, std::size_t, std::size_t>
statistics(Rtree const& tree)
{
    ...
    return nimboost::make_tuple(stats_v.levels, stats_v.nodes, stats_v.leaves, stats_v.values, stats_v.values_min, stats_v.values_max);
}

}}}}}} // namespace nimboost::geometry::index::detail::rtree::utilities
