...
//    >::other::pointer internal_node_pointer;
    ...
    inline allocators(BOOST_FWD_REF(allocators) a)
        : node_allocator_type(nimboost::move(a.node_allocator()))
    {}

    inline allocators & operator=(BOOST_FWD_REF(allocators) a)
    {
        node_allocator() = nimboost::move(a.node_allocator());
        return *this;
    }
    ...
    {
        nimboost::swap(node_allocator(), a.node_allocator());
    }
...
struct create_static_node
{
    ...
    static inline VariantPtr apply(AllocNode & alloc_node)
    {
        ...
        Al::construct(alloc_node, nimboost::addressof(*p), Node(alloc_node)); // implicit cast to Variant
...
struct destroy_static_node
{
    ...
    static inline void apply(AllocNode & alloc_node, VariantPtr n)
    {
        ...
        Al::destroy(alloc_node, nimboost::addressof(*n));
