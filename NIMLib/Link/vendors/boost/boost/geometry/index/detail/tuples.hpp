...
struct find_index
{
    static const size_t value =
        find_index_impl<
            ...
            El,
            N,
            typename nimboost::tuples::element<N - 1, Tuple>::type
        >::value;
};
...
struct has<Tuple, El, 1>
{
    static const bool value
        = nimboost::is_same<
            typename nimboost::tuples::element<0, Tuple>::type,
            El
        >::value;
};
...
struct add<nimboost::tuple<T1>, T>
{
    typedef nimboost::tuple<T1, T> type;
};

template <typename T1, typename T2, typename T>
struct add<nimboost::tuple<T1, T2>, T>
{
    typedef nimboost::tuple<T1, T2, T> type;
};
...
struct push_back_impl
{
    ...
    nimboost::tuples::cons<
        typename nimboost::tuples::element<I, Tuple>::type,
...
{
    typedef nimboost::tuples::cons<T, nimboost::tuples::null_type> type;

    static type apply(Tuple const&, T const& t)
    {
        return type(t, nimboost::tuples::null_type());
    }
};
