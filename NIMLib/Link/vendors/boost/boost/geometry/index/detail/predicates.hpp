...
struct satisfies
    : satisfies_impl<Fun, ::nimboost::is_function<Fun>::value>
{
    typedef satisfies_impl<Fun, ::nimboost::is_function<Fun>::value> base;
...
//struct predicates_length< nimboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
//{
//    static const unsigned value = nimboost::tuples::length< nimboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >::value;
//};

template <typename Head, typename Tail>
struct predicates_length< nimboost::tuples::cons<Head, Tail> >
{
    static const unsigned value = nimboost::tuples::length< nimboost::tuples::cons<Head, Tail> >::value;
};
...
//struct predicates_element< I, nimboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
//{
//    typedef nimboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> predicate_type;
//
//    typedef typename nimboost::tuples::element<I, predicate_type>::type type;
//    static type const& get(predicate_type const& p) { return nimboost::get<I>(p); }
//};

template <unsigned I, typename Head, typename Tail>
struct predicates_element< I, nimboost::tuples::cons<Head, Tail> >
{
    typedef nimboost::tuples::cons<Head, Tail> predicate_type;
...
struct predicates_check_tuple
{
    ...
    static inline bool apply(TuplePredicates const& p, Value const& v, Indexable const& i)
    {
        return
        predicate_check<
            typename nimboost::tuples::element<First, TuplePredicates>::type,
            Tag
        >::apply(nimboost::get<First>(p), v, i) &&
...
//>
//struct predicates_check_impl<
//    nimboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>,
//    Tag, First, Last
//>
//{
//    typedef nimboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> predicates_type;
//
//    static const unsigned pred_len = nimboost::tuples::length<predicates_type>::value;
...
struct predicates_check_impl<
    nimboost::tuples::cons<Head, Tail>,
    Tag, First, Last
>
{
    typedef nimboost::tuples::cons<Head, Tail> predicates_type;
...
struct predicates_count_distance_tuple
{
    static const unsigned value =
        predicates_is_distance<typename nimboost::tuples::element<N-1, Tuple>::type>::value
...
{
    static const unsigned value =
        predicates_is_distance<typename nimboost::tuples::element<0, Tuple>::type>::value;
};

//template <typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9>
//struct predicates_count_distance< nimboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
//{
//    static const unsigned value = predicates_count_distance_tuple<
//        nimboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>,
//        nimboost::tuples::length< nimboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >::value
//    >::value;
//};

template <typename Head, typename Tail>
struct predicates_count_distance< nimboost::tuples::cons<Head, Tail> >
{
    static const unsigned value = predicates_count_distance_tuple<
        nimboost::tuples::cons<Head, Tail>,
        nimboost::tuples::length< nimboost::tuples::cons<Head, Tail> >::value
    >::value;
};
...
struct predicates_find_distance_tuple
{
    ...
    static const unsigned value = predicates_find_distance_tuple<Tuple, N-1>::is_found ?
        ...
        (predicates_is_distance<typename nimboost::tuples::element<N-1, Tuple>::type>::value ?
            N-1 : nimboost::tuples::length<Tuple>::value);
};

template <typename Tuple>
struct predicates_find_distance_tuple<Tuple, 1>
{
    static const bool is_found = predicates_is_distance<typename nimboost::tuples::element<0, Tuple>::type>::value;
    static const unsigned value = is_found ? 0 : nimboost::tuples::length<Tuple>::value;
};

//template <typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9>
//struct predicates_find_distance< nimboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
//{
...
template <typename Head, typename Tail>
struct predicates_find_distance< nimboost::tuples::cons<Head, Tail> >
{
    static const unsigned value = predicates_find_distance_tuple<
        nimboost::tuples::cons<Head, Tail>,
        nimboost::tuples::length< nimboost::tuples::cons<Head, Tail> >::value
