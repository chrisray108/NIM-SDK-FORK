...
struct indexed_access_pointer
{
    static inline CoordinateType get(Geometry const* geometry)
    {
        return traits::indexed_access<typename nimboost::remove_pointer<Geometry>::type, Index, Dimension>::get(*geometry);
    }
    static inline void set(Geometry* geometry, CoordinateType const& value)
    {
        traits::indexed_access<typename nimboost::remove_pointer<Geometry>::type, Index, Dimension>::set(*geometry, value);
    }
};
...
struct access<point_tag, Point, CoordinateType, Dimension, nimboost::false_type>
{
...
template <typename Point, typename CoordinateType, std::size_t Dimension>
struct access<point_tag, Point, CoordinateType, Dimension, nimboost::true_type>
{
    static inline CoordinateType get(Point const* point)
    {
        return traits::access<typename nimboost::remove_pointer<Point>::type, Dimension>::get(*point);
    }
    static inline void set(Point* p, CoordinateType const& value)
    {
        traits::access<typename nimboost::remove_pointer<Point>::type, Dimension>::set(*p, value);
    }
};
...
<
    ...
    std::size_t Dimension
>
struct indexed_access<box_tag, Box, CoordinateType, Index, Dimension, nimboost::false_type>
...
<
    ...
    std::size_t Dimension
>
struct indexed_access<box_tag, Box, CoordinateType, Index, Dimension, nimboost::true_type>
...
<
    ...
    std::size_t Dimension
>
struct indexed_access<segment_tag, Segment, CoordinateType, Index, Dimension, nimboost::false_type>
...
<
    ...
    std::size_t Dimension
>
struct indexed_access<segment_tag, Segment, CoordinateType, Index, Dimension, nimboost::true_type>
...
{
    nimboost::ignore_unused_variable_warning(dummy);
    ...
    typedef core_dispatch::access
        <
            ...
            Dimension,
            typename nimboost::is_pointer<Geometry>::type
        > coord_access_type;
