...
// Specializations for linestring/ring, via nimboost::range
template <typename Linestring>
struct point_type<linestring_tag, Linestring>
{
    typedef typename nimboost::range_value<Linestring>::type type;
};
...
{
    typedef typename nimboost::range_value<Ring>::type type;
};
...
struct point_type
{
    typedef typename core_dispatch::point_type
        <
            ...
            typename nimboost::geometry::util::bare_type<Geometry>::type
        >::type type;
};
