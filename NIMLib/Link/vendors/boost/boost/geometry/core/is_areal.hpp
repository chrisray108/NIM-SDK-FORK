...
template <typename GeometryTag> struct is_areal : nimboost::false_type {};

template <> struct is_areal<ring_tag> : nimboost::true_type {};
template <> struct is_areal<box_tag> : nimboost::true_type {};
template <> struct is_areal<polygon_tag> : nimboost::true_type {};
