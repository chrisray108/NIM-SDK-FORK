...
struct equals_by_collection
{
    ...
    static inline bool apply(Geometry1 const& geometry1, Geometry2 const& geometry2)
    {
        ...
        if (nimboost::size(c1) != nimboost::size(c2))
        {
            return false;
        }
...
struct devarianted_equals<nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Geometry2>
{
...
struct devarianted_equals<Geometry1, nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
    struct visitor: static_visitor<bool>
    {
    ...
    static inline bool apply(
        ...
        nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& geometry2
    )
    {
...
>
struct devarianted_equals<
    nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T1)>,
    nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T2)>
>
{
    struct visitor: static_visitor<bool>
    {
    ...
    static inline bool apply(
        nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T1)> const& geometry1,
        nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T2)> const& geometry2
    )
    {
        return apply_visitor(visitor(), geometry1, geometry2);
    }
