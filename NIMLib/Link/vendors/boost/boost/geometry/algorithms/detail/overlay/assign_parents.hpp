            ...
            bool check_for_orientation = false)
{
...

    {
        ...
        typedef typename nimboost::range_iterator<vector_type const>::type vector_iterator_type;
        ...
        for (map_iterator_type it = nimboost::begin(ring_map);
            it != nimboost::end(ring_map); ++it, ++index)
        {
        ...
        if (! check_for_orientation)
        {
            ...
            if (count_positive == 1)
            {
                ...
                std::size_t index = 0;
                for (vector_iterator_type it = nimboost::begin(vector);
                    it != nimboost::end(vector); ++it, ++index)
                {
