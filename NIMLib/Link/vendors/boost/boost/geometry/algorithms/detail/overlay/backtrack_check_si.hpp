...
{
    typedef typename nimboost::range_value<Turns>::type tp_type;

    for (typename nimboost::range_iterator<Turns>::type
        it = nimboost::begin(turns);
        it != nimboost::end(turns);
        ++it)
    {
        for (typename nimboost::range_iterator
            <
                typename tp_type::container_type
            >::type op_it = nimboost::begin(it->operations);
...
public :
    ...
    static inline void apply(std::size_t size_at_start, 
                Rings& rings, typename nimboost::range_value<Rings>::type& ring,
                ...
                )
    {
        ...
        geometry::traits::clear<typename nimboost::range_value<Rings>::type>::apply(ring);
