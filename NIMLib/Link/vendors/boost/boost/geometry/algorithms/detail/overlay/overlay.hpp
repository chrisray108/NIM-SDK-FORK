...
std::cout << "traverse" << std::endl;
        ...
        // Add rings created during traversal
        {
            ...
            for (typename nimboost::range_iterator<ring_container_type>::type
                    it = nimboost::begin(rings);
                    it != nimboost::end(rings);
                    ++it)
            {
...
template <>
struct do_reverse<clockwise, false> : nimboost::false_type {};

template <>
struct do_reverse<clockwise, true> : nimboost::true_type {};

template <>
struct do_reverse<counterclockwise, false> : nimboost::true_type {};

template <>
struct do_reverse<counterclockwise, true> : nimboost::false_type {};
