...
struct intersection
{
    ...
    static inline bool apply(Geometry1 const& geometry1,
            ...
            Strategy const& strategy)
    {
        typedef typename nimboost::range_value<GeometryOut>::type OneOut;
...
\tparam GeometryOut Collection of geometries (e.g. std::vector, std::deque, nimboost::geometry::multi*) of which
