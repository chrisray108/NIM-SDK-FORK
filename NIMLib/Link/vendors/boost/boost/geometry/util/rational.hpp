...
struct select_most_precise<nimboost::rational<T1>, nimboost::rational<T2> >
{
    typedef typename nimboost::rational
        <
...
template <typename T>
struct select_most_precise<nimboost::rational<T>, double>
{
    typedef typename nimboost::rational<T> type;
};
...
// Specializes nimboost::rational to nimboost::numeric::bounds
...
// Support for nimboost::numeric_cast to int and to double (necessary for SVG-mapper)
namespace nimboost { namespace numeric
{
