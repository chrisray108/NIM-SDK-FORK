...
struct select_most_precise
{
    ...
    static const bool one_not_fundamental = !
        (nimboost::is_fundamental<T1>::type::value
          && nimboost::is_fundamental<T2>::type::value);

    static const bool both_same =
        nimboost::is_floating_point<T1>::type::value
        == nimboost::is_floating_point<T2>::type::value;
