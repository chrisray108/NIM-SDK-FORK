      ...
      >
{
                ...
                Strategy const& strategy)
    {
        ...
        for(typename range_iterator<MultiGeometry const>::type it = nimboost::begin(multi);
      ...
      >
{
                ...
                Multi2 const& multi2, Strategy const& strategy)
    {
        ...
        for(typename range_iterator<Multi1 const>::type it = nimboost::begin(multi1);
                it != nimboost::end(multi1);
                ++it, first = false)
        {
