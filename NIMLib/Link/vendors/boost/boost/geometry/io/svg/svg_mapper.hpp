...
struct svg_map<multi_tag, Multi>
{
    ...
    {
        for (typename nimboost::range_iterator<Multi const>::type it
            = nimboost::begin(multi);
        ...
        <
            typename tag_cast
                <
                    ...
                    multi_tag
                >::type,
            typename nimboost::remove_const<Geometry>::type
...
class svg_mapper : nimboost::noncopyable
{
    ...
    nimboost::scoped_ptr<transformer_type> m_matrix;
    ...
    */
                ...
                int offset_x = 0, int offset_y = 0, int lineheight = 10)
    {
        ...
        else
        {
            ...
            nimboost::split(splitted, s, nimboost::is_any_of("\n"));
