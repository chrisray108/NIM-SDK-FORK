...
// Silence warning C4512: 'nimboost::geometry::wkt_manipulator<Geometry>' : assignment operator could not be generated
#if defined(_MSC_VER)
#pragma warning(push)  
...
struct wkt_range
{
                ...
                Range const& range)
    {
        ...
        for (iterator_type it = nimboost::begin(range);
...
struct wkt_segment
{
                ...
                Segment const& segment)
    {
        ...
        typedef nimboost::array<point_type, 2> sequence;
