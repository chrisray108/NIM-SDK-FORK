...
// Don't use namespace nimboost::geometry, to enable the library to stream custom
// geometries which are living outside the namespace nimboost::geometry
