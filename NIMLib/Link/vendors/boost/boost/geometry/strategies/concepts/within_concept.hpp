        ...
        static void apply(ApplyMethod const&, ResultMethod const& )
        {
            ...
            BOOST_MPL_ASSERT_MSG
                (
                    (nimboost::is_same
                        <
                            bool, typename nimboost::function_types::result_type<ApplyMethod>::type
                        >::type::value),
            ...
            BOOST_MPL_ASSERT_MSG
                (
                    (nimboost::is_same
                        <
                            int, typename nimboost::function_types::result_type<ResultMethod>::type
                        >::type::value),
            ...
            nimboost::ignore_unused_variable_warning(str);
        }
    };
            ...
            BOOST_MPL_ASSERT_MSG
                (
                    (nimboost::is_same
                        <
                            bool, 
                            typename nimboost::function_types::result_type<ApplyMethod>::type
                        >::type::value),
                    WRONG_RETURN_TYPE
                    , (bool)
                );
...
// So now: nimboost::geometry::concept::within
namespace within 
{ 
...
inline void check()
{
    ...
    nimboost::ignore_unused_variable_warning(c);
}


}}}} // namespace nimboost::geometry::concept::within
