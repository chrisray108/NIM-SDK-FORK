...
// nimboost::polygon::polygon_data -> nimboost::geometry::ring
...
struct tag<nimboost::polygon::polygon_data<CoordinateType> >
{
    typedef ring_tag type;
};

template <typename CoordinateType>
struct clear<nimboost::polygon::polygon_data<CoordinateType> >
{
    static inline void apply(nimboost::polygon::polygon_data<CoordinateType>& data)
    {
        // There is no "clear" function but we can assign
        // a newly (and therefore empty) constructed polygon
        nimboost::polygon::assign(data, nimboost::polygon::polygon_data<CoordinateType>());
    }
};

template <typename CoordinateType>
struct push_back<nimboost::polygon::polygon_data<CoordinateType> >
{
    typedef nimboost::polygon::point_data<CoordinateType> point_type;
         ...
         point_type const& point)
    {
        ...
        std::vector<point_type> temporary_vector
            (
                nimboost::polygon::begin_points(data),
                nimboost::polygon::end_points(data)
            );
...
{
    template<typename CoordinateType>
    struct range_mutable_iterator<nimboost::polygon::polygon_data<CoordinateType> >
    {
        typedef typename nimboost::polygon::polygon_traits
            <
                nimboost::polygon::polygon_data<CoordinateType>
            >::iterator_type type;
    };

    template<typename CoordinateType>
    struct range_const_iterator<nimboost::polygon::polygon_data<CoordinateType> >
    {
        typedef typename nimboost::polygon::polygon_traits
            <
                nimboost::polygon::polygon_data<CoordinateType>
    ...
    template<typename CoordinateType>
    struct range_size<nimboost::polygon::polygon_data<CoordinateType> >
    {
...
namespace nimboost { namespace polygon
{
