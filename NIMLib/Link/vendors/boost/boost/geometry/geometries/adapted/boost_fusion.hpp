...
struct all_same :
    nimboost::mpl::bool_<
        nimboost::mpl::count_if<
            Sequence,
            nimboost::is_same<
                typename nimboost::mpl::front<Sequence>::type,
                nimboost::mpl::_
            >
        >::value == nimboost::mpl::size<Sequence>::value
    >
{};

template <class Sequence>
struct is_coordinate_size : nimboost::mpl::bool_<
            nimboost::fusion::result_of::size<Sequence>::value == 2 ||
            nimboost::fusion::result_of::size<Sequence>::value == 3> {};

template<typename Sequence>
struct is_fusion_sequence
    : mpl::and_<nimboost::fusion::traits::is_sequence<Sequence>,
...
struct coordinate_type
    ...
    >
{
    typedef typename nimboost::mpl::front<Sequence>::type type;
};
    ...
    >
{
    ...
    {
        return nimboost::fusion::at_c<Dimension>(point);
    }

    template <class CoordinateType>
    static inline void set(Sequence& point, CoordinateType const& value)
    {
        nimboost::fusion::at_c<Dimension>(point) = value;
    }
};
