...
struct tag<nimboost::adjacent_filtered_range<Filter, Geometry, DefaultPass> >
#else
struct tag<nimboost::range_detail::adjacent_filter_range<Filter, Geometry, DefaultPass> >
#endif
{
