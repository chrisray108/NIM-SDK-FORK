...
struct tag<nimboost::array<CoordinateType, DimensionCount> >
    : detail::boost_array_tag<nimboost::is_arithmetic<CoordinateType>::value> {};


template <typename CoordinateType, std::size_t DimensionCount>
struct coordinate_type<nimboost::array<CoordinateType, DimensionCount> >
{
...
template <typename CoordinateType, std::size_t DimensionCount>
struct dimension<nimboost::array<CoordinateType, DimensionCount> >: nimboost::mpl::int_<DimensionCount> {};


template <typename CoordinateType, std::size_t DimensionCount, std::size_t Dimension>
struct access<nimboost::array<CoordinateType, DimensionCount>, Dimension>
{
    static inline CoordinateType get(nimboost::array<CoordinateType, DimensionCount> const& a)
    {
        return a[Dimension];
    }

    static inline void set(nimboost::array<CoordinateType, DimensionCount>& a,
...
#define BOOST_GEOMETRY_REGISTER_BOOST_ARRAY_CS(CoordinateSystem) \
    namespace nimboost { namespace geometry { namespace traits { \
    template <class T, std::size_t N> \
    struct coordinate_system<nimboost::array<T, N> > \
    { \
