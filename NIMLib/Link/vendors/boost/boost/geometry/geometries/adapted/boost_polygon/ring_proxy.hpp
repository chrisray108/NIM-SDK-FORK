...
struct modify<true>
{
    ...
    static inline void push_back(Ring& ring, Point const& point)
    {
        ...
        std::vector<Point> temporary_vector
            (
                nimboost::polygon::begin_points(ring),
                nimboost::polygon::end_points(ring)
            );
        temporary_vector.push_back(point);
        nimboost::polygon::set_points(ring, temporary_vector.begin(), temporary_vector.end());
    }
...
{
public :
    typedef typename nimboost::polygon::polygon_traits
        <
            typename nimboost::remove_const<Polygon>::type
        >::iterator_type iterator_type;

    typedef typename nimboost::polygon::polygon_with_holes_traits
        <
            typename nimboost::remove_const<Polygon>::type
        >::iterator_holes_type hole_iterator_type;

    static const bool is_mutable = !nimboost::is_const<Polygon>::type::value;
    ...
    {
        return m_do_hole
            ? nimboost::polygon::begin_points(*m_hole_it)
            : nimboost::polygon::begin_points(*m_polygon_pointer)
            ;
    }
    ...
    {
        return m_do_hole
            ? nimboost::polygon::end_points(*m_hole_it)
            : nimboost::polygon::end_points(*m_polygon_pointer)
            ;
    }
    ...
    void clear()
    {
        ...
        {
            nimboost::polygon::set_points(*m_polygon_pointer,
                nimboost::polygon::begin_points(p),
                nimboost::polygon::end_points(p));
        }
    }
...
template<typename Polygon>
inline typename nimboost::geometry::adapt::bp::ring_proxy<Polygon>::iterator_type
            range_begin(nimboost::geometry::adapt::bp::ring_proxy<Polygon>& proxy)
{
    return proxy.begin();
}

template<typename Polygon>
inline typename nimboost::geometry::adapt::bp::ring_proxy<Polygon const>::iterator_type
            range_begin(nimboost::geometry::adapt::bp::ring_proxy<Polygon const> const& proxy)
{
    return proxy.begin();
}
...
template<typename Polygon>
inline typename nimboost::geometry::adapt::bp::ring_proxy<Polygon>::iterator_type
            range_end(nimboost::geometry::adapt::bp::ring_proxy<Polygon>& proxy)
{
    return proxy.end();
}
...
template<typename Polygon>
inline typename nimboost::geometry::adapt::bp::ring_proxy<Polygon const>::iterator_type
            range_end(nimboost::geometry::adapt::bp::ring_proxy<Polygon const> const& proxy)
{
    return proxy.end();
}
...
{
    static inline void apply(adapt::bp::ring_proxy<Polygon> proxy,
        typename nimboost::polygon::polygon_traits<Polygon>::point_type const& point)
    {
