...
namespace nimboost { namespace geometry { namespace concept
{
...
class Polygon
{
    ...
    typedef typename nimboost::remove_const<PolygonType>::type polygon_type;
    ...
    //BOOST_CONCEPT_ASSERT( (nimboost::RandomAccessRangeConcept<interior_type>) );
    ...
    struct checker
    {
        static inline void apply()
        {
            ...
            nimboost::ignore_unused_variable_warning(e);
            nimboost::ignore_unused_variable_warning(i);
            nimboost::ignore_unused_variable_warning(ce);
            nimboost::ignore_unused_variable_warning(ci);
            nimboost::ignore_unused_variable_warning(poly);
            nimboost::ignore_unused_variable_warning(cpoly);
        }
    };
...
class ConstPolygon
{
    ...
    typedef typename nimboost::remove_const<PolygonType>::type const_polygon_type;
...
}}} // namespace nimboost::geometry::concept
