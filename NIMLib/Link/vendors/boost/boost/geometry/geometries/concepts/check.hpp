...
<
    ...
    bool IsConst = nimboost::is_const<Geometry>::type::value
>
...
struct checker<nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{};

template <BOOST_VARIANT_ENUM_PARAMS(typename T)>
struct checker<nimboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const>
{};
