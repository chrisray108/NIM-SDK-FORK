...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::nimboost::mpl::aux::yes_tag operator|( \
      ::nimboost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::nimboost::mpl::aux::no_tag operator|( \
      ::nimboost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::nimboost::mpl::na) >* \
    ); \
/**/
...
::nimboost::mpl::aux::yes_tag operator|( \
      ::nimboost::mpl::aux::has_rebind_tag<int> \
    , ::nimboost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
