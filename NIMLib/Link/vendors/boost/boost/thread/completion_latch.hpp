...
namespace nimboost
{
  ...
  private:
    ...
    struct around_wait
    {
      ...
      nimboost::unique_lock<nimboost::mutex> &lk_;
      around_wait(completion_latch &that, nimboost::unique_lock<nimboost::mutex> &lk)
      : that_(that), lk_(lk)
      {
  ...
  public:
    ...
    void wait()
    {
      nimboost::unique_lock<nimboost::mutex> lk(mutex_);
    ...
    {
      nimboost::lock_guard<nimboost::mutex> lk(mutex_);
      //BOOST_ASSERT(count_ == 0);
      count_ = count;
    }
