...
namespace nimboost
{
    ...
    private:
        ...
        state_data state;
        nimboost::mutex state_change;
        nimboost::condition_variable shared_cond;
        nimboost::condition_variable exclusive_cond;
        nimboost::condition_variable upgrade_cond;
    ...
    public:
        ...
        {
#if defined BOOST_THREAD_PROVIDES_INTERRUPTIONS
            nimboost::this_thread::disable_interruption do_not_disturb;
#endif
            nimboost::unique_lock<nimboost::mutex> lk(state_change);
