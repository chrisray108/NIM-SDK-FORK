...
//#endif
        ...
        typedef nimboost::intrusive_ptr<detail::thread_data_base> thread_data_ptr;
        ...
        struct BOOST_SYMBOL_VISIBLE timeout
        {
            ...
            timeout(uintmax_t milliseconds_):
                ...
                relative(true),
                abs_time(nimboost::get_system_time())
            {}

            timeout(nimboost::system_time const& abs_time_):
                start(win32::GetTickCount64()),
                milliseconds(0),
                relative(false),
                abs_time(abs_time_)
