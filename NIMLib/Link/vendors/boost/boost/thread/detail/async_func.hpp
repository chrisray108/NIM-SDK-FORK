...
namespace nimboost
{
  namespace detail
  {
    ...
    public:
      ...
      : f_(nimboost::move(f), nimboost::move(args)...)
      {}

      BOOST_SYMBOL_VISIBLE
      async_func(BOOST_THREAD_RV_REF(async_func) f) : f_(nimboost::move(f.f_))
      {}
    ...
    private:
      ...
      {
        return invoke(nimboost::move(std::get<0>(f_)), nimboost::move(std::get<Indices>(f_))...);
      }
    };
    ...
    class async_func<Fp, T0, T1, T2, T3, T4, T5, T6, T7, T8>
    {
      ...
      T7 v7_;
      T8 v8_;
      //::nimboost::tuple<Fp, T0, T1, T2, T3, T4, T5, T6, T7, T8> f_;
    ...
    public:
      ...
      : fp_(nimboost::move(f))
      , v0_(nimboost::move(a0))
      , v1_(nimboost::move(a1))
      , v2_(nimboost::move(a2))
      , v3_(nimboost::move(a3))
      , v4_(nimboost::move(a4))
      , v5_(nimboost::move(a5))
      , v6_(nimboost::move(a6))
      , v7_(nimboost::move(a7))
      , v8_(nimboost::move(a8))
      {}

      BOOST_SYMBOL_VISIBLE
      async_func(BOOST_THREAD_RV_REF(async_func) f)
      : fp_(nimboost::move(f.fp))
      , v0_(nimboost::move(f.a0))
      , v1_(nimboost::move(f.a1))
      , v2_(nimboost::move(f.a2))
      , v3_(nimboost::move(f.a3))
      , v4_(nimboost::move(f.a4))
      , v5_(nimboost::move(f.a5))
      , v6_(nimboost::move(f.a6))
      , v7_(nimboost::move(f.a7))
      , v8_(nimboost::move(f.a8))
      {}

      result_type operator()()
      {
        return invoke(nimboost::move(fp_)
            , nimboost::move(v0_)
            , nimboost::move(v1_)
            , nimboost::move(v2_)
            , nimboost::move(v3_)
