...
#define BOOST_THREAD_PROVIDES_INVOKE
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0, BOOST_THREAD_RV_REF(Args) ...args)
        -> decltype((nimboost::forward<A0>(a0).*f)(nimboost::forward<Args>(args)...))
    {
        return (nimboost::forward<A0>(a0).*f)(nimboost::forward<Args>(args)...);
    }
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0)
        -> decltype(nimboost::forward<A0>(a0).*f)
    {
        return nimboost::forward<A0>(a0).*f;
    }
    ...
    -> decltype(nimboost::forward<Fp>(f)(nimboost::forward<Args>(args)...))
    {
      return nimboost::forward<Fp>(f)(nimboost::forward<Args>(args)...);
    }
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0, BOOST_THREAD_RV_REF(A1) a1)
        -> decltype((nimboost::forward<A0>(a0).*f)(nimboost::forward<Args>(a1)))
    {
        return (nimboost::forward<A0>(a0).*f)(nimboost::forward<Args>(a1));
    }
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0, BOOST_THREAD_RV_REF(A1) a1, BOOST_THREAD_RV_REF(A2) a2)
        -> decltype((nimboost::forward<A0>(a0).*f)(nimboost::forward<Args>(a1), nimboost::forward<Args>(a2)))
    {
        return (nimboost::forward<A0>(a0).*f)(nimboost::forward<Args>(a1), nimboost::forward<Args>(a2));
    }
    ...
    -> decltype(nimboost::forward<Fp>(f)())
    {
      return nimboost::forward<Fp>(f)();
    }
    template <class Fp, class A1>
    inline
    auto invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(Args) a1)
    -> decltype(nimboost::forward<Fp>(f)(nimboost::forward<A1>(a1)))
    {
      return nimboost::forward<Fp>(f)(nimboost::forward<A1>(a1));
    ...
    -> decltype(nimboost::forward<Fp>(f)(nimboost::forward<A1>(a1), nimboost::forward<A2>(a2)))
    {
      return nimboost::forward<Fp>(f)(nimboost::forward<A1>(a1), nimboost::forward<A2>(a2));
    }
    ...
    -> decltype(nimboost::forward<Fp>(f)(nimboost::forward<A1>(a1), nimboost::forward<A2>(a2), nimboost::forward<A3>(a3)))
    {
      return nimboost::forward<Fp>(f)(nimboost::forward<A1>(a1), nimboost::forward<A2>(a2), nimboost::forward<A3>(a3));
    }
    ...
    {
      return std::bind(nimboost::forward<Fp>(f), nimboost::forward<A1>(a1))();
    }
    ...
    {
      return std::bind(nimboost::forward<Fp>(f), nimboost::forward<A1>(a1), nimboost::forward<A2>(a2))();
    }
    ...
    {
      return std::bind(nimboost::forward<Fp>(f), nimboost::forward<A1>(a1), nimboost::forward<A2>(a2), nimboost::forward<A3>(a3))();
    }
...
//    }
    ...
    {
      return f(nimboost::forward<Args>(args)...);
    }
#else // BOOST_NO_CXX11_VARIADIC_TEMPLATES
    // bullet 1
    // (t1.*f)(t2, ..., tN) when f is a pointer to a member function of a class T and t1 is an object of
    ...
    {
        return (nimboost::forward<A0>(a0).*f)(nimboost::forward<A1>(a1));
    }
    template <class Ret, class A, class A0, class A1>
    inline
    typename enable_if_c
    ...
    {
        return (nimboost::forward<A0>(a0).*f)(nimboost::forward<A1>(a1), nimboost::forward<A2>(a2));
    }
    template <class Ret, class A, class A0, class A1, class A2>
    inline
    typename enable_if_c
    ...
    {
        return (nimboost::forward<A0>(a0).*f)(nimboost::forward<A1>(a1), nimboost::forward<A2>(a2), nimboost::forward<A3>(a3));
    }
    template <class Ret, class A, class A0, class A1, class A2, class A3>
    inline
    typename enable_if_c
...
///
    ...
    {
      return ((*nimboost::forward<A0>(a0)).*f)(a1);
    }
    template <class Ret, class A, class A0, class A1>
    inline
    typename enable_if_c
...
//    }
    ...
    {
      return nimboost::forward<Fp>(f)(a1);
    }
    template <class Ret, class Fp, class A1, class A2>
    inline
    typename enable_if_c
    ...
    {
      return nimboost::forward<Fp>(f)(a1, a2);
    }
    template <class Ret, class Fp, class A1, class A2, class A3>
    inline
    typename enable_if_c
    ...
    {
      return nimboost::forward<Fp>(f)(a1, a2, a3);
    }
    ...
    {
      return f(nimboost::forward<A1>(a1));
    }
    template <class Ret, class Fp, class A1>
    inline
    typename enable_if_c
    ...
    {
      return f(nimboost::forward<A1>(a1), nimboost::forward<A2>(a2));
    }
    template <class Ret, class Fp, class A1, class A2>
    inline
    typename enable_if_c
    ...
    {
      return f(nimboost::forward<A1>(a1), nimboost::forward<A2>(a2), nimboost::forward<A3>(a3));
    }
    template <class Ret, class Fp, class A1, class A2, class A3>
    inline
    typename enable_if_c
