...
namespace nimboost
{
    ...
    public:
        lock_error()
        : base_type(0, "nimboost::lock_error")
        {}

        lock_error( int ev )
        : base_type(ev, "nimboost::lock_error")
        {
        }
    ...
    public:
          ...
          : base_type(system::errc::resource_unavailable_try_again, "nimboost::thread_resource_error")
          {}

          thread_resource_error( int ev )
          : base_type(ev, "nimboost::thread_resource_error")
          {
          }
    ...
    public:
          ...
          : base_type(system::errc::invalid_argument, "nimboost::unsupported_thread_option")
          {}

          unsupported_thread_option( int ev )
          : base_type(ev, "nimboost::unsupported_thread_option")
          {
          }
    ...
    public:
        ...
        : base_type(system::errc::invalid_argument, "nimboost::invalid_thread_argument")
        {}

        invalid_thread_argument( int ev )
        : base_type(ev, "nimboost::invalid_thread_argument")
        {
        }
    ...
    public:
          ...
          : base_type(system::errc::permission_denied, "nimboost::thread_permission_error")
          {}

          thread_permission_error( int ev )
          : base_type(ev, "nimboost::thread_permission_error")
          {
          }
