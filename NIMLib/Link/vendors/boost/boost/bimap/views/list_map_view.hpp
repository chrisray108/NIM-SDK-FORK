...
{
    typedef ::nimboost::bimaps::container_adaptor::list_map_adaptor
    <
        ...
        ::nimboost::bimaps::detail::      reverse_map_view_iterator<Tag,BimapType>,
        ::nimboost::bimaps::detail::const_reverse_map_view_iterator<Tag,BimapType>,
        ...
        BOOST_DEDUCED_TYPENAME ::nimboost::bimaps::relation::support::data_extractor
        <
            Tag,
...
template< class Tag, class BimapType >
struct left_map_view_extra_typedefs< ::nimboost::bimaps::views::list_map_view<Tag,BimapType> >
{
    private: typedef ::nimboost::bimaps::views::list_map_view<Tag,BimapType> map_view_;
    public : BOOST_BIMAP_MAP_VIEW_EXTRA_TYPEDEFS_BODY(map_view_,left)
};

template< class Tag, class BimapType >
struct right_map_view_extra_typedefs< ::nimboost::bimaps::views::list_map_view<Tag,BimapType> >
{
    private: typedef ::nimboost::bimaps::views::list_map_view<Tag,BimapType> map_view_;
