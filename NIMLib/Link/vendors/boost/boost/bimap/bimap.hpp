...
the next step will be:
    ...
    - Understand the tagged idiom. (nimboost::bimaps::tags)
    - Understand the internals of the relation class (nimboost::bimaps::relation)
    - Read the container_adaptor toolbox docs (nimboost::bimaps::container_adaptor)
    - Understand the internals of the bimap class. (nimboost::bimaps, nimboost::bimaps::views
      and nimboost::bimaps::detail)
...
<
    ...
    class AP1 = ::nimboost::mpl::na,
    class AP2 = ::nimboost::mpl::na,
    class AP3 = ::nimboost::mpl::na
>
class bimap
:
    // Bimap Core, use mpl magic to find the desired bimap type

    public ::nimboost::bimaps::detail::bimap_core<KeyTypeA,KeyTypeB,AP1,AP2,AP3>,
    ...
    public ::nimboost::bimaps::detail:: left_map_view_extra_typedefs<
        BOOST_DEDUCED_TYPENAME ::nimboost::bimaps::detail::left_map_view_type<
            ::nimboost::bimaps::detail::bimap_core<KeyTypeA,KeyTypeB,AP1,AP2,AP3>
        >::type
    >,
    public ::nimboost::bimaps::detail::right_map_view_extra_typedefs< 
        BOOST_DEDUCED_TYPENAME ::nimboost::bimaps::detail::right_map_view_type<
            ::nimboost::bimaps::detail::bimap_core<KeyTypeA,KeyTypeB,AP1,AP2,AP3>
        >::type
    >
{
    typedef BOOST_DEDUCED_TYPENAME ::nimboost::bimaps::detail::
   ...
   {}
    ...
    BOOST_DEDUCED_TYPENAME ::nimboost::bimaps::support::
    ...
    template< class Tag >
    struct map_by :
        public ::nimboost::bimaps::support::map_type_by<Tag,bimap>::type
    {
        typedef BOOST_DEDUCED_TYPENAME ::nimboost::bimaps::support::
    ...
    {
        return ::nimboost::bimaps::support::map_by<Tag>(*this);
    }

    template< class Tag >
    const BOOST_DEDUCED_TYPENAME ::nimboost::bimaps::support::
    map_type_by<Tag,bimap>::type &
...
/** \namespace nimboost::bimaps::support
\brief Metafunctions to help working with bimaps.
                                                            **/

/** \namespace nimboost::bimaps::views
\brief Bimap views.
                                                            **/

/** \namespace nimboost::bimaps::views::detail
...
using ::nimboost::bimaps::tags::tagged;

namespace member_at = ::nimboost::bimaps::relation::member_at;

using ::nimboost::multi_index::unbounded;
