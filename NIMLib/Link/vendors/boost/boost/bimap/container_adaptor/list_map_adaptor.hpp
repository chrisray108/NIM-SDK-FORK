...
struct list_map_adaptor_base
{
    ...
    <
        ...
        BOOST_DEDUCED_TYPENAME mpl::push_front<
            ...
            BOOST_DEDUCED_TYPENAME mpl::if_< ::nimboost::mpl::is_na<KeyFromBaseValueConverter>,
            // {
...
<
    ...
    class ReverseIteratorFromBaseConverter = ::nimboost::mpl::na,
    class ValueToBaseConverter             = ::nimboost::mpl::na,
    class ValueFromBaseConverter           = ::nimboost::mpl::na,
    class KeyFromBaseValueConverter        = ::nimboost::mpl::na,
    ...
    >::type
{
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::nimboost::mpl::is_na<KeyFromBaseValueConverter>,
    // {
    ...
    {
        this->base().remove_if(
            ::nimboost::bimaps::container_adaptor::detail::unary_check_adaptor
            <
                Predicate,
    ...
    {
        this->base().unique(
            ::nimboost::bimaps::container_adaptor::detail::comparison_adaptor
            <
