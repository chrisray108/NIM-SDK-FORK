...
<
    ...
    class IteratorToBaseConverter   = ::nimboost::mpl::na,
    class IteratorFromBaseConverter = ::nimboost::mpl::na,
    class ValueToBaseConverter      = ::nimboost::mpl::na,
    class ValueFromBaseConverter    = ::nimboost::mpl::na,
...
class container_adaptor
{
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::nimboost::mpl::is_na<IteratorToBaseConverter>,
        // {
                ::nimboost::bimaps::container_adaptor::detail::
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::nimboost::mpl::is_na<IteratorFromBaseConverter>,
        // {
                ::nimboost::bimaps::container_adaptor::detail::
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::nimboost::mpl::is_na<ValueToBaseConverter>,
        // {
                ::nimboost::bimaps::container_adaptor::detail::
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::nimboost::mpl::is_na<ValueFromBaseConverter>,
        // {
                ::nimboost::bimaps::container_adaptor::detail::
    ...
    std::pair<iterator, bool> insert(
        BOOST_DEDUCED_TYPENAME ::nimboost::call_traits< value_type >::param_type x)
    {
    ...
    ::nimboost::bimaps::container_adaptor::detail::data_with_functor_bag
    <
        Base &,
