...
{
    BOOST_MPL_ASSERT((
        ::nimboost::mpl::contains<BOOST_DEDUCED_TYPENAME Type::mutant_views,View>
    ));
    return *reinterpret_cast< View* >(nimboost::addressof(m));
}
...
>::type mutate( Type & m )
{
    ...
    return *reinterpret_cast< const View* >(nimboost::addressof(m));
}
