...
{
    const Relation
        operator()(const BOOST_DEDUCED_TYPENAME ::nimboost::bimaps::relation::support::
...
struct pair_to_relation_functor<
    Tag,::nimboost::bimaps::relation::mutant_relation<TA,TB,Info,true> >
{
    typedef ::nimboost::bimaps::relation::mutant_relation<TA,TB,Info,true> Relation;

    Relation &
        operator()( BOOST_DEDUCED_TYPENAME ::nimboost::bimaps::relation::support::
            pair_type_by<Tag,Relation>::type & p ) const
    {
        return ::nimboost::bimaps::relation::detail::mutate<Relation>(p);
    }
...
struct get_mutable_relation_functor< ::nimboost::bimaps::relation::mutant_relation<TA,TB,Info,true> >
{
    typedef ::nimboost::bimaps::relation::mutant_relation<TA,TB,Info,true> Relation;
    ...
    {
        return ::nimboost::bimaps::relation::detail::mutate<Relation>(r);
    }
