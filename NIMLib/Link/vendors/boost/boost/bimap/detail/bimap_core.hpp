...
class bimap_core
{
    ...
    typedef BOOST_DEDUCED_TYPENAME ::nimboost::bimaps::tags::support::default_tagged
    <
    ...
    typedef ::nimboost::bimaps::relation::mutant_relation
    <

        ::nimboost::bimaps::tags::tagged<
            ...
            // else
            // {
                    BOOST_DEDUCED_TYPENAME ::nimboost::add_const< left_key_type >::type
            // }
        ...
        ::nimboost::bimaps::tags::tagged<
            ...
            // else
            // {
                    BOOST_DEDUCED_TYPENAME ::nimboost::add_const< right_key_type >::type
            // }
        ...
        // It is ::nimboost::mpl::na if no info_hook was included
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_<
        ::nimboost::bimaps::detail::is_unconstrained_set_of< left_set_type >,
    // {
            mpl::vector<>,
    // }
    // else
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_<
        ::nimboost::bimaps::detail::is_unconstrained_set_of< right_set_type >,
    // {
            left_core_indices,
    // }
    // else
    ...
    // {
            ...
            <
                ...
                BOOST_NESTED_TEMPLATE index_bind
                <
                    ::nimboost::bimaps::relation::support::both_keys_extractor<relation>,
                    independent_index_tag
    ...
    typedef BOOST_DEDUCED_TYPENAME ::nimboost::multi_index::
    ...
    typedef BOOST_DEDUCED_TYPENAME ::nimboost::multi_index::index
    <
