...
::nimboost::bimaps::container_adaptor::CONTAINER_ADAPTOR                         \
<                                                                             \
    BOOST_DEDUCED_TYPENAME BIMAP::core_type::                                 \
        BOOST_NESTED_TEMPLATE index<TAG>::type,                               \
    ::nimboost::bimaps::detail::      map_view_iterator<TAG,BIMAP>,              \
    ::nimboost::bimaps::detail::const_map_view_iterator<TAG,BIMAP>,              \
    ::nimboost::bimaps::detail::      OTHER_ITER<TAG,BIMAP>,                     \
    ::nimboost::bimaps::detail::CONST_OTHER_ITER<TAG,BIMAP>,                     \
    ::nimboost::bimaps::container_adaptor::support::iterator_facade_to_base      \
    <                                                                         \
        ::nimboost::bimaps::detail::      map_view_iterator<TAG,BIMAP>,          \
        ::nimboost::bimaps::detail::const_map_view_iterator<TAG,BIMAP>           \
    >,                                                                        \
    ...
    ::nimboost::bimaps::relation::support::                                      \
...
#define BOOST_BIMAP_MAP_VIEW_BASE_FRIEND(TYPE,TAG,BIMAP)                      \
    typedef ::nimboost::bimaps::detail::map_view_base<                           \
...
/*===========================================================================*/
#define BOOST_BIMAP_MAP_VIEW_BASE_FRIEND(TYPE,TAG,BIMAP)                      \
    friend class ::nimboost::bimaps::detail::map_view_base<                      \
...
class map_view_base
{
    typedef ::nimboost::bimaps::container_adaptor::support::
        iterator_facade_to_base<
            ::nimboost::bimaps::detail::      map_view_iterator<Tag,BimapType>,
            ::nimboost::bimaps::detail::const_map_view_iterator<Tag,BimapType>
        > iterator_to_base_;
    ...
    typedef BOOST_DEDUCED_TYPENAME ::nimboost::bimaps::relation::support::
           pair_type_by<Tag,
              BOOST_DEDUCED_TYPENAME BimapType::relation>::type value_type_;

    typedef 
        ::nimboost::bimaps::detail::map_view_iterator<Tag,BimapType> iterator_;
    ...
    bool modify(iterator_ position, Modifier mod)
    {
        return derived().base().modify(
            ...
            ::nimboost::bimaps::detail::relation_modifier_adaptor
            <
                Modifier,
    ...
    */
    ...
    bool modify_data(iterator_ position, Modifier mod)
    {
        ...
        return derived().base().modify(
            ...
            // ::nimboost::bind( mod, ::nimboost::bind(data_extractor_(),_1) )

            ::nimboost::bimaps::detail::unary_modifier_adaptor
            <
                Modifier,
                BOOST_DEDUCED_TYPENAME BimapType::relation,
                data_extractor_
...
class mutable_data_unique_map_view_access
{
    ...
    {
        typedef ::nimboost::bimaps::detail::
