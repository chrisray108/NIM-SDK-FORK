...
template< class Type >
struct is_with_info : ::nimboost::mpl::false_ {};

template< class ValueType >
struct is_with_info< with_info<ValueType> > : ::nimboost::mpl::true_ {};

/** \struct nimboost::bimaps::detail::manage_additional_parameters
\brief Utility class to extract the additional parameters from the template parameters.
...
struct manage_additional_parameters
{
    ...
    struct case_NNN
    {
        ...
        typedef ::nimboost::mpl::na additional_info;
    };
    ...
    <
        ::nimboost::mpl::is_na<AP1>,
        case_NNN, // (1)
        BOOST_DEDUCED_TYPENAME mpl::if_
        <
            ::nimboost::mpl::is_na<AP2>,
            BOOST_DEDUCED_TYPENAME mpl::if_
            <
