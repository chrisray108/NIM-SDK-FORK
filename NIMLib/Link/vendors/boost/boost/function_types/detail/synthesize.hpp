...
struct synthesize_impl
  : detail::synthesize_impl_o
    < ::nimboost::function_types::detail::decode_bits<Bits>::flags
    , ::nimboost::function_types::detail::decode_bits<Bits>::cc_id
    , ::nimboost::mpl::size<Seq>::value
    >
...
struct synthesize_func
  : detail::synthesize_impl
    < Seq
    , ::nimboost::function_types::detail::bits
