...
namespace nimboost { namespace function_types { namespace detail {
...
struct cv_code
{
  ...
  BOOST_STATIC_CONSTANT(std::size_t, value = 
      sizeof(::nimboost::function_types::detail::switch_cv(
         ::nimboost::function_types::detail::ref_to_ptr(_t) ) ));
};

template<typename T> struct cv_traits 
{
  typedef typename nimboost::function_types::detail::cv_tag_impl< 
    ::nimboost::function_types::detail::cv_code<T>::value >::type
  tag;
...
} } } // namespace nimboost::function_types::detail
