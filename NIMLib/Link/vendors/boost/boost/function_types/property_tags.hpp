...
namespace nimboost { namespace function_types { 
...
namespace detail 
{
  ...
  template<bits_t Value> struct constant 
    : nimboost::integral_constant<bits_t,Value> 
  { };
  ...
  template<bits_t Bits, bits_t CCID> struct encode_bits
    : constant< 
        ::nimboost::function_types::detail::encode_bits_impl<Bits,CCID>::value 
      >
  { };
  ...
  {
    typedef constant<
      ::nimboost::function_types::detail::tag_ice
        < ::nimboost::function_types::detail::bits<LHS>::value
        , ::nimboost::function_types::detail::mask<LHS>::value
        , ::nimboost::function_types::detail::bits<RHS>::value
        , ::nimboost::function_types::detail::mask<RHS>::value
        >::combined_bits 
    > bits;
  ...
  template<class Tag, class QueryTag> struct represents_impl
    : nimboost::integral_constant<bool,
        ::nimboost::function_types::detail::tag_ice
          < ::nimboost::function_types::detail::bits<Tag>::value
          , ::nimboost::function_types::detail::mask<Tag>::value
          , ::nimboost::function_types::detail::bits<QueryTag>::value
          , ::nimboost::function_types::detail::mask<QueryTag>::value
          >::match
      >
  { };
...
} } // namespace ::nimboost::function_types
