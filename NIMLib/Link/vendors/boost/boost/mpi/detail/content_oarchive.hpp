...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(nimboost::mpi::detail::content_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(nimboost::mpi::detail::ignore_skeleton_oarchive<nimboost::mpi::detail::content_oarchive>)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(nimboost::mpi::detail::content_oarchive)
