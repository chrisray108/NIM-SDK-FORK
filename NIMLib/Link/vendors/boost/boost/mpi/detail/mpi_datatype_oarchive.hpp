...
namespace nimboost { namespace mpi { namespace detail {
...
public:
    ...
    {
      save_enum(t,nimboost::is_enum<T>());
    }
    ...
    void save_enum(T const& t, mpl::true_)
    {
      ...
      typedef typename nimboost::uint_t<8*sizeof(T)>::least int_type;
...
} } } // end namespace nimboost::mpi::detail

// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(nimboost::mpi::detail::mpi_datatype_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(nimboost::mpi::detail::ignore_skeleton_oarchive<nimboost::mpi::detail::mpi_datatype_oarchive>)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(nimboost::mpi::detail::mpi_datatype_oarchive)
