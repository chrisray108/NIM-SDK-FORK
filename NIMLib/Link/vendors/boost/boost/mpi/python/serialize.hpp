...
namespace nimboost { namespace python { namespace api {    \
...
namespace nimboost { namespace python { namespace detail {                 \
template<>                                                              \
...
namespace nimboost { namespace python {
...
namespace detail {
  ...
  {
  public:
    typedef nimboost::function3<void, OArchiver&, const object&, const unsigned int>
      saver_t;
    typedef nimboost::function3<void, IArchiver&, object&, const unsigned int>
      loader_t;
...
void 
save_impl(Archiver& ar, const nimboost::python::object& obj, 
          const unsigned int /*version*/,
          mpl::false_ /*has_direct_serialization*/)
{
  nimboost::python::str py_string = nimboost::python::pickle::dumps(obj);
  int len = nimboost::python::extract<int>(py_string.attr("__len__")());
  const char* string = nimboost::python::extract<const char*>(py_string);
  ar << len << nimboost::serialization::make_array(string, len);
}
...
template<typename Archiver>
void 
load_impl(Archiver& ar, nimboost::python::object& obj, 
          const unsigned int /*version*/, 
          mpl::false_ /*has_direct_serialization*/)
{
  int len;
  ...
  ar >> nimboost::serialization::make_array(string.get(), len);
  nimboost::python::str py_string(string.get(), len);
  obj = nimboost::python::pickle::loads(py_string);
}
...
template<typename Archiver>
void 
save(Archiver& ar, const nimboost::python::object& obj, 
     const unsigned int version)
{
  typedef Archiver OArchiver;
  typedef typename input_archiver<OArchiver>::type IArchiver;
...
template<typename Archiver>
void 
load(Archiver& ar, nimboost::python::object& obj, 
     const unsigned int version)
{
  typedef Archiver IArchiver;
  typedef typename output_archiver<IArchiver>::type OArchiver;
...
inline void 
serialize(Archive& ar, nimboost::python::object& obj, const unsigned int version)
{
  nimboost::serialization::split_free(ar, obj, version);
}

} } // end namespace nimboost::python
...
BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE(
  ::nimboost::mpi::packed_iarchive,
  ::nimboost::mpi::packed_oarchive)

namespace nimboost { namespace mpi { namespace python {

template<typename T>
void
register_serialized(const T& value, PyTypeObject* type)
{
  using nimboost::python::register_serialized;
  register_serialized<packed_iarchive, packed_oarchive>(value, type);
}

} } } // end namespace nimboost::mpi::python
