 ...
 */
class content : public nimboost::mpi::content
{
  typedef nimboost::mpi::content inherited;

 public:
  content(const inherited& base, nimboost::python::object object) 
    : inherited(base), object(object) { }

  inherited&       base()       { return *this; }
  const inherited& base() const { return *this; }

  nimboost::python::object object;
};
...
{
public:
  skeleton_proxy_base(const nimboost::python::object& object) : object(object) { }
...
{
 public:
  skeleton_proxy(const nimboost::python::object& object) 
    : skeleton_proxy_base(object) { }
};

namespace detail {
  using nimboost::python::object;
  using nimboost::python::extract;
   
  extern BOOST_MPI_DECL nimboost::python::object skeleton_proxy_base_type;
  ...
  struct do_get_content
  {
    content operator()(object value_obj) {
      ...
      return content(nimboost::mpi::get_content(value), value_obj);
    }
  };
...
{
  using nimboost::python::detail::direct_serialization_table;
  using nimboost::python::detail::get_direct_serialization_table;
  using namespace nimboost::python;
  ...
  {
    nimboost::python::scope proxy_scope(detail::skeleton_proxy_base_type);
