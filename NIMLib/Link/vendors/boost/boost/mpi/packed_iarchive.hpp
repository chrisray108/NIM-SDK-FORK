...
public:
  ...
  packed_iarchive(MPI_Comm const & comm, buffer_type & b, unsigned int flags = nimboost::archive::no_header, int position = 0)
...
BOOST_BROKEN_COMPILER_TYPE_TRAITS_SPECIALIZATION(nimboost::mpi::packed_iarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(nimboost::mpi::packed_iarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(nimboost::mpi::packed_iarchive)
