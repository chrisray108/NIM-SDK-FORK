   ...
   /// @endcond
{
   ...
   {  return static_cast<splaytree_impl&>(tree_type::operator=(::nimboost::move(static_cast<tree_type&>(x)))); }
      ...
      >::type
{
   ...
   {  return static_cast<splaytree &>(this->Base::operator=(::nimboost::move(static_cast<Base&>(x))));  }
