...
struct pointer_traits
{
      ...
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT
         ( nimboost::intrusive::detail::, Ptr, element_type
         , nimboost::intrusive::detail::first_param<Ptr>)                        element_type;
      //
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
         (nimboost::intrusive::detail::, Ptr, difference_type, std::ptrdiff_t)   difference_type;
      //
      typedef typename nimboost::intrusive::detail::unvoid_ref<element_type>::type  reference;
      //
      template <class U> struct rebind_pointer
      {
         typedef typename nimboost::intrusive::detail::type_rebinder<Ptr, U>::type  type;
      };

      #if !defined(BOOST_NO_CXX11_TEMPLATE_ALIASES)
         template <class U> using rebind = typename nimboost::intrusive::detail::type_rebinder<Ptr, U>::type;
      #endif
   ...
   static pointer pointer_to(reference r)
   {
      ...
      const bool value = nimboost::intrusive::detail::
         has_member_function_callable_with_pointer_to
            <Ptr, typename nimboost::intrusive::detail::unvoid<element_type &>::type>::value;
   ...
   //priv_pointer_to
   static pointer priv_pointer_to(nimboost::true_type, typename nimboost::intrusive::detail::unvoid<element_type>::type& r)
      { return Ptr::pointer_to(r); }

   static pointer priv_pointer_to(nimboost::false_type, typename nimboost::intrusive::detail::unvoid<element_type>::type& r)
      { return pointer(nimboost::intrusive::detail::addressof(r)); }

   //priv_static_cast_from
   template<class UPtr>
   static pointer priv_static_cast_from(nimboost::true_type, const UPtr &uptr)
   { return Ptr::static_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_static_cast_from(nimboost::false_type, const UPtr &uptr)
   {  return pointer_to(*static_cast<element_type*>(to_raw_pointer(uptr)));  }

   //priv_const_cast_from
   template<class UPtr>
   static pointer priv_const_cast_from(nimboost::true_type, const UPtr &uptr)
   { return Ptr::const_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_const_cast_from(nimboost::false_type, const UPtr &uptr)
   {  return pointer_to(const_cast<element_type&>(*uptr));  }

   //priv_dynamic_cast_from
   template<class UPtr>
   static pointer priv_dynamic_cast_from(nimboost::true_type, const UPtr &uptr)
   { return Ptr::dynamic_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_dynamic_cast_from(nimboost::false_type, const UPtr &uptr)
...
struct pointer_traits<T*>
{
   ...
   //!
   static pointer pointer_to(reference r)
   { return nimboost::intrusive::detail::addressof(r); }
