...
struct get_slist_impl
{
   ...
   struct type : make_slist
      ...
      , nimboost::intrusive::value_traits<trivial_traits>
      , nimboost::intrusive::constant_time_size<false>
	  , nimboost::intrusive::size_type<typename nimboost::make_unsigned
         ...
         >
{
   ...
   {
      return nimboost::intrusive::detail::to_raw_pointer(this->priv_real_value_traits().to_value_ptr
   ...
   void increment()
   {
      ...
      bucket_type* const buckets = nimboost::intrusive::detail::to_raw_pointer(rbuck_traits.bucket_begin());
