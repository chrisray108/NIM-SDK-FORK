...
struct alpha_holder
{
   typedef nimboost::intrusive::detail::h_alpha_t           h_alpha_t;
   typedef nimboost::intrusive::detail::alpha_by_max_size_t multiply_by_alpha_t;
...
struct alpha_holder<false, SizeType>
{
   ...
   typedef nimboost::intrusive::detail::h_alpha_sqrt2_t           h_alpha_t;
   typedef nimboost::intrusive::detail::alpha_0_75_by_max_size_t  multiply_by_alpha_t;
   ...
   /// @endcond
{
   ...
   //! @copydoc ::nimboost::intrusive::bstree::bstree(const value_compare &,const value_traits &)
   explicit sgtree_impl( const value_compare &cmp = value_compare()
                       , const value_traits &v_traits = value_traits())
      :  tree_type(cmp, v_traits)
   {}

   //! @copydoc ::nimboost::intrusive::bstree::bstree(bool,Iterator,Iterator,const value_compare &,const value_traits &)
   ...
   //! @copydoc ::nimboost::intrusive::bstree::bstree(bstree &&)
   sgtree_impl(BOOST_RV_REF(sgtree_impl) x)
      :  tree_type(::nimboost::move(static_cast<tree_type&>(x))), alpha_traits(x.get_alpha_traits())
   {  std::swap(this->get_alpha_traits(), x.get_alpha_traits());   }

   //! @copydoc ::nimboost::intrusive::bstree::operator=(bstree &&)
   sgtree_impl& operator=(BOOST_RV_REF(sgtree_impl) x)
   {
      this->get_alpha_traits() = x.get_alpha_traits();
      return static_cast<sgtree_impl&>(tree_type::operator=(::nimboost::move(static_cast<tree_type&>(x))));
   }
   ...
   //! @copydoc ::nimboost::intrusive::bstree::~bstree()
   ~sgtree_impl();

   //! @copydoc ::nimboost::intrusive::bstree::begin()
   iterator begin();

   //! @copydoc ::nimboost::intrusive::bstree::begin()const
   const_iterator begin() const;

   //! @copydoc ::nimboost::intrusive::bstree::cbegin()const
   const_iterator cbegin() const;

   //! @copydoc ::nimboost::intrusive::bstree::end()
   iterator end();

   //! @copydoc ::nimboost::intrusive::bstree::end()const
   const_iterator end() const;

   //! @copydoc ::nimboost::intrusive::bstree::cend()const
   const_iterator cend() const;

   //! @copydoc ::nimboost::intrusive::bstree::rbegin()
   reverse_iterator rbegin();

   //! @copydoc ::nimboost::intrusive::bstree::rbegin()const
   const_reverse_iterator rbegin() const;

   //! @copydoc ::nimboost::intrusive::bstree::crbegin()const
   const_reverse_iterator crbegin() const;

   //! @copydoc ::nimboost::intrusive::bstree::rend()
   reverse_iterator rend();

   //! @copydoc ::nimboost::intrusive::bstree::rend()const
   const_reverse_iterator rend() const;

   //! @copydoc ::nimboost::intrusive::bstree::crend()const
   const_reverse_iterator crend() const;

   //! @copydoc ::nimboost::intrusive::bstree::container_from_end_iterator(iterator)
   static sgtree_impl &container_from_end_iterator(iterator end_iterator);

   //! @copydoc ::nimboost::intrusive::bstree::container_from_end_iterator(const_iterator)
   static const sgtree_impl &container_from_end_iterator(const_iterator end_iterator);

   //! @copydoc ::nimboost::intrusive::bstree::container_from_iterator(iterator)
   static sgtree_impl &container_from_iterator(iterator it);

   //! @copydoc ::nimboost::intrusive::bstree::container_from_iterator(const_iterator)
   static const sgtree_impl &container_from_iterator(const_iterator it);

   //! @copydoc ::nimboost::intrusive::bstree::key_comp()const
   key_compare key_comp() const;

   //! @copydoc ::nimboost::intrusive::bstree::value_comp()const
   value_compare value_comp() const;

   //! @copydoc ::nimboost::intrusive::bstree::empty()const
   bool empty() const;

   //! @copydoc ::nimboost::intrusive::bstree::size()const
   size_type size() const;

   #endif   //#ifdef BOOST_INTRUSIVE_DOXYGEN_INVOKED

   //! @copydoc ::nimboost::intrusive::bstree::swap
   ...
   //! @copydoc ::nimboost::intrusive::bstree::clone_from
   ...
   //! @copydoc ::nimboost::intrusive::bstree::insert_equal(reference)
   ...
   //! @copydoc ::nimboost::intrusive::bstree::insert_equal(const_iterator,reference)
   ...
   //! @copydoc ::nimboost::intrusive::bstree::insert_equal(Iterator,Iterator)
   template<class Iterator>
   ...
   //! @copydoc ::nimboost::intrusive::bstree::insert_unique(reference)
   ...
   //! @copydoc ::nimboost::intrusive::bstree::insert_unique(const_iterator,reference)
   ...
   //! @copydoc ::nimboost::intrusive::bstree::insert_unique_check(const KeyType&,KeyValueCompare,insert_commit_data&)
   ...
   //! @copydoc ::nimboost::intrusive::bstree::insert_unique_check(const_iterator,const KeyType&,KeyValueCompare,insert_commit_data&)
   template<class KeyType, class KeyValueCompare>
   std::pair<iterator, bool> insert_unique_check
   ...
   //! @copydoc ::nimboost::intrusive::bstree::insert_unique_commit
   ...
   //! @copydoc ::nimboost::intrusive::bstree::insert_unique(Iterator,Iterator)
   template<class Iterator>
   ...
   //! @copydoc ::nimboost::intrusive::bstree::insert_before
   ...
   //! @copydoc ::nimboost::intrusive::bstree::push_back
   ...
   //! @copydoc ::nimboost::intrusive::bstree::push_front
   ...
   //! @copydoc ::nimboost::intrusive::bstree::erase(const_iterator)
   ...
   //! @copydoc ::nimboost::intrusive::bstree::erase(const_iterator,const_iterator)
   iterator erase(const_iterator b, const_iterator e)
   {  size_type n;   return private_erase(b, e, n);   }

   //! @copydoc ::nimboost::intrusive::bstree::erase(const_reference)
   size_type erase(const_reference value)
   {  return this->erase(value, this->value_comp());   }

   //! @copydoc ::nimboost::intrusive::bstree::erase(const KeyType&,KeyValueCompare)
   template<class KeyType, class KeyValueCompare>
   ...
   //! @copydoc ::nimboost::intrusive::bstree::erase_and_dispose(const_iterator,Disposer)
   ...
   //! @copydoc ::nimboost::intrusive::bstree::erase_and_dispose(const_iterator,const_iterator,Disposer)
   template<class Disposer>
   iterator erase_and_dispose(const_iterator b, const_iterator e, Disposer disposer)
   {  size_type n;   return private_erase(b, e, n, disposer);   }

   //! @copydoc ::nimboost::intrusive::bstree::erase_and_dispose(const_reference, Disposer)
   template<class Disposer>
   ...
   //! @copydoc ::nimboost::intrusive::bstree::erase_and_dispose(const KeyType&,KeyValueCompare,Disposer)
   ...
   //! @copydoc ::nimboost::intrusive::bstree::clear
   void clear()
   {
      tree_type::clear();
   ...
   //! @copydoc ::nimboost::intrusive::bstree::clear_and_dispose
   template<class Disposer>
   ...
   #ifdef BOOST_INTRUSIVE_DOXYGEN_INVOKED
   //! @copydoc ::nimboost::intrusive::bstree::count(const_reference)const
   size_type count(const_reference value) const;

   //! @copydoc ::nimboost::intrusive::bstree::count(const KeyType&,KeyValueCompare)const
   template<class KeyType, class KeyValueCompare>
   size_type count(const KeyType& key, KeyValueCompare comp) const;
   
   //! @copydoc ::nimboost::intrusive::bstree::lower_bound(const_reference)
   iterator lower_bound(const_reference value);
   
   //! @copydoc ::nimboost::intrusive::bstree::lower_bound(const KeyType&,KeyValueCompare)
   template<class KeyType, class KeyValueCompare>
   iterator lower_bound(const KeyType& key, KeyValueCompare comp);

   //! @copydoc ::nimboost::intrusive::bstree::lower_bound(const_reference)const
   const_iterator lower_bound(const_reference value) const;

   //! @copydoc ::nimboost::intrusive::bstree::lower_bound(const KeyType&,KeyValueCompare)const
   template<class KeyType, class KeyValueCompare>
   const_iterator lower_bound(const KeyType& key, KeyValueCompare comp) const;

   //! @copydoc ::nimboost::intrusive::bstree::upper_bound(const_reference)
   iterator upper_bound(const_reference value);

   //! @copydoc ::nimboost::intrusive::bstree::upper_bound(const KeyType&,KeyValueCompare)
   template<class KeyType, class KeyValueCompare>
   iterator upper_bound(const KeyType& key, KeyValueCompare comp);

   //! @copydoc ::nimboost::intrusive::bstree::upper_bound(const_reference)const
   const_iterator upper_bound(const_reference value) const;

   //! @copydoc ::nimboost::intrusive::bstree::upper_bound(const KeyType&,KeyValueCompare)const
   template<class KeyType, class KeyValueCompare>
   const_iterator upper_bound(const KeyType& key, KeyValueCompare comp) const;

   //! @copydoc ::nimboost::intrusive::bstree::find(const_reference)
   iterator find(const_reference value);

   //! @copydoc ::nimboost::intrusive::bstree::find(const KeyType&,KeyValueCompare)
   template<class KeyType, class KeyValueCompare>
   iterator find(const KeyType& key, KeyValueCompare comp);

   //! @copydoc ::nimboost::intrusive::bstree::find(const_reference)const
   const_iterator find(const_reference value) const;

   //! @copydoc ::nimboost::intrusive::bstree::find(const KeyType&,KeyValueCompare)const
   template<class KeyType, class KeyValueCompare>
   const_iterator find(const KeyType& key, KeyValueCompare comp) const;

   //! @copydoc ::nimboost::intrusive::bstree::equal_range(const_reference)
   std::pair<iterator,iterator> equal_range(const_reference value);

   //! @copydoc ::nimboost::intrusive::bstree::equal_range(const KeyType&,KeyValueCompare)
   template<class KeyType, class KeyValueCompare>
   std::pair<iterator,iterator> equal_range(const KeyType& key, KeyValueCompare comp);

   //! @copydoc ::nimboost::intrusive::bstree::equal_range(const_reference)const
   std::pair<const_iterator, const_iterator>
      equal_range(const_reference value) const;

   //! @copydoc ::nimboost::intrusive::bstree::equal_range(const KeyType&,KeyValueCompare)const
   template<class KeyType, class KeyValueCompare>
   std::pair<const_iterator, const_iterator>
      equal_range(const KeyType& key, KeyValueCompare comp) const;

   //! @copydoc ::nimboost::intrusive::bstree::bounded_range(const_reference,const_reference,bool,bool)
   std::pair<iterator,iterator> bounded_range
      (const_reference lower_value, const_reference upper_value, bool left_closed, bool right_closed);

   //! @copydoc ::nimboost::intrusive::bstree::bounded_range(const KeyType&,const KeyType&,KeyValueCompare,bool,bool)
   template<class KeyType, class KeyValueCompare>
   std::pair<iterator,iterator> bounded_range
      (const KeyType& lower_key, const KeyType& upper_key, KeyValueCompare comp, bool left_closed, bool right_closed);

   //! @copydoc ::nimboost::intrusive::bstree::bounded_range(const_reference,const_reference,bool,bool)const
   std::pair<const_iterator, const_iterator>
      bounded_range(const_reference lower_value, const_reference upper_value, bool left_closed, bool right_closed) const;

   //! @copydoc ::nimboost::intrusive::bstree::bounded_range(const KeyType&,const KeyType&,KeyValueCompare,bool,bool)const
   template<class KeyType, class KeyValueCompare>
   std::pair<const_iterator, const_iterator> bounded_range
         (const KeyType& lower_key, const KeyType& upper_key, KeyValueCompare comp, bool left_closed, bool right_closed) const;

   //! @copydoc ::nimboost::intrusive::bstree::s_iterator_to(reference)
   static iterator s_iterator_to(reference value);

   //! @copydoc ::nimboost::intrusive::bstree::s_iterator_to(const_reference)
   static const_iterator s_iterator_to(const_reference value);

   //! @copydoc ::nimboost::intrusive::bstree::iterator_to(reference)
   iterator iterator_to(reference value);

   //! @copydoc ::nimboost::intrusive::bstree::iterator_to(const_reference)const
   const_iterator iterator_to(const_reference value) const;

   //! @copydoc ::nimboost::intrusive::bstree::init_node(reference)
   static void init_node(reference value);

   //! @copydoc ::nimboost::intrusive::bstree::unlink_leftmost_without_rebalance
   pointer unlink_leftmost_without_rebalance();

   //! @copydoc ::nimboost::intrusive::bstree::replace_node
   void replace_node(iterator replace_this, reference with_this);

   //! @copydoc ::nimboost::intrusive::bstree::remove_node
   void remove_node(reference value);

   //! @copydoc ::nimboost::intrusive::bstree::rebalance
   void rebalance();

   //! @copydoc ::nimboost::intrusive::bstree::rebalance_subtree
      ...
      >::type
{
   ...
   {  return static_cast<sgtree &>(this->Base::operator=(::nimboost::move(static_cast<Base&>(x))));  }
