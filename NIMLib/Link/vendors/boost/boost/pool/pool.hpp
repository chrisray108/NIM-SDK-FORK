...
// nimboost::simple_segregated_storage
#include <boost/pool/simple_segregated_storage.hpp>
// nimboost::alignment_of
...
class pool: protected simple_segregated_storage < typename UserAllocator::size_type >
{
  ...
  private:
    BOOST_STATIC_CONSTANT(size_type, min_alloc_size =
        (::nimboost::math::static_lcm<sizeof(void *), sizeof(size_type)>::value) );
    BOOST_STATIC_CONSTANT(size_type, min_align =
        (::nimboost::math::static_lcm< ::nimboost::alignment_of<void *>::value, ::nimboost::alignment_of<size_type>::value>::value) );
