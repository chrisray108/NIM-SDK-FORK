...
struct archive_input_hash_map
{
    inline void operator()(
        ...
        ar >> nimboost::serialization::make_nvp("item", t.reference());
...
inline void save(
    ...
    nimboost::serialization::stl::save_hash_collection<
        Archive, 
...
inline void load(
    ...
    nimboost::serialization::stl::load_hash_collection<
        Archive,
        BOOST_STD_EXTENSION_NAMESPACE::hash_map<
            Key, HashFcn, EqualKey, Allocator
        >,
        nimboost::serialization::stl::archive_input_hash_map<
            Archive, 
            BOOST_STD_EXTENSION_NAMESPACE::hash_map<
                Key, HashFcn, EqualKey, Allocator
            >
...
inline void load(
    ...
    nimboost::serialization::stl::load_hash_collection<
        ...
        BOOST_STD_EXTENSION_NAMESPACE::hash_multimap<
            Key, HashFcn, EqualKey, Allocator
        >,
        nimboost::serialization::stl::archive_input_hash_multimap<
            Archive, 
            BOOST_STD_EXTENSION_NAMESPACE::hash_multimap<
                Key, HashFcn, EqualKey, Allocator
            >
