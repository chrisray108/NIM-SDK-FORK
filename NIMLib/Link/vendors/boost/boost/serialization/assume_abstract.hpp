...
// this is useful for compilers which don't support the nimboost::is_abstract
...
namespace serialization {
    template<class T>
    struct is_abstract : nimboost::is_abstract< T > {} ;
} // namespace serialization
} // namespace nimboost
...
namespace serialization {
    template<class T>
    struct is_abstract : nimboost::false_type {};
} // namespace serialization
} // namespace nimboost
...
namespace serialization {                             \
template<>                                            \
struct is_abstract< T > : nimboost::true_type {};        \
template<>                                            \
struct is_abstract< const T > : nimboost::true_type {};  \
}}                                                    \
/**/
