...
inline void save_hash_collection(Archive & ar, const Container &s)
{
    ...
    if(nimboost::archive::library_version_type(6) != library_version){
    ...
    while(count-- > 0){
        ...
        nimboost::serialization::save_construct_data_adl(
            ar, 
            &(*it), 
            nimboost::serialization::version<
                BOOST_DEDUCED_TYPENAME Container::value_type
            >::value
        );
        ar << nimboost::serialization::make_nvp("item", *it++);
    }
}
