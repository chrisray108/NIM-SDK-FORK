...
struct static_warning_test{
    typename nimboost::mpl::eval_if_c<
        B,
        nimboost::mpl::true_,
        typename nimboost::mpl::identity<
            nimboost::mpl::print<
...
#define BOOST_SERIALIZATION_BSW(B, L) \
    typedef nimboost::serialization::BOOST_SERIALIZATION_SS< \
        sizeof( nimboost::serialization::static_warning_test< B, L > ) \
