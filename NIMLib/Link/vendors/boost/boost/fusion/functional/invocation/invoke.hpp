...
namespace nimboost { namespace fusion
{
    ...
    namespace detail
    {
        ...
        // use same implementation as for function objects but...
            : invoke_fn_ptr< // ...work around nimboost::result_of bugs
                typename mpl::eval_if< ft::is_function<F>,
                    nimboost::add_reference<F>, nimboost::remove_cv<F> >::type,
        ...
        private:
            ...
            typedef mpl::or_< nimboost::is_convertible<that,C*>,
                              nimboost::is_convertible<that,C&>,
        ...
        public:
            ...
            typedef typename nimboost::add_reference<qualified_type>::type
                result_type;
    ...
    namespace result_of
    {
        template <typename Function, class Sequence> struct invoke
        {
            typedef typename detail::invoke_impl<
                typename nimboost::remove_reference<Function>::type, Sequence
              >::result_type type;
        };
    }
    ...
    {
        return detail::invoke_impl<
                typename nimboost::remove_reference<Function>::type,Sequence const
            >::call(f,s);
    }
