...
namespace nimboost 
{
    ...
    struct result_of< nimboost::fusion::unfused_typed<F,Seq> const () >
        : nimboost::fusion::unfused_typed<F,Seq>::template result< 
            nimboost::fusion::unfused_typed<F,Seq> const () >
    { };
    template<class F, class Seq>
    struct result_of< nimboost::fusion::unfused_typed<F,Seq>() >
        : nimboost::fusion::unfused_typed<F,Seq>::template result< 
            nimboost::fusion::unfused_typed<F,Seq> () >
    { };
#endif
    template<class F, class Seq>
    struct tr1_result_of< nimboost::fusion::unfused_typed<F,Seq> const () >
        : nimboost::fusion::unfused_typed<F,Seq>::template result< 
            nimboost::fusion::unfused_typed<F,Seq> const () >
    { };
    template<class F, class Seq>
    struct tr1_result_of< nimboost::fusion::unfused_typed<F,Seq>() >
        : nimboost::fusion::unfused_typed<F,Seq>::template result< 
            nimboost::fusion::unfused_typed<F,Seq> () >
    { };
}
...
#define M(z,i,s)                                                                \
    typename call_param<typename result_of::value_at_c<s,i>::type>::type a##i
            ...
            inline typename nimboost::result_of< 
...
#undef M
            ...
            struct result< Self const (BOOST_PP_ENUM_PARAMS(N,T)) >
                : nimboost::result_of< function_c(arg_vector_t &) > 
            { };

            template <class Self BOOST_PP_ENUM_TRAILING_PARAMS(N,typename T)>
            struct result< Self (BOOST_PP_ENUM_PARAMS(N,T)) >
                : nimboost::result_of< function(arg_vector_t &) >
            { };
        };
