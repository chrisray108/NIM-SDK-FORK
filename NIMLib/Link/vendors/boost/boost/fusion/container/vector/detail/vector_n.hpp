...
#define N BOOST_PP_ITERATION()
    ...
    struct BOOST_PP_CAT(vector_data, N)
    {
        ...
        BOOST_PP_CAT(vector_data, N)(BOOST_PP_ENUM_BINARY_PARAMS(N, U, && _)
          , typename nimboost::enable_if<is_convertible<U0, T0> >::type* /*dummy*/ = 0
        )
    ...
    template <BOOST_PP_ENUM_PARAMS(N, typename U)>
        ...
        BOOST_PP_CAT(vector, N)(
            Sequence const& seq
#if (N == 1)
          , typename nimboost::disable_if<is_convertible<Sequence, T0> >::type* /*dummy*/ = 0
#endif
            )
        ...
        template <typename Sequence>
        typename nimboost::disable_if<is_convertible<Sequence, T0>, this_type&>::type
