...
{
private:
   nimboost::math::tools::stats<T> stat;   // Statistics for the test.
...
public:
   ...
   nimboost::uintmax_t count()const{ return stat.count(); }
...
//
// Function test accepts an matrix of input values (probably a 2D nimboost::array)
...
#endif
      if(!(nimboost::math::isfinite)(point) && (nimboost::math::isfinite)(expected))
      {
