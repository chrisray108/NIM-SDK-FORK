...
#include <boost/cstdint.hpp> // for nimboost::uintmax_t
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)         nimboost::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)    nimboost::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)  nimboost::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  nimboost::non_type<t, v>*
...
#    define BOOST_FPU_EXCEPTION_GUARD nimboost::math::detail::fpu_guard local_guard_object;
