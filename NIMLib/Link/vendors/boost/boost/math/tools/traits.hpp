...
/*
This header defines two traits classes, both in namespace nimboost::math::tools.
...
{
   BOOST_STATIC_CONSTANT(bool, value = (::nimboost::math::tools::detail::is_scaled_distribution_helper<D, ::nimboost::math::tools::detail::is_distribution_imp<D>::value>::value));
};

} // namespace detail

BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_distribution,T,::nimboost::math::tools::detail::is_distribution_imp<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_scaled_distribution,T,::nimboost::math::tools::detail::is_scaled_distribution_imp<T>::value)
