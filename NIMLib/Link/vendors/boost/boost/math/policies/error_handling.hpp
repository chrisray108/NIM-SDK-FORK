...
void raise_error(const char* function, const char* message)
{
  ...
  msg += (nimboost::format(function) % typeid(T).name()).str();
  msg += ": ";
  msg += message;
...
void raise_error(const char* function, const char* message, const T& val)
{
  ...
  int prec = 2 + (nimboost::math::policies::digits<T, nimboost::math::policies::policy<> >() * 30103UL) / 100000UL;
  msg = do_format(nimboost::format(msg), nimboost::io::group(std::setprecision(prec), val));
...
inline T raise_domain_error(
           ...
           const char* message,
           const T& val,
           const ::nimboost::math::policies::domain_error< ::nimboost::math::policies::throw_on_error>&)
{
...
inline T raise_domain_error(
           ...
           const char* ,
           const T& ,
           const ::nimboost::math::policies::domain_error< ::nimboost::math::policies::ignore_error>&)
{
...
inline T raise_domain_error(
           ...
           const char* ,
           const T& ,
           const ::nimboost::math::policies::domain_error< ::nimboost::math::policies::errno_on_error>&)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
...
inline T raise_domain_error(
           ...
           const char* message,
           const T& val,
           const  ::nimboost::math::policies::domain_error< ::nimboost::math::policies::user_error>&)
{
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::nimboost::math::policies::pole_error< ::nimboost::math::policies::throw_on_error>&)
{
   return nimboost::math::policies::detail::raise_domain_error(function, message, val,  ::nimboost::math::policies::domain_error< ::nimboost::math::policies::throw_on_error>());
}
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::nimboost::math::policies::pole_error< ::nimboost::math::policies::ignore_error>&)
{
   return  ::nimboost::math::policies::detail::raise_domain_error(function, message, val,  ::nimboost::math::policies::domain_error< ::nimboost::math::policies::ignore_error>());
}
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::nimboost::math::policies::pole_error< ::nimboost::math::policies::errno_on_error>&)
{
   return  ::nimboost::math::policies::detail::raise_domain_error(function, message, val,  ::nimboost::math::policies::domain_error< ::nimboost::math::policies::errno_on_error>());
}
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::nimboost::math::policies::pole_error< ::nimboost::math::policies::user_error>&)
{
...
inline T raise_overflow_error(
           const char* function,
           const char* message,
           const  ::nimboost::math::policies::overflow_error< ::nimboost::math::policies::throw_on_error>&)
{
   raise_error<std::overflow_error, T>(function, message ? message : "numeric overflow");
   // We should never get here:
   return std::numeric_limits<T>::has_infinity ? std::numeric_limits<T>::infinity() : nimboost::math::tools::max_value<T>();
}
...
inline T raise_overflow_error(
           const char* ,
           const char* ,
           const  ::nimboost::math::policies::overflow_error< ::nimboost::math::policies::ignore_error>&)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return std::numeric_limits<T>::has_infinity ? std::numeric_limits<T>::infinity() : nimboost::math::tools::max_value<T>();
...
inline T raise_overflow_error(
           const char* ,
           const char* ,
           const  ::nimboost::math::policies::overflow_error< ::nimboost::math::policies::errno_on_error>&)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_overflow_error(
           const char* function,
           const char* message,
           const  ::nimboost::math::policies::overflow_error< ::nimboost::math::policies::user_error>&)
{
...
inline T raise_underflow_error(
           const char* function,
           const char* message,
           const  ::nimboost::math::policies::underflow_error< ::nimboost::math::policies::throw_on_error>&)
{
...
inline T raise_underflow_error(
           const char* ,
           const char* ,
           const  ::nimboost::math::policies::underflow_error< ::nimboost::math::policies::ignore_error>&)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return T(0);
...
inline T raise_underflow_error(
           const char* /* function */,
           const char* /* message */,
           const  ::nimboost::math::policies::underflow_error< ::nimboost::math::policies::errno_on_error>&)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_underflow_error(
           const char* function,
           const char* message,
           const  ::nimboost::math::policies::underflow_error< ::nimboost::math::policies::user_error>&)
{
...
inline T raise_denorm_error(
           ...
           const char* message,
           const T& /* val */,
           const  ::nimboost::math::policies::denorm_error< ::nimboost::math::policies::throw_on_error>&)
{
...
inline T raise_denorm_error(
           ...
           const char* ,
           const T&  val,
           const  ::nimboost::math::policies::denorm_error< ::nimboost::math::policies::ignore_error>&)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return val;
...
inline T raise_denorm_error(
           ...
           const char* ,
           const T& val,
           const  ::nimboost::math::policies::denorm_error< ::nimboost::math::policies::errno_on_error>&)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_denorm_error(
           ...
           const char* message,
           const T& val,
           const  ::nimboost::math::policies::denorm_error< ::nimboost::math::policies::user_error>&)
{
...
inline T raise_evaluation_error(
           ...
           const char* message,
           const T& val,
           const  ::nimboost::math::policies::evaluation_error< ::nimboost::math::policies::throw_on_error>&)
{
   raise_error<nimboost::math::evaluation_error, T>(function, message, val);
   // we never get here:
   return T(0);
}
...
inline T raise_evaluation_error(
           ...
           const char* ,
           const T& val,
           const  ::nimboost::math::policies::evaluation_error< ::nimboost::math::policies::ignore_error>&)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return val;
...
inline T raise_evaluation_error(
           ...
           const char* ,
           const T& val,
           const  ::nimboost::math::policies::evaluation_error< ::nimboost::math::policies::errno_on_error>&)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_evaluation_error(
           ...
           const char* message,
           const T& val,
           const  ::nimboost::math::policies::evaluation_error< ::nimboost::math::policies::user_error>&)
{
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::nimboost::math::policies::rounding_error< ::nimboost::math::policies::throw_on_error>&)
{
   raise_error<nimboost::math::rounding_error, T>(function, message, val);
   // we never get here:
   return TargetType(0);
}
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::nimboost::math::policies::rounding_error< ::nimboost::math::policies::ignore_error>&)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::nimboost::math::policies::rounding_error< ::nimboost::math::policies::errno_on_error>&)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType& t,
           const  ::nimboost::math::policies::rounding_error< ::nimboost::math::policies::user_error>&)
{
...
inline T raise_indeterminate_result_error(
           ...
           const T& val,
           const R& ,
           const ::nimboost::math::policies::indeterminate_result_error< ::nimboost::math::policies::throw_on_error>&)
{
   raise_error<std::domain_error, T>(function, message, val);
   // we never get here:
   return std::numeric_limits<T>::quiet_NaN();
...
inline T raise_indeterminate_result_error(
           ...
           const T& ,
           const R& result,
           const ::nimboost::math::policies::indeterminate_result_error< ::nimboost::math::policies::ignore_error>&)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return result;
...
inline T raise_indeterminate_result_error(
           ...
           const T& ,
           const R& result,
           const ::nimboost::math::policies::indeterminate_result_error< ::nimboost::math::policies::errno_on_error>&)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_indeterminate_result_error(
           ...
           const T& val,
           const R& ,
           const ::nimboost::math::policies::indeterminate_result_error< ::nimboost::math::policies::user_error>&)
{
...
inline bool check_overflow(T val, R* result, const char* function, const Policy& pol)
{
   ...
   {
      *result = static_cast<R>(nimboost::math::policies::detail::raise_overflow_error<R>(function, 0, pol));
      return true;
   }
   return false;
}
...
inline bool check_underflow(T val, R* result, const char* function, const Policy& pol)
{
   ...
   {
      *result = static_cast<R>(nimboost::math::policies::detail::raise_underflow_error<R>(function, 0, pol));
      return true;
   }
   return false;
}
...
inline bool check_denorm(T val, R* result, const char* function, const Policy& pol)
{
   ...
   {
      *result = static_cast<R>(nimboost::math::policies::detail::raise_denorm_error<R>(function, 0, static_cast<R>(val), pol));
      return true;
   }
   return false;
}
...
template <class T, class Policy>
inline void check_series_iterations(const char* function, nimboost::uintmax_t max_iter, const Policy& pol)
{
...
template <class T, class Policy>
inline void check_root_iterations(const char* function, nimboost::uintmax_t max_iter, const Policy& pol)
{
