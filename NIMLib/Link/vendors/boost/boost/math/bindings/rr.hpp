...
public:
   ...
   RR(nimboost::ulong_long_type c)
   {
      assign_large_int(c);
   }
   RR(nimboost::long_long_type c)
   {
      assign_large_int(c);
   }
#endif
...
#ifdef BOOST_HAS_LONG_LONG
   RR& operator=(nimboost::long_long_type c) { assign_large_int(c); return *this; }
   RR& operator=(nimboost::ulong_long_type c) { assign_large_int(c); return *this; }
#endif
...
template<>
inline int digits<nimboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(nimboost::math::ntl::RR))
{
   return ::NTL::RR::precision();
}

template <>
inline float real_cast<float, nimboost::math::ntl::RR>(nimboost::math::ntl::RR t)
{
   double r;
   conv(r, t.value());
...
template <>
inline double real_cast<double, nimboost::math::ntl::RR>(nimboost::math::ntl::RR t)
{
   double r;
   conv(r, t.value());
   return r;
...
template <>
inline long double real_cast<long double, nimboost::math::ntl::RR>(nimboost::math::ntl::RR t)
{
...
template <>
inline nimboost::math::ntl::RR real_cast<nimboost::math::ntl::RR, nimboost::math::ntl::RR>(nimboost::math::ntl::RR t)
{
   return t;
}
template <>
inline unsigned real_cast<unsigned, nimboost::math::ntl::RR>(nimboost::math::ntl::RR t)
{
   unsigned result;
   detail::convert_to_long_result(t.value(), result);
   return result;
...
template <>
inline int real_cast<int, nimboost::math::ntl::RR>(nimboost::math::ntl::RR t)
{
   int result;
   detail::convert_to_long_result(t.value(), result);
   return result;
...
template <>
inline long real_cast<long, nimboost::math::ntl::RR>(nimboost::math::ntl::RR t)
{
   long result;
   detail::convert_to_long_result(t.value(), result);
   return result;
...
template <>
inline long long real_cast<long long, nimboost::math::ntl::RR>(nimboost::math::ntl::RR t)
{
   long long result;
   detail::convert_to_long_result(t.value(), result);
   return result;
...
template <>
inline nimboost::math::ntl::RR max_value<nimboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(nimboost::math::ntl::RR))
{
...
template <>
inline nimboost::math::ntl::RR min_value<nimboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(nimboost::math::ntl::RR))
{
   static bool has_init = false;
   static NTL::RR val;
   if(!has_init)
...
template <>
inline nimboost::math::ntl::RR log_max_value<nimboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(nimboost::math::ntl::RR))
{
   static bool has_init = false;
   static NTL::RR val;
   if(!has_init)
...
template <>
inline nimboost::math::ntl::RR log_min_value<nimboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(nimboost::math::ntl::RR))
{
   static bool has_init = false;
   static NTL::RR val;
   if(!has_init)
...
template <>
inline nimboost::math::ntl::RR epsilon<nimboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(nimboost::math::ntl::RR))
{
   return ldexp(nimboost::math::ntl::RR(1), 1-nimboost::math::policies::digits<nimboost::math::ntl::RR, nimboost::math::policies::policy<> >());
}
...
template<> inline nimboost::math::ntl::RR pi<nimboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(nimboost::math::ntl::RR))
{
    NTL::RR result;
    ComputePi(result);
    return result;
}
template<> inline nimboost::math::ntl::RR e<nimboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(nimboost::math::ntl::RR))
{
    NTL::RR result;
    result = 1;
    return exp(result);
...
namespace ntl{
   ...
   struct asin_root
   {
      ...
      nimboost::math::tuple<RR, RR, RR> operator()(RR const& p)
      {
         RR f0 = sin(p);
         RR f1 = cos(p);
         RR f2 = -f0;
         f0 -= t;
         return nimboost::math::make_tuple(f0, f1, f2);
      }
   private:
      RR t;
   };
   ...
   inline RR asin(RR z)
   {
      double r;
      conv(r, z.value());
      return nimboost::math::tools::halley_iterate(
         asin_root(z), 
         RR(std::asin(r)), 
         RR(-nimboost::math::constants::pi<RR>()/2),
         RR(nimboost::math::constants::pi<RR>()/2),
         NTL::RR::precision());
   }
   ...
   inline RR atan(RR z)
   {
      ...
      return nimboost::math::tools::halley_iterate(
         atan_root(z), 
         RR(std::atan(r)), 
         -nimboost::math::constants::pi<RR>()/2,
         nimboost::math::constants::pi<RR>()/2,
         NTL::RR::precision());
   }
   ...
   inline RR atan2(RR y, RR x)
   {
      ...
      if(x < 0)
      {
         return y < 0 ? atan(y / x) - nimboost::math::constants::pi<RR>() : atan(y / x) + nimboost::math::constants::pi<RR>();
      }
      return y < 0 ? -nimboost::math::constants::half_pi<RR>() : nimboost::math::constants::half_pi<RR>() ;
   }
...
ntl::RR digamma_imp(ntl::RR x, const mpl::int_<0>* , const Policy& pol)
{
   ...
   if(x < 0)
   {
      ...
      if(remainder == 0)
      {
         return policies::raise_pole_error<ntl::RR>("nimboost::math::digamma<%1%>(%1%)", 0, (1-x), pol);
      }
