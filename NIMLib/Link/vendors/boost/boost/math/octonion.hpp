...
#define    BOOST_OCTONION_ACCESSOR_GENERATOR(type)                      \
            ...
            {                                                           \
                return(::std::complex<type>(g,h));                      \
                                                                        ...
                                                                        \
            ::nimboost::math::quaternion<type>    H_component_1() const    \
            {                                                           \
                return(::nimboost::math::quaternion<type>(a,b,c,d));       \
            }                                                           \
                                                                        \
            ::nimboost::math::quaternion<type>    H_component_2() const    \
            {                                                           \
                return(::nimboost::math::quaternion<type>(e,f,g,h));       \
            }
...
#define    BOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(type)                                         \
            ...
            {                                                                                       \
                ...
                return(*this);                                                                      \
                                                                                                    ...
                                                                                                    \
            octonion<type> &        operator = (::nimboost::math::quaternion<type> const & a_affecter) \
            {                                                                                       \
...
#define    BOOST_OCTONION_MEMBER_DATA_GENERATOR(type) \
        ...
        public:
            ...
            explicit                octonion(   ::nimboost::math::quaternion<T> const & q0,
                                                ::nimboost::math::quaternion<T> const & q1 = ::nimboost::math::quaternion<T>())
            :   a(q0.R_component_1()),
                b(q0.R_component_2()),
                c(q0.R_component_3()),
                d(q0.R_component_4()),
            ...
            octonion<T> &            operator += (::nimboost::math::quaternion<T> const & rhs)
            {
...
#define    BOOST_OCTONION_CONSTRUCTOR_GENERATOR(type)                                                                               \
            ...
            {                                                                                                                       \
                                                                                                                                    ...
                                                                                                                                    \
            explicit                    octonion(   ::nimboost::math::quaternion<type> const & q0,                                     \
                                                    ::nimboost::math::quaternion<type> const & q1 = ::nimboost::math::quaternion<type>()) \
            :   a(q0.R_component_1()),                                                                                              \
                b(q0.R_component_2()),                                                                                              \
                c(q0.R_component_3()),                                                                                              \
                d(q0.R_component_4()),                                                                                              \
...
#define    BOOST_OCTONION_MEMBER_ADD_GENERATOR_3(type)                                              \
            octonion<type> &            operator += (::nimboost::math::quaternion<type> const & rhs)   \
            {                                                                                       \
                a += rhs.R_component_1();                                                           \
                b += rhs.R_component_2();                                                           \
                c += rhs.R_component_3();                                                           \
...
#define    BOOST_OCTONION_OPERATOR_GENERATOR_3_L(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (::nimboost::math::quaternion<T> const & lhs, octonion<T> const & rhs) \
        BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
        
#define    BOOST_OCTONION_OPERATOR_GENERATOR_3_R(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (octonion<T> const & lhs, ::nimboost::math::quaternion<T> const & rhs) \
        BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
...
#undef    BOOST_OCTONION_OPERATOR_GENERATOR_BODY
        ...
        template<typename T>
        inline bool                                operator == (::nimboost::math::quaternion<T> const & lhs, octonion<T> const & rhs)
        {
            return(
        ...
        template<typename T>
        inline bool                                operator == (octonion<T> const & lhs, ::nimboost::math::quaternion<T> const & rhs)
        {
            return(
...
#define    BOOST_OCTONION_NOT_EQUAL_GENERATOR \
    ...
    #undef    BOOST_OCTONION_NOT_EQUAL_GENERATOR
...
#endif /* BOOST_WORKAROUND(__GNUC__, < 3) */
        {
            ...
            ::nimboost::math::quaternion<T>    p = ::nimboost::math::quaternion<T>();
            ::nimboost::math::quaternion<T>    q = ::nimboost::math::quaternion<T>();
                ...
                if    (cc == '(')                                // read "(("
                {
                    ...
                    if    (cc == '(')                                // read "((("
                    {
                        ...
                        if        (cc == ')')                        // read "((u)"
                        {
                            ...
                            {
                                p = ::nimboost::math::quaternion<T>(u);
                        ...
                        else if    (cc ==',')                        // read "((u,"
                        {
                            ...
                            if        (cc == ')')                        // read "((u,v)"
                            {
                                p = ::nimboost::math::quaternion<T>(u,v);
                            ...
                            else if    (cc == ',')                            // read "((a),"
                            {
                                ...
                                if        (cc == '(')                            // read "((a),("
                                {
                                    ...
                                    if        (cc == '(')                            // read "((a),(("
                                    {
                                        ...
                                        if        (cc == ')')                            // read "((a),q)"
                                        {
                                            p = ::nimboost::math::quaternion<T>(a);
                                    ...
                                    else                                        // read "((a),(c" or "((a),(e"
                                    {
                                        ...
                                        else if    (cc == ',')                            // read "((a),(c," or "((a),(e,"
                                        {
                                            ...
                                            if        (cc == '(')                        // read "((a),(e,(" (ambiguity resolution)
                                            {
                                                ...
                                                if        (cc == ')')                        // read "((a),(e,y)"
                                                {
                                                    q = ::nimboost::math::quaternion<T>(x,y);
                                            ...
                                            else                                    // read "((a),(c,d" or "((a),(e,f"
                                            {
                                                ...
                                                else if    (cc == ',')                        // read "((a),(e,f," (ambiguity resolution)
                                                {
                                                    ...
                                                    if        (cc == ')')                        // read "((a),(e,f,g)"
                                                    {
                                                        q = ::nimboost::math::quaternion<T>(c,d,g);        // "c" was actually "e", and "d" was actually "f"
                                                    ...
                                                    else if    (cc == ',')                        // read "((a),(e,f,g,"
                                                    {
                                                        ...
                                                        {
                                                            q = ::nimboost::math::quaternion<T>(c,d,g,h);    // "c" was actually "e", and "d" was actually "f"
                            ...
                            else
                            {
                                ...
                                if        (cc == ')')                            // read "((a,b)"
                                {
                                    ...
                                    else if    (cc == ',')                            // read "((a,b),"
                                    {
                                        ...
                                        if        (cc == '(')                            // read "((a,b),("
                                        {
                                            ...
                                            if        (cc == '(')                            // read "((a,b),(("
                                            {
                                                p = ::nimboost::math::quaternion<T>(a,b);
                                            ...
                                            else                                        // read "((a,b),(c" or "((a,b),(e"
                                            {
                                                ...
                                                else if    (cc == ',')                            // read "((a,b),(c," or "((a,b),(e,"
                                                {
                                                    ...
                                                    else                                        // read "((a,b),(c,d" or "((a,b),(e,f"
                                                    {
                                                        ...
                                                        {
                                                            p = ::nimboost::math::quaternion<T>(a,b);                // too late to backtrack
                                                            ...
                                                            if        (cc == ')')                            // read "((a,b),(e,f,g)"
                                                            {
                                                                ...
                                                                if        (cc == ')')                            // read "((a,b),(e,f,g))"
                                                                {
                                                                    q = ::nimboost::math::quaternion<T>(c,d,g);            // "c" is actually "e" and "d" is actually "f"
                                                            ...
                                                            else if    (cc == ',')                            // read "((a,b),(e,f,g,"
                                                            {
                                                                ...
                                                                if        (cc == ')')                            // read "((a,b),(e,f,g,h)"
                                                                {
                                                                    ...
                                                                    if        (cc == ')')                            // read ((a,b),(e,f,g,h))"
                                                                    {
                                                                        q = ::nimboost::math::quaternion<T>(c,d,g,h);            // "c" is actually "e" and "d" is actually "f"
                                ...
                                else if    (cc == ',')                            // read "((a,b,"
                                {
                                    ...
                                    if        (cc == ')')                            // read "((a,b,c)"
                                    {
                                        ...
                                        {
                                            p = ::nimboost::math::quaternion<T>(a,b,c);
                                    ...
                                    else if    (cc == ',')                            // read "((a,b,c,"
                                    {
                                        ...
                                        if        (cc == ')')                            // read "((a,b,c,d)"
                                        {
                                            ...
                                            {
                                                p = ::nimboost::math::quaternion<T>(a,b,c,d);
