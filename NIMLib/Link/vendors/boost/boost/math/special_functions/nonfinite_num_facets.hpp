    ...
    */
    ...
    private:
        ...
        CharType fill, ValType val) const
      {
        ...
        switch((nimboost::math::fpclassify)(val))
        {
        ...
        case FP_INFINITE:
          ...
          else if((nimboost::math::signbit)(val))
          { // negative infinity.
        ...
        case FP_ZERO:
          if((flags_ & signed_zero) && ((nimboost::math::signbit)(val)))
    ...
    private:
      ...
      ) const
      {
        ...
        if(negative)
        {
          val = (nimboost::math::changesign)(val);
        }
      } // void get_signed
