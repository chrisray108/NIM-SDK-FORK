   ...
   hermite(unsigned n, T x, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::hermite_imp(n, static_cast<value_type>(x)), "nimboost::math::hermite<%1%>(unsigned, %1%)");
}
...
{
   return nimboost::math::hermite(n, x, policies::policy<>());
}
