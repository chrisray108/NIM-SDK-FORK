...
{
   return (z == 0) ? 0 : (nimboost::math::signbit)(z) ? -1 : 1;
}
   ...
   copysign BOOST_NO_MACRO_EXPAND(const T& x, const U& y)
{
   ...
   return (nimboost::math::signbit)(static_cast<result_type>(x)) != (nimboost::math::signbit)(static_cast<result_type>(y)) 
      ? (nimboost::math::changesign)(static_cast<result_type>(x)) : static_cast<result_type>(x);
}
