...
//   test_spots(nimboost::math::concepts::real_concept(0.));
...
public:
   ...
   real_concept(nimboost::ulong_long_type c) : m_value(static_cast<real_concept_base_type>(c)){}
   real_concept(nimboost::long_long_type c) : m_value(static_cast<real_concept_base_type>(c)){}
   ...
   real_concept& operator=(nimboost::long_long_type c) { m_value = static_cast<real_concept_base_type>(c); return *this; }
   real_concept& operator=(nimboost::ulong_long_type c) { m_value = static_cast<real_concept_base_type>(c); return *this; }
#endif
...
#ifdef BOOST_HAS_LONG_LONG
template <class Policy>
inline nimboost::long_long_type llround(const concepts::real_concept& v, const Policy& pol)
{ return nimboost::math::llround(v.value(), pol); }
inline nimboost::long_long_type llround(const concepts::real_concept& v)
...
#ifdef BOOST_HAS_LONG_LONG
template <class Policy>
inline nimboost::long_long_type lltrunc(const concepts::real_concept& v, const Policy& pol)
{ return nimboost::math::lltrunc(v.value(), pol); }
inline nimboost::long_long_type lltrunc(const concepts::real_concept& v)
