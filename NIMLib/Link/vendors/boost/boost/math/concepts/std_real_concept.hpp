...
public:
   ...
   std_real_concept(nimboost::ulong_long_type c) : m_value(static_cast<std_real_concept_base_type>(c)){}
   std_real_concept(nimboost::long_long_type c) : m_value(static_cast<std_real_concept_base_type>(c)){}
#endif
...
#elif defined(BOOST_HAS_LONG_LONG)
   std_real_concept& operator=(nimboost::long_long_type c) { m_value = static_cast<std_real_concept_base_type>(c); return *this; }
   std_real_concept& operator=(nimboost::ulong_long_type c) { m_value = static_cast<std_real_concept_base_type>(c); return *this; }
#endif
...
inline nimboost::math::concepts::std_real_concept acos(nimboost::math::concepts::std_real_concept a)
{ return std::acos(a.value()); }
inline nimboost::math::concepts::std_real_concept cos(nimboost::math::concepts::std_real_concept a)
{ return std::cos(a.value()); }
inline nimboost::math::concepts::std_real_concept asin(nimboost::math::concepts::std_real_concept a)
{ return std::asin(a.value()); }
inline nimboost::math::concepts::std_real_concept atan(nimboost::math::concepts::std_real_concept a)
{ return std::atan(a.value()); }
inline nimboost::math::concepts::std_real_concept atan2(nimboost::math::concepts::std_real_concept a, nimboost::math::concepts::std_real_concept b)
{ return std::atan2(a.value(), b.value()); }
inline nimboost::math::concepts::std_real_concept ceil(nimboost::math::concepts::std_real_concept a)
{ return std::ceil(a.value()); }
#ifndef BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS
inline nimboost::math::concepts::std_real_concept fmod(nimboost::math::concepts::std_real_concept a, nimboost::math::concepts::std_real_concept b)
{ return fmodl(a.value(), b.value()); }
#else
inline nimboost::math::concepts::std_real_concept fmod(nimboost::math::concepts::std_real_concept a, nimboost::math::concepts::std_real_concept b)
{ return std::fmod(a.value(), b.value()); }
#endif
inline nimboost::math::concepts::std_real_concept cosh(nimboost::math::concepts::std_real_concept a)
{ return std::cosh(a.value()); }
inline nimboost::math::concepts::std_real_concept exp(nimboost::math::concepts::std_real_concept a)
{ return std::exp(a.value()); }
inline nimboost::math::concepts::std_real_concept fabs(nimboost::math::concepts::std_real_concept a)
{ return std::fabs(a.value()); }
inline nimboost::math::concepts::std_real_concept abs(nimboost::math::concepts::std_real_concept a)
{ return std::abs(a.value()); }
inline nimboost::math::concepts::std_real_concept floor(nimboost::math::concepts::std_real_concept a)
{ return std::floor(a.value()); }
inline nimboost::math::concepts::std_real_concept modf(nimboost::math::concepts::std_real_concept a, nimboost::math::concepts::std_real_concept* ipart)
{
   nimboost::math::concepts::std_real_concept_base_type ip;
   nimboost::math::concepts::std_real_concept_base_type result = std::modf(a.value(), &ip);
   *ipart = ip;
   return result;
}
inline nimboost::math::concepts::std_real_concept frexp(nimboost::math::concepts::std_real_concept a, int* expon)
{ return std::frexp(a.value(), expon); }
inline nimboost::math::concepts::std_real_concept ldexp(nimboost::math::concepts::std_real_concept a, int expon)
{ return std::ldexp(a.value(), expon); }
inline nimboost::math::concepts::std_real_concept log(nimboost::math::concepts::std_real_concept a)
{ return std::log(a.value()); }
inline nimboost::math::concepts::std_real_concept log10(nimboost::math::concepts::std_real_concept a)
{ return std::log10(a.value()); }
inline nimboost::math::concepts::std_real_concept tan(nimboost::math::concepts::std_real_concept a)
{ return std::tan(a.value()); }
inline nimboost::math::concepts::std_real_concept pow(nimboost::math::concepts::std_real_concept a, nimboost::math::concepts::std_real_concept b)
{ return std::pow(a.value(), b.value()); }
#if !defined(__SUNPRO_CC)
inline nimboost::math::concepts::std_real_concept pow(nimboost::math::concepts::std_real_concept a, int b)
{ return std::pow(a.value(), b); }
#else
inline nimboost::math::concepts::std_real_concept pow(nimboost::math::concepts::std_real_concept a, int b)
{ return std::pow(a.value(), static_cast<long double>(b)); }
#endif
inline nimboost::math::concepts::std_real_concept sin(nimboost::math::concepts::std_real_concept a)
{ return std::sin(a.value()); }
inline nimboost::math::concepts::std_real_concept sinh(nimboost::math::concepts::std_real_concept a)
{ return std::sinh(a.value()); }
inline nimboost::math::concepts::std_real_concept sqrt(nimboost::math::concepts::std_real_concept a)
{ return std::sqrt(a.value()); }
inline nimboost::math::concepts::std_real_concept tanh(nimboost::math::concepts::std_real_concept a)
...
namespace nimboost{ namespace math{ namespace concepts{
...
{
   return nimboost::math::iround(v.value(), pol);
}
inline int iround(const concepts::std_real_concept& v)
{
   return nimboost::math::iround(v.value(), policies::policy<>());
}

template <class Policy>
inline long lround(const concepts::std_real_concept& v, const Policy& pol)
{
   return nimboost::math::lround(v.value(), pol);
}
inline long lround(const concepts::std_real_concept& v)
{
   return nimboost::math::lround(v.value(), policies::policy<>());
}

#ifdef BOOST_HAS_LONG_LONG

template <class Policy>
inline nimboost::long_long_type llround(const concepts::std_real_concept& v, const Policy& pol)
{
   return nimboost::math::llround(v.value(), pol);
}
inline nimboost::long_long_type llround(const concepts::std_real_concept& v)
{
   return nimboost::math::llround(v.value(), policies::policy<>());
}
...
{
   return nimboost::math::itrunc(v.value(), pol);
}
inline int itrunc(const concepts::std_real_concept& v)
{
   return nimboost::math::itrunc(v.value(), policies::policy<>());
}

template <class Policy>
inline long ltrunc(const concepts::std_real_concept& v, const Policy& pol)
{
   return nimboost::math::ltrunc(v.value(), pol);
}
inline long ltrunc(const concepts::std_real_concept& v)
{
   return nimboost::math::ltrunc(v.value(), policies::policy<>());
}

#ifdef BOOST_HAS_LONG_LONG

template <class Policy>
inline nimboost::long_long_type lltrunc(const concepts::std_real_concept& v, const Policy& pol)
{
   return nimboost::math::lltrunc(v.value(), pol);
}
inline nimboost::long_long_type lltrunc(const concepts::std_real_concept& v)
{
   return nimboost::math::lltrunc(v.value(), policies::policy<>());
}
