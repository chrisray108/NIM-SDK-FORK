...
struct RealTypeConcept
{
   ...
   void constraints()
   {
      ...
      r2 = ldexp(r, i);
      r2 = frexp(r, &i);
      i = nimboost::math::tools::digits<RealType>();
      r2 = nimboost::math::tools::max_value<RealType>();
      r2 = nimboost::math::tools::min_value<RealType>();
      r2 = nimboost::math::tools::log_max_value<RealType>();
      r2 = nimboost::math::tools::log_min_value<RealType>();
      r2 = nimboost::math::tools::epsilon<RealType>();
   }
