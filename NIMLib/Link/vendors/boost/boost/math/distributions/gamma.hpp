...
public:
   ...
   {
      RealType result;
      detail::check_gamma("nimboost::math::gamma_distribution<%1%>::gamma_distribution", l_scale, l_shape, &result, Policy());
   }
...
inline RealType pdf(const gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "nimboost::math::pdf(const gamma_distribution<%1%>&, %1%)";
...
inline RealType cdf(const gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "nimboost::math::cdf(const gamma_distribution<%1%>&, %1%)";
   ...
   result = nimboost::math::gamma_p(shape, x / scale, Policy());
   return result;
} // cdf
...
inline RealType mean(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "nimboost::math::mean(const gamma_distribution<%1%>&)";
...
inline RealType variance(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "nimboost::math::variance(const gamma_distribution<%1%>&)";
...
inline RealType mode(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "nimboost::math::mode(const gamma_distribution<%1%>&)";
...
inline RealType skewness(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "nimboost::math::skewness(const gamma_distribution<%1%>&)";
...
inline RealType kurtosis_excess(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "nimboost::math::kurtosis_excess(const gamma_distribution<%1%>&)";
