...
public:
      ...
      : m_shape(l_shape), m_scale(l_scale)
   {
      ...
      detail::check_inverse_gamma(
        "nimboost::math::inverse_gamma_distribution<%1%>::inverse_gamma_distribution",
...
inline RealType pdf(const inverse_gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "nimboost::math::pdf(const inverse_gamma_distribution<%1%>&, %1%)";
...
inline RealType cdf(const inverse_gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "nimboost::math::cdf(const inverse_gamma_distribution<%1%>&, %1%)";
   ...
   result = nimboost::math::gamma_q(shape, scale / x, Policy());
...
{
   BOOST_MATH_STD_USING  // for ADL of std functions
   using nimboost::math::gamma_q_inv;

   static const char* function = "nimboost::math::quantile(const inverse_gamma_distribution<%1%>&, %1%)";
...
inline RealType cdf(const complemented2_type<inverse_gamma_distribution<RealType, Policy>, RealType>& c)
{
   ...
   static const char* function = "nimboost::math::quantile(const gamma_distribution<%1%>&, %1%)";
...
inline RealType mean(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "nimboost::math::mean(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 1) || !(nimboost::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
inline RealType variance(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "nimboost::math::variance(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 2) || !(nimboost::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
inline RealType mode(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "nimboost::math::mode(const inverse_gamma_distribution<%1%>&)";
...
inline RealType skewness(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "nimboost::math::skewness(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 3) || !(nimboost::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
inline RealType kurtosis_excess(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "nimboost::math::kurtosis_excess(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 4) || !(nimboost::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
{
  static const char* function = "nimboost::math::kurtosis(const inverse_gamma_distribution<%1%>&)";
   RealType shape = dist.shape();
   RealType scale = dist.scale();
