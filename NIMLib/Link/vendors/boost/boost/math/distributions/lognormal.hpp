...
namespace detail
{
  ...
  {
     if((x < 0) || !(nimboost::math::isfinite)(x))
     {
...
public:
   ...
   {
      RealType result;
      detail::check_scale("nimboost::math::lognormal_distribution<%1%>::lognormal_distribution", l_scale, &result, Policy());
      detail::check_location("nimboost::math::lognormal_distribution<%1%>::lognormal_distribution", l_location, &result, Policy());
   }
...
{ // Range of permissible values for random variable x is >0 to +infinity.
   using nimboost::math::tools::max_value;
...
RealType pdf(const lognormal_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "nimboost::math::pdf(const lognormal_distribution<%1%>&, %1%)";
...
inline RealType cdf(const lognormal_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "nimboost::math::cdf(const lognormal_distribution<%1%>&, %1%)";
...
inline RealType quantile(const lognormal_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "nimboost::math::quantile(const lognormal_distribution<%1%>&, %1%)";
...
inline RealType mean(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("nimboost::math::mean(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("nimboost::math::mean(const lognormal_distribution<%1%>&)", mu, &result, Policy()))
      return result;
...
inline RealType variance(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("nimboost::math::variance(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("nimboost::math::variance(const lognormal_distribution<%1%>&)", mu, &result, Policy()))
      return result;

   return nimboost::math::expm1(sigma * sigma, Policy()) * exp(2 * mu + sigma * sigma);
}
...
inline RealType mode(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("nimboost::math::mode(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("nimboost::math::mode(const lognormal_distribution<%1%>&)", mu, &result, Policy()))
      return result;
...
inline RealType skewness(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("nimboost::math::skewness(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("nimboost::math::skewness(const lognormal_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;

   return (ess + 2) * sqrt(nimboost::math::expm1(ss, Policy()));
}
...
inline RealType kurtosis(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("nimboost::math::kurtosis(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("nimboost::math::kurtosis(const lognormal_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;
...
inline RealType kurtosis_excess(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("nimboost::math::kurtosis_excess(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("nimboost::math::kurtosis_excess(const lognormal_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;
