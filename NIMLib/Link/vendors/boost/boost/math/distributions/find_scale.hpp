...
// using nimboost::math::complement; // will be needed by users who want complement,
...
namespace nimboost
{
  namespace math
  {
      ...
      )
    {
      ...
      BOOST_STATIC_ASSERT(::nimboost::math::tools::is_distribution<Dist>::value); 
      BOOST_STATIC_ASSERT(::nimboost::math::tools::is_scaled_distribution<Dist>::value); 
#endif
      static const char* function = "nimboost::math::find_scale<Dist, Policy>(%1%, %1%, %1%, Policy)";
      ...
      complemented4_type<Real1, Real2, Real3, Policy> const& c)
    {
      ...
      BOOST_STATIC_ASSERT(::nimboost::math::tools::is_scaled_distribution<Dist>::value); 
#endif
      static const char* function = "nimboost::math::find_scale<Dist, Policy>(complement(%1%, %1%, %1%, Policy))";

      // Checks on arguments, as not complemented version,
      // Explicit policy.
      typename Dist::value_type q = c.param1;
      if(!(nimboost::math::isfinite)(q) || (q < 0) || (q > 1))
      {
        return policies::raise_domain_error<typename Dist::value_type>(
