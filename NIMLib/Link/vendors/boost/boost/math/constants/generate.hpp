...
#elif defined(USE_CPP_FLOAT)
typedef nimboost::multiprecision::number<nimboost::multiprecision::cpp_dec_float<500> > generator_type;
#else
...
#endif
   generator_type value = f(nimboost::mpl::int_<0>());
   std::stringstream os;
...
#define BOOST_CONSTANTS_GENERATE(name) \
   nimboost::math::constants::print_constant(#name, \
   & nimboost::math::constants::detail::BOOST_JOIN(constant_, name)<nimboost::math::constants::generator_type>::get)
