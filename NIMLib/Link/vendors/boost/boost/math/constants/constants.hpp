  ...
  namespace constants
  {
   ...
   public:
      typedef typename mpl::if_<
         mpl::and_<nimboost::is_convertible<float, Real>, mpl::bool_< t1::value <= t2::value>, mpl::bool_<0 != t1::value> >,
         mpl::int_<construct_from_float>,
         typename mpl::if_<
            mpl::and_<nimboost::is_convertible<double, Real>, mpl::bool_< t1::value <= t3::value>, mpl::bool_<0 != t1::value> >,
            mpl::int_<construct_from_double>,
            typename mpl::if_<
               mpl::and_<nimboost::is_convertible<long double, Real>, mpl::bool_< t1::value <= t4::value>, mpl::bool_<0 != t1::value> >,
               mpl::int_<construct_from_long_double>,
#ifdef BOOST_MATH_USE_FLOAT128
               typename mpl::if_<
                  mpl::and_<nimboost::is_convertible<__float128, Real>, mpl::bool_< t1::value <= t5::value>, mpl::bool_<0 != t1::value> >,
...
#define BOOST_MATH_CONSTANT_THREAD_HELPER(name, prefix) \
      nimboost::once_flag f = BOOST_ONCE_INIT;\
      nimboost::call_once(f, &BOOST_JOIN(BOOST_JOIN(string_, get_), name)<T>);
#else
#define BOOST_MATH_CONSTANT_THREAD_HELPER(name, prefix)
#endif
   ...
   namespace detail{
      ...
      template <class Real, class Policy = nimboost::math::policies::policy<> >
...
#else
         return nimboost::lexical_cast<Real>(p);
#endif
      }
      template <class Real>
...
#  define BOOST_MATH_FLOAT128_CONSTANT_OVERLOAD(x)
   ...
   {\
      static const T result = convert_from_string<T>(y, nimboost::is_convertible<const char*, T>());\
      return result;\
   }\
   ...
   { return name<T, nimboost::math::policies::policy<> >(); }\
   \
   \
