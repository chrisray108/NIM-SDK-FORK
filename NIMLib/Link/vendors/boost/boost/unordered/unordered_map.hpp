...
namespace unordered
{
    ...
    private:
        ...
        typedef nimboost::unordered::detail::map<A, K, T, H, P> types;
    ...
    public:
        ...
        explicit unordered_map(
                size_type = nimboost::unordered::detail::default_bucket_count,
                const hasher& = hasher(),
        ...
        unordered_map(BOOST_RV_REF(unordered_map) other)
            ...
            : table_(other.table_, nimboost::unordered::detail::move_tag())
        {
        }
        ...
        {
            return table_.emplace(nimboost::forward<Args>(args)...);
        }

        template <class... Args>
        iterator emplace_hint(const_iterator, BOOST_FWD_REF(Args)... args)
        {
            return table_.emplace(nimboost::forward<Args>(args)...).first;
        }
#else
        ...
        std::pair<iterator, bool> emplace(
                nimboost::unordered::detail::empty_emplace
                    = nimboost::unordered::detail::empty_emplace(),
                value_type v = value_type())
        {
            return this->emplace(nimboost::move(v));
        }
        ...
        {
            return this->emplace_hint(hint, nimboost::move(v));
        }
        ...
        std::pair<iterator, bool> emplace(BOOST_FWD_REF(A0) a0)
        {
            return table_.emplace(
                nimboost::unordered::detail::create_emplace_args(
                    nimboost::forward<A0>(a0))
            );
        }
...
#undef BOOST_UNORDERED_EMPLACE
        ...
        {
            return this->emplace(nimboost::move(x));
        }
        ...
        {
            return this->emplace_hint(hint, nimboost::move(x));
        }
    ...
    private:
        ...
        typedef nimboost::unordered::detail::multimap<A, K, T, H, P> types;
        typedef typename types::traits allocator_traits;
        typedef typename types::table table;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    unordered_map<K,T,H,P,A>::unordered_map(allocator_type const& a)
      : table_(nimboost::unordered::detail::default_bucket_count,
            hasher(), key_equal(), a)
    {
    }
    ...
    unordered_map<K,T,H,P,A>::unordered_map(InputIt f, InputIt l)
      : table_(nimboost::unordered::detail::initial_size(f, l),
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
            ...
            const hasher &hf,
            const key_equal &eql)
      : table_(nimboost::unordered::detail::initial_size(f, l, n),
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
            ...
            const key_equal &eql,
            const allocator_type &a)
      : table_(nimboost::unordered::detail::initial_size(f, l, n), hf, eql, a)
    {
        table_.insert_range(f, l);
    }
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
      ...
      : table_(other.table_, a, nimboost::unordered::detail::move_tag())
    {
    }
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
      ...
      : table_(
            nimboost::unordered::detail::initial_size(
