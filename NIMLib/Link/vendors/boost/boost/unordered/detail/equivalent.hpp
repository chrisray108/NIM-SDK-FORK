...
namespace nimboost { namespace unordered { namespace detail {
    ...
    struct grouped_node :
        nimboost::unordered::detail::value_base<T>
    {
        typedef typename ::nimboost::unordered::detail::rebind_wrap<
            A, grouped_node<A, T> >::type allocator;
        typedef typename ::nimboost::unordered::detail::
    ...
    struct grouped_ptr_node :
        nimboost::unordered::detail::value_base<T>,
        nimboost::unordered::detail::ptr_bucket
    {
        typedef nimboost::unordered::detail::ptr_bucket bucket_base;
    ...
    {
        typedef nimboost::unordered::detail::grouped_node<A, T> node;

        typedef typename nimboost::unordered::detail::allocator_traits<
            typename nimboost::unordered::detail::rebind_wrap<A, node>::type
        >::pointer node_pointer;

        typedef nimboost::unordered::detail::bucket<node_pointer> bucket;
        typedef node_pointer link_pointer;
    };

    template <typename A, typename T>
    struct pick_grouped_node2<A, T,
        nimboost::unordered::detail::grouped_ptr_node<T>*,
        nimboost::unordered::detail::ptr_bucket*>
    {
        typedef nimboost::unordered::detail::grouped_ptr_node<T> node;
        typedef nimboost::unordered::detail::ptr_bucket bucket;
    ...
    {
        typedef nimboost::unordered::detail::allocator_traits<
            typename nimboost::unordered::detail::rebind_wrap<A,
                nimboost::unordered::detail::grouped_ptr_node<T> >::type
        > tentative_node_traits;

        typedef nimboost::unordered::detail::allocator_traits<
            typename nimboost::unordered::detail::rebind_wrap<A,
                nimboost::unordered::detail::ptr_bucket >::type
    ...
    struct multiset
    {
        typedef nimboost::unordered::detail::multiset<A, T, H, P> types;
        ...
        typedef nimboost::unordered::detail::pick_grouped_node<allocator,
            value_type> pick;
        typedef typename pick::node node;
        typedef typename pick::bucket bucket;
        typedef typename pick::link_pointer link_pointer;

        typedef nimboost::unordered::detail::grouped_table_impl<types> table;
        typedef nimboost::unordered::detail::set_extractor<value_type> extractor;

        typedef nimboost::unordered::detail::pick_policy::type policy;
    };

    template <typename A, typename K, typename M, typename H, typename P>
    struct multimap
    {
        typedef nimboost::unordered::detail::multimap<A, K, M, H, P> types;
        ...
        typedef nimboost::unordered::detail::grouped_table_impl<types> table;
        typedef nimboost::unordered::detail::map_extractor<key_type, value_type>
            extractor;
    ...
    struct grouped_table_impl : nimboost::unordered::detail::table<Types>
    {
        typedef nimboost::unordered::detail::table<Types> table;
        ...
        grouped_table_impl(grouped_table_impl& x,
                nimboost::unordered::detail::move_tag m)
          : table(x, m)
        {}
...
#   if defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
        iterator emplace(nimboost::unordered::detail::emplace_args1<
                nimboost::unordered::detail::please_ignore_this_overload> const&)
        {
            BOOST_ASSERT(false);
            return iterator();
        }
...
#   endif
        ...
        template <class I>
        typename nimboost::unordered::detail::enable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            if(i == j) return;

            std::size_t distance = nimboost::unordered::detail::distance(i, j);
            if(distance == 1) {
                node_constructor a(this->node_alloc());
        ...
        template <class I>
        typename nimboost::unordered::detail::disable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            node_constructor a(this->node_alloc());
            for (; i != j; ++i) {
        ...
        static link_pointer split_groups(node_pointer begin, node_pointer end)
        {
            ...
            if (end) {
                ...
                nimboost::swap(first->group_prev_, end->group_prev_);
            ...
            if (prev) {
                ...
                nimboost::swap(first->group_prev_, begin->group_prev_);
            }
