...
namespace nimboost { namespace unordered { namespace iterator_detail {
            ...
            typename Node::value_type&>
    {
        ...
        friend struct nimboost::unordered::iterator_detail::cl_iterator;
    private:
#endif
        typedef typename Node::node_pointer node_pointer;
        typedef nimboost::unordered::iterator_detail::iterator<Node> iterator;
        node_pointer ptr_;
        std::size_t bucket_;
    ...
    {
        friend struct nimboost::unordered::iterator_detail::l_iterator
            <Node, Policy>;
    private:
    ...
    public:
        ...
        cl_iterator(nimboost::unordered::iterator_detail::l_iterator<
            ...
            typename Node::value_type&>
    {
        ...
        friend struct nimboost::unordered::iterator_detail::c_iterator;
        template <typename, typename>
        friend struct nimboost::unordered::iterator_detail::l_iterator;
        template <typename, typename, typename>
        friend struct nimboost::unordered::iterator_detail::cl_iterator;
        template <typename>
        friend struct nimboost::unordered::detail::table;
        template <typename>
        friend struct nimboost::unordered::detail::table_impl;
        template <typename>
        friend struct nimboost::unordered::detail::grouped_table_impl;
    private:
#endif
        typedef typename Node::node_pointer node_pointer;
        node_pointer node_;
    ...
    struct c_iterator
        : public nimboost::iterator<
            ...
            typename Node::value_type const&>
    {
        friend struct nimboost::unordered::iterator_detail::iterator<Node>;
...
namespace nimboost { namespace unordered { namespace detail {
    ...
    private:
        ...
        typedef nimboost::unordered::detail::allocator_traits<NodeAlloc>
    ...
    public:
        ...
        {
            construct();
            nimboost::unordered::detail::func::construct_value_impl(
        ...
        void construct_with_value2(BOOST_FWD_REF(A0) a0)
        {
            ...
            nimboost::unordered::detail::func::construct_value_impl(
                ...
                BOOST_UNORDERED_EMPLACE_ARGS1(nimboost::forward<A0>(a0)));
            value_constructed_ = true;
        }
    ...
    node_constructor<Alloc>::~node_constructor()
    {
        if (node_) {
            if (value_constructed_) {
                nimboost::unordered::detail::func::destroy_value_impl(alloc_,
                    node_->value_ptr());
            }

            if (node_constructed_) {
                node_allocator_traits::destroy(alloc_,
                    nimboost::addressof(*node_));
            }
    ...
    public:
        ...
        inline void move_assign_impl(T& v) {
            if (this->node_ && this->value_constructed_) {
                this->node_->value() = nimboost::move(v);
            }
            else {
                this->construct_with_value2(nimboost::move(v));
            }
        }
    ...
    node_holder<Alloc>::~node_holder()
    {
        while (nodes_) {
            ...
            nimboost::unordered::detail::func::destroy_value_impl(this->alloc_,
                p->value_ptr());
            node_allocator_traits::destroy(this->alloc_, nimboost::addressof(*p));
    ...
    struct prime_policy
    {
        ...
        static inline SizeT new_bucket_count(SizeT min) {
            return nimboost::unordered::detail::next_prime(min);
        }

        static inline SizeT prev_bucket_count(SizeT max) {
            return nimboost::unordered::detail::prev_prime(max);
        }
    };
    ...
    public:
        static const bool nothrow_move_assignable =
                nimboost::is_nothrow_move_assignable<H>::value &&
                nimboost::is_nothrow_move_assignable<P>::value;
        static const bool nothrow_move_constructible =
                nimboost::is_nothrow_move_constructible<H>::value &&
                nimboost::is_nothrow_move_constructible<P>::value;

    private:
        friend class nimboost::unordered::detail::set_hash_functions<H, P,
               nothrow_move_assignable>;
        functions& operator=(functions const&);

        typedef compressed<H, P> function_pair;

        typedef typename nimboost::aligned_storage<
            sizeof(function_pair),
            nimboost::alignment_of<function_pair>::value>::type aligned_function;
        ...
        void construct(bool which, function_pair const& f,
                nimboost::unordered::detail::false_type =
                    nimboost::unordered::detail::false_type())
        {
        ...
        void construct(bool which, function_pair& f,
                nimboost::unordered::detail::true_type)
        {
            new((void*) &funcs_[which]) function_pair(f,
                nimboost::unordered::detail::move_tag());
        }

        void destroy(bool which)
        {
            nimboost::unordered::detail::func::destroy((function_pair*)(&funcs_[which]));
        }
        
    public:

        typedef nimboost::unordered::detail::set_hash_functions<H, P,
        ...
        functions(functions& bf, nimboost::unordered::detail::move_tag)
            : current_(false)
        {
            construct(current_, bf.current(),
                nimboost::unordered::detail::integral_constant<bool,
    ...
    public:
        ...
        void commit()
        {
            functions_.current().first() = nimboost::move(hash_);
            functions_.current().second() = nimboost::move(pred_);
        }
    };
...
#   define BOOST_UNORDERED_RV_REF(T) BOOST_RV_REF(T)
    ...
    template <typename T>
    struct rv_ref :
        nimboost::detail::if_true<
            nimboost::is_class<T>::value
        >::BOOST_NESTED_TEMPLATE then <
            nimboost::unordered::detail::rv_ref_impl<T>,
            please_ignore_this_overload
        >::type
    {};

#   define BOOST_UNORDERED_RV_REF(T) \
        typename nimboost::unordered::detail::rv_ref<T>::type
#endif
}}}
