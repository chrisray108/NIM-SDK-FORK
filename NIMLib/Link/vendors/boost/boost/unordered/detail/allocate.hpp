...
namespace nimboost { namespace unordered { namespace detail {

    ////////////////////////////////////////////////////////////////////////////
    // Bits and pieces for implementing traits

    template <typename T> typename nimboost::add_lvalue_reference<T>::type make();
...
#define BOOST_UNORDERED_EMPLACE_FORWARD nimboost::forward<Args>(args)...
...
#define BOOST_UNORDERED_CALL_FORWARD(z, i, a) \
    nimboost::forward<BOOST_PP_CAT(A,i)>(BOOST_PP_CAT(a,i))
...
#define BOOST_UNORDERED_EARGS_INIT(z, n, _)                                 \
    BOOST_PP_CAT(a, n)(                                                     \
        nimboost::forward<BOOST_PP_CAT(A,n)>(BOOST_PP_CAT(b, n)))

#else

#define BOOST_UNORDERED_EARGS_MEMBER(z, n, _)                               \
    typedef typename nimboost::add_lvalue_reference<BOOST_PP_CAT(A, n)>::type  \
        BOOST_PP_CAT(Arg, n);                                               \
    BOOST_PP_CAT(Arg, n) BOOST_PP_CAT(a, n);
...
// 2 = nimboost::container::allocator_traits
...
namespace nimboost { namespace unordered { namespace detail {
    ...
    typedef nimboost::unordered::detail::integral_constant<bool, true> true_type;
    typedef nimboost::unordered::detail::integral_constant<bool, false> false_type;
...
#   define BOOST_UNORDERED_CHECK_EXPRESSION(count, result, expression)      \
        template <typename U>                                               \
        static typename nimboost::unordered::detail::expr_test<                \
...
#   define BOOST_UNORDERED_HAS_FUNCTION(name, thing, args, _)               \
    ...
    {                                                                       \
        ...
        BOOST_UNORDERED_CHECK_EXPRESSION(1, 1,                              \
            nimboost::unordered::detail::make< thing >().name args);           \
...
#   define BOOST_UNORDERED_CHECK_MEMBER(count, result, name, member)        \
                                                                            \
    typedef typename nimboost::unordered::detail::identity<member>::type       \
...
#       define BOOST_UNORDERED_DEFAULT_TYPE_TMPLT(tname)                    \
    ...
    struct default_type_ ## tname {                                         \
        ...
        enum { value = (1 == sizeof(test<Tp>(choose()))) };                 \
                                                                            \
        typedef typename nimboost::detail::if_true<value>::                    \
...
#       define BOOST_UNORDERED_DEFAULT_TYPE_TMPLT(tname)                    \
    ...
    struct default_type_ ## tname {                                         \
                                                                            \
        template <typename X>                                               \
        static typename nimboost::unordered::detail::sfinae<                   \
...
#       if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
    ...
    BOOST_UNORDERED_HAS_FUNCTION(
    construct, U, (
        nimboost::unordered::detail::make<ValueType*>(),
        nimboost::unordered::detail::make<Args const>()...), 2
    );
...
#       else
    ...
    construct, U, (
        nimboost::unordered::detail::make<ValueType*>(),
        nimboost::unordered::detail::make<ValueType const>()), 2
    );
...
#       endif
    ...
    template <typename T, typename ValueType>
    BOOST_UNORDERED_HAS_FUNCTION(
        destroy, U, (nimboost::unordered::detail::make<ValueType*>()), 1
    );
...
#   endif
    ...
    template <typename Alloc>
    inline Alloc call_select_on_container_copy_construction(const Alloc& rhs,
        typename nimboost::disable_if_c<
            nimboost::unordered::detail::
            has_select_on_container_copy_construction<Alloc>::value, void*
        >::type = 0)
    {
    ...
    inline SizeType call_max_size(const Alloc& a,
        typename nimboost::enable_if_c<
            nimboost::unordered::detail::has_max_size<Alloc>::value, void*
        >::type = 0)
    {
        return a.max_size();
    }
    ...
    template <typename SizeType, typename Alloc>
    inline SizeType call_max_size(const Alloc&, typename nimboost::disable_if_c<
            nimboost::unordered::detail::has_max_size<Alloc>::value, void*
        >::type = 0)
    {
    ...
    struct allocator_traits
    {
        ...
        template <typename T>
        struct pointer_to_other : nimboost::pointer_to_other<pointer, T> {};
...
#   if BOOST_UNORDERED_DETAIL_FULL_CONSTRUCT
        ...
        static typename nimboost::enable_if_c<
                nimboost::unordered::detail::has_construct<Alloc, T, Args...>
                ::value>::type
            construct(Alloc& a, T* p, BOOST_FWD_REF(Args)... x)
        {
            a.construct(p, nimboost::forward<Args>(x)...);
        }

        template <typename T, typename... Args>
        static typename nimboost::disable_if_c<
                nimboost::unordered::detail::has_construct<Alloc, T, Args...>
                ::value>::type
            construct(Alloc&, T* p, BOOST_FWD_REF(Args)... x)
        {
            new ((void*) p) T(nimboost::forward<Args>(x)...);
        }

        template <typename T>
        static typename nimboost::enable_if_c<
                nimboost::unordered::detail::has_destroy<Alloc, T>::value>::type
            destroy(Alloc& a, T* p)
        {
            a.destroy(p);
        }
        ...
        static typename nimboost::disable_if_c<
            ...
            destroy(Alloc&, T* p)
        {
            nimboost::unordered::detail::func::destroy(p);
        }
...
#   elif !defined(BOOST_NO_SFINAE_EXPR)
        ...
        template <typename T>
        static typename nimboost::enable_if_c<
                nimboost::unordered::detail::has_construct<Alloc, T>::value>::type
...
#   else
        ...
        static void construct(Alloc& a, T* p, T const& x,
            typename nimboost::enable_if_c<
                    nimboost::unordered::detail::has_construct<Alloc, T>::value &&
                    nimboost::is_same<T, value_type>::value,
                    void*>::type = 0)
        {
            a.construct(p, x);
        }
        ...
        static void destroy(Alloc& a, T* p,
            typename nimboost::enable_if_c<
                nimboost::unordered::detail::has_destroy<Alloc, T>::value &&
                nimboost::is_same<T, value_type>::value,
                void*>::type = 0)
        {
            a.destroy(p);
...
#   endif
        ...
        {
            return nimboost::unordered::detail::func::
...
////////////////////////////////////////////////////////////////////////////////
//
// nimboost::container::allocator_traits
...
namespace nimboost { namespace unordered { namespace detail {
    ...
    template <typename Alloc>
    struct allocator_traits :
        nimboost::container::allocator_traits<Alloc> {};
...
namespace nimboost { namespace unordered { namespace detail { namespace func {
...
#   if BOOST_UNORDERED_DETAIL_FULL_CONSTRUCT
    ...
    {
        nimboost::unordered::detail::allocator_traits<Alloc>::construct(alloc,
            address, nimboost::forward<Args>(args)...);
    }

    template <typename Alloc, typename T>
    inline void destroy_value_impl(Alloc& alloc, T* x) {
        nimboost::unordered::detail::allocator_traits<Alloc>::destroy(alloc, x);
    }
...
#   else
    ...
    inline void call_construct(Alloc&, T* address,
        BOOST_FWD_REF(Args)... args)
    {
        new((void*) address) T(nimboost::forward<Args>(args)...);
    }

    template <typename Alloc, typename T>
    inline void destroy_value_impl(Alloc&, T* x) {
        nimboost::unordered::detail::func::destroy(x);
    }
...
#   define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(n, namespace_)              \
    ...
    {                                                                       \
        nimboost::unordered::detail::func::call_construct(alloc, ptr);         \
    }                                                                       \
                                                                            \
...
#   define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(n, namespace_)              \
    ...
    void construct_from_tuple_impl(                                         \
            nimboost::unordered::detail::length<0>, Alloc&, T* ptr,            \
            namespace_ tuple<>)                                             \
    {                                                                       \
        new ((void*) ptr) T();                                              \
    }                                                                       \
...
#   define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE_IMPL(z, n, namespace_)      \
    template<typename Alloc, typename T,                                    \
        BOOST_PP_ENUM_PARAMS_Z(z, n, typename A)>                           \
    void construct_from_tuple_impl(                                         \
            nimboost::unordered::detail::length<n>, Alloc&, T* ptr,            \
            namespace_ tuple<BOOST_PP_ENUM_PARAMS_Z(z, n, A)> const& x)     \
    {                                                                       \
        new ((void*) ptr) T(                                                \
            BOOST_PP_ENUM_##z(n, BOOST_UNORDERED_GET_TUPLE_ARG, namespace_) \
...
BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(10, nimboost::)
...
#undef BOOST_UNORDERED_GET_TUPLE_ARG
    ...
    void construct_from_tuple(Alloc& alloc, T* ptr, Tuple const& x)
    {
        construct_from_tuple_impl(
            nimboost::unordered::detail::length<
                nimboost::tuples::length<Tuple>::value>(),
            alloc, ptr, x);
    }
    ...
    struct use_piecewise {
        static choice1::type test(choice1,
            nimboost::unordered::piecewise_construct_t);

        static choice2::type test(choice2, ...);

        enum { value = sizeof(choice1::type) ==
            sizeof(test(choose(), nimboost::unordered::detail::make<A0>())) };
    };
    ...
    inline void construct_value_impl(Alloc& alloc, T* address,
        BOOST_FWD_REF(Args)... args)
    {
        nimboost::unordered::detail::func::call_construct(alloc,
            address, nimboost::forward<Args>(args)...);
    }
    ...
    {
        nimboost::unordered::detail::func::construct_from_tuple(alloc,
            nimboost::addressof(address->first), nimboost::forward<A1>(a1));
        nimboost::unordered::detail::func::construct_from_tuple(alloc,
            nimboost::addressof(address->second), nimboost::forward<A2>(a2));
    }
...
// Construct from emplace_args
    ...
    {
        new((void*) address) T(nimboost::forward<A0>(args.a0));
    }
    ...
    {
        new((void*) address) T(
            nimboost::forward<A0>(args.a0),
            nimboost::forward<A1>(args.a1)
        );
    }
...
#define BOOST_UNORDERED_CONSTRUCT_IMPL(z, num_params, _)                    \
    ...
    >                                                                       \
    inline void construct_value_impl(Alloc&, T* address,                    \
        nimboost::unordered::detail::BOOST_PP_CAT(emplace_args,num_params) <   \
...
#undef BOOST_UNORDERED_CONSTRUCT_IMPL
    ...
    inline void construct_value_impl(Alloc& alloc, std::pair<A, B>* address,
            nimboost::unordered::detail::emplace_args3<A0, A1, A2> const& args,
            typename enable_if<use_piecewise<A0>, void*>::type = 0)
    {
        nimboost::unordered::detail::func::construct_from_tuple(alloc,
            nimboost::addressof(address->first), args.a1);
        nimboost::unordered::detail::func::construct_from_tuple(alloc,
            nimboost::addressof(address->second), args.a2);
    }
...
namespace nimboost { namespace unordered { namespace detail {
    ...
    {
        typedef nimboost::unordered::detail::allocator_traits<Allocator> traits;
        ...
        ~array_constructor() {
            if (ptr_) {
                for(pointer p = ptr_; p != constructed_; ++p)
                    traits::destroy(alloc_, nimboost::addressof(*p));
        ...
        void construct(V const& v, std::size_t l)
        {
            ...
            for(constructed_ = ptr_; constructed_ != end; ++constructed_)
                traits::construct(alloc_, nimboost::addressof(*constructed_), v);
        }
