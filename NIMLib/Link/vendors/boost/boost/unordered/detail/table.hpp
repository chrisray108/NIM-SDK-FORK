...
namespace nimboost { namespace unordered { namespace detail {
    ...
    struct value_base
    {
        ...
        typename nimboost::aligned_storage<
            sizeof(value_type),
            nimboost::alignment_of<value_type>::value>::type data_;
    ...
    struct move_nodes
    {
        ...
        {
            constructor.construct_with_value2(nimboost::move(v));
            return constructor.release();
        }
    };
    ...
    struct table :
        nimboost::unordered::detail::functions<
    ...
    public:
        ...
        typedef nimboost::unordered::detail::functions<
            typename Types::hasher,
        ...
        typedef nimboost::unordered::detail::allocator_traits<node_allocator>
            node_allocator_traits;
        typedef nimboost::unordered::detail::allocator_traits<bucket_allocator>
        ...
        typedef typename bucket_allocator_traits::pointer
            bucket_pointer;
        typedef nimboost::unordered::detail::node_constructor<node_allocator>
            node_constructor;

        typedef nimboost::unordered::iterator_detail::
        ...
        nimboost::unordered::detail::compressed<bucket_allocator, node_allocator>
            allocators_;
        ...
        std::size_t max_size() const
        {
            ...
            // size < mlf_ * count
            return nimboost::unordered::detail::double_to_size(ceil(
        ...
        void recalculate_max_load()
        {
            ...
            max_load_ = buckets_ ? nimboost::unordered::detail::double_to_size(ceil(
                    static_cast<double>(mlf_) *
        ...
        std::size_t min_buckets_for_size(std::size_t size) const
        {
            ...
            return policy::new_bucket_count(
                nimboost::unordered::detail::double_to_size(floor(
        ...
        table(table& x, nimboost::unordered::detail::move_tag m) :
            functions(x, m),
        ...
        {
            nimboost::unordered::detail::array_constructor<bucket_allocator>
        ...
        {
            nimboost::unordered::detail::func::ignore_unused_variable_warning(other);
        ...
        void swap(table& x)
        {
            ...
            nimboost::swap(buckets_, x.buckets_);
            nimboost::swap(bucket_count_, x.bucket_count_);
            nimboost::swap(size_, x.size_);
        ...
        void delete_node(link_pointer prev)
        {
            ...
            nimboost::unordered::detail::func::destroy_value_impl(node_alloc(),
                n->value_ptr());
            node_allocator_traits::destroy(node_alloc(),
                    nimboost::addressof(*n));
