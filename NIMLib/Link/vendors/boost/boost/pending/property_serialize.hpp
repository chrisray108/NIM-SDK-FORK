...
namespace nimboost { namespace mpi {
    template<>
    struct is_mpi_datatype<nimboost::no_property> : mpl::true_ { };

} } // end namespace nimboost::mpi

BOOST_IS_BITWISE_SERIALIZABLE(nimboost::no_property)
BOOST_CLASS_IMPLEMENTATION(nimboost::no_property,object_serializable)
BOOST_CLASS_TRACKING(nimboost::no_property,track_never)
#endif // BOOST_GRAPH_USE_MPI
