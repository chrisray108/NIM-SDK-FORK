...
#ifndef BASE_UTIL_BIND_HELPERS_H_
#define BASE_UTIL_BIND_HELPERS_H_
...
template <typename T>
struct MaybeRefcount<nbase::false_type, T>
{
...
struct MaybeRefcount<nbase::false_type, T[n]>
{
	static void AddRef(const T*) {}
	static void Release(const T*) {}
};
...
template <typename T>
struct MaybeRefcount<nbase::true_type, UnretainedWrapper<T> >
{
...
template <typename T>
struct MaybeRefcount<nbase::true_type, T*>
{
...
template <typename T>
struct MaybeRefcount<nbase::true_type, const T*>
{
...
template <typename T>
struct MaybeRefcount<nbase::true_type, WeakPtr<T> >
{
...
#endif  // BASE_UTIL_BIND_HELPERS_H_
