...
#ifndef BASE_UTIL_CALLBACK_INTERNAL_H_
#define BASE_UTIL_CALLBACK_INTERNAL_H_
...
// "type erasure."
class InvokerStorageBase : public ThreadSafeRefCount
{
protected:
...
protected:
	...
	// another type. It is not ok to use void*. We create a InvokeFuncStorage
...
#endif  // BASE_UTIL_CALLBACK_INTERNAL_H_
