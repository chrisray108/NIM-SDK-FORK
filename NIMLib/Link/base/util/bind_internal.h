...
#ifndef BASE_UTIL_BIND_INTERNAL_H_
#define BASE_UTIL_BIND_INTERNAL_H_

#include "base/util/bind_helpers.h"
...
#if defined(OS_WIN)
#include "base/util/bind_internal_win.h"
#endif
...
#endif  // BASE_UTIL_BIND_INTERNAL_H_