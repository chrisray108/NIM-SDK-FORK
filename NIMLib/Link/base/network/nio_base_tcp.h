 ...
 */
class BASE_API TcpClient : public NIOBinaryClientInterface
{
    friend class ProxySocketLayer;
public:
...
public:
    // proxy support
    void SetProxy(const nbase::ProxySet *proxy);
...
private:
    int ConnectDirectly(const char *host, int port);
...
private:
    ...
    bool                        proxy_connected_;   // is proxy connected
    bool                        proxy_can_change_;  // is proxy can change
    nbase::ProxySocketLayer     *proxy_layer_;      // proxy layer
};
 ...
 */
class BASE_API TcpConnection : public NIOBinaryConnectionInterface
{
public:
 ...
 */
class BASE_API TcpServer : public NIOServerAbleInterface
{
public:
